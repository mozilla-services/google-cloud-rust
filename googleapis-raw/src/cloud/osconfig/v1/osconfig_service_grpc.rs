...
const METHOD_OS_CONFIG_SERVICE_UPDATE_PATCH_DEPLOYMENT: ::grpcio::Method<super::patch_deployments::UpdatePatchDeploymentRequest, super::patch_deployments::PatchDeployment> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/google.cloud.osconfig.v1.OsConfigService/UpdatePatchDeployment",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};

const METHOD_OS_CONFIG_SERVICE_PAUSE_PATCH_DEPLOYMENT: ::grpcio::Method<super::patch_deployments::PausePatchDeploymentRequest, super::patch_deployments::PatchDeployment> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/google.cloud.osconfig.v1.OsConfigService/PausePatchDeployment",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};

const METHOD_OS_CONFIG_SERVICE_RESUME_PATCH_DEPLOYMENT: ::grpcio::Method<super::patch_deployments::ResumePatchDeploymentRequest, super::patch_deployments::PatchDeployment> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/google.cloud.osconfig.v1.OsConfigService/ResumePatchDeployment",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
impl OsConfigServiceClient {
    ...
    pub fn update_patch_deployment_opt(&self, req: &super::patch_deployments::UpdatePatchDeploymentRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::patch_deployments::PatchDeployment> {
        self.client.unary_call(&METHOD_OS_CONFIG_SERVICE_UPDATE_PATCH_DEPLOYMENT, req, opt)
    }

    pub fn update_patch_deployment(&self, req: &super::patch_deployments::UpdatePatchDeploymentRequest) -> ::grpcio::Result<super::patch_deployments::PatchDeployment> {
        self.update_patch_deployment_opt(req, ::grpcio::CallOption::default())
    }

    pub fn update_patch_deployment_async_opt(&self, req: &super::patch_deployments::UpdatePatchDeploymentRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::patch_deployments::PatchDeployment>> {
        self.client.unary_call_async(&METHOD_OS_CONFIG_SERVICE_UPDATE_PATCH_DEPLOYMENT, req, opt)
    }

    pub fn update_patch_deployment_async(&self, req: &super::patch_deployments::UpdatePatchDeploymentRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::patch_deployments::PatchDeployment>> {
        self.update_patch_deployment_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn pause_patch_deployment_opt(&self, req: &super::patch_deployments::PausePatchDeploymentRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::patch_deployments::PatchDeployment> {
        self.client.unary_call(&METHOD_OS_CONFIG_SERVICE_PAUSE_PATCH_DEPLOYMENT, req, opt)
    }

    pub fn pause_patch_deployment(&self, req: &super::patch_deployments::PausePatchDeploymentRequest) -> ::grpcio::Result<super::patch_deployments::PatchDeployment> {
        self.pause_patch_deployment_opt(req, ::grpcio::CallOption::default())
    }

    pub fn pause_patch_deployment_async_opt(&self, req: &super::patch_deployments::PausePatchDeploymentRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::patch_deployments::PatchDeployment>> {
        self.client.unary_call_async(&METHOD_OS_CONFIG_SERVICE_PAUSE_PATCH_DEPLOYMENT, req, opt)
    }

    pub fn pause_patch_deployment_async(&self, req: &super::patch_deployments::PausePatchDeploymentRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::patch_deployments::PatchDeployment>> {
        self.pause_patch_deployment_async_opt(req, ::grpcio::CallOption::default())
    }

    pub fn resume_patch_deployment_opt(&self, req: &super::patch_deployments::ResumePatchDeploymentRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::patch_deployments::PatchDeployment> {
        self.client.unary_call(&METHOD_OS_CONFIG_SERVICE_RESUME_PATCH_DEPLOYMENT, req, opt)
    }

    pub fn resume_patch_deployment(&self, req: &super::patch_deployments::ResumePatchDeploymentRequest) -> ::grpcio::Result<super::patch_deployments::PatchDeployment> {
        self.resume_patch_deployment_opt(req, ::grpcio::CallOption::default())
    }

    pub fn resume_patch_deployment_async_opt(&self, req: &super::patch_deployments::ResumePatchDeploymentRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::patch_deployments::PatchDeployment>> {
        self.client.unary_call_async(&METHOD_OS_CONFIG_SERVICE_RESUME_PATCH_DEPLOYMENT, req, opt)
    }

    pub fn resume_patch_deployment_async(&self, req: &super::patch_deployments::ResumePatchDeploymentRequest) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::patch_deployments::PatchDeployment>> {
        self.resume_patch_deployment_async_opt(req, ::grpcio::CallOption::default())
    }
...
pub trait OsConfigService {
    ...
    fn update_patch_deployment(&mut self, ctx: ::grpcio::RpcContext, _req: super::patch_deployments::UpdatePatchDeploymentRequest, sink: ::grpcio::UnarySink<super::patch_deployments::PatchDeployment>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn pause_patch_deployment(&mut self, ctx: ::grpcio::RpcContext, _req: super::patch_deployments::PausePatchDeploymentRequest, sink: ::grpcio::UnarySink<super::patch_deployments::PatchDeployment>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn resume_patch_deployment(&mut self, ctx: ::grpcio::RpcContext, _req: super::patch_deployments::ResumePatchDeploymentRequest, sink: ::grpcio::UnarySink<super::patch_deployments::PatchDeployment>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
}
...
pub fn create_os_config_service<S: OsConfigService + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let mut instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_OS_CONFIG_SERVICE_UPDATE_PATCH_DEPLOYMENT, move |ctx, req, resp| {
        instance.update_patch_deployment(ctx, req, resp)
    });
    let mut instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_OS_CONFIG_SERVICE_PAUSE_PATCH_DEPLOYMENT, move |ctx, req, resp| {
        instance.pause_patch_deployment(ctx, req, resp)
    });
    let mut instance = s;
    builder = builder.add_unary_handler(&METHOD_OS_CONFIG_SERVICE_RESUME_PATCH_DEPLOYMENT, move |ctx, req, resp| {
        instance.resume_patch_deployment(ctx, req, resp)
    });
    builder.build()
}
