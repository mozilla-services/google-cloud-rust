...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            deps.push(super::instance_os_policies_compliance::file_descriptor().clone());
            deps.push(super::inventory::file_descriptor().clone());
            deps.push(super::os_policy_assignment_reports::file_descriptor().clone());
            deps.push(super::os_policy_assignments::file_descriptor().clone());
