...
// @@protoc_insertion_point(message:google.cloud.osconfig.v1alpha.FixedOrPercent)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct FixedOrPercent {
    // message oneof groups
    pub mode: ::std::option::Option<fixed_or_percent::Mode>,
    // special fields
    // @@protoc_insertion_point(special_field:google.cloud.osconfig.v1alpha.FixedOrPercent.special_fields)
...
pub mod fixed_or_percent {
    ...
    #[non_exhaustive]
    // @@protoc_insertion_point(oneof:google.cloud.osconfig.v1alpha.FixedOrPercent.mode)
    pub enum Mode {
        // @@protoc_insertion_point(oneof_field:google.cloud.osconfig.v1alpha.FixedOrPercent.fixed)
        Fixed(i32),
        // @@protoc_insertion_point(oneof_field:google.cloud.osconfig.v1alpha.FixedOrPercent.percent)
        Percent(i32),
    }
