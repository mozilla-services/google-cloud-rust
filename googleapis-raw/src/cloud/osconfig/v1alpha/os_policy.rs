...
impl OSPolicy {
    ...
    // .google.cloud.osconfig.v1alpha.OSPolicy.Mode mode = 3;
    ...
    // repeated .google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup resource_groups = 4;
...
impl<'a> ::std::default::Default for &'a OSPolicy_OSFilter {
    fn default() -> &'a OSPolicy_OSFilter {
        <OSPolicy_OSFilter as ::protobuf::Message>::default_instance()
    }
}

impl OSPolicy_OSFilter {
    pub fn new() -> OSPolicy_OSFilter {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for OSPolicy_OSFilter {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn new() -> OSPolicy_OSFilter {
        OSPolicy_OSFilter::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "os_short_name",
                |m: &OSPolicy_OSFilter| { &m.os_short_name },
                |m: &mut OSPolicy_OSFilter| { &mut m.os_short_name },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "os_version",
                |m: &OSPolicy_OSFilter| { &m.os_version },
                |m: &mut OSPolicy_OSFilter| { &mut m.os_version },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<OSPolicy_OSFilter>(
                "OSPolicy.OSFilter",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static OSPolicy_OSFilter {
        static instance: ::protobuf::rt::LazyV2<OSPolicy_OSFilter> = ::protobuf::rt::LazyV2::INIT;
        instance.get(OSPolicy_OSFilter::new)
    }
}

impl ::protobuf::Clear for OSPolicy_OSFilter {
    fn clear(&mut self) {
        self.os_short_name.clear();
        self.os_version.clear();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for OSPolicy_OSFilter {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for OSPolicy_OSFilter {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
impl OSPolicy_Resource_PackageResource {
    ...
    // .google.cloud.osconfig.v1alpha.OSPolicy.Resource.PackageResource.DesiredState desired_state = 1;
...
impl OSPolicy_Resource_PackageResource_Deb {
    ...
    // .google.cloud.osconfig.v1alpha.OSPolicy.Resource.File source = 1;
...
impl OSPolicy_Resource_RepositoryResource_AptRepository {
    ...
    // .google.cloud.osconfig.v1alpha.OSPolicy.Resource.RepositoryResource.AptRepository.ArchiveType archive_type = 1;
...
impl OSPolicy_Resource_ExecResource {
    ...
    // .google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource.Exec validate = 1;
...
impl OSPolicy_Resource_ExecResource_Exec {
    ...
    // .google.cloud.osconfig.v1alpha.OSPolicy.Resource.ExecResource.Exec.Interpreter interpreter = 4;
...
impl OSPolicy_Resource_FileResource {
    ...
    // .google.cloud.osconfig.v1alpha.OSPolicy.Resource.FileResource.DesiredState state = 4;
...
pub struct OSPolicy_ResourceGroup {
    // message fields
    pub os_filter: ::protobuf::SingularPtrField<OSPolicy_OSFilter>,
...
impl OSPolicy_ResourceGroup {
    ...
    pub fn get_os_filter(&self) -> &OSPolicy_OSFilter {
        self.os_filter.as_ref().unwrap_or_else(|| <OSPolicy_OSFilter as ::protobuf::Message>::default_instance())
    }
    pub fn clear_os_filter(&mut self) {
        self.os_filter.clear();
    }

    pub fn has_os_filter(&self) -> bool {
        self.os_filter.is_some()
    }

    // Param is passed by value, moved
    pub fn set_os_filter(&mut self, v: OSPolicy_OSFilter) {
        self.os_filter = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_os_filter(&mut self) -> &mut OSPolicy_OSFilter {
        if self.os_filter.is_none() {
            self.os_filter.set_default();
        }
        self.os_filter.as_mut().unwrap()
    }

    // Take field
    pub fn take_os_filter(&mut self) -> OSPolicy_OSFilter {
        self.os_filter.take().unwrap_or_else(|| OSPolicy_OSFilter::new())
    }
    ...
    // repeated .google.cloud.osconfig.v1alpha.OSPolicy.Resource resources = 2;
...
impl ::protobuf::Message for OSPolicy_ResourceGroup {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.os_filter)?;
                },
                3 => {
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if let Some(ref v) = self.os_filter.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<OSPolicy_OSFilter>>(
                "os_filter",
                |m: &OSPolicy_ResourceGroup| { &m.os_filter },
                |m: &mut OSPolicy_ResourceGroup| { &mut m.os_filter },
            ));
