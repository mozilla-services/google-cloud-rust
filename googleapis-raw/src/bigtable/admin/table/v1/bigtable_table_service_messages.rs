...
impl ::protobuf::Message for RenameTableRequest {
    ...
    fn default_instance() -> &'static RenameTableRequest {
        static mut instance: ::protobuf::lazy::Lazy<RenameTableRequest> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for CreateColumnFamilyRequest {
    ...
    fn default_instance() -> &'static CreateColumnFamilyRequest {
        static mut instance: ::protobuf::lazy::Lazy<CreateColumnFamilyRequest> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for DeleteColumnFamilyRequest {
    ...
    fn default_instance() -> &'static DeleteColumnFamilyRequest {
        static mut instance: ::protobuf::lazy::Lazy<DeleteColumnFamilyRequest> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for BulkDeleteRowsRequest {
    ...
    fn default_instance() -> &'static BulkDeleteRowsRequest {
        static mut instance: ::protobuf::lazy::Lazy<BulkDeleteRowsRequest> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17\0;\n\t\n\x02\x08\x01\x12\x03\x17\0;\n\n\n\x02\x04\0\x12\x04\x1a\06\
    \x01\n\n\n\x03\x04\0\x01\x12\x03\x1a\x08\x1a\nO\n\x04\x04\0\x02\0\x12\
    \x03\x1c\x02\x12\x1aB\x20The\x20unique\x20name\x20of\x20the\x20cluster\
    ...
    \x04\0\x02\x01\x12\x03\x20\x02\x16\x1a\x86\x01\x20The\x20name\x20by\x20w\
    hich\x20the\x20new\x20table\x20should\x20be\x20referred\x20to\x20within\
    \x20the\x20cluster,\n\x20e.g.\x20\"foobar\"\x20rather\x20than\x20\"<clus\
    ter_name>/tables/foobar\".\n\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03\x20\
    \x02\x08\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\x20\t\x11\n\x0c\n\x05\x04\
    \0\x02\x01\x03\x12\x03\x20\x14\x15\n\x9c\x01\n\x04\x04\0\x02\x02\x12\x03\
    $\x02\x12\x1a\x8e\x01\x20The\x20Table\x20to\x20create.\x20The\x20`name`\
    \x20field\x20of\x20the\x20Table\x20and\x20all\x20of\x20its\n\x20ColumnFa\
    milies\x20must\x20be\x20left\x20blank,\x20and\x20will\x20be\x20populated\
    ...
    \x1a\xf6\x05\x20The\x20optional\x20list\x20of\x20row\x20keys\x20that\x20\
    ...
    egions).\n\x20Given\x20two\x20split\x20keys,\x20\"s1\"\x20and\x20\"s2\",\
    \x20three\x20tablets\x20will\x20be\x20created,\n\x20spanning\x20the\x20k\
    ey\x20ranges:\x20[,\x20s1),\x20[s1,\x20s2),\x20[s2,\x20).\n\n\x20Example\
    :\n\x20\x20*\x20Row\x20keys\x20:=\x20[\"a\",\x20\"apple\",\x20\"custom\"\
    ,\x20\"customer_1\",\x20\"customer_2\",\n\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\"other\",\x20\"zz\"]\n\x20\x20*\
    \x20initial_split_keys\x20:=\x20[\"apple\",\x20\"customer_1\",\x20\"cust\
    omer_2\",\x20\"other\"]\n\x20\x20*\x20Key\x20assignment:\n\x20\x20\x20\
    \x20-\x20Tablet\x201\x20[,\x20apple)\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20=>\x20{\"a\"}.\n\x20\x20\x20\x20-\x20Tablet\
    \x202\x20[apple,\x20customer_1)\x20\x20\x20\x20\x20\x20=>\x20{\"apple\",\
    \x20\"custom\"}.\n\x20\x20\x20\x20-\x20Tablet\x203\x20[customer_1,\x20cu\
    stomer_2)\x20=>\x20{\"customer_1\"}.\n\x20\x20\x20\x20-\x20Tablet\x204\
    \x20[customer_2,\x20other)\x20\x20\x20\x20\x20\x20=>\x20{\"customer_2\"}\
    .\n\x20\x20\x20\x20-\x20Tablet\x205\x20[other,\x20)\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20=>\x20{\"other\",\x20\"zz\"}\
    .\n\n\x0c\n\x05\x04\0\x02\x03\x04\x12\x035\x02\n\n\x0c\n\x05\x04\0\x02\
    \x03\x05\x12\x035\x0b\x11\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x035\x12$\n\
    ...
    \x12\x03@\x02\x1c\x1ag\x20The\x20tables\x20present\x20in\x20the\x20reque\
    sted\x20cluster.\n\x20At\x20present,\x20only\x20the\x20names\x20of\x20th\
    e\x20tables\x20are\x20populated.\n\n\x0c\n\x05\x04\x02\x02\0\x04\x12\x03\
    @\x02\n\n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03@\x0b\x10\n\x0c\n\x05\x04\
    \x02\x02\0\x01\x12\x03@\x11\x17\n\x0c\n\x05\x04\x02\x02\0\x03\x12\x03@\
    \x1a\x1b\n\n\n\x02\x04\x03\x12\x04C\0F\x01\n\n\n\x03\x04\x03\x01\x12\x03\
    C\x08\x17\n6\n\x04\x04\x03\x02\0\x12\x03E\x02\x12\x1a)\x20The\x20unique\
    \x20name\x20of\x20the\x20requested\x20table.\n\n\x0c\n\x05\x04\x03\x02\0\
    ...
    \x03J\x02\x12\x1a-\x20The\x20unique\x20name\x20of\x20the\x20table\x20to\
    ...
    \x05\x02\0\x05\x12\x03O\x02\x08\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x03O\t\
    \r\n\x0c\n\x05\x04\x05\x02\0\x03\x12\x03O\x10\x11\n\x9f\x01\n\x04\x04\
    \x05\x02\x01\x12\x03S\x02\x14\x1a\x91\x01\x20The\x20new\x20name\x20by\
    \x20which\x20the\x20table\x20should\x20be\x20referred\x20to\x20within\
    \x20its\x20containing\n\x20cluster,\x20e.g.\x20\"foobar\"\x20rather\x20t\
    han\x20\"<cluster_name>/tables/foobar\".\n\n\x0c\n\x05\x04\x05\x02\x01\
    ...
    \x12\x03X\x02\x12\x1aH\x20The\x20unique\x20name\x20of\x20the\x20table\
    \x20in\x20which\x20to\x20create\x20the\x20new\x20column\x20family.\n\n\
    \x0c\n\x05\x04\x06\x02\0\x05\x12\x03X\x02\x08\n\x0c\n\x05\x04\x06\x02\0\
    \x01\x12\x03X\t\r\n\x0c\n\x05\x04\x06\x02\0\x03\x12\x03X\x10\x11\n\xa0\
    \x01\n\x04\x04\x06\x02\x01\x12\x03\\\x02\x1e\x1a\x92\x01\x20The\x20name\
    \x20by\x20which\x20the\x20new\x20column\x20family\x20should\x20be\x20ref\
    erred\x20to\x20within\x20the\n\x20table,\x20e.g.\x20\"foobar\"\x20rather\
    \x20than\x20\"<table_name>/columnFamilies/foobar\".\n\n\x0c\n\x05\x04\
    \x06\x02\x01\x05\x12\x03\\\x02\x08\n\x0c\n\x05\x04\x06\x02\x01\x01\x12\
    \x03\\\t\x19\n\x0c\n\x05\x04\x06\x02\x01\x03\x12\x03\\\x1c\x1d\nP\n\x04\
    \x04\x06\x02\x02\x12\x03_\x02!\x1aC\x20The\x20column\x20family\x20to\x20\
    create.\x20The\x20`name`\x20field\x20must\x20be\x20left\x20blank.\n\n\
    \x0c\n\x05\x04\x06\x02\x02\x06\x12\x03_\x02\x0e\n\x0c\n\x05\x04\x06\x02\
    \x02\x01\x12\x03_\x0f\x1c\n\x0c\n\x05\x04\x06\x02\x02\x03\x12\x03_\x1f\
    \x20\n\n\n\x02\x04\x07\x12\x04b\0e\x01\n\n\n\x03\x04\x07\x01\x12\x03b\
    \x08!\nB\n\x04\x04\x07\x02\0\x12\x03d\x02\x12\x1a5\x20The\x20unique\x20n\
    ...
    \x04\x08\x02\0\x12\x03i\x02\x18\x1aB\x20The\x20unique\x20name\x20of\x20t\
    he\x20table\x20on\x20which\x20to\x20perform\x20the\x20bulk\x20delete\n\n\
    ...
    \x03k\x08\x0e\nb\n\x04\x04\x08\x02\x01\x12\x03n\x04\x1d\x1aU\x20Delete\
    \x20all\x20rows\x20that\x20start\x20with\x20this\x20row\x20key\x20prefix\
    .\x20Prefix\x20cannot\x20be\n\x20zero\x20length.\n\n\x0c\n\x05\x04\x08\
    \x02\x01\x05\x12\x03n\x04\t\n\x0c\n\x05\x04\x08\x02\x01\x01\x12\x03n\n\
    \x18\n\x0c\n\x05\x04\x08\x02\x01\x03\x12\x03n\x1b\x1c\nN\n\x04\x04\x08\
    \x02\x02\x12\x03q\x04(\x1aA\x20Delete\x20all\x20rows\x20in\x20the\x20tab\
    le.\x20Setting\x20this\x20to\x20false\x20is\x20a\x20no-op.\n\n\x0c\n\x05\
    \x04\x08\x02\x02\x05\x12\x03q\x04\x08\n\x0c\n\x05\x04\x08\x02\x02\x01\
    \x12\x03q\t#\n\x0c\n\x05\x04\x08\x02\x02\x03\x12\x03q&'b\x06proto3\
";
