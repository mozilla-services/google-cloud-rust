...
impl ::protobuf::Message for Cluster {
    ...
    fn default_instance() -> &'static Cluster {
        static mut instance: ::protobuf::lazy::Lazy<Cluster> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for AppProfile {
    ...
    fn default_instance() -> &'static AppProfile {
        static mut instance: ::protobuf::lazy::Lazy<AppProfile> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for AppProfile_MultiClusterRoutingUseAny {
    ...
    fn default_instance() -> &'static AppProfile_MultiClusterRoutingUseAny {
        static mut instance: ::protobuf::lazy::Lazy<AppProfile_MultiClusterRoutingUseAny> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for AppProfile_SingleClusterRouting {
    ...
    fn default_instance() -> &'static AppProfile_SingleClusterRouting {
        static mut instance: ::protobuf::lazy::Lazy<AppProfile_SingleClusterRouting> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\x04\x06\x12\x03b\x02\x15\n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03b\x16\
    \x1c\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03b\x1f\x20\n\xc9\x01\n\x02\x04\
    \x01\x12\x05h\0\x9a\x01\x01\x1a\xbb\x01\x20A\x20resizable\x20group\x20of\
    ...
    \n\n\n\n\x03\x04\x01\x01\x12\x03h\x08\x0f\n.\n\x04\x04\x01\x04\0\x12\x05\
    j\x02\x80\x01\x03\x1a\x1f\x20Possible\x20states\x20of\x20a\x20cluster.\n\
    \n\x0c\n\x05\x04\x01\x04\0\x01\x12\x03j\x07\x0c\nB\n\x06\x04\x01\x04\0\
    \x02\0\x12\x03l\x04\x18\x1a3\x20The\x20state\x20of\x20the\x20cluster\x20\
    could\x20not\x20be\x20determined.\n\n\x0e\n\x07\x04\x01\x04\0\x02\0\x01\
    \x12\x03l\x04\x13\n\x0e\n\x07\x04\x01\x04\0\x02\0\x02\x12\x03l\x16\x17\n\
    Z\n\x06\x04\x01\x04\0\x02\x01\x12\x03o\x04\x0e\x1aK\x20The\x20cluster\
    \x20has\x20been\x20successfully\x20created\x20and\x20is\x20ready\x20to\
    \x20serve\x20requests.\n\n\x0e\n\x07\x04\x01\x04\0\x02\x01\x01\x12\x03o\
    \x04\t\n\x0e\n\x07\x04\x01\x04\0\x02\x01\x02\x12\x03o\x0c\r\n\xbe\x01\n\
    \x06\x04\x01\x04\0\x02\x02\x12\x03t\x04\x11\x1a\xae\x01\x20The\x20cluste\
    r\x20is\x20currently\x20being\x20created,\x20and\x20may\x20be\x20destroy\
    ed\n\x20if\x20the\x20creation\x20process\x20encounters\x20an\x20error.\n\
    \x20A\x20cluster\x20may\x20not\x20be\x20able\x20to\x20serve\x20requests\
    \x20while\x20being\x20created.\n\n\x0e\n\x07\x04\x01\x04\0\x02\x02\x01\
    \x12\x03t\x04\x0c\n\x0e\n\x07\x04\x01\x04\0\x02\x02\x02\x12\x03t\x0f\x10\
    \n\xbd\x02\n\x06\x04\x01\x04\0\x02\x03\x12\x03{\x04\x11\x1a\xad\x02\x20T\
    he\x20cluster\x20is\x20currently\x20being\x20resized,\x20and\x20may\x20r\
    evert\x20to\x20its\x20previous\n\x20node\x20count\x20if\x20the\x20proces\
    s\x20encounters\x20an\x20error.\n\x20A\x20cluster\x20is\x20still\x20capa\
    ble\x20of\x20serving\x20requests\x20while\x20being\x20resized,\n\x20but\
    ...
    \x04\x01\x04\0\x02\x04\x12\x03\x7f\x04\x11\x1av\x20The\x20cluster\x20has\
    ...
    \n\x20The\x20unique\x20name\x20of\x20the\x20cluster.\x20Values\x20are\
    \x20of\x20the\x20form\n\x20`projects/<project>/instances/<instance>/clus\
    ters/[a-z][-a-z0-9]*`.\n\n\r\n\x05\x04\x01\x02\0\x05\x12\x04\x85\x01\x02\
    \x08\n\r\n\x05\x04\x01\x02\0\x01\x12\x04\x85\x01\t\r\n\r\n\x05\x04\x01\
    \x02\0\x03\x12\x04\x85\x01\x10\x11\n\xa2\x02\n\x04\x04\x01\x02\x01\x12\
    \x04\x8c\x01\x02\x16\x1a\x93\x02\x20(`CreationOnly`)\n\x20The\x20locatio\
    n\x20where\x20this\x20cluster's\x20nodes\x20and\x20storage\x20reside.\
    \x20For\x20best\n\x20performance,\x20clients\x20should\x20be\x20located\
    \x20as\x20close\x20as\x20possible\x20to\x20this\n\x20cluster.\x20Current\
    ly\x20only\x20zones\x20are\x20supported,\x20so\x20values\x20should\x20be\
    \x20of\x20the\n\x20form\x20`projects/<project>/locations/<zone>`.\n\n\r\
    \n\x05\x04\x01\x02\x01\x05\x12\x04\x8c\x01\x02\x08\n\r\n\x05\x04\x01\x02\
    \x01\x01\x12\x04\x8c\x01\t\x11\n\r\n\x05\x04\x01\x02\x01\x03\x12\x04\x8c\
    \x01\x14\x15\nA\n\x04\x04\x01\x02\x02\x12\x04\x90\x01\x02\x12\x1a3\x20(`\
    ...
    \x01\x10\x11\n\x84\x01\n\x04\x04\x01\x02\x03\x12\x04\x94\x01\x02\x18\x1a\
    ...
    \x04\x03\x12\x04\x99\x01%&\n\x82\x01\n\x02\x04\x02\x12\x06\x9e\x01\0\xcf\
    ...
    ar\x20end\x20user\x20application.\n\n\x0b\n\x03\x04\x02\x01\x12\x04\x9e\
    \x01\x08\x12\n\xff\x01\n\x04\x04\x02\x03\0\x12\x06\xa3\x01\x02\xa5\x01\
    \x03\x1a\xee\x01\x20Read/write\x20requests\x20may\x20be\x20routed\x20to\
    \x20any\x20cluster\x20in\x20the\x20instance,\x20and\x20will\n\x20fail\
    \x20over\x20to\x20another\x20cluster\x20in\x20the\x20event\x20of\x20tran\
    sient\x20errors\x20or\x20delays.\n\x20Choosing\x20this\x20option\x20sacr\
    ifices\x20read-your-writes\x20consistency\x20to\x20improve\n\x20availabi\
    lity.\n\n\r\n\x05\x04\x02\x03\0\x01\x12\x04\xa3\x01\n#\n\xb1\x01\n\x04\
    \x04\x02\x03\x01\x12\x06\xaa\x01\x02\xb2\x01\x03\x1a\xa0\x01\x20Uncondit\
    ...
    \x02\0\x12\x04\xac\x01\x04\x1a\x1a<\x20The\x20cluster\x20to\x20which\x20\
    read/write\x20requests\x20should\x20be\x20routed.\n\n\x0f\n\x07\x04\x02\
    \x03\x01\x02\0\x05\x12\x04\xac\x01\x04\n\n\x0f\n\x07\x04\x02\x03\x01\x02\
    \0\x01\x12\x04\xac\x01\x0b\x15\n\x0f\n\x07\x04\x02\x03\x01\x02\0\x03\x12\
    \x04\xac\x01\x18\x19\n\xd1\x01\n\x06\x04\x02\x03\x01\x02\x01\x12\x04\xb1\
    ...
    usters.\n\n\x0f\n\x07\x04\x02\x03\x01\x02\x01\x05\x12\x04\xb1\x01\x04\
    \x08\n\x0f\n\x07\x04\x02\x03\x01\x02\x01\x01\x12\x04\xb1\x01\t#\n\x0f\n\
    \x07\x04\x02\x03\x01\x02\x01\x03\x12\x04\xb1\x01&'\n\xaf\x01\n\x04\x04\
    \x02\x02\0\x12\x04\xb7\x01\x02\x12\x1a\xa0\x01\x20(`OutputOnly`)\n\x20Th\
    ...
    \x02\x01\x12\x04\xc1\x01\x02\x12\x1a\xbe\x03\x20Strongly\x20validated\
