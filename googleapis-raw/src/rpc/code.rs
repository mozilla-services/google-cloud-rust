...
// @@protoc_insertion_point(enum:google.rpc.Code)
pub enum Code {
    // @@protoc_insertion_point(enum_value:google.rpc.Code.OK)
    OK = 0,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.CANCELLED)
    CANCELLED = 1,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.UNKNOWN)
    UNKNOWN = 2,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.INVALID_ARGUMENT)
    INVALID_ARGUMENT = 3,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.DEADLINE_EXCEEDED)
    DEADLINE_EXCEEDED = 4,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.NOT_FOUND)
    NOT_FOUND = 5,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.ALREADY_EXISTS)
    ALREADY_EXISTS = 6,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.PERMISSION_DENIED)
    PERMISSION_DENIED = 7,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.UNAUTHENTICATED)
    UNAUTHENTICATED = 16,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.RESOURCE_EXHAUSTED)
    RESOURCE_EXHAUSTED = 8,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.FAILED_PRECONDITION)
    FAILED_PRECONDITION = 9,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.ABORTED)
    ABORTED = 10,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.OUT_OF_RANGE)
    OUT_OF_RANGE = 11,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.UNIMPLEMENTED)
    UNIMPLEMENTED = 12,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.INTERNAL)
    INTERNAL = 13,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.UNAVAILABLE)
    UNAVAILABLE = 14,
    // @@protoc_insertion_point(enum_value:google.rpc.Code.DATA_LOSS)
    DATA_LOSS = 15,
}
...
impl ::protobuf::Enum for Code {
    ...
    fn from_str(str: &str) -> ::std::option::Option<Code> {
        match str {
            "OK" => ::std::option::Option::Some(Code::OK),
            "CANCELLED" => ::std::option::Option::Some(Code::CANCELLED),
            "UNKNOWN" => ::std::option::Option::Some(Code::UNKNOWN),
            "INVALID_ARGUMENT" => ::std::option::Option::Some(Code::INVALID_ARGUMENT),
            "DEADLINE_EXCEEDED" => ::std::option::Option::Some(Code::DEADLINE_EXCEEDED),
            "NOT_FOUND" => ::std::option::Option::Some(Code::NOT_FOUND),
            "ALREADY_EXISTS" => ::std::option::Option::Some(Code::ALREADY_EXISTS),
            "PERMISSION_DENIED" => ::std::option::Option::Some(Code::PERMISSION_DENIED),
            "UNAUTHENTICATED" => ::std::option::Option::Some(Code::UNAUTHENTICATED),
            "RESOURCE_EXHAUSTED" => ::std::option::Option::Some(Code::RESOURCE_EXHAUSTED),
            "FAILED_PRECONDITION" => ::std::option::Option::Some(Code::FAILED_PRECONDITION),
            "ABORTED" => ::std::option::Option::Some(Code::ABORTED),
            "OUT_OF_RANGE" => ::std::option::Option::Some(Code::OUT_OF_RANGE),
            "UNIMPLEMENTED" => ::std::option::Option::Some(Code::UNIMPLEMENTED),
            "INTERNAL" => ::std::option::Option::Some(Code::INTERNAL),
            "UNAVAILABLE" => ::std::option::Option::Some(Code::UNAVAILABLE),
            "DATA_LOSS" => ::std::option::Option::Some(Code::DATA_LOSS),
            _ => ::std::option::Option::None
        }
    }
...
impl ::protobuf::EnumFull for Code {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        ...
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("Code").unwrap()).clone()
    }
    ...
    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ...
            Code::UNAUTHENTICATED => 8,
            Code::RESOURCE_EXHAUSTED => 9,
            Code::FAILED_PRECONDITION => 10,
            Code::ABORTED => 11,
            Code::OUT_OF_RANGE => 12,
...
impl Code {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<Code>("Code")
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ual\x20feature\x20rollout\x20or\x20undocumented\x20allowlist,\n\x20`NOT_\
    ...
    \x12\x03\x7f\x02\x1a\x1a\xd6\x07\x20The\x20operation\x20was\x20rejected\
    ...
    uld\x20retry\x20at\x20a\x20higher\x20level.\x20For\n\x20\x20\x20\x20\x20\
    \x20example,\x20when\x20a\x20client-specified\x20test-and-set\x20fails,\
    \x20indicating\x20the\n\x20\x20\x20\x20\x20\x20client\x20should\x20resta\
    rt\x20a\x20read-modify-write\x20sequence.\n\x20\x20(c)\x20Use\x20`FAILED\
    _PRECONDITION`\x20if\x20the\x20client\x20should\x20not\x20retry\x20until\
    \n\x20\x20\x20\x20\x20\x20the\x20system\x20state\x20has\x20been\x20expli\
    citly\x20fixed.\x20For\x20example,\x20if\x20an\x20\"rmdir\"\n\x20\x20\
    \x20\x20\x20\x20fails\x20because\x20the\x20directory\x20is\x20non-empty,\
    \x20`FAILED_PRECONDITION`\n\x20\x20\x20\x20\x20\x20should\x20be\x20retur\
    ned\x20since\x20the\x20client\x20should\x20not\x20retry\x20unless\n\x20\
    \x20\x20\x20\x20\x20the\x20files\x20are\x20deleted\x20from\x20the\x20dir\
    ectory.\n\n\x20HTTP\x20Mapping:\x20400\x20Bad\x20Request\n\n\x0c\n\x05\
    \x05\0\x02\n\x01\x12\x03\x7f\x02\x15\n\x0c\n\x05\x05\0\x02\n\x02\x12\x03\
    \x7f\x18\x19\n\x8c\x02\n\x04\x05\0\x02\x0b\x12\x04\x88\x01\x02\x0f\x1a\
    ...
    \x0c\x12\x04\x9b\x01\x02\x14\x1a\xf6\x05\x20The\x20operation\x20was\x20a\
    ...
    ing:\x20400\x20Bad\x20Request\n\n\r\n\x05\x05\0\x02\x0c\x01\x12\x04\x9b\
    \x01\x02\x0e\n\r\n\x05\x05\0\x02\x0c\x02\x12\x04\x9b\x01\x11\x13\n\x82\
    \x01\n\x04\x05\0\x02\r\x12\x04\xa1\x01\x02\x15\x1at\x20The\x20operation\
    ...
    \0\x02\r\x02\x12\x04\xa1\x01\x12\x14\n\xd3\x01\n\x04\x05\0\x02\x0e\x12\
    \x04\xa8\x01\x02\x10\x1a\xc4\x01\x20Internal\x20errors.\x20\x20This\x20m\
    ...
    \n\xea\x02\n\x04\x05\0\x02\x0f\x12\x04\xb3\x01\x02\x13\x1a\xdb\x02\x20Th\
    ...
    orrected\x20by\x20retrying\x20with\n\x20a\x20backoff.\x20Note\x20that\
    \x20it\x20is\x20not\x20always\x20safe\x20to\x20retry\n\x20non-idempotent\
    \x20operations.\n\n\x20See\x20the\x20guidelines\x20above\x20for\x20decid\
    ing\x20between\x20`FAILED_PRECONDITION`,\n\x20`ABORTED`,\x20and\x20`UNAV\
    AILABLE`.\n\n\x20HTTP\x20Mapping:\x20503\x20Service\x20Unavailable\n\n\r\
    \n\x05\x05\0\x02\x0f\x01\x12\x04\xb3\x01\x02\r\n\r\n\x05\x05\0\x02\x0f\
    \x02\x12\x04\xb3\x01\x10\x12\n`\n\x04\x05\0\x02\x10\x12\x04\xb8\x01\x02\
    \x11\x1aR\x20Unrecoverable\x20data\x20loss\x20or\x20corruption.\n\n\x20H\
    TTP\x20Mapping:\x20500\x20Internal\x20Server\x20Error\n\n\r\n\x05\x05\0\
    \x02\x10\x01\x12\x04\xb8\x01\x02\x0b\n\r\n\x05\x05\0\x02\x10\x02\x12\x04\
    \xb8\x01\x0e\x10b\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            enums.push(Code::generated_enum_descriptor_data());
