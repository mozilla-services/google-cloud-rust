...
// @@protoc_insertion_point(message:google.type.PhoneNumber)
...
pub struct PhoneNumber {
    ...
    ///  future.
    // @@protoc_insertion_point(field:google.type.PhoneNumber.extension)
    pub extension: ::std::string::String,
    // message oneof groups
    pub kind: ::std::option::Option<phone_number::Kind>,
    // special fields
    // @@protoc_insertion_point(special_field:google.type.PhoneNumber.special_fields)
...
impl PhoneNumber {
    ...
    pub fn e164_number(&self) -> &str {
        match self.kind {
            ::std::option::Option::Some(phone_number::Kind::E164Number(ref v)) => v,
            _ => "",
        }
    }
    ...
    pub fn has_e164_number(&self) -> bool {
        match self.kind {
            ::std::option::Option::Some(phone_number::Kind::E164Number(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_e164_number(&mut self, v: ::std::string::String) {
        self.kind = ::std::option::Option::Some(phone_number::Kind::E164Number(v))
    }

    // Mutable pointer to the field.
    pub fn mut_e164_number(&mut self) -> &mut ::std::string::String {
        if let ::std::option::Option::Some(phone_number::Kind::E164Number(_)) = self.kind {
        } else {
            self.kind = ::std::option::Option::Some(phone_number::Kind::E164Number(::std::string::String::new()));
        }
        match self.kind {
            ::std::option::Option::Some(phone_number::Kind::E164Number(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_e164_number(&mut self) -> ::std::string::String {
        if self.has_e164_number() {
            match self.kind.take() {
                ::std::option::Option::Some(phone_number::Kind::E164Number(v)) => v,
                _ => panic!(),
            }
        } else {
    ...
    pub fn short_code(&self) -> &phone_number::ShortCode {
        match self.kind {
            ::std::option::Option::Some(phone_number::Kind::ShortCode(ref v)) => v,
            _ => <phone_number::ShortCode as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    pub fn has_short_code(&self) -> bool {
        match self.kind {
            ::std::option::Option::Some(phone_number::Kind::ShortCode(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_short_code(&mut self, v: phone_number::ShortCode) {
        self.kind = ::std::option::Option::Some(phone_number::Kind::ShortCode(v))
    }

    // Mutable pointer to the field.
    pub fn mut_short_code(&mut self) -> &mut phone_number::ShortCode {
        if let ::std::option::Option::Some(phone_number::Kind::ShortCode(_)) = self.kind {
        } else {
            self.kind = ::std::option::Option::Some(phone_number::Kind::ShortCode(phone_number::ShortCode::new()));
        }
        match self.kind {
            ::std::option::Option::Some(phone_number::Kind::ShortCode(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_short_code(&mut self) -> phone_number::ShortCode {
        if self.has_short_code() {
            match self.kind.take() {
                ::std::option::Option::Some(phone_number::Kind::ShortCode(v)) => v,
                _ => panic!(),
            }
        } else {
            phone_number::ShortCode::new()
        }
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_deref_has_get_set_simpler_accessor::<_, _>(
            ...
            PhoneNumber::set_e164_number,
        ));
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, phone_number::ShortCode>(
            "short_code",
            PhoneNumber::has_short_code,
            PhoneNumber::short_code,
            PhoneNumber::mut_short_code,
            PhoneNumber::set_short_code,
        ));
        ...
        oneofs.push(phone_number::Kind::generated_oneof_descriptor_data());
...
impl ::protobuf::Message for PhoneNumber {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.kind = ::std::option::Option::Some(phone_number::Kind::E164Number(is.read_string()?));
                },
                18 => {
                    self.kind = ::std::option::Option::Some(phone_number::Kind::ShortCode(is.read_message()?));
                },
                26 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.kind {
            match v {
                &phone_number::Kind::E164Number(ref v) => {
                    my_size += ::protobuf::rt::string_size(1, &v);
                },
                &phone_number::Kind::ShortCode(ref v) => {
...
/// Nested message and enums of message `PhoneNumber`
pub mod phone_number {

    #[derive(Clone,PartialEq,Debug)]
    #[non_exhaustive]
    // @@protoc_insertion_point(oneof:google.type.PhoneNumber.kind)
    pub enum Kind {
        // @@protoc_insertion_point(oneof_field:google.type.PhoneNumber.e164_number)
        E164Number(::std::string::String),
        // @@protoc_insertion_point(oneof_field:google.type.PhoneNumber.short_code)
        ShortCode(ShortCode),
    }
    ...
    impl ::protobuf::OneofFull for Kind {
        fn descriptor() -> ::protobuf::reflect::OneofDescriptor {
            ...
            descriptor.get(|| <super::PhoneNumber as ::protobuf::MessageFull>::descriptor().oneof_by_name("kind").unwrap()).clone()
        }
    }
    ...
    // @@protoc_insertion_point(message:google.type.PhoneNumber.ShortCode)
    #[derive(PartialEq,Clone,Default,Debug)]
    pub struct ShortCode {
        ...
        // @@protoc_insertion_point(field:google.type.PhoneNumber.ShortCode.region_code)
        pub region_code: ::std::string::String,
        ///  Required. The short code digits, without a leading plus ('+') or country
        ///  calling code, e.g. "611".
        // @@protoc_insertion_point(field:google.type.PhoneNumber.ShortCode.number)
        pub number: ::std::string::String,
        // special fields
        // @@protoc_insertion_point(special_field:google.type.PhoneNumber.ShortCode.special_fields)
        pub special_fields: ::protobuf::SpecialFields,
    }

    impl<'a> ::std::default::Default for &'a ShortCode {
        fn default() -> &'a ShortCode {
            <ShortCode as ::protobuf::Message>::default_instance()
        }
    }
    ...
    impl ShortCode {
        ...
        pub(in super) fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
            ...
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                "region_code",
                |m: &ShortCode| { &m.region_code },
                |m: &mut ShortCode| { &mut m.region_code },
            ));
            fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
                "number",
                |m: &ShortCode| { &m.number },
                |m: &mut ShortCode| { &mut m.number },
            ));
            ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<ShortCode>(
    ...
    impl ::protobuf::Message for ShortCode {
        ...
        fn default_instance() -> &'static ShortCode {
            static instance: ShortCode = ShortCode {
    ...
    impl ::protobuf::MessageFull for ShortCode {
        fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
            static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
            descriptor.get(|| super::file_descriptor().message_by_package_relative_name("PhoneNumber.ShortCode").unwrap()).clone()
        }
    }
    ...
    impl ::protobuf::reflect::ProtobufValue for ShortCode {
        type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\0\x01\x12\x03C\x0b\x16\n\x0e\n\x07\x04\0\x03\0\x02\0\x03\x12\x03C\
    \x19\x1a\nt\n\x06\x04\0\x03\0\x02\x01\x12\x03G\x04\x16\x1ae\x20Required.\
    \x20The\x20short\x20code\x20digits,\x20without\x20a\x20leading\x20plus\
    \x20('+')\x20or\x20country\n\x20calling\x20code,\x20e.g.\x20\"611\".\n\n\
    \x0e\n\x07\x04\0\x03\0\x02\x01\x05\x12\x03G\x04\n\n\x0e\n\x07\x04\0\x03\
    \0\x02\x01\x01\x12\x03G\x0b\x11\n\x0e\n\x07\x04\0\x03\0\x02\x01\x03\x12\
    \x03G\x14\x15\n\xe2\x01\n\x04\x04\0\x08\0\x12\x04M\x02d\x03\x1a\xd3\x01\
    \x20Required.\x20\x20Either\x20a\x20regular\x20number,\x20or\x20a\x20sho\
    rt\x20code.\x20\x20New\x20fields\x20may\x20be\n\x20added\x20to\x20the\
    \x20oneof\x20below\x20in\x20the\x20future,\x20so\x20clients\x20should\
    \x20ignore\x20phone\n\x20numbers\x20for\x20which\x20none\x20of\x20the\
    \x20fields\x20they\x20coded\x20against\x20are\x20set.\n\n\x0c\n\x05\x04\
    \0\x08\0\x01\x12\x03M\x08\x0c\n\xb0\x05\n\x04\x04\0\x02\0\x12\x03]\x04\
    \x1b\x1a\xa2\x05\x20The\x20phone\x20number,\x20represented\x20as\x20a\
    \x20leading\x20plus\x20sign\x20('+'),\x20followed\x20by\x20a\n\x20phone\
    \x20number\x20that\x20uses\x20a\x20relaxed\x20ITU\x20E.164\x20format\x20\
    consisting\x20of\x20the\n\x20country\x20calling\x20code\x20(1\x20to\x203\
    \x20digits)\x20and\x20the\x20subscriber\x20number,\x20with\x20no\n\x20ad\
    ditional\x20spaces\x20or\x20formatting,\x20e.g.:\n\x20\x20-\x20correct:\
    \x20\"+15552220123\"\n\x20\x20-\x20incorrect:\x20\"+1\x20(555)\x20222-01\
    234\x20x123\".\n\n\x20The\x20ITU\x20E.164\x20format\x20limits\x20the\x20\
    latter\x20to\x2012\x20digits,\x20but\x20in\x20practice\x20not\n\x20all\
    \x20countries\x20respect\x20that,\x20so\x20we\x20relax\x20that\x20restri\
    ction\x20here.\n\x20National-only\x20numbers\x20are\x20not\x20allowed.\n\
    \n\x20References:\n\x20\x20-\x20https://www.itu.int/rec/T-REC-E.164-2010\
    11-I\n\x20\x20-\x20https://en.wikipedia.org/wiki/E.164.\n\x20\x20-\x20ht\
    tps://en.wikipedia.org/wiki/List_of_country_calling_codes\n\n\x0c\n\x05\
    \x04\0\x02\0\x05\x12\x03]\x04\n\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03]\x0b\
    \x16\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03]\x19\x1a\nY\n\x04\x04\0\x02\x01\
    \x12\x03c\x04\x1d\x1aL\x20A\x20short\x20code.\n\n\x20Reference(s):\n\x20\
    \x20-\x20https://en.wikipedia.org/wiki/Short_code\n\n\x0c\n\x05\x04\0\
    \x02\x01\x06\x12\x03c\x04\r\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03c\x0e\
    \x18\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03c\x1b\x1c\n\x95\x04\n\x04\x04\
    \0\x02\x02\x12\x03o\x02\x17\x1a\x87\x04\x20The\x20phone\x20number's\x20e\
    xtension.\x20The\x20extension\x20is\x20not\x20standardized\x20in\x20ITU\
    \n\x20recommendations,\x20except\x20for\x20being\x20defined\x20as\x20a\
    \x20series\x20of\x20numbers\x20with\x20a\n\x20maximum\x20length\x20of\
    \x2040\x20digits.\x20Other\x20than\x20digits,\x20some\x20other\x20dialin\
    g\n\x20characters\x20such\x20as\x20','\x20(indicating\x20a\x20wait)\x20o\
    r\x20'#'\x20may\x20be\x20stored\x20here.\n\n\x20Note\x20that\x20no\x20re\
    gions\x20currently\x20use\x20extensions\x20with\x20short\x20codes,\x20so\
    \x20this\n\x20field\x20is\x20normally\x20only\x20set\x20in\x20conjunctio\
    n\x20with\x20an\x20E.164\x20number.\x20It\x20is\x20held\n\x20separately\
    \x20from\x20the\x20E.164\x20number\x20to\x20allow\x20for\x20short\x20cod\
    e\x20extensions\x20in\x20the\n\x20future.\n\n\x0c\n\x05\x04\0\x02\x02\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(phone_number::ShortCode::generated_message_descriptor_data());
