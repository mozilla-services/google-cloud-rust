...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    to/googleapis/type/money;money\xf8\x01\x01\xa2\x02\x03GTPJ\xde\x0b\n\x06\
    ...
    \x03\x20\x02\x12\x1ai\x20The\x20whole\x20units\x20of\x20the\x20amount.\n\
    \x20For\x20example\x20if\x20`currencyCode`\x20is\x20`\"USD\"`,\x20then\
    \x201\x20unit\x20is\x20one\x20US\x20dollar.\n\n\x0c\n\x05\x04\0\x02\x01\
    \x05\x12\x03\x20\x02\x07\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\x20\x08\r\
    \n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x20\x10\x11\n\x81\x03\n\x04\x04\0\
    \x02\x02\x12\x03(\x02\x12\x1a\xf3\x02\x20Number\x20of\x20nano\x20(10^-9)\
    \x20units\x20of\x20the\x20amount.\n\x20The\x20value\x20must\x20be\x20bet\
    ween\x20-999,999,999\x20and\x20+999,999,999\x20inclusive.\n\x20If\x20`un\
    its`\x20is\x20positive,\x20`nanos`\x20must\x20be\x20positive\x20or\x20ze\
    ro.\n\x20If\x20`units`\x20is\x20zero,\x20`nanos`\x20can\x20be\x20positiv\
    e,\x20zero,\x20or\x20negative.\n\x20If\x20`units`\x20is\x20negative,\x20\
    `nanos`\x20must\x20be\x20negative\x20or\x20zero.\n\x20For\x20example\x20\
    $-1.75\x20is\x20represented\x20as\x20`units`=-1\x20and\x20`nanos`=-750,0\
