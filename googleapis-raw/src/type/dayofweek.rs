...
impl ::protobuf::Enum for DayOfWeek {
    ...
    fn from_str(str: &str) -> ::std::option::Option<DayOfWeek> {
        match str {
            "DAY_OF_WEEK_UNSPECIFIED" => ::std::option::Option::Some(DayOfWeek::DAY_OF_WEEK_UNSPECIFIED),
            "MONDAY" => ::std::option::Option::Some(DayOfWeek::MONDAY),
            "TUESDAY" => ::std::option::Option::Some(DayOfWeek::TUESDAY),
            "WEDNESDAY" => ::std::option::Option::Some(DayOfWeek::WEDNESDAY),
            "THURSDAY" => ::std::option::Option::Some(DayOfWeek::THURSDAY),
            "FRIDAY" => ::std::option::Option::Some(DayOfWeek::FRIDAY),
            "SATURDAY" => ::std::option::Option::Some(DayOfWeek::SATURDAY),
            "SUNDAY" => ::std::option::Option::Some(DayOfWeek::SUNDAY),
            _ => ::std::option::Option::None
        }
    }
