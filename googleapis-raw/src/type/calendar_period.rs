...
// @@protoc_insertion_point(enum:google.type.CalendarPeriod)
pub enum CalendarPeriod {
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.CALENDAR_PERIOD_UNSPECIFIED)
    CALENDAR_PERIOD_UNSPECIFIED = 0,
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.DAY)
    DAY = 1,
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.WEEK)
    WEEK = 2,
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.FORTNIGHT)
    FORTNIGHT = 3,
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.MONTH)
    MONTH = 4,
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.QUARTER)
    QUARTER = 5,
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.HALF)
    HALF = 6,
    // @@protoc_insertion_point(enum_value:google.type.CalendarPeriod.YEAR)
    YEAR = 7,
}

impl ::protobuf::Enum for CalendarPeriod {
    const NAME: &'static str = "CalendarPeriod";
    ...
    fn from_str(str: &str) -> ::std::option::Option<CalendarPeriod> {
        match str {
            "CALENDAR_PERIOD_UNSPECIFIED" => ::std::option::Option::Some(CalendarPeriod::CALENDAR_PERIOD_UNSPECIFIED),
            "DAY" => ::std::option::Option::Some(CalendarPeriod::DAY),
            "WEEK" => ::std::option::Option::Some(CalendarPeriod::WEEK),
            "FORTNIGHT" => ::std::option::Option::Some(CalendarPeriod::FORTNIGHT),
            "MONTH" => ::std::option::Option::Some(CalendarPeriod::MONTH),
            "QUARTER" => ::std::option::Option::Some(CalendarPeriod::QUARTER),
            "HALF" => ::std::option::Option::Some(CalendarPeriod::HALF),
            "YEAR" => ::std::option::Option::Some(CalendarPeriod::YEAR),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [CalendarPeriod] = &[
...
impl ::protobuf::EnumFull for CalendarPeriod {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("CalendarPeriod").unwrap()).clone()
    }
...
impl CalendarPeriod {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<CalendarPeriod>("CalendarPeriod")
    }
}
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            enums.push(CalendarPeriod::generated_enum_descriptor_data());
