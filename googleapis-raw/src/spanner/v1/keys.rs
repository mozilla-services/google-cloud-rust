...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    e/protobuf/struct.proto\"\xa0\x02\n\x08KeyRange\x12?\n\x0cstart_closed\
    \x18\x01\x20\x01(\x0b2\x1a.google.protobuf.ListValueH\0R\x0bstartClosed\
    \x12;\n\nstart_open\x18\x02\x20\x01(\x0b2\x1a.google.protobuf.ListValueH\
    \0R\tstartOpen\x12;\n\nend_closed\x18\x03\x20\x01(\x0b2\x1a.google.proto\
    buf.ListValueH\x01R\tendClosed\x127\n\x08end_open\x18\x04\x20\x01(\x0b2\
    \x1a.google.protobuf.ListValueH\x01R\x07endOpenB\x10\n\x0estart_key_type\
    B\x0e\n\x0cend_key_type\"\x7f\n\x06KeySet\x12.\n\x04keys\x18\x01\x20\x03\
    (\x0b2\x1a.google.protobuf.ListValueR\x04keys\x123\n\x06ranges\x18\x02\
    \x20\x03(\x0b2\x1b.google.spanner.v1.KeyRangeR\x06ranges\x12\x10\n\x03al\
    l\x18\x03\x20\x01(\x08R\x03allB\xac\x01\n\x15com.google.spanner.v1B\tKey\
    sProtoP\x01Z5cloud.google.com/go/spanner/apiv1/spannerpb;spannerpb\xaa\
    \x02\x17Google.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\
    \xea\x02\x1aGoogle::Cloud::Spanner::V1J\xfc+\n\x07\x12\x05\x0e\0\xa2\x01\
    ...
    \x8a\x01\x01\x1a\xa7\x15\x20KeyRange\x20represents\x20a\x20range\x20of\
    \x20rows\x20in\x20a\x20table\x20or\x20index.\n\n\x20A\x20range\x20has\
    \x20a\x20start\x20key\x20and\x20an\x20end\x20key.\x20These\x20keys\x20ca\
    n\x20be\x20open\x20or\n\x20closed,\x20indicating\x20if\x20the\x20range\
    \x20includes\x20rows\x20with\x20that\x20key.\n\n\x20Keys\x20are\x20repre\
    sented\x20by\x20lists,\x20where\x20the\x20ith\x20value\x20in\x20the\x20l\
    ist\n\x20corresponds\x20to\x20the\x20ith\x20component\x20of\x20the\x20ta\
    ble\x20or\x20index\x20primary\x20key.\n\x20Individual\x20values\x20are\
    \x20encoded\x20as\x20described\n\x20[here][google.spanner.v1.TypeCode].\
    \n\n\x20For\x20example,\x20consider\x20the\x20following\x20table\x20defi\
    nition:\n\n\x20\x20\x20\x20\x20CREATE\x20TABLE\x20UserEvents\x20(\n\x20\
    \x20\x20\x20\x20\x20\x20UserName\x20STRING(MAX),\n\x20\x20\x20\x20\x20\
    \x20\x20EventDate\x20STRING(10)\n\x20\x20\x20\x20\x20)\x20PRIMARY\x20KEY\
    (UserName,\x20EventDate);\n\n\x20The\x20following\x20keys\x20name\x20row\
    s\x20in\x20this\x20table:\n\n\x20\x20\x20\x20\x20[\"Bob\",\x20\"2014-09-\
    23\"]\n\x20\x20\x20\x20\x20[\"Alfred\",\x20\"2015-06-12\"]\n\n\x20Since\
    \x20the\x20`UserEvents`\x20table's\x20`PRIMARY\x20KEY`\x20clause\x20name\
    s\x20two\n\x20columns,\x20each\x20`UserEvents`\x20key\x20has\x20two\x20e\
    lements;\x20the\x20first\x20is\x20the\n\x20`UserName`,\x20and\x20the\x20\
    second\x20is\x20the\x20`EventDate`.\n\n\x20Key\x20ranges\x20with\x20mult\
    iple\x20components\x20are\x20interpreted\n\x20lexicographically\x20by\
    \x20component\x20using\x20the\x20table\x20or\x20index\x20key's\x20declar\
    ed\n\x20sort\x20order.\x20For\x20example,\x20the\x20following\x20range\
    \x20returns\x20all\x20events\x20for\n\x20user\x20`\"Bob\"`\x20that\x20oc\
    curred\x20in\x20the\x20year\x202015:\n\n\x20\x20\x20\x20\x20\"start_clos\
    ed\":\x20[\"Bob\",\x20\"2015-01-01\"]\n\x20\x20\x20\x20\x20\"end_closed\
    \":\x20[\"Bob\",\x20\"2015-12-31\"]\n\n\x20Start\x20and\x20end\x20keys\
    \x20can\x20omit\x20trailing\x20key\x20components.\x20This\x20affects\x20\
    the\n\x20inclusion\x20and\x20exclusion\x20of\x20rows\x20that\x20exactly\
    \x20match\x20the\x20provided\x20key\n\x20components:\x20if\x20the\x20key\
    \x20is\x20closed,\x20then\x20rows\x20that\x20exactly\x20match\x20the\n\
    \x20provided\x20components\x20are\x20included;\x20if\x20the\x20key\x20is\
    \x20open,\x20then\x20rows\n\x20that\x20exactly\x20match\x20are\x20not\
    \x20included.\n\n\x20For\x20example,\x20the\x20following\x20range\x20inc\
    ludes\x20all\x20events\x20for\x20`\"Bob\"`\x20that\n\x20occurred\x20duri\
    ng\x20and\x20after\x20the\x20year\x202000:\n\n\x20\x20\x20\x20\x20\"star\
    t_closed\":\x20[\"Bob\",\x20\"2000-01-01\"]\n\x20\x20\x20\x20\x20\"end_c\
    losed\":\x20[\"Bob\"]\n\n\x20The\x20next\x20example\x20retrieves\x20all\
    \x20events\x20for\x20`\"Bob\"`:\n\n\x20\x20\x20\x20\x20\"start_closed\":\
    \x20[\"Bob\"]\n\x20\x20\x20\x20\x20\"end_closed\":\x20[\"Bob\"]\n\n\x20T\
    o\x20retrieve\x20events\x20before\x20the\x20year\x202000:\n\n\x20\x20\
    \x20\x20\x20\"start_closed\":\x20[\"Bob\"]\n\x20\x20\x20\x20\x20\"end_op\
    en\":\x20[\"Bob\",\x20\"2000-01-01\"]\n\n\x20The\x20following\x20range\
    \x20includes\x20all\x20rows\x20in\x20the\x20table:\n\n\x20\x20\x20\x20\
    ...
    \x04\0\x01\x12\x03t\x08\x10\nP\n\x04\x04\0\x08\0\x12\x04v\x02~\x03\x1aB\
    \x20The\x20start\x20key\x20must\x20be\x20provided.\x20It\x20can\x20be\
    \x20either\x20closed\x20or\x20open.\n\n\x0c\n\x05\x04\0\x08\0\x01\x12\
