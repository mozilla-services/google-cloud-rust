...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04\x04\0\x02\x01\x12\x03-\x02.\x1a\xd0\x02\x20Each\x20element\x20in\
    \x20`rows`\x20is\x20a\x20row\x20whose\x20format\x20is\x20defined\x20by\n\
    \x20[metadata.row_type][google.spanner.v1.ResultSetMetadata.row_type].\
    \x20The\x20ith\x20element\n\x20in\x20each\x20row\x20matches\x20the\x20it\
    h\x20field\x20in\n\x20[metadata.row_type][google.spanner.v1.ResultSetMet\
    adata.row_type].\x20Elements\x20are\n\x20encoded\x20based\x20on\x20type\
    \x20as\x20described\n\x20[here][google.spanner.v1.TypeCode].\n\n\x0c\n\
    \x05\x04\0\x02\x01\x04\x12\x03-\x02\n\n\x0c\n\x05\x04\0\x02\x01\x06\x12\
    \x03-\x0b$\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03-%)\n\x0c\n\x05\x04\0\
    \x02\x01\x03\x12\x03-,-\n\xf5\x04\n\x04\x04\0\x02\x02\x12\x037\x02\x1b\
    \x1a\xe7\x04\x20Query\x20plan\x20and\x20execution\x20statistics\x20for\
    \x20the\x20SQL\x20statement\x20that\n\x20produced\x20this\x20result\x20s\
    et.\x20These\x20can\x20be\x20requested\x20by\x20setting\n\x20[ExecuteSql\
    Request.query_mode][google.spanner.v1.ExecuteSqlRequest.query_mode].\n\
    \x20DML\x20statements\x20always\x20produce\x20stats\x20containing\x20the\
    \x20number\x20of\x20rows\n\x20modified,\x20unless\x20executed\x20using\
    \x20the\n\x20[ExecuteSqlRequest.QueryMode.PLAN][google.spanner.v1.Execut\
    eSqlRequest.QueryMode.PLAN]\x20[ExecuteSqlRequest.query_mode][google.spa\
    nner.v1.ExecuteSqlRequest.query_mode].\n\x20Other\x20fields\x20may\x20or\
    \x20may\x20not\x20be\x20populated,\x20based\x20on\x20the\n\x20[ExecuteSq\
    lRequest.query_mode][google.spanner.v1.ExecuteSqlRequest.query_mode].\n\
    \n\x0c\n\x05\x04\0\x02\x02\x06\x12\x037\x02\x10\n\x0c\n\x05\x04\0\x02\
    \x02\x01\x12\x037\x11\x16\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x037\x19\x1a\
    \n\xcc\x01\n\x02\x04\x01\x12\x05=\0\xa0\x01\x01\x1a\xbe\x01\x20Partial\
    \x20results\x20from\x20a\x20streaming\x20read\x20or\x20SQL\x20query.\x20\
    Streaming\x20reads\x20and\n\x20SQL\x20queries\x20better\x20tolerate\x20l\
    arge\x20result\x20sets,\x20large\x20rows,\x20and\x20large\n\x20values,\
    \x20but\x20are\x20a\x20little\x20trickier\x20to\x20consume.\n\n\n\n\x03\
    \x04\x01\x01\x12\x03=\x08\x18\np\n\x04\x04\x01\x02\0\x12\x03@\x02!\x1ac\
    \x20Metadata\x20about\x20the\x20result\x20set,\x20such\x20as\x20row\x20t\
    ype\x20information.\n\x20Only\x20present\x20in\x20the\x20first\x20respon\
    se.\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x03@\x02\x13\n\x0c\n\x05\x04\x01\
    \x02\0\x01\x12\x03@\x14\x1c\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03@\x1f\
    \x20\n\xc0\x15\n\x04\x04\x01\x02\x01\x12\x04\x8b\x01\x02,\x1a\xb1\x15\
    \x20A\x20streamed\x20result\x20set\x20consists\x20of\x20a\x20stream\x20o\
    f\x20values,\x20which\x20might\n\x20be\x20split\x20into\x20many\x20`Part\
    ialResultSet`\x20messages\x20to\x20accommodate\n\x20large\x20rows\x20and\
    /or\x20large\x20values.\x20Every\x20N\x20complete\x20values\x20defines\
    \x20a\n\x20row,\x20where\x20N\x20is\x20equal\x20to\x20the\x20number\x20o\
    f\x20entries\x20in\n\x20[metadata.row_type.fields][google.spanner.v1.Str\
    uctType.fields].\n\n\x20Most\x20values\x20are\x20encoded\x20based\x20on\
    \x20type\x20as\x20described\n\x20[here][google.spanner.v1.TypeCode].\n\n\
    \x20It\x20is\x20possible\x20that\x20the\x20last\x20value\x20in\x20values\
    \x20is\x20\"chunked\",\n\x20meaning\x20that\x20the\x20rest\x20of\x20the\
    \x20value\x20is\x20sent\x20in\x20subsequent\n\x20`PartialResultSet`(s).\
    \x20This\x20is\x20denoted\x20by\x20the\x20[chunked_value][google.spanner\
    .v1.PartialResultSet.chunked_value]\n\x20field.\x20Two\x20or\x20more\x20\
    chunked\x20values\x20can\x20be\x20merged\x20to\x20form\x20a\n\x20complet\
    e\x20value\x20as\x20follows:\n\n\x20\x20\x20*\x20`bool/number/null`:\x20\
    cannot\x20be\x20chunked\n\x20\x20\x20*\x20`string`:\x20concatenate\x20th\
    e\x20strings\n\x20\x20\x20*\x20`list`:\x20concatenate\x20the\x20lists.\
    \x20If\x20the\x20last\x20element\x20in\x20a\x20list\x20is\x20a\n\x20\x20\
    \x20\x20\x20`string`,\x20`list`,\x20or\x20`object`,\x20merge\x20it\x20wi\
    th\x20the\x20first\x20element\x20in\n\x20\x20\x20\x20\x20the\x20next\x20\
    list\x20by\x20applying\x20these\x20rules\x20recursively.\n\x20\x20\x20*\
    \x20`object`:\x20concatenate\x20the\x20(field\x20name,\x20field\x20value\
    )\x20pairs.\x20If\x20a\n\x20\x20\x20\x20\x20field\x20name\x20is\x20dupli\
    cated,\x20then\x20apply\x20these\x20rules\x20recursively\n\x20\x20\x20\
    \x20\x20to\x20merge\x20the\x20field\x20values.\n\n\x20Some\x20examples\
    \x20of\x20merging:\n\n\x20\x20\x20\x20\x20#\x20Strings\x20are\x20concate\
    nated.\n\x20\x20\x20\x20\x20\"foo\",\x20\"bar\"\x20=>\x20\"foobar\"\n\n\
    \x20\x20\x20\x20\x20#\x20Lists\x20of\x20non-strings\x20are\x20concatenat\
    ed.\n\x20\x20\x20\x20\x20[2,\x203],\x20[4]\x20=>\x20[2,\x203,\x204]\n\n\
    \x20\x20\x20\x20\x20#\x20Lists\x20are\x20concatenated,\x20but\x20the\x20\
    last\x20and\x20first\x20elements\x20are\x20merged\n\x20\x20\x20\x20\x20#\
    \x20because\x20they\x20are\x20strings.\n\x20\x20\x20\x20\x20[\"a\",\x20\
    \"b\"],\x20[\"c\",\x20\"d\"]\x20=>\x20[\"a\",\x20\"bc\",\x20\"d\"]\n\n\
    \x20\x20\x20\x20\x20#\x20Lists\x20are\x20concatenated,\x20but\x20the\x20\
    last\x20and\x20first\x20elements\x20are\x20merged\n\x20\x20\x20\x20\x20#\
    \x20because\x20they\x20are\x20lists.\x20Recursively,\x20the\x20last\x20a\
    nd\x20first\x20elements\n\x20\x20\x20\x20\x20#\x20of\x20the\x20inner\x20\
    lists\x20are\x20merged\x20because\x20they\x20are\x20strings.\n\x20\x20\
    \x20\x20\x20[\"a\",\x20[\"b\",\x20\"c\"]],\x20[[\"d\"],\x20\"e\"]\x20=>\
    \x20[\"a\",\x20[\"b\",\x20\"cd\"],\x20\"e\"]\n\n\x20\x20\x20\x20\x20#\
    \x20Non-overlapping\x20object\x20fields\x20are\x20combined.\n\x20\x20\
    \x20\x20\x20{\"a\":\x20\"1\"},\x20{\"b\":\x20\"2\"}\x20=>\x20{\"a\":\x20\
    \"1\",\x20\"b\":\x202\"}\n\n\x20\x20\x20\x20\x20#\x20Overlapping\x20obje\
    ct\x20fields\x20are\x20merged.\n\x20\x20\x20\x20\x20{\"a\":\x20\"1\"},\
    \x20{\"a\":\x20\"2\"}\x20=>\x20{\"a\":\x20\"12\"}\n\n\x20\x20\x20\x20\
    \x20#\x20Examples\x20of\x20merging\x20objects\x20containing\x20lists\x20\
    of\x20strings.\n\x20\x20\x20\x20\x20{\"a\":\x20[\"1\"]},\x20{\"a\":\x20[\
    \"2\"]}\x20=>\x20{\"a\":\x20[\"12\"]}\n\n\x20For\x20a\x20more\x20complet\
    e\x20example,\x20suppose\x20a\x20streaming\x20SQL\x20query\x20is\n\x20yi\
    elding\x20a\x20result\x20set\x20whose\x20rows\x20contain\x20a\x20single\
    \x20string\n\x20field.\x20The\x20following\x20`PartialResultSet`s\x20mig\
    ht\x20be\x20yielded:\n\n\x20\x20\x20\x20\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20\"metadata\":\x20{\x20...\x20}\n\x20\x20\x20\x20\x20\x20\x20\"values\
    \":\x20[\"Hello\",\x20\"W\"]\n\x20\x20\x20\x20\x20\x20\x20\"chunked_valu\
    e\":\x20true\n\x20\x20\x20\x20\x20\x20\x20\"resume_token\":\x20\"Af65...\
    \"\n\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20{\n\x20\x20\x20\x20\x20\
    \x20\x20\"values\":\x20[\"orl\"]\n\x20\x20\x20\x20\x20\x20\x20\"chunked_\
    value\":\x20true\n\x20\x20\x20\x20\x20\x20\x20\"resume_token\":\x20\"Bqp\
    2...\"\n\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20{\n\x20\x20\x20\x20\
    \x20\x20\x20\"values\":\x20[\"d\"]\n\x20\x20\x20\x20\x20\x20\x20\"resume\
    _token\":\x20\"Zx1B...\"\n\x20\x20\x20\x20\x20}\n\n\x20This\x20sequence\
    \x20of\x20`PartialResultSet`s\x20encodes\x20two\x20rows,\x20one\n\x20con\
    taining\x20the\x20field\x20value\x20`\"Hello\"`,\x20and\x20a\x20second\
    \x20containing\x20the\n\x20field\x20value\x20`\"World\"\x20=\x20\"W\"\
    \x20+\x20\"orl\"\x20+\x20\"d\"`.\n\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04\
    \x8b\x01\x02\n\n\r\n\x05\x04\x01\x02\x01\x06\x12\x04\x8b\x01\x0b\x20\n\r\
    \n\x05\x04\x01\x02\x01\x01\x12\x04\x8b\x01!'\n\r\n\x05\x04\x01\x02\x01\
    \x03\x12\x04\x8b\x01*+\n\xdf\x01\n\x04\x04\x01\x02\x02\x12\x04\x90\x01\
    \x02\x19\x1a\xd0\x01\x20If\x20true,\x20then\x20the\x20final\x20value\x20\
    in\x20[values][google.spanner.v1.PartialResultSet.values]\x20is\x20chunk\
    ed,\x20and\x20must\n\x20be\x20combined\x20with\x20more\x20values\x20from\
    \x20subsequent\x20`PartialResultSet`s\n\x20to\x20obtain\x20a\x20complete\
    \x20field\x20value.\n\n\r\n\x05\x04\x01\x02\x02\x05\x12\x04\x90\x01\x02\
    \x06\n\r\n\x05\x04\x01\x02\x02\x01\x12\x04\x90\x01\x07\x14\n\r\n\x05\x04\
    \x01\x02\x02\x03\x12\x04\x90\x01\x17\x18\n\xbb\x02\n\x04\x04\x01\x02\x03\
    \x12\x04\x97\x01\x02\x19\x1a\xac\x02\x20Streaming\x20calls\x20might\x20b\
    e\x20interrupted\x20for\x20a\x20variety\x20of\x20reasons,\x20such\n\x20a\
    s\x20TCP\x20connection\x20loss.\x20If\x20this\x20occurs,\x20the\x20strea\
    m\x20of\x20results\x20can\n\x20be\x20resumed\x20by\x20re-sending\x20the\
    \x20original\x20request\x20and\x20including\n\x20`resume_token`.\x20Note\
    \x20that\x20executing\x20any\x20other\x20transaction\x20in\x20the\n\x20s\
    ame\x20session\x20invalidates\x20the\x20token.\n\n\r\n\x05\x04\x01\x02\
    \x03\x05\x12\x04\x97\x01\x02\x07\n\r\n\x05\x04\x01\x02\x03\x01\x12\x04\
    \x97\x01\x08\x14\n\r\n\x05\x04\x01\x02\x03\x03\x12\x04\x97\x01\x17\x18\n\
    \xeb\x02\n\x04\x04\x01\x02\x04\x12\x04\x9f\x01\x02\x1b\x1a\xdc\x02\x20Qu\
    ery\x20plan\x20and\x20execution\x20statistics\x20for\x20the\x20statement\
    \x20that\x20produced\x20this\n\x20streaming\x20result\x20set.\x20These\
    \x20can\x20be\x20requested\x20by\x20setting\n\x20[ExecuteSqlRequest.quer\
    y_mode][google.spanner.v1.ExecuteSqlRequest.query_mode]\x20and\x20are\
    \x20sent\n\x20only\x20once\x20with\x20the\x20last\x20response\x20in\x20t\
    he\x20stream.\n\x20This\x20field\x20will\x20also\x20be\x20present\x20in\
    \x20the\x20last\x20response\x20for\x20DML\n\x20statements.\n\n\r\n\x05\
    \x04\x01\x02\x04\x06\x12\x04\x9f\x01\x02\x10\n\r\n\x05\x04\x01\x02\x04\
    \x01\x12\x04\x9f\x01\x11\x16\n\r\n\x05\x04\x01\x02\x04\x03\x12\x04\x9f\
    \x01\x19\x1a\n\x84\x01\n\x02\x04\x02\x12\x06\xa3\x01\0\xb1\x01\x01\x1av\
    \x20Metadata\x20about\x20a\x20[ResultSet][google.spanner.v1.ResultSet]\
    \x20or\x20[PartialResultSet][google.spanner.v1.PartialResultSet].\n\n\
    \x0b\n\x03\x04\x02\x01\x12\x04\xa3\x01\x08\x19\n\xd2\x02\n\x04\x04\x02\
    \x02\0\x12\x04\xac\x01\x02\x1a\x1a\xc3\x02\x20Indicates\x20the\x20field\
    \x20names\x20and\x20types\x20for\x20the\x20rows\x20in\x20the\x20result\n\
    \x20set.\x20\x20For\x20example,\x20a\x20SQL\x20query\x20like\x20`\"SELEC\
    T\x20UserId,\x20UserName\x20FROM\n\x20Users\"`\x20could\x20return\x20a\
    \x20`row_type`\x20value\x20like:\n\n\x20\x20\x20\x20\x20\"fields\":\x20[\
    \n\x20\x20\x20\x20\x20\x20\x20{\x20\"name\":\x20\"UserId\",\x20\"type\":\
    \x20{\x20\"code\":\x20\"INT64\"\x20}\x20},\n\x20\x20\x20\x20\x20\x20\x20\
    {\x20\"name\":\x20\"UserName\",\x20\"type\":\x20{\x20\"code\":\x20\"STRI\
    NG\"\x20}\x20},\n\x20\x20\x20\x20\x20]\n\n\r\n\x05\x04\x02\x02\0\x06\x12\
    \x04\xac\x01\x02\x0c\n\r\n\x05\x04\x02\x02\0\x01\x12\x04\xac\x01\r\x15\n\
    \r\n\x05\x04\x02\x02\0\x03\x12\x04\xac\x01\x18\x19\n\x8a\x01\n\x04\x04\
    \x02\x02\x01\x12\x04\xb0\x01\x02\x1e\x1a|\x20If\x20the\x20read\x20or\x20\
    SQL\x20query\x20began\x20a\x20transaction\x20as\x20a\x20side-effect,\x20\
    the\n\x20information\x20about\x20the\x20new\x20transaction\x20is\x20yiel\
    ...
    d\x20with\x20this\x20result.\n\n\r\n\x05\x04\x03\x02\0\x06\x12\x04\xb6\
    \x01\x02\x0b\n\r\n\x05\x04\x03\x02\0\x01\x12\x04\xb6\x01\x0c\x16\n\r\n\
    \x05\x04\x03\x02\0\x03\x12\x04\xb6\x01\x19\x1a\n\x9e\x02\n\x04\x04\x03\
    \x02\x01\x12\x04\xc1\x01\x02)\x1a\x8f\x02\x20Aggregated\x20statistics\
    \x20from\x20the\x20execution\x20of\x20the\x20query.\x20Only\x20present\
    ...
    \x20\x20\x20\x20\x20}\n\n\r\n\x05\x04\x03\x02\x01\x06\x12\x04\xc1\x01\
    \x02\x18\n\r\n\x05\x04\x03\x02\x01\x01\x12\x04\xc1\x01\x19$\n\r\n\x05\
    \x04\x03\x02\x01\x03\x12\x04\xc1\x01'(\nC\n\x04\x04\x03\x08\0\x12\x06\
    \xc4\x01\x02\xcb\x01\x03\x1a3\x20The\x20number\x20of\x20rows\x20modified\
    \x20by\x20the\x20DML\x20statement.\n\n\r\n\x05\x04\x03\x08\0\x01\x12\x04\
    \xc4\x01\x08\x11\nO\n\x04\x04\x03\x02\x02\x12\x04\xc6\x01\x04\x1e\x1aA\
    \x20Standard\x20DML\x20returns\x20an\x20exact\x20count\x20of\x20rows\x20\
    that\x20were\x20modified.\n\n\r\n\x05\x04\x03\x02\x02\x05\x12\x04\xc6\
    \x01\x04\t\n\r\n\x05\x04\x03\x02\x02\x01\x12\x04\xc6\x01\n\x19\n\r\n\x05\
    \x04\x03\x02\x02\x03\x12\x04\xc6\x01\x1c\x1d\ny\n\x04\x04\x03\x02\x03\
    \x12\x04\xca\x01\x04$\x1ak\x20Partitioned\x20DML\x20does\x20not\x20offer\
    \x20exactly-once\x20semantics,\x20so\x20it\n\x20returns\x20a\x20lower\
    \x20bound\x20of\x20the\x20rows\x20modified.\n\n\r\n\x05\x04\x03\x02\x03\
    \x05\x12\x04\xca\x01\x04\t\n\r\n\x05\x04\x03\x02\x03\x01\x12\x04\xca\x01\
    \n\x1f\n\r\n\x05\x04\x03\x02\x03\x03\x12\x04\xca\x01\"#b\x06proto3\
";
