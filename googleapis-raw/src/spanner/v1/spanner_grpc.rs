...
const METHOD_SPANNER_COMMIT: ::grpcio::Method<
    ...
    super::commit_response::CommitResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_SPANNER_BATCH_WRITE: ::grpcio::Method<
    super::spanner::BatchWriteRequest,
    super::spanner::BatchWriteResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::ServerStreaming,
...
impl SpannerClient {
    ...
    pub fn commit_opt(
        ...
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::commit_response::CommitResponse> {
    ...
    pub fn commit_async_opt(
        ...
        req: &super::spanner::CommitRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::commit_response::CommitResponse>>
    {
        self.client
    ...
    pub fn batch_write_opt(
        &self,
        req: &super::spanner::BatchWriteRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientSStreamReceiver<super::spanner::BatchWriteResponse>> {
        self.client
            .server_streaming(&METHOD_SPANNER_BATCH_WRITE, req, opt)
    }
...
pub trait Spanner {
    fn create_session(
        ...
        _req: super::spanner::CreateSessionRequest,
    ...
    fn batch_create_sessions(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::BatchCreateSessionsRequest,
    ...
    fn get_session(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::GetSessionRequest,
        sink: ::grpcio::UnarySink<super::spanner::Session>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn list_sessions(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::ListSessionsRequest,
    ...
    fn delete_session(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::DeleteSessionRequest,
    ...
    fn execute_sql(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::ExecuteSqlRequest,
    ...
    fn execute_batch_dml(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::ExecuteBatchDmlRequest,
    ...
    fn read(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::ReadRequest,
        sink: ::grpcio::UnarySink<super::result_set::ResultSet>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    ...
    fn begin_transaction(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::BeginTransactionRequest,
    ...
    fn commit(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::CommitRequest,
        sink: ::grpcio::UnarySink<super::commit_response::CommitResponse>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn rollback(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::RollbackRequest,
        sink: ::grpcio::UnarySink<super::empty::Empty>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn partition_query(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::PartitionQueryRequest,
    ...
    fn partition_read(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::PartitionReadRequest,
        sink: ::grpcio::UnarySink<super::spanner::PartitionResponse>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn batch_write(
        &mut self,
        ctx: ::grpcio::RpcContext,
        _req: super::spanner::BatchWriteRequest,
        sink: ::grpcio::ServerStreamingSink<super::spanner::BatchWriteResponse>,
    ) {
        grpcio::unimplemented_call!(ctx, sink)
    }
}
...
pub fn create_spanner<S: Spanner + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let mut instance = s;
    builder = builder
        .add_server_streaming_handler(&METHOD_SPANNER_BATCH_WRITE, move |ctx, req, resp| {
