...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x82\x02\n\x06\x04\0\x03\0\x02\x01\x12\x03-\x04\x20\x1a\xf2\x01\x20The\
    \x20names\x20of\x20the\x20columns\x20in\x20[table][google.spanner.v1.Mut\
    ation.Write.table]\x20to\x20be\x20written.\n\n\x20The\x20list\x20of\x20c\
    olumns\x20must\x20contain\x20enough\x20columns\x20to\x20allow\n\x20Cloud\
    \x20Spanner\x20to\x20derive\x20values\x20for\x20all\x20primary\x20key\
    \x20columns\x20in\x20the\n\x20row(s)\x20to\x20be\x20modified.\n\n\x0e\n\
    ...
    \n\x06\x04\0\x03\0\x02\x02\x12\x037\x042\x1a\xe8\x04\x20The\x20values\
    \x20to\x20be\x20written.\x20`values`\x20can\x20contain\x20more\x20than\
    \x20one\n\x20list\x20of\x20values.\x20If\x20it\x20does,\x20then\x20multi\
    ple\x20rows\x20are\x20written,\x20one\n\x20for\x20each\x20entry\x20in\
    ...
    \n\x06\x04\0\x03\x01\x02\x01\x12\x03E\x04\x17\x1a\x84\x03\x20Required.\
    \x20The\x20primary\x20keys\x20of\x20the\x20rows\x20within\x20[table][goo\
    gle.spanner.v1.Mutation.Delete.table]\x20to\x20delete.\x20\x20The\n\x20p\
    rimary\x20keys\x20must\x20be\x20specified\x20in\x20the\x20order\x20in\
    \x20which\x20they\x20appear\x20in\x20the\n\x20`PRIMARY\x20KEY()`\x20clau\
    se\x20of\x20the\x20table's\x20equivalent\x20DDL\x20statement\x20(the\x20\
    DDL\n\x20statement\x20used\x20to\x20create\x20the\x20table).\n\x20Delete\
    \x20is\x20idempotent.\x20The\x20transaction\x20will\x20succeed\x20even\
    \x20if\x20some\x20or\x20all\n\x20rows\x20do\x20not\x20exist.\n\n\x0e\n\
