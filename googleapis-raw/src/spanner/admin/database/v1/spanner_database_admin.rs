...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    oogle.longrunning.Operation\"\xb9\x01\xdaA\x17parent,create_statement\
    \xcaAd\n)google.spanner.admin.database.v1.Database\x127google.spanner.ad\
    min.database.v1.CreateDatabaseMetadata\x82\xd3\xe4\x93\x022\"-/v1/{paren\
    t=projects/*/instances/*}/databases:\x01*\x12\xad\x01\n\x0bGetDatabase\
    \x124.google.spanner.admin.database.v1.GetDatabaseRequest\x1a*.google.sp\
    anner.admin.database.v1.Database\"<\x82\xd3\xe4\x93\x02/\x12-/v1/{name=p\
    rojects/*/instances/*/databases/*}\xdaA\x04name\x12\x9d\x02\n\x11UpdateD\
    atabaseDdl\x12:.google.spanner.admin.database.v1.UpdateDatabaseDdlReques\
    t\x1a\x1d.google.longrunning.Operation\"\xac\x01\xcaAS\n\x15google.proto\
    buf.Empty\x12:google.spanner.admin.database.v1.UpdateDatabaseDdlMetadata\
    \xdaA\x13database,statements\x82\xd3\xe4\x93\x02:25/v1/{database=project\
    s/*/instances/*/databases/*}/ddl:\x01*\x12\xa3\x01\n\x0cDropDatabase\x12\
    5.google.spanner.admin.database.v1.DropDatabaseRequest\x1a\x16.google.pr\
    otobuf.Empty\"D\x82\xd3\xe4\x93\x023*1/v1/{database=projects/*/instances\
    /*/databases/*}\xdaA\x08database\x12\xcd\x01\n\x0eGetDatabaseDdl\x127.go\
    ogle.spanner.admin.database.v1.GetDatabaseDdlRequest\x1a8.google.spanner\
    .admin.database.v1.GetDatabaseDdlResponse\"H\x82\xd3\xe4\x93\x027\x125/v\
    1/{database=projects/*/instances/*/databases/*}/ddl\xdaA\x08database\x12\
    \xeb\x01\n\x0cSetIamPolicy\x12\".google.iam.v1.SetIamPolicyRequest\x1a\
    \x15.google.iam.v1.Policy\"\x9f\x01\xdaA\x0fresource,policy\x82\xd3\xe4\
    \x93\x02\x86\x01\">/v1/{resource=projects/*/instances/*/databases/*}:set\
    IamPolicy:\x01*ZA\"</v1/{resource=projects/*/instances/*/backups/*}:setI\
    amPolicy:\x01*\x12\xe4\x01\n\x0cGetIamPolicy\x12\".google.iam.v1.GetIamP\
    olicyRequest\x1a\x15.google.iam.v1.Policy\"\x98\x01\x82\xd3\xe4\x93\x02\
    \x86\x01\">/v1/{resource=projects/*/instances/*/databases/*}:getIamPolic\
    y:\x01*ZA\"</v1/{resource=projects/*/instances/*/backups/*}:getIamPolicy\
    :\x01*\xdaA\x08resource\x12\x9c\x02\n\x12TestIamPermissions\x12(.google.\
    iam.v1.TestIamPermissionsRequest\x1a).google.iam.v1.TestIamPermissionsRe\
    sponse\"\xb0\x01\x82\xd3\xe4\x93\x02\x92\x01\"D/v1/{resource=projects/*/\
    instances/*/databases/*}:testIamPermissions:\x01*ZG\"B/v1/{resource=proj\
    ects/*/instances/*/backups/*}:testIamPermissions:\x01*\xdaA\x14resource,\
    permissions\x1ax\xcaA\x16spanner.googleapis.com\xd2A\\https://www.google\
    apis.com/auth/cloud-platform,https://www.googleapis.com/auth/spanner.adm\
    inB\xac\x02\n$com.google.spanner.admin.database.v1B\x19SpannerDatabaseAd\
    minProtoP\x01ZHgoogle.golang.org/genproto/googleapis/spanner/admin/datab\
    ase/v1;database\xaa\x02&Google.Cloud.Spanner.Admin.Database.V1\xca\x02&G\
    oogle\\Cloud\\Spanner\\Admin\\Database\\V1\xeaAJ\n\x1fspanner.googleapis\
    .com/Instance\x12'projects/{project}/instances/{instance}J\xcdf\n\x07\
    \x12\x05\x0f\0\x92\x03\x01\n\xbe\x04\n\x01\x0c\x12\x03\x0f\0\x122\xb3\
