...
impl ::protobuf::Enum for LogSeverity {
    ...
    fn from_str(str: &str) -> ::std::option::Option<LogSeverity> {
        match str {
            "DEFAULT" => ::std::option::Option::Some(LogSeverity::DEFAULT),
            "DEBUG" => ::std::option::Option::Some(LogSeverity::DEBUG),
            "INFO" => ::std::option::Option::Some(LogSeverity::INFO),
            "NOTICE" => ::std::option::Option::Some(LogSeverity::NOTICE),
            "WARNING" => ::std::option::Option::Some(LogSeverity::WARNING),
            "ERROR" => ::std::option::Option::Some(LogSeverity::ERROR),
            "CRITICAL" => ::std::option::Option::Some(LogSeverity::CRITICAL),
            "ALERT" => ::std::option::Option::Some(LogSeverity::ALERT),
            "EMERGENCY" => ::std::option::Option::Some(LogSeverity::EMERGENCY),
            _ => ::std::option::Option::None
        }
    }
