...
// @@protoc_insertion_point(message:google.api.Documentation)
...
pub struct Documentation {
    ...
    // @@protoc_insertion_point(field:google.api.Documentation.summary)
    pub summary: ::std::string::String,
    ///  The top level pages for the documentation set.
    // @@protoc_insertion_point(field:google.api.Documentation.pages)
    pub pages: ::std::vec::Vec<Page>,
    ///  A list of documentation rules that apply to individual API elements.
    ///
    ///  **NOTE:** All service configuration rules follow "last one wins" order.
    // @@protoc_insertion_point(field:google.api.Documentation.rules)
    pub rules: ::std::vec::Vec<DocumentationRule>,
    ///  The URL to the root of documentation.
    // @@protoc_insertion_point(field:google.api.Documentation.documentation_root_url)
    pub documentation_root_url: ::std::string::String,
    ///  Specifies the service root url if the default one (the service name
    ///  from the yaml file) is not suitable. This can be seen in any fully
    ///  specified service urls as well as sections that show a base that other
    ///  urls are relative to.
    // @@protoc_insertion_point(field:google.api.Documentation.service_root_url)
    pub service_root_url: ::std::string::String,
    // @@protoc_insertion_point(field:google.api.Documentation.overview)
    pub overview: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:google.api.Documentation.special_fields)
...
impl ::protobuf::Message for Documentation {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                34 => {
                    self.documentation_root_url = is.read_string()?;
                },
                50 => {
                    self.service_root_url = is.read_string()?;
                },
                18 => {
                    self.overview = is.read_string()?;
                },
                tag => {
    ...
    fn default_instance() -> &'static Documentation {
        static instance: Documentation = Documentation {
            ...
            documentation_root_url: ::std::string::String::new(),
            service_root_url: ::std::string::String::new(),
...
impl ::protobuf::MessageFull for Documentation {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| file_descriptor().message_by_package_relative_name("Documentation").unwrap()).clone()
    }
}
...
// @@protoc_insertion_point(message:google.api.DocumentationRule)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct DocumentationRule {
    ...
    // @@protoc_insertion_point(field:google.api.DocumentationRule.selector)
    pub selector: ::std::string::String,
    ///  Description of the selected proto element (e.g. a message, a method, a
    ///  'service' definition, or a field). Defaults to leading & trailing comments
    ///  taken from the proto source definition of the proto element.
    // @@protoc_insertion_point(field:google.api.DocumentationRule.description)
    pub description: ::std::string::String,
    ///  Deprecation description of the selected element(s). It can be provided if
    ///  an element is marked as `deprecated`.
    // @@protoc_insertion_point(field:google.api.DocumentationRule.deprecation_description)
    pub deprecation_description: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:google.api.DocumentationRule.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl ::protobuf::Message for DocumentationRule {
    const NAME: &'static str = "DocumentationRule";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                26 => {
                    self.deprecation_description = is.read_string()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static DocumentationRule {
        static instance: DocumentationRule = DocumentationRule {
            selector: ::std::string::String::new(),
            description: ::std::string::String::new(),
            deprecation_description: ::std::string::String::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::protobuf::MessageFull for DocumentationRule {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("DocumentationRule").unwrap()).clone()
    }
}

impl ::std::fmt::Display for DocumentationRule {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
// @@protoc_insertion_point(message:google.api.Page)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Page {
    // message fields
    // @@protoc_insertion_point(field:google.api.Page.name)
    pub name: ::std::string::String,
    ///  The Markdown content of the page. You can use <code>&#40;== include {path}
    ///  ==&#41;</code> to include content from a Markdown file. The content can be
    ///  used to produce the documentation page such as HTML format page.
    // @@protoc_insertion_point(field:google.api.Page.content)
    pub content: ::std::string::String,
    ///  Subpages of this page. The order of subpages specified here will be
    ///  honored in the generated docset.
    // @@protoc_insertion_point(field:google.api.Page.subpages)
    pub subpages: ::std::vec::Vec<Page>,
    // special fields
    // @@protoc_insertion_point(special_field:google.api.Page.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                26 => {
                    self.subpages.push(is.read_message()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
impl ::protobuf::MessageFull for Page {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("Page").unwrap()).clone()
    }
}
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(Documentation::generated_message_descriptor_data());
            messages.push(DocumentationRule::generated_message_descriptor_data());
            messages.push(Page::generated_message_descriptor_data());
