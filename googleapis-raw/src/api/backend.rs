...
pub struct BackendRule {
    ...
    // @@protoc_insertion_point(field:google.api.BackendRule.protocol)
    pub protocol: ::std::string::String,
    ///  The map between request protocol and the backend address.
    // @@protoc_insertion_point(field:google.api.BackendRule.overrides_by_request_protocol)
...
impl BackendRule {
    ...
    pub fn disable_auth(&self) -> bool {
        match self.authentication {
            ::std::option::Option::Some(backend_rule::Authentication::DisableAuth(v)) => v,
            _ => false,
        }
    }
    ...
    pub fn has_disable_auth(&self) -> bool {
        match self.authentication {
            ::std::option::Option::Some(backend_rule::Authentication::DisableAuth(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_disable_auth(&mut self, v: bool) {
        self.authentication = ::std::option::Option::Some(backend_rule::Authentication::DisableAuth(v))
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_copy_has_get_set_simpler_accessors::<_, _>(
            ...
            BackendRule::disable_auth,
            BackendRule::set_disable_auth,
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "protocol",
...
impl ::protobuf::Message for BackendRule {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                64 => {
                    self.authentication = ::std::option::Option::Some(backend_rule::Authentication::DisableAuth(is.read_bool()?));
                },
                74 => {
                ...
                82 => {
                    ...
                    self.overrides_by_request_protocol.insert(key, value);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        for (k, v) in &self.overrides_by_request_protocol {
    ...
    fn default_instance() -> &'static BackendRule {
        static instance: ::protobuf::rt::Lazy<BackendRule> = ::protobuf::rt::Lazy::new();
...
pub mod backend_rule {
    ...
    pub enum Authentication {
        ...
        // @@protoc_insertion_point(oneof_field:google.api.BackendRule.disable_auth)
        DisableAuth(bool),
    }
