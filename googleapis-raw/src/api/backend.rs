...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    o/googleapis/api/serviceconfig;serviceconfig\xa2\x02\x04GAPIJ\xb23\n\x07\
    ...
    \n\x99\x05\n\x04\x04\x01\x02\x01\x12\x03t\x02\x15\x1a\x8b\x05\x20The\x20\
    address\x20of\x20the\x20API\x20backend.\n\n\x20The\x20scheme\x20is\x20us\
    ed\x20to\x20determine\x20the\x20backend\x20protocol\x20and\x20security.\
    \n\x20The\x20following\x20schemes\x20are\x20accepted:\n\n\x20\x20\x20\
    \x20SCHEME\x20\x20\x20\x20\x20\x20\x20\x20PROTOCOL\x20\x20\x20\x20SECURI\
    TY\n\x20\x20\x20\x20http://\x20\x20\x20\x20\x20\x20\x20HTTP\x20\x20\x20\
    \x20\x20\x20\x20\x20None\n\x20\x20\x20\x20https://\x20\x20\x20\x20\x20\
    \x20HTTP\x20\x20\x20\x20\x20\x20\x20\x20TLS\n\x20\x20\x20\x20grpc://\x20\
    \x20\x20\x20\x20\x20\x20gRPC\x20\x20\x20\x20\x20\x20\x20\x20None\n\x20\
    \x20\x20\x20grpcs://\x20\x20\x20\x20\x20\x20gRPC\x20\x20\x20\x20\x20\x20\
    \x20\x20TLS\n\n\x20It\x20is\x20recommended\x20to\x20explicitly\x20includ\
    e\x20a\x20scheme.\x20Leaving\x20out\x20the\x20scheme\n\x20may\x20cause\
    \x20constrasting\x20behaviors\x20across\x20platforms.\n\n\x20If\x20the\
    \x20port\x20is\x20unspecified,\x20the\x20default\x20is:\n\x20-\x2080\x20\
    for\x20schemes\x20without\x20TLS\n\x20-\x20443\x20for\x20schemes\x20with\
    \x20TLS\n\n\x20For\x20HTTP\x20backends,\x20use\x20[protocol][google.api.\
    BackendRule.protocol]\n\x20to\x20specify\x20the\x20protocol\x20version.\
    \n\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03t\x02\x08\n\x0c\n\x05\x04\x01\
    \x02\x01\x01\x12\x03t\t\x10\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03t\x13\
    \x14\n\x9a\x01\n\x04\x04\x01\x02\x02\x12\x03x\x02\x16\x1a\x8c\x01\x20The\
    \x20number\x20of\x20seconds\x20to\x20wait\x20for\x20a\x20response\x20fro\
    m\x20a\x20request.\x20The\x20default\n\x20varies\x20based\x20on\x20the\
    \x20request\x20protocol\x20and\x20deployment\x20environment.\n\n\x0c\n\
    ...
    \x04\x01\x02\x03\x01\x12\x03|\t\x15\n\x0c\n\x05\x04\x01\x02\x03\x03\x12\
    \x03|\x18\x19\nz\n\x04\x04\x01\x02\x04\x12\x04\x80\x01\x02\x20\x1al\x20T\
    he\x20number\x20of\x20seconds\x20to\x20wait\x20for\x20the\x20completion\
    \x20of\x20a\x20long\x20running\n\x20operation.\x20The\x20default\x20is\
    \x20no\x20deadline.\n\n\r\n\x05\x04\x01\x02\x04\x05\x12\x04\x80\x01\x02\
    \x08\n\r\n\x05\x04\x01\x02\x04\x01\x12\x04\x80\x01\t\x1b\n\r\n\x05\x04\
    \x01\x02\x04\x03\x12\x04\x80\x01\x1e\x1f\n\x0c\n\x04\x04\x01\x02\x05\x12\
    \x04\x82\x01\x02'\n\r\n\x05\x04\x01\x02\x05\x06\x12\x04\x82\x01\x02\x11\
    \n\r\n\x05\x04\x01\x02\x05\x01\x12\x04\x82\x01\x12\"\n\r\n\x05\x04\x01\
    \x02\x05\x03\x12\x04\x82\x01%&\n\xc0\x04\n\x04\x04\x01\x08\0\x12\x06\x92\
    \x01\x02\x9d\x01\x03\x1a\xaf\x04\x20Authentication\x20settings\x20used\
    ...
    \n\x20authentication\x20via\x20a\x20JWT.\n\n\x20When\x20authentication\
    \x20is\x20unspecified,\x20the\x20resulting\x20behavior\x20is\x20the\x20s\
    ame\n\x20as\x20`disable_auth`\x20set\x20to\x20`true`.\n\n\x20Refer\x20to\
    \x20https://developers.google.com/identity/protocols/OpenIDConnect\x20fo\
    r\n\x20JWT\x20ID\x20token.\n\n\r\n\x05\x04\x01\x08\0\x01\x12\x04\x92\x01\
    \x08\x16\n\xb4\x01\n\x04\x04\x01\x02\x06\x12\x04\x96\x01\x04\x1c\x1a\xa5\
    \x01\x20The\x20JWT\x20audience\x20is\x20used\x20when\x20generating\x20a\
    \x20JWT\x20ID\x20token\x20for\x20the\x20backend.\n\x20This\x20ID\x20toke\
    n\x20will\x20be\x20added\x20in\x20the\x20HTTP\x20\"authorization\"\x20he\
    ader,\x20and\x20sent\n\x20to\x20the\x20backend.\n\n\r\n\x05\x04\x01\x02\
    \x06\x05\x12\x04\x96\x01\x04\n\n\r\n\x05\x04\x01\x02\x06\x01\x12\x04\x96\
    \x01\x0b\x17\n\r\n\x05\x04\x01\x02\x06\x03\x12\x04\x96\x01\x1a\x1b\n\x99\
    \x02\n\x04\x04\x01\x02\x07\x12\x04\x9c\x01\x04\x1a\x1a\x8a\x02\x20When\
    \x20disable_auth\x20is\x20true,\x20a\x20JWT\x20ID\x20token\x20won't\x20b\
    e\x20generated\x20and\x20the\n\x20original\x20\"Authorization\"\x20HTTP\
    \x20header\x20will\x20be\x20preserved.\x20If\x20the\x20header\x20is\n\
    \x20used\x20to\x20carry\x20the\x20original\x20token\x20and\x20is\x20expe\
    cted\x20by\x20the\x20backend,\x20this\n\x20field\x20must\x20be\x20set\
    \x20to\x20true\x20to\x20preserve\x20the\x20header.\n\n\r\n\x05\x04\x01\
    \x02\x07\x05\x12\x04\x9c\x01\x04\x08\n\r\n\x05\x04\x01\x02\x07\x01\x12\
    \x04\x9c\x01\t\x15\n\r\n\x05\x04\x01\x02\x07\x03\x12\x04\x9c\x01\x18\x19\
    \n\xf5\x05\n\x04\x04\x01\x02\x08\x12\x04\xb4\x01\x02\x16\x1a\xe6\x05\x20\
    The\x20protocol\x20used\x20for\x20sending\x20a\x20request\x20to\x20the\
    \x20backend.\n\x20The\x20supported\x20values\x20are\x20\"http/1.1\"\x20a\
    nd\x20\"h2\".\n\n\x20The\x20default\x20value\x20is\x20inferred\x20from\
    \x20the\x20scheme\x20in\x20the\n\x20[address][google.api.BackendRule.add\
    ress]\x20field:\n\n\x20\x20\x20\x20SCHEME\x20\x20\x20\x20\x20\x20\x20\
    \x20PROTOCOL\n\x20\x20\x20\x20http://\x20\x20\x20\x20\x20\x20\x20http/1.\
    1\n\x20\x20\x20\x20https://\x20\x20\x20\x20\x20\x20http/1.1\n\x20\x20\
    \x20\x20grpc://\x20\x20\x20\x20\x20\x20\x20h2\n\x20\x20\x20\x20grpcs://\
    \x20\x20\x20\x20\x20\x20h2\n\n\x20For\x20secure\x20HTTP\x20backends\x20(\
    https://)\x20that\x20support\x20HTTP/2,\x20set\x20this\x20field\n\x20to\
    \x20\"h2\"\x20for\x20improved\x20performance.\n\n\x20Configuring\x20this\
    \x20field\x20to\x20non-default\x20values\x20is\x20only\x20supported\x20f\
    or\x20secure\n\x20HTTP\x20backends.\x20This\x20field\x20will\x20be\x20ig\
    nored\x20for\x20all\x20other\x20backends.\n\n\x20See\n\x20https://www.ia\
    na.org/assignments/tls-extensiontype-values/tls-extensiontype-values.xht\
    ml#alpn-protocol-ids\n\x20for\x20more\x20details\x20on\x20the\x20support\
    ed\x20values.\n\n\r\n\x05\x04\x01\x02\x08\x05\x12\x04\xb4\x01\x02\x08\n\
    \r\n\x05\x04\x01\x02\x08\x01\x12\x04\xb4\x01\t\x11\n\r\n\x05\x04\x01\x02\
    \x08\x03\x12\x04\xb4\x01\x14\x15b\x06proto3\
";
