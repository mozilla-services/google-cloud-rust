...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\x07\0\x12\x03(\x02:\x1a\xce\x03\x20A\x20designation\x20of\x20a\x20s\
    pecific\x20field\x20behavior\x20(required,\x20output\x20only,\x20etc.)\n\
    \x20in\x20protobuf\x20messages.\n\n\x20Examples:\n\n\x20\x20\x20string\
    \x20name\x20=\x201\x20[(google.api.field_behavior)\x20=\x20REQUIRED];\n\
    \x20\x20\x20State\x20state\x20=\x201\x20[(google.api.field_behavior)\x20\
    =\x20OUTPUT_ONLY];\n\x20\x20\x20google.protobuf.Duration\x20ttl\x20=\x20\
