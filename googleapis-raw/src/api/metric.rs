...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    org/genproto/googleapis/api/metric;metric\xa2\x02\x04GAPIJ\xc9Q\n\x07\
    \x12\x05\x0e\0\x87\x02\x01\n\xbc\x04\n\x01\x0c\x12\x03\x0e\0\x122\xb1\
    \x04\x20Copyright\x202015\x20Google\x20LLC\n\n\x20Licensed\x20under\x20t\
    ...
    \x8a\x02\n\x06\x04\0\x03\0\x02\x01\x12\x03*\x04/\x1a\xfa\x01\x20The\x20s\
    ampling\x20period\x20of\x20metric\x20data\x20points.\x20For\x20metrics\
    \x20which\x20are\x20written\n\x20periodically,\x20consecutive\x20data\
    ...
    \x04\0\x03\0\x02\x01\x01\x12\x03*\x1d*\n\x0e\n\x07\x04\0\x03\0\x02\x01\
    \x03\x12\x03*-.\n\xbc\x01\n\x06\x04\0\x03\0\x02\x02\x12\x03/\x04.\x1a\
    \xac\x01\x20The\x20delay\x20of\x20data\x20points\x20caused\x20by\x20inge\
    stion.\x20Data\x20points\x20older\x20than\x20this\n\x20age\x20are\x20gua\
    ranteed\x20to\x20be\x20ingested\x20and\x20available\x20to\x20be\x20read,\
    \x20excluding\n\x20data\x20loss\x20due\x20to\x20errors.\n\n\x0e\n\x07\
    \x04\0\x03\0\x02\x02\x06\x12\x03/\x04\x1c\n\x0e\n\x07\x04\0\x03\0\x02\
    \x02\x01\x12\x03/\x1d)\n\x0e\n\x07\x04\0\x03\0\x02\x02\x03\x12\x03/,-\n\
    \xd9\x01\n\x04\x04\0\x04\0\x12\x045\x02E\x03\x1a\xca\x01\x20The\x20kind\
    \x20of\x20measurement.\x20It\x20describes\x20how\x20the\x20data\x20is\
    \x20reported.\n\x20For\x20information\x20on\x20setting\x20the\x20start\
    \x20time\x20and\x20end\x20time\x20based\x20on\n\x20the\x20MetricKind,\
    ...
    \0\x03\x12\x03b\x10\x11\n\xa9\x03\n\x04\x04\0\x02\x01\x12\x03l\x02\x12\
    \x1a\x9b\x03\x20The\x20metric\x20type,\x20including\x20its\x20DNS\x20nam\
    e\x20prefix.\x20The\x20type\x20is\x20not\n\x20URL-encoded.\x20All\x20use\
    r-defined\x20metric\x20types\x20have\x20the\x20DNS\x20name\n\x20`custom.\
    googleapis.com`\x20or\x20`external.googleapis.com`.\x20Metric\x20types\
    \x20should\n\x20use\x20a\x20natural\x20hierarchical\x20grouping.\x20For\
    \x20example:\n\n\x20\x20\x20\x20\x20\"custom.googleapis.com/invoice/paid\
    /amount\"\n\x20\x20\x20\x20\x20\"external.googleapis.com/prometheus/up\"\
    \n\x20\x20\x20\x20\x20\"appengine.googleapis.com/http/server/response_la\
    tencies\"\n\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03l\x02\x08\n\x0c\n\x05\
    \x04\0\x02\x01\x01\x12\x03l\t\r\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03l\
    \x10\x11\n\xd5\x02\n\x04\x04\0\x02\x02\x12\x03t\x02&\x1a\xc7\x02\x20The\
    \x20set\x20of\x20labels\x20that\x20can\x20be\x20used\x20to\x20describe\
    \x20a\x20specific\n\x20instance\x20of\x20this\x20metric\x20type.\x20For\
    \x20example,\x20the\n\x20`appengine.googleapis.com/http/server/response_\
    latencies`\x20metric\n\x20type\x20has\x20a\x20label\x20for\x20the\x20HTT\
    P\x20response\x20code,\x20`response_code`,\x20so\n\x20you\x20can\x20look\
    \x20at\x20latencies\x20for\x20successful\x20responses\x20or\x20just\n\
    \x20for\x20responses\x20that\x20failed.\n\n\x0c\n\x05\x04\0\x02\x02\x04\
    \x12\x03t\x02\n\n\x0c\n\x05\x04\0\x02\x02\x06\x12\x03t\x0b\x1a\n\x0c\n\
    \x05\x04\0\x02\x02\x01\x12\x03t\x1b!\n\x0c\n\x05\x04\0\x02\x02\x03\x12\
    \x03t$%\n\xa6\x01\n\x04\x04\0\x02\x03\x12\x03x\x02\x1d\x1a\x98\x01\x20Wh\
    ...
    \x02\x05\x12\x04\xe4\x01\x02\x12\x1a\xbb\x1e\x20The\x20units\x20in\x20wh\
    ich\x20the\x20metric\x20value\x20is\x20reported.\x20It\x20is\x20only\x20\
    applicable\n\x20if\x20the\x20`value_type`\x20is\x20`INT64`,\x20`DOUBLE`,\
    \x20or\x20`DISTRIBUTION`.\x20The\x20`unit`\n\x20defines\x20the\x20repres\
    entation\x20of\x20the\x20stored\x20metric\x20values.\n\n\x20Different\
    \x20systems\x20might\x20scale\x20the\x20values\x20to\x20be\x20more\x20ea\
    sily\x20displayed\x20(so\x20a\n\x20value\x20of\x20`0.02kBy`\x20_might_\
    \x20be\x20displayed\x20as\x20`20By`,\x20and\x20a\x20value\x20of\n\x20`35\
    23kBy`\x20_might_\x20be\x20displayed\x20as\x20`3.5MBy`).\x20However,\x20\
    if\x20the\x20`unit`\x20is\n\x20`kBy`,\x20then\x20the\x20value\x20of\x20t\
    he\x20metric\x20is\x20always\x20in\x20thousands\x20of\x20bytes,\x20no\n\
    \x20matter\x20how\x20it\x20might\x20be\x20displayed.\n\n\x20If\x20you\
    \x20want\x20a\x20custom\x20metric\x20to\x20record\x20the\x20exact\x20num\
    ber\x20of\x20CPU-seconds\x20used\n\x20by\x20a\x20job,\x20you\x20can\x20c\
    reate\x20an\x20`INT64\x20CUMULATIVE`\x20metric\x20whose\x20`unit`\x20is\
    \n\x20`s{CPU}`\x20(or\x20equivalently\x20`1s{CPU}`\x20or\x20just\x20`s`)\
    .\x20If\x20the\x20job\x20uses\x2012,005\n\x20CPU-seconds,\x20then\x20the\
    \x20value\x20is\x20written\x20as\x20`12005`.\n\n\x20Alternatively,\x20if\
    \x20you\x20want\x20a\x20custom\x20metric\x20to\x20record\x20data\x20in\
    \x20a\x20more\n\x20granular\x20way,\x20you\x20can\x20create\x20a\x20`DOU\
    BLE\x20CUMULATIVE`\x20metric\x20whose\x20`unit`\x20is\n\x20`ks{CPU}`,\
    \x20and\x20then\x20write\x20the\x20value\x20`12.005`\x20(which\x20is\x20\
    `12005/1000`),\n\x20or\x20use\x20`Kis{CPU}`\x20and\x20write\x20`11.723`\
    \x20(which\x20is\x20`12005/1024`).\n\n\x20The\x20supported\x20units\x20a\
    re\x20a\x20subset\x20of\x20[The\x20Unified\x20Code\x20for\x20Units\x20of\
    \n\x20Measure](https://unitsofmeasure.org/ucum.html)\x20standard:\n\n\
    \x20**Basic\x20units\x20(UNIT)**\n\n\x20*\x20`bit`\x20\x20\x20bit\n\x20*\
    \x20`By`\x20\x20\x20\x20byte\n\x20*\x20`s`\x20\x20\x20\x20\x20second\n\
    \x20*\x20`min`\x20\x20\x20minute\n\x20*\x20`h`\x20\x20\x20\x20\x20hour\n\
    \x20*\x20`d`\x20\x20\x20\x20\x20day\n\x20*\x20`1`\x20\x20\x20\x20\x20dim\
    ensionless\n\n\x20**Prefixes\x20(PREFIX)**\n\n\x20*\x20`k`\x20\x20\x20\
    \x20\x20kilo\x20\x20\x20\x20(10^3)\n\x20*\x20`M`\x20\x20\x20\x20\x20mega\
    \x20\x20\x20\x20(10^6)\n\x20*\x20`G`\x20\x20\x20\x20\x20giga\x20\x20\x20\
    \x20(10^9)\n\x20*\x20`T`\x20\x20\x20\x20\x20tera\x20\x20\x20\x20(10^12)\
    \n\x20*\x20`P`\x20\x20\x20\x20\x20peta\x20\x20\x20\x20(10^15)\n\x20*\x20\
    `E`\x20\x20\x20\x20\x20exa\x20\x20\x20\x20\x20(10^18)\n\x20*\x20`Z`\x20\
    \x20\x20\x20\x20zetta\x20\x20\x20(10^21)\n\x20*\x20`Y`\x20\x20\x20\x20\
    \x20yotta\x20\x20\x20(10^24)\n\n\x20*\x20`m`\x20\x20\x20\x20\x20milli\
    \x20\x20\x20(10^-3)\n\x20*\x20`u`\x20\x20\x20\x20\x20micro\x20\x20\x20(1\
    ...
    *\x20`p`\x20\x20\x20\x20\x20pico\x20\x20\x20\x20(10^-12)\n\x20*\x20`f`\
    ...
    \x20tebi\x20\x20\x20\x20(2^40)\n\x20*\x20`Pi`\x20\x20\x20\x20pebi\x20\
    \x20\x20\x20(2^50)\n\n\x20**Grammar**\n\n\x20The\x20grammar\x20also\x20i\
    ncludes\x20these\x20connectors:\n\n\x20*\x20`/`\x20\x20\x20\x20division\
    \x20or\x20ratio\x20(as\x20an\x20infix\x20operator).\x20For\x20examples,\
    \n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20`kBy/{email}`\x20or\x20`MiBy/1\
    0ms`\x20(although\x20you\x20should\x20almost\x20never\n\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20have\x20`/s`\x20in\x20a\x20metric\x20`unit`;\x20\
    rates\x20should\x20always\x20be\x20computed\x20at\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20query\x20time\x20from\x20the\x20underlying\x20cumula\
    tive\x20or\x20delta\x20value).\n\x20*\x20`.`\x20\x20\x20\x20multiplicati\
    on\x20or\x20composition\x20(as\x20an\x20infix\x20operator).\x20For\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20examples,\x20`GBy.d`\x20or\x20`k{wat\
    t}.h`.\n\n\x20The\x20grammar\x20for\x20a\x20unit\x20is\x20as\x20follows:\
    \n\n\x20\x20\x20\x20\x20Expression\x20=\x20Component\x20{\x20\".\"\x20Co\
    mponent\x20}\x20{\x20\"/\"\x20Component\x20}\x20;\n\n\x20\x20\x20\x20\
    \x20Component\x20=\x20(\x20[\x20PREFIX\x20]\x20UNIT\x20|\x20\"%\"\x20)\
    \x20[\x20Annotation\x20]\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20|\x20Annotation\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20|\x20\"1\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20;\n\n\x20\x20\x20\x20\x20Annotation\x20=\x20\"{\
    \"\x20NAME\x20\"}\"\x20;\n\n\x20Notes:\n\n\x20*\x20`Annotation`\x20is\
    \x20just\x20a\x20comment\x20if\x20it\x20follows\x20a\x20`UNIT`.\x20If\
    \x20the\x20annotation\n\x20\x20\x20\x20is\x20used\x20alone,\x20then\x20t\
    he\x20unit\x20is\x20equivalent\x20to\x20`1`.\x20For\x20examples,\n\x20\
    \x20\x20\x20`{request}/s\x20==\x201/s`,\x20`By{transmitted}/s\x20==\x20B\
    y/s`.\n\x20*\x20`NAME`\x20is\x20a\x20sequence\x20of\x20non-blank\x20prin\
    table\x20ASCII\x20characters\x20not\n\x20\x20\x20\x20containing\x20`{`\
    \x20or\x20`}`.\n\x20*\x20`1`\x20represents\x20a\x20unitary\x20[dimension\
    less\n\x20\x20\x20\x20unit](https://en.wikipedia.org/wiki/Dimensionless_\
    quantity)\x20of\x201,\x20such\n\x20\x20\x20\x20as\x20in\x20`1/s`.\x20It\
    \x20is\x20typically\x20used\x20when\x20none\x20of\x20the\x20basic\x20uni\
    ts\x20are\n\x20\x20\x20\x20appropriate.\x20For\x20example,\x20\"new\x20u\
    sers\x20per\x20day\"\x20can\x20be\x20represented\x20as\n\x20\x20\x20\x20\
    `1/d`\x20or\x20`{new-users}/d`\x20(and\x20a\x20metric\x20value\x20`5`\
    \x20would\x20mean\x20\"5\x20new\n\x20\x20\x20\x20users).\x20Alternativel\
    y,\x20\"thousands\x20of\x20page\x20views\x20per\x20day\"\x20would\x20be\
    \n\x20\x20\x20\x20represented\x20as\x20`1000/d`\x20or\x20`k1/d`\x20or\
    \x20`k{page_views}/d`\x20(and\x20a\x20metric\n\x20\x20\x20\x20value\x20o\
    f\x20`5.3`\x20would\x20mean\x20\"5300\x20page\x20views\x20per\x20day\").\
    \n\x20*\x20`%`\x20represents\x20dimensionless\x20value\x20of\x201/100,\
    \x20and\x20annotates\x20values\x20giving\n\x20\x20\x20\x20a\x20percentag\
    e\x20(so\x20the\x20metric\x20values\x20are\x20typically\x20in\x20the\x20\
    range\x20of\x200..100,\n\x20\x20\x20\x20and\x20a\x20metric\x20value\x20`\
    3`\x20means\x20\"3\x20percent\").\n\x20*\x20`10^2.%`\x20indicates\x20a\
    \x20metric\x20contains\x20a\x20ratio,\x20typically\x20in\x20the\x20range\
    \n\x20\x20\x20\x200..1,\x20that\x20will\x20be\x20multiplied\x20by\x20100\
    \x20and\x20displayed\x20as\x20a\x20percentage\n\x20\x20\x20\x20(so\x20a\
    \x20metric\x20value\x20`0.03`\x20means\x20\"3\x20percent\").\n\n\r\n\x05\
    \x04\0\x02\x05\x05\x12\x04\xe4\x01\x02\x08\n\r\n\x05\x04\0\x02\x05\x01\
    \x12\x04\xe4\x01\t\r\n\r\n\x05\x04\0\x02\x05\x03\x12\x04\xe4\x01\x10\x11\
    \nY\n\x04\x04\0\x02\x06\x12\x04\xe7\x01\x02\x19\x1aK\x20A\x20detailed\
    \x20description\x20of\x20the\x20metric,\x20which\x20can\x20be\x20used\
    \x20in\x20documentation.\n\n\r\n\x05\x04\0\x02\x06\x05\x12\x04\xe7\x01\
    \x02\x08\n\r\n\x05\x04\0\x02\x06\x01\x12\x04\xe7\x01\t\x14\n\r\n\x05\x04\
    \0\x02\x06\x03\x12\x04\xe7\x01\x17\x18\n\xa3\x02\n\x04\x04\0\x02\x07\x12\
    \x04\xed\x01\x02\x1a\x1a\x94\x02\x20A\x20concise\x20name\x20for\x20the\
    \x20metric,\x20which\x20can\x20be\x20displayed\x20in\x20user\x20interfac\
    ...
    uch\x20as\x20Quota.\n\n\r\n\x05\x04\0\x02\x07\x05\x12\x04\xed\x01\x02\
    \x08\n\r\n\x05\x04\0\x02\x07\x01\x12\x04\xed\x01\t\x15\n\r\n\x05\x04\0\
    \x02\x07\x03\x12\x04\xed\x01\x18\x19\nR\n\x04\x04\0\x02\x08\x12\x04\xf0\
    \x01\x02)\x1aD\x20Optional.\x20Metadata\x20which\x20can\x20be\x20used\
    \x20to\x20guide\x20usage\x20of\x20the\x20metric.\n\n\r\n\x05\x04\0\x02\
    \x08\x06\x12\x04\xf0\x01\x02\x1a\n\r\n\x05\x04\0\x02\x08\x01\x12\x04\xf0\
    \x01\x1b#\n\r\n\x05\x04\0\x02\x08\x03\x12\x04\xf0\x01&(\nD\n\x04\x04\0\
    \x02\t\x12\x04\xf3\x01\x02\x20\x1a6\x20Optional.\x20The\x20launch\x20sta\
    ge\x20of\x20the\x20metric\x20definition.\n\n\r\n\x05\x04\0\x02\t\x06\x12\
    \x04\xf3\x01\x02\r\n\r\n\x05\x04\0\x02\t\x01\x12\x04\xf3\x01\x0e\x1a\n\r\
    \n\x05\x04\0\x02\t\x03\x12\x04\xf3\x01\x1d\x1f\n\xd4\x02\n\x04\x04\0\x02\
    \n\x12\x04\xfa\x01\x020\x1a\xc5\x02\x20Read-only.\x20If\x20present,\x20t\
    hen\x20a\x20[time\n\x20series][google.monitoring.v3.TimeSeries],\x20whic\
    h\x20is\x20identified\x20partially\x20by\n\x20a\x20metric\x20type\x20and\
    \x20a\x20[MonitoredResourceDescriptor][google.api.MonitoredResourceDescr\
    iptor],\x20that\x20is\x20associated\n\x20with\x20this\x20metric\x20type\
    \x20can\x20only\x20be\x20associated\x20with\x20one\x20of\x20the\x20monit\
    ored\n\x20resource\x20types\x20listed\x20here.\n\n\r\n\x05\x04\0\x02\n\
    \x04\x12\x04\xfa\x01\x02\n\n\r\n\x05\x04\0\x02\n\x05\x12\x04\xfa\x01\x0b\
    \x11\n\r\n\x05\x04\0\x02\n\x01\x12\x04\xfa\x01\x12*\n\r\n\x05\x04\0\x02\
    \n\x03\x12\x04\xfa\x01-/\n\x92\x01\n\x02\x04\x01\x12\x06\xff\x01\0\x87\
    \x02\x01\x1a\x83\x01\x20A\x20specific\x20metric,\x20identified\x20by\x20\
    specifying\x20values\x20for\x20all\x20of\x20the\n\x20labels\x20of\x20a\
    \x20[`MetricDescriptor`][google.api.MetricDescriptor].\n\n\x0b\n\x03\x04\
    \x01\x01\x12\x04\xff\x01\x08\x0e\n\xa4\x01\n\x04\x04\x01\x02\0\x12\x04\
    \x82\x02\x02\x12\x1a\x95\x01\x20An\x20existing\x20metric\x20type,\x20see\
    \x20[google.api.MetricDescriptor][google.api.MetricDescriptor].\n\x20For\
    \x20example,\x20`custom.googleapis.com/invoice/paid/amount`.\n\n\r\n\x05\
    \x04\x01\x02\0\x05\x12\x04\x82\x02\x02\x08\n\r\n\x05\x04\x01\x02\0\x01\
    \x12\x04\x82\x02\t\r\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\x82\x02\x10\x11\
    \n\x92\x01\n\x04\x04\x01\x02\x01\x12\x04\x86\x02\x02!\x1a\x83\x01\x20The\
    ...
    \x12\x04\x86\x02\x02\x15\n\r\n\x05\x04\x01\x02\x01\x01\x12\x04\x86\x02\
    \x16\x1c\n\r\n\x05\x04\x01\x02\x01\x03\x12\x04\x86\x02\x1f\x20b\x06proto\
    3\
";
