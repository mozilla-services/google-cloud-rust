...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    /googleapis/api/serviceconfig;serviceconfig\xa2\x02\x04GAPIJ\xb3:\n\x07\
    \x12\x05\x0f\0\xbb\x01\x01\n\xbe\x04\n\x01\x0c\x12\x03\x0f\0\x122\xb3\
    ...
    \x08$\x12\x03\x19\0\"\n\xf8\x0c\n\x02\x04\0\x12\x04M\0T\x01\x1a\xeb\x0c\
    \x20Quota\x20configuration\x20helps\x20to\x20achieve\x20fairness\x20and\
    \x20budgeting\x20in\x20service\n\x20usage.\n\n\x20The\x20quota\x20config\
    uration\x20works\x20this\x20way:\n\x20-\x20The\x20service\x20configurati\
    on\x20defines\x20a\x20set\x20of\x20metrics.\n\x20-\x20For\x20API\x20call\
    s,\x20the\x20quota.metric_rules\x20maps\x20methods\x20to\x20metrics\x20w\
    ith\n\x20\x20\x20corresponding\x20costs.\n\x20-\x20The\x20quota.limits\
    \x20defines\x20limits\x20on\x20the\x20metrics,\x20which\x20will\x20be\
    \x20used\x20for\n\x20\x20\x20quota\x20checks\x20at\x20runtime.\n\n\x20An\
    \x20example\x20quota\x20configuration\x20in\x20yaml\x20format:\n\n\x20\
    \x20\x20\x20quota:\n\x20\x20\x20\x20\x20\x20limits:\n\n\x20\x20\x20\x20\
    \x20\x20-\x20name:\x20apiWriteQpsPerProject\n\x20\x20\x20\x20\x20\x20\
    \x20\x20metric:\x20library.googleapis.com/write_calls\n\x20\x20\x20\x20\
    \x20\x20\x20\x20unit:\x20\"1/min/{project}\"\x20\x20#\x20rate\x20limit\
    \x20for\x20consumer\x20projects\n\x20\x20\x20\x20\x20\x20\x20\x20values:\
    \n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20STANDARD:\x2010000\n\n\n\x20\
    \x20\x20\x20\x20\x20#\x20The\x20metric\x20rules\x20bind\x20all\x20method\
    s\x20to\x20the\x20read_calls\x20metric,\n\x20\x20\x20\x20\x20\x20#\x20ex\
    cept\x20for\x20the\x20UpdateBook\x20and\x20DeleteBook\x20methods.\x20The\
    se\x20two\x20methods\n\x20\x20\x20\x20\x20\x20#\x20are\x20mapped\x20to\
    \x20the\x20write_calls\x20metric,\x20with\x20the\x20UpdateBook\x20method\
    \n\x20\x20\x20\x20\x20\x20#\x20consuming\x20at\x20twice\x20rate\x20as\
    \x20the\x20DeleteBook\x20method.\n\x20\x20\x20\x20\x20\x20metric_rules:\
    \n\x20\x20\x20\x20\x20\x20-\x20selector:\x20\"*\"\n\x20\x20\x20\x20\x20\
    \x20\x20\x20metric_costs:\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20libra\
    ry.googleapis.com/read_calls:\x201\n\x20\x20\x20\x20\x20\x20-\x20selecto\
    r:\x20google.example.library.v1.LibraryService.UpdateBook\n\x20\x20\x20\
    \x20\x20\x20\x20\x20metric_costs:\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20library.googleapis.com/write_calls:\x202\n\x20\x20\x20\x20\x20\x20-\
    \x20selector:\x20google.example.library.v1.LibraryService.DeleteBook\n\
    \x20\x20\x20\x20\x20\x20\x20\x20metric_costs:\n\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20library.googleapis.com/write_calls:\x201\n\n\x20\x20Corr\
    esponding\x20Metric\x20definition:\n\n\x20\x20\x20\x20\x20\x20metrics:\n\
    \x20\x20\x20\x20\x20\x20-\x20name:\x20library.googleapis.com/read_calls\
    \n\x20\x20\x20\x20\x20\x20\x20\x20display_name:\x20Read\x20requests\n\
    \x20\x20\x20\x20\x20\x20\x20\x20metric_kind:\x20DELTA\n\x20\x20\x20\x20\
    \x20\x20\x20\x20value_type:\x20INT64\n\n\x20\x20\x20\x20\x20\x20-\x20nam\
    e:\x20library.googleapis.com/write_calls\n\x20\x20\x20\x20\x20\x20\x20\
    \x20display_name:\x20Write\x20requests\n\x20\x20\x20\x20\x20\x20\x20\x20\
    metric_kind:\x20DELTA\n\x20\x20\x20\x20\x20\x20\x20\x20value_type:\x20IN\
    T64\n\n\n\n\x03\x04\0\x01\x12\x03M\x08\r\n@\n\x04\x04\0\x02\0\x12\x03O\
    \x02!\x1a3\x20List\x20of\x20`QuotaLimit`\x20definitions\x20for\x20the\
    \x20service.\n\n\x0c\n\x05\x04\0\x02\0\x04\x12\x03O\x02\n\n\x0c\n\x05\
    \x04\0\x02\0\x06\x12\x03O\x0b\x15\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03O\
    \x16\x1c\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03O\x1f\x20\nl\n\x04\x04\0\x02\
    \x01\x12\x03S\x02'\x1a_\x20List\x20of\x20`MetricRule`\x20definitions,\
    \x20each\x20one\x20mapping\x20a\x20selected\x20method\x20to\x20one\n\x20\
    or\x20more\x20metrics.\n\n\x0c\n\x05\x04\0\x02\x01\x04\x12\x03S\x02\n\n\
    \x0c\n\x05\x04\0\x02\x01\x06\x12\x03S\x0b\x15\n\x0c\n\x05\x04\0\x02\x01\
    \x01\x12\x03S\x16\"\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03S%&\n\x96\x01\n\
    \x02\x04\x01\x12\x04X\0e\x01\x1a\x89\x01\x20Bind\x20API\x20methods\x20to\
    \x20metrics.\x20Binding\x20a\x20method\x20to\x20a\x20metric\x20causes\
    \x20that\n\x20metric's\x20configured\x20quota\x20behaviors\x20to\x20appl\
    y\x20to\x20the\x20method\x20call.\n\n\n\n\x03\x04\x01\x01\x12\x03X\x08\
    \x12\n\x90\x01\n\x04\x04\x01\x02\0\x12\x03\\\x02\x16\x1a\x82\x01\x20Sele\
    cts\x20the\x20methods\x20to\x20which\x20this\x20rule\x20applies.\n\n\x20\
    Refer\x20to\x20[selector][google.api.DocumentationRule.selector]\x20for\
    \x20syntax\x20details.\n\n\r\n\x05\x04\x01\x02\0\x04\x12\x04\\\x02X\x14\
    \n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03\\\x02\x08\n\x0c\n\x05\x04\x01\x02\
    \0\x01\x12\x03\\\t\x11\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\\\x14\x15\n\
    \xa6\x02\n\x04\x04\x01\x02\x01\x12\x03d\x02&\x1a\x98\x02\x20Metrics\x20t\
    o\x20update\x20when\x20the\x20selected\x20methods\x20are\x20called,\x20a\
    nd\x20the\x20associated\n\x20cost\x20applied\x20to\x20each\x20metric.\n\
    \n\x20The\x20key\x20of\x20the\x20map\x20is\x20the\x20metric\x20name,\x20\
    and\x20the\x20values\x20are\x20the\x20amount\n\x20increased\x20for\x20th\
    e\x20metric\x20against\x20which\x20the\x20quota\x20limits\x20are\x20defi\
    ned.\n\x20The\x20value\x20must\x20not\x20be\x20negative.\n\n\r\n\x05\x04\
    \x01\x02\x01\x04\x12\x04d\x02\\\x16\n\x0c\n\x05\x04\x01\x02\x01\x06\x12\
    \x03d\x02\x14\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03d\x15!\n\x0c\n\x05\
    \x04\x01\x02\x01\x03\x12\x03d$%\n\xd8\x01\n\x02\x04\x02\x12\x05j\0\xbb\
    \x01\x01\x1a\xca\x01\x20`QuotaLimit`\x20defines\x20a\x20specific\x20limi\
    ...
    \x08\x12\n\xeb\x01\n\x04\x04\x02\x02\0\x12\x03q\x02\x12\x1a\xdd\x01\x20N\
    ...
    \x02\0\x04\x12\x04q\x02j\x14\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03q\x02\
    \x08\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03q\t\r\n\x0c\n\x05\x04\x02\x02\
    \0\x03\x12\x03q\x10\x11\n\xde\x01\n\x04\x04\x02\x02\x01\x12\x03v\x02\x19\
    ...
    \x20(see:\x20`display_name`).\n\n\r\n\x05\x04\x02\x02\x01\x04\x12\x04v\
    \x02q\x12\n\x0c\n\x05\x04\x02\x02\x01\x05\x12\x03v\x02\x08\n\x0c\n\x05\
    \x04\x02\x02\x01\x01\x12\x03v\t\x14\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\
    \x03v\x17\x18\n\xe8\x03\n\x04\x04\x02\x02\x02\x12\x04\x82\x01\x02\x1a\
    \x1a\xd9\x03\x20Default\x20number\x20of\x20tokens\x20that\x20can\x20be\
    \x20consumed\x20during\x20the\x20specified\n\x20duration.\x20This\x20is\
    \x20the\x20number\x20of\x20tokens\x20assigned\x20when\x20a\x20client\n\
    \x20application\x20developer\x20activates\x20the\x20service\x20for\x20hi\
    s/her\x20project.\n\n\x20Specifying\x20a\x20value\x20of\x200\x20will\x20\
    block\x20all\x20requests.\x20This\x20can\x20be\x20used\x20if\x20you\n\
    \x20are\x20provisioning\x20quota\x20to\x20selected\x20consumers\x20and\
    \x20blocking\x20others.\n\x20Similarly,\x20a\x20value\x20of\x20-1\x20wil\
    l\x20indicate\x20an\x20unlimited\x20quota.\x20No\x20other\n\x20negative\
    \x20values\x20are\x20allowed.\n\n\x20Used\x20by\x20group-based\x20quotas\
    \x20only.\n\n\x0e\n\x05\x04\x02\x02\x02\x04\x12\x05\x82\x01\x02v\x19\n\r\
    \n\x05\x04\x02\x02\x02\x05\x12\x04\x82\x01\x02\x07\n\r\n\x05\x04\x02\x02\
    \x02\x01\x12\x04\x82\x01\x08\x15\n\r\n\x05\x04\x02\x02\x02\x03\x12\x04\
    \x82\x01\x18\x19\n\xc5\x03\n\x04\x04\x02\x02\x03\x12\x04\x8d\x01\x02\x16\
    \x1a\xb6\x03\x20Maximum\x20number\x20of\x20tokens\x20that\x20can\x20be\
    \x20consumed\x20during\x20the\x20specified\n\x20duration.\x20Client\x20a\
    pplication\x20developers\x20can\x20override\x20the\x20default\x20limit\
    \x20up\n\x20to\x20this\x20maximum.\x20If\x20specified,\x20this\x20value\
    \x20cannot\x20be\x20set\x20to\x20a\x20value\x20less\n\x20than\x20the\x20\
    default\x20limit.\x20If\x20not\x20specified,\x20it\x20is\x20set\x20to\
    \x20the\x20default\x20limit.\n\n\x20To\x20allow\x20clients\x20to\x20appl\
    y\x20overrides\x20with\x20no\x20upper\x20bound,\x20set\x20this\x20to\x20\
    -1,\n\x20indicating\x20unlimited\x20maximum\x20quota.\n\n\x20Used\x20by\
    \x20group-based\x20quotas\x20only.\n\n\x0f\n\x05\x04\x02\x02\x03\x04\x12\
    \x06\x8d\x01\x02\x82\x01\x1a\n\r\n\x05\x04\x02\x02\x03\x05\x12\x04\x8d\
    \x01\x02\x07\n\r\n\x05\x04\x02\x02\x03\x01\x12\x04\x8d\x01\x08\x11\n\r\n\
    \x05\x04\x02\x02\x03\x03\x12\x04\x8d\x01\x14\x15\n\xbf\x03\n\x04\x04\x02\
    \x02\x04\x12\x04\x97\x01\x02\x16\x1a\xb0\x03\x20Free\x20tier\x20value\
    \x20displayed\x20in\x20the\x20Developers\x20Console\x20for\x20this\x20li\
    mit.\n\x20The\x20free\x20tier\x20is\x20the\x20number\x20of\x20tokens\x20\
    that\x20will\x20be\x20subtracted\x20from\x20the\n\x20billed\x20amount\
    \x20when\x20billing\x20is\x20enabled.\n\x20This\x20field\x20can\x20only\
    \x20be\x20set\x20on\x20a\x20limit\x20with\x20duration\x20\"1d\",\x20in\
    \x20a\x20billable\n\x20group;\x20it\x20is\x20invalid\x20on\x20any\x20oth\
    er\x20limit.\x20If\x20this\x20field\x20is\x20not\x20set,\x20it\n\x20defa\
    ults\x20to\x200,\x20indicating\x20that\x20there\x20is\x20no\x20free\x20t\
    ier\x20for\x20this\x20service.\n\n\x20Used\x20by\x20group-based\x20quota\
    s\x20only.\n\n\x0f\n\x05\x04\x02\x02\x04\x04\x12\x06\x97\x01\x02\x8d\x01\
    \x16\n\r\n\x05\x04\x02\x02\x04\x05\x12\x04\x97\x01\x02\x07\n\r\n\x05\x04\
    \x02\x02\x04\x01\x12\x04\x97\x01\x08\x11\n\r\n\x05\x04\x02\x02\x04\x03\
    \x12\x04\x97\x01\x14\x15\n\xc0\x02\n\x04\x04\x02\x02\x05\x12\x04\x9f\x01\
    \x02\x16\x1a\xb1\x02\x20Duration\x20of\x20this\x20limit\x20in\x20textual\
    \x20notation.\x20Example:\x20\"100s\",\x20\"24h\",\x20\"1d\".\n\x20For\
    \x20duration\x20longer\x20than\x20a\x20day,\x20only\x20multiple\x20of\
    \x20days\x20is\x20supported.\x20We\n\x20support\x20only\x20\"100s\"\x20a\
    nd\x20\"1d\"\x20for\x20now.\x20Additional\x20support\x20will\x20be\x20ad\
    ded\x20in\n\x20the\x20future.\x20\"0\"\x20indicates\x20indefinite\x20dur\
    ation.\n\n\x20Used\x20by\x20group-based\x20quotas\x20only.\n\n\x0f\n\x05\
    \x04\x02\x02\x05\x04\x12\x06\x9f\x01\x02\x97\x01\x16\n\r\n\x05\x04\x02\
    \x02\x05\x05\x12\x04\x9f\x01\x02\x08\n\r\n\x05\x04\x02\x02\x05\x01\x12\
    \x04\x9f\x01\t\x11\n\r\n\x05\x04\x02\x02\x05\x03\x12\x04\x9f\x01\x14\x15\
    \n\xcb\x01\n\x04\x04\x02\x02\x06\x12\x04\xa4\x01\x02\x14\x1a\xbc\x01\x20\
    The\x20name\x20of\x20the\x20metric\x20this\x20quota\x20limit\x20applies\
    ...
    \x0f\n\x05\x04\x02\x02\x06\x04\x12\x06\xa4\x01\x02\x9f\x01\x16\n\r\n\x05\
    \x04\x02\x02\x06\x05\x12\x04\xa4\x01\x02\x08\n\r\n\x05\x04\x02\x02\x06\
    \x01\x12\x04\xa4\x01\t\x0f\n\r\n\x05\x04\x02\x02\x06\x03\x12\x04\xa4\x01\
    \x12\x13\n\xf8\x02\n\x04\x04\x02\x02\x07\x12\x04\xaf\x01\x02\x12\x1a\xe9\
    \x02\x20Specify\x20the\x20unit\x20of\x20the\x20quota\x20limit.\x20It\x20\
    uses\x20the\x20same\x20syntax\x20as\n\x20[Metric.unit][].\x20The\x20supp\
    orted\x20unit\x20kinds\x20are\x20determined\x20by\x20the\x20quota\n\x20b\
    ackend\x20system.\n\n\x20Here\x20are\x20some\x20examples:\n\x20*\x20\"1/\
    min/{project}\"\x20for\x20quota\x20per\x20minute\x20per\x20project.\n\n\
    \x20Note:\x20the\x20order\x20of\x20unit\x20components\x20is\x20insignifi\
    cant.\n\x20The\x20\"1\"\x20at\x20the\x20beginning\x20is\x20required\x20t\
    o\x20follow\x20the\x20metric\x20unit\x20syntax.\n\n\x0f\n\x05\x04\x02\
    \x02\x07\x04\x12\x06\xaf\x01\x02\xa4\x01\x14\n\r\n\x05\x04\x02\x02\x07\
    \x05\x12\x04\xaf\x01\x02\x08\n\r\n\x05\x04\x02\x02\x07\x01\x12\x04\xaf\
    \x01\t\r\n\r\n\x05\x04\x02\x02\x07\x03\x12\x04\xaf\x01\x10\x11\n\xd5\x01\
    \n\x04\x04\x02\x02\x08\x12\x04\xb4\x01\x02!\x1a\xc6\x01\x20Tiered\x20lim\
    it\x20values.\x20You\x20must\x20specify\x20this\x20as\x20a\x20key:value\
    \x20pair,\x20with\x20an\n\x20integer\x20value\x20that\x20is\x20the\x20ma\
    ximum\x20number\x20of\x20requests\x20allowed\x20for\x20the\n\x20specifie\
    d\x20unit.\x20Currently\x20only\x20STANDARD\x20is\x20supported.\n\n\x0f\
    \n\x05\x04\x02\x02\x08\x04\x12\x06\xb4\x01\x02\xaf\x01\x12\n\r\n\x05\x04\
    \x02\x02\x08\x06\x12\x04\xb4\x01\x02\x14\n\r\n\x05\x04\x02\x02\x08\x01\
    \x12\x04\xb4\x01\x15\x1b\n\r\n\x05\x04\x02\x02\x08\x03\x12\x04\xb4\x01\
    \x1e\x20\n\xfe\x01\n\x04\x04\x02\x02\t\x12\x04\xba\x01\x02\x1b\x1a\xef\
    \x01\x20User-visible\x20display\x20name\x20for\x20this\x20limit.\n\x20Op\
    tional.\x20If\x20not\x20set,\x20the\x20UI\x20will\x20provide\x20a\x20def\
    ault\x20display\x20name\x20based\x20on\n\x20the\x20quota\x20configuratio\
    n.\x20This\x20field\x20can\x20be\x20used\x20to\x20override\x20the\x20def\
    ault\n\x20display\x20name\x20generated\x20from\x20the\x20configuration.\
    \n\n\x0f\n\x05\x04\x02\x02\t\x04\x12\x06\xba\x01\x02\xb4\x01!\n\r\n\x05\
    \x04\x02\x02\t\x05\x12\x04\xba\x01\x02\x08\n\r\n\x05\x04\x02\x02\t\x01\
    \x12\x04\xba\x01\t\x15\n\r\n\x05\x04\x02\x02\t\x03\x12\x04\xba\x01\x18\
    \x1ab\x06proto3\
";
