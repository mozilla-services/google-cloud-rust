...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20all\x20methods\x20to\x20the\x20read_calls\x20metric,\n\x20\x20\x20\
    ...
    \x20mapped\x20to\x20the\x20write_calls\x20metric,\x20with\x20the\x20Upda\
    ...
    \x20\x20\x20\x20\x20\x20\x20metric_costs:\n\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20library.googleapis.com/read_calls:\x201\n\x20\x20\x20\x20\
    \x20\x20-\x20selector:\x20google.example.library.v1.LibraryService.Updat\
    eBook\n\x20\x20\x20\x20\x20\x20\x20\x20metric_costs:\n\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20library.googleapis.com/write_calls:\x202\n\x20\
    \x20\x20\x20\x20\x20-\x20selector:\x20google.example.library.v1.LibraryS\
    ervice.DeleteBook\n\x20\x20\x20\x20\x20\x20\x20\x20metric_costs:\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20library.googleapis.com/write_calls:\
    \x201\n\n\x20\x20Corresponding\x20Metric\x20definition:\n\n\x20\x20\x20\
    \x20\x20\x20metrics:\n\x20\x20\x20\x20\x20\x20-\x20name:\x20library.goog\
    leapis.com/read_calls\n\x20\x20\x20\x20\x20\x20\x20\x20display_name:\x20\
    Read\x20requests\n\x20\x20\x20\x20\x20\x20\x20\x20metric_kind:\x20DELTA\
    \n\x20\x20\x20\x20\x20\x20\x20\x20value_type:\x20INT64\n\n\x20\x20\x20\
    \x20\x20\x20-\x20name:\x20library.googleapis.com/write_calls\n\x20\x20\
    \x20\x20\x20\x20\x20\x20display_name:\x20Write\x20requests\n\x20\x20\x20\
    \x20\x20\x20\x20\x20metric_kind:\x20DELTA\n\x20\x20\x20\x20\x20\x20\x20\
    \x20value_type:\x20INT64\n\n\n\n\n\n\x03\x04\0\x01\x12\x03K\x08\r\n>\n\
    \x04\x04\0\x02\0\x12\x03M\x02!\x1a1\x20List\x20of\x20QuotaLimit\x20defin\
    itions\x20for\x20the\x20service.\n\n\x0c\n\x05\x04\0\x02\0\x04\x12\x03M\
    ...
    \x1a\x83\x01\x20Selects\x20the\x20methods\x20to\x20which\x20this\x20rule\
    \x20applies.\n\n\x20Refer\x20to\x20[selector][google.api.DocumentationRu\
    le.selector]\x20for\x20syntax\n\x20details.\n\n\x0c\n\x05\x04\x01\x02\0\
    ...
    \x20Duration\x20of\x20this\x20limit\x20in\x20textual\x20notation.\x20Mus\
    t\x20be\x20\"100s\"\x20or\x20\"1d\".\n\n\x20Used\x20by\x20group-based\
    \x20quotas\x20only.\n\n\r\n\x05\x04\x02\x02\x05\x05\x12\x04\x9b\x01\x02\
    \x08\n\r\n\x05\x04\x02\x02\x05\x01\x12\x04\x9b\x01\t\x11\n\r\n\x05\x04\
    \x02\x02\x05\x03\x12\x04\x9b\x01\x14\x15\n\xcb\x01\n\x04\x04\x02\x02\x06\
    \x12\x04\xa0\x01\x02\x14\x1a\xbc\x01\x20The\x20name\x20of\x20the\x20metr\
    ic\x20this\x20quota\x20limit\x20applies\x20to.\x20The\x20quota\x20limits\
    \x20with\n\x20the\x20same\x20metric\x20will\x20be\x20checked\x20together\
    \x20during\x20runtime.\x20The\x20metric\x20must\x20be\n\x20defined\x20wi\
    thin\x20the\x20service\x20config.\n\n\r\n\x05\x04\x02\x02\x06\x05\x12\
    \x04\xa0\x01\x02\x08\n\r\n\x05\x04\x02\x02\x06\x01\x12\x04\xa0\x01\t\x0f\
    \n\r\n\x05\x04\x02\x02\x06\x03\x12\x04\xa0\x01\x12\x13\n\xf8\x02\n\x04\
    \x04\x02\x02\x07\x12\x04\xab\x01\x02\x12\x1a\xe9\x02\x20Specify\x20the\
    \x20unit\x20of\x20the\x20quota\x20limit.\x20It\x20uses\x20the\x20same\
    \x20syntax\x20as\n\x20[Metric.unit][].\x20The\x20supported\x20unit\x20ki\
    nds\x20are\x20determined\x20by\x20the\x20quota\n\x20backend\x20system.\n\
    \n\x20Here\x20are\x20some\x20examples:\n\x20*\x20\"1/min/{project}\"\x20\
    for\x20quota\x20per\x20minute\x20per\x20project.\n\n\x20Note:\x20the\x20\
    order\x20of\x20unit\x20components\x20is\x20insignificant.\n\x20The\x20\"\
    1\"\x20at\x20the\x20beginning\x20is\x20required\x20to\x20follow\x20the\
    \x20metric\x20unit\x20syntax.\n\n\r\n\x05\x04\x02\x02\x07\x05\x12\x04\
    \xab\x01\x02\x08\n\r\n\x05\x04\x02\x02\x07\x01\x12\x04\xab\x01\t\r\n\r\n\
    \x05\x04\x02\x02\x07\x03\x12\x04\xab\x01\x10\x11\n\xd5\x01\n\x04\x04\x02\
    \x02\x08\x12\x04\xb0\x01\x02!\x1a\xc6\x01\x20Tiered\x20limit\x20values.\
    \x20You\x20must\x20specify\x20this\x20as\x20a\x20key:value\x20pair,\x20w\
    ith\x20an\n\x20integer\x20value\x20that\x20is\x20the\x20maximum\x20numbe\
    r\x20of\x20requests\x20allowed\x20for\x20the\n\x20specified\x20unit.\x20\
    Currently\x20only\x20STANDARD\x20is\x20supported.\n\n\r\n\x05\x04\x02\
    \x02\x08\x06\x12\x04\xb0\x01\x02\x14\n\r\n\x05\x04\x02\x02\x08\x01\x12\
    ...
    \x02\t\x01\x12\x04\xb6\x01\t\x15\n\r\n\x05\x04\x02\x02\t\x03\x12\x04\xb6\
    \x01\x18\x1ab\x06proto3\
";
