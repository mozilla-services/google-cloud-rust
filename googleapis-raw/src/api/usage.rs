...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    rviceconfig;serviceconfig\xa2\x02\x04GAPIJ\xc9\x1a\n\x06\x12\x04\x0f\0\\\
    ...
    \x04\0\x12\x04\x1d\01\x01\x1a/\x20Configuration\x20controlling\x20usage\
    \x20of\x20a\x20service.\n\n\n\n\x03\x04\0\x01\x12\x03\x1d\x08\r\n\xe0\
    \x01\n\x04\x04\0\x02\0\x12\x03!\x02#\x1a\xd2\x01\x20Requirements\x20that\
    \x20must\x20be\x20satisfied\x20before\x20a\x20consumer\x20project\x20can\
    \x20use\x20the\n\x20service.\x20Each\x20requirement\x20is\x20of\x20the\
    \x20form\x20<service.name>/<requirement-id>;\n\x20for\x20example\x20'ser\
    viceusage.googleapis.com/billing-enabled'.\n\n\x0c\n\x05\x04\0\x02\0\x04\
    \x12\x03!\x02\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03!\x0b\x11\n\x0c\n\x05\
    \x04\0\x02\0\x01\x12\x03!\x12\x1e\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03!!\
    \"\n\x95\x01\n\x04\x04\0\x02\x01\x12\x03&\x02\x1f\x1a\x87\x01\x20A\x20li\
    st\x20of\x20usage\x20rules\x20that\x20apply\x20to\x20individual\x20API\
    ...
    \x03\x12\x03&\x1d\x1e\n\xbd\x03\n\x04\x04\0\x02\x02\x12\x030\x02+\x1a\
    \xaf\x03\x20The\x20full\x20resource\x20name\x20of\x20a\x20channel\x20use\
    d\x20for\x20sending\x20notifications\x20to\x20the\n\x20service\x20produc\
    er.\n\n\x20Google\x20Service\x20Management\x20currently\x20only\x20suppo\
    rts\n\x20[Google\x20Cloud\x20Pub/Sub](https://cloud.google.com/pubsub)\
    \x20as\x20a\x20notification\n\x20channel.\x20To\x20use\x20Google\x20Clou\
    d\x20Pub/Sub\x20as\x20the\x20channel,\x20this\x20must\x20be\x20the\x20na\
    me\n\x20of\x20a\x20Cloud\x20Pub/Sub\x20topic\x20that\x20uses\x20the\x20C\
    loud\x20Pub/Sub\x20topic\x20name\x20format\n\x20documented\x20in\x20http\
    s://cloud.google.com/pubsub/docs/overview.\n\n\r\n\x05\x04\0\x02\x02\x04\
    \x12\x040\x02&\x1f\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x030\x02\x08\n\x0c\
    \n\x05\x04\0\x02\x02\x01\x12\x030\t&\n\x0c\n\x05\x04\0\x02\x02\x03\x12\
    \x030)*\n\xc0\x06\n\x02\x04\x01\x12\x04L\0\\\x01\x1a\xb3\x06\x20Usage\
    \x20configuration\x20rules\x20for\x20the\x20service.\n\n\x20NOTE:\x20Und\
    er\x20development.\n\n\n\x20Use\x20this\x20rule\x20to\x20configure\x20un\
    registered\x20calls\x20for\x20the\x20service.\x20Unregistered\n\x20calls\
    \x20are\x20calls\x20that\x20do\x20not\x20contain\x20consumer\x20project\
    \x20identity.\n\x20(Example:\x20calls\x20that\x20do\x20not\x20contain\
    \x20an\x20API\x20key).\n\x20By\x20default,\x20API\x20methods\x20do\x20no\
    t\x20allow\x20unregistered\x20calls,\x20and\x20each\x20method\x20call\n\
    \x20must\x20be\x20identified\x20by\x20a\x20consumer\x20project\x20identi\
    ty.\x20Use\x20this\x20rule\x20to\n\x20allow/disallow\x20unregistered\x20\
    calls.\n\n\x20Example\x20of\x20an\x20API\x20that\x20wants\x20to\x20allow\
    \x20unregistered\x20calls\x20for\x20entire\x20service.\n\n\x20\x20\x20\
    \x20\x20usage:\n\x20\x20\x20\x20\x20\x20\x20rules:\n\x20\x20\x20\x20\x20\
    \x20\x20-\x20selector:\x20\"*\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20all\
    ow_unregistered_calls:\x20true\n\n\x20Example\x20of\x20a\x20method\x20th\
    at\x20wants\x20to\x20allow\x20unregistered\x20calls.\n\n\x20\x20\x20\x20\
    \x20usage:\n\x20\x20\x20\x20\x20\x20\x20rules:\n\x20\x20\x20\x20\x20\x20\
    \x20-\x20selector:\x20\"google.example.library.v1.LibraryService.CreateB\
    ook\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20allow_unregistered_calls:\x20\
    true\n\n\n\n\x03\x04\x01\x01\x12\x03L\x08\x11\n\xbe\x01\n\x04\x04\x01\
    \x02\0\x12\x03Q\x02\x16\x1a\xb0\x01\x20Selects\x20the\x20methods\x20to\
    ...
    \n\n\r\n\x05\x04\x01\x02\0\x04\x12\x04Q\x02L\x13\n\x0c\n\x05\x04\x01\x02\
    \0\x05\x12\x03Q\x02\x08\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03Q\t\x11\n\
    \x0c\n\x05\x04\x01\x02\0\x03\x12\x03Q\x14\x15\n\x7f\n\x04\x04\x01\x02\
    \x01\x12\x03U\x02$\x1ar\x20If\x20true,\x20the\x20selected\x20method\x20a\
    llows\x20unregistered\x20calls,\x20e.g.\x20calls\n\x20that\x20don't\x20i\
    dentify\x20any\x20user\x20or\x20application.\n\n\r\n\x05\x04\x01\x02\x01\
    \x04\x12\x04U\x02Q\x16\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03U\x02\x06\
    \n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03U\x07\x1f\n\x0c\n\x05\x04\x01\
    \x02\x01\x03\x12\x03U\"#\n\x96\x02\n\x04\x04\x01\x02\x02\x12\x03[\x02\
    \x20\x1a\x88\x02\x20If\x20true,\x20the\x20selected\x20method\x20should\
    \x20skip\x20service\x20control\x20and\x20the\x20control\n\x20plane\x20fe\
    atures,\x20such\x20as\x20quota\x20and\x20billing,\x20will\x20not\x20be\
    \x20available.\n\x20This\x20flag\x20is\x20used\x20by\x20Google\x20Cloud\
    \x20Endpoints\x20to\x20bypass\x20checks\x20for\x20internal\n\x20methods,\
    \x20such\x20as\x20service\x20health\x20check\x20methods.\n\n\r\n\x05\x04\
    \x01\x02\x02\x04\x12\x04[\x02U$\n\x0c\n\x05\x04\x01\x02\x02\x05\x12\x03[\
    \x02\x06\n\x0c\n\x05\x04\x01\x02\x02\x01\x12\x03[\x07\x1b\n\x0c\n\x05\
    \x04\x01\x02\x02\x03\x12\x03[\x1e\x1fb\x06proto3\
";
