...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03A\t\x11\n\x0c\n\x05\x04\x01\x02\0\
    \x03\x12\x03A\x14\x15\n6\n\x04\x04\x01\x02\x01\x12\x03D\x02\x1e\x1a)\x20\
    The\x20requirements\x20for\x20OAuth\x20credentials.\n\n\x0c\n\x05\x04\
    \x01\x02\x01\x06\x12\x03D\x02\x13\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\
    \x03D\x14\x19\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03D\x1c\x1d\n\x85\x01\
    \n\x04\x04\x01\x02\x02\x12\x03H\x02$\x1ax\x20If\x20true,\x20the\x20servi\
    ce\x20accepts\x20API\x20keys\x20without\x20any\x20other\x20credential.\n\
    \x20This\x20flag\x20only\x20applies\x20to\x20HTTP\x20and\x20gRPC\x20requ\
    ests.\n\n\x0c\n\x05\x04\x01\x02\x02\x05\x12\x03H\x02\x06\n\x0c\n\x05\x04\
    \x01\x02\x02\x01\x12\x03H\x07\x1f\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\
    \x03H\"#\nD\n\x04\x04\x01\x02\x03\x12\x03K\x02,\x1a7\x20Requirements\x20\
    for\x20additional\x20authentication\x20providers.\n\n\x0c\n\x05\x04\x01\
    \x02\x03\x04\x12\x03K\x02\n\n\x0c\n\x05\x04\x01\x02\x03\x06\x12\x03K\x0b\
    \x1a\n\x0c\n\x05\x04\x01\x02\x03\x01\x12\x03K\x1b'\n\x0c\n\x05\x04\x01\
    \x02\x03\x03\x12\x03K*+\nF\n\x02\x04\x02\x12\x04O\0a\x01\x1a:\x20Specifi\
    es\x20a\x20location\x20to\x20extract\x20JWT\x20from\x20an\x20API\x20requ\
    est.\n\n\n\n\x03\x04\x02\x01\x12\x03O\x08\x13\n\x0c\n\x04\x04\x02\x08\0\
    \x12\x04P\x02V\x03\n\x0c\n\x05\x04\x02\x08\0\x01\x12\x03P\x08\n\n?\n\x04\
    \x04\x02\x02\0\x12\x03R\x04\x16\x1a2\x20Specifies\x20HTTP\x20header\x20n\
    ame\x20to\x20extract\x20JWT\x20token.\n\n\x0c\n\x05\x04\x02\x02\0\x05\
    \x12\x03R\x04\n\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03R\x0b\x11\n\x0c\n\
    \x05\x04\x02\x02\0\x03\x12\x03R\x14\x15\nG\n\x04\x04\x02\x02\x01\x12\x03\
    U\x04\x15\x1a:\x20Specifies\x20URL\x20query\x20parameter\x20name\x20to\
    \x20extract\x20JWT\x20token.\n\n\x0c\n\x05\x04\x02\x02\x01\x05\x12\x03U\
    ...
    \x04\x02\x02\x02\x01\x12\x03`\t\x15\n\x0c\n\x05\x04\x02\x02\x02\x03\x12\
    \x03`\x18\x19\n\xad\x01\n\x02\x04\x03\x12\x05f\0\xac\x01\x01\x1a\x9f\x01\
    ...
    \x01\x12\x03f\x08\x14\n\x92\x01\n\x04\x04\x03\x02\0\x12\x03k\x02\x10\x1a\
    ...
    \x02\x01\x12\x03s\x02\x14\x1a\x87\x02\x20Identifies\x20the\x20principal\
    \x20that\x20issued\x20the\x20JWT.\x20See\n\x20https://tools.ietf.org/htm\
    l/draft-ietf-oauth-json-web-token-32#section-4.1.1\n\x20Usually\x20a\x20\
    URL\x20or\x20an\x20email\x20address.\n\n\x20Example:\x20https://secureto\
    ken.google.com\n\x20Example:\x201234567-compute@developer.gserviceaccoun\
    t.com\n\n\x0c\n\x05\x04\x03\x02\x01\x05\x12\x03s\x02\x08\n\x0c\n\x05\x04\
    \x03\x02\x01\x01\x12\x03s\t\x0f\n\x0c\n\x05\x04\x03\x02\x01\x03\x12\x03s\
    \x12\x13\n\xf6\x03\n\x04\x04\x03\x02\x02\x12\x04\x81\x01\x02\x16\x1a\xe7\
    \x03\x20URL\x20of\x20the\x20provider's\x20public\x20key\x20set\x20to\x20\
    validate\x20signature\x20of\x20the\x20JWT.\x20See\n\x20[OpenID\n\x20Disc\
    overy](https://openid.net/specs/openid-connect-discovery-1_0.html#Provid\
    erMetadata).\n\x20Optional\x20if\x20the\x20key\x20set\x20document:\n\x20\
    \x20-\x20can\x20be\x20retrieved\x20from\n\x20\x20\x20\x20[OpenID\n\x20\
    \x20\x20\x20Discovery](https://openid.net/specs/openid-connect-discovery\
    -1_0.html)\n\x20\x20\x20\x20of\x20the\x20issuer.\n\x20\x20-\x20can\x20be\
    \x20inferred\x20from\x20the\x20email\x20domain\x20of\x20the\x20issuer\
    \x20(e.g.\x20a\x20Google\n\x20\x20service\x20account).\n\n\x20Example:\
    \x20https://www.googleapis.com/oauth2/v1/certs\n\n\r\n\x05\x04\x03\x02\
    \x02\x05\x12\x04\x81\x01\x02\x08\n\r\n\x05\x04\x03\x02\x02\x01\x12\x04\
    \x81\x01\t\x11\n\r\n\x05\x04\x03\x02\x02\x03\x12\x04\x81\x01\x14\x15\n\
    \xee\x05\n\x04\x04\x03\x02\x03\x12\x04\x94\x01\x02\x17\x1a\xdf\x05\x20Th\
    e\x20list\x20of\x20JWT\n\x20[audiences](https://tools.ietf.org/html/draf\
    t-ietf-oauth-json-web-token-32#section-4.1.3).\n\x20that\x20are\x20allow\
    ed\x20to\x20access.\x20A\x20JWT\x20containing\x20any\x20of\x20these\x20a\
    udiences\x20will\n\x20be\x20accepted.\x20When\x20this\x20setting\x20is\
    \x20absent,\x20JWTs\x20with\x20audiences:\n\x20\x20\x20-\x20\"https://[s\
    ervice.name]/[google.protobuf.Api.name]\"\n\x20\x20\x20-\x20\"https://[s\
    ervice.name]/\"\n\x20will\x20be\x20accepted.\n\x20For\x20example,\x20if\
    \x20no\x20audiences\x20are\x20in\x20the\x20setting,\x20LibraryService\
    \x20API\x20will\n\x20accept\x20JWTs\x20with\x20the\x20following\x20audie\
    nces:\n\x20\x20\x20-\n\x20\x20\x20https://library-example.googleapis.com\
    /google.example.library.v1.LibraryService\n\x20\x20\x20-\x20https://libr\
    ary-example.googleapis.com/\n\n\x20Example:\n\n\x20\x20\x20\x20\x20audie\
    nces:\x20bookstore_android.apps.googleusercontent.com,\n\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20bookstore_web.apps.googl\
    eusercontent.com\n\n\r\n\x05\x04\x03\x02\x03\x05\x12\x04\x94\x01\x02\x08\
    \n\r\n\x05\x04\x03\x02\x03\x01\x12\x04\x94\x01\t\x12\n\r\n\x05\x04\x03\
    \x02\x03\x03\x12\x04\x94\x01\x15\x16\n\x99\x01\n\x04\x04\x03\x02\x04\x12\
    \x04\x98\x01\x02\x1f\x1a\x8a\x01\x20Redirect\x20URL\x20if\x20JWT\x20toke\
    n\x20is\x20required\x20but\x20not\x20present\x20or\x20is\x20expired.\n\
    ...
    \x02\x04\x03\x12\x04\x98\x01\x1d\x1e\n\xd8\x04\n\x04\x04\x03\x02\x05\x12\
    \x04\xab\x01\x02)\x1a\xc9\x04\x20Defines\x20the\x20locations\x20to\x20ex\
    tract\x20the\x20JWT.\n\n\x20JWT\x20locations\x20can\x20be\x20either\x20f\
    rom\x20HTTP\x20headers\x20or\x20URL\x20query\x20parameters.\n\x20The\x20\
    rule\x20is\x20that\x20the\x20first\x20match\x20wins.\x20The\x20checking\
    \x20order\x20is:\x20checking\n\x20all\x20headers\x20first,\x20then\x20UR\
    L\x20query\x20parameters.\n\n\x20If\x20not\x20specified,\x20\x20default\
    ...
    \x05\x04\x04\x02\0\x01\x12\x04\xc8\x01\t\x19\n\r\n\x05\x04\x04\x02\0\x03\
    \x12\x04\xc8\x01\x1c\x1d\n\xaa\x01\n\x02\x04\x05\x12\x06\xce\x01\0\xe7\
    ...
    \n\x03\x04\x05\x01\x12\x04\xce\x01\x08\x17\n{\n\x04\x04\x05\x02\0\x12\
    \x04\xd4\x01\x02\x19\x1am\x20[id][google.api.AuthProvider.id]\x20from\
    \x20authentication\x20provider.\n\n\x20Example:\n\n\x20\x20\x20\x20\x20p\
    rovider_id:\x20bookstore_auth\n\n\r\n\x05\x04\x05\x02\0\x05\x12\x04\xd4\
    \x01\x02\x08\n\r\n\x05\x04\x05\x02\0\x01\x12\x04\xd4\x01\t\x14\n\r\n\x05\
    \x04\x05\x02\0\x03\x12\x04\xd4\x01\x17\x18\n\xc0\x06\n\x04\x04\x05\x02\
    \x01\x12\x04\xe6\x01\x02\x17\x1a\xb1\x06\x20NOTE:\x20This\x20will\x20be\
    ...
    rcontent.com\n\n\r\n\x05\x04\x05\x02\x01\x05\x12\x04\xe6\x01\x02\x08\n\r\
    \n\x05\x04\x05\x02\x01\x01\x12\x04\xe6\x01\t\x12\n\r\n\x05\x04\x05\x02\
    \x01\x03\x12\x04\xe6\x01\x15\x16b\x06proto3\
";
