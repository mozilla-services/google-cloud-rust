...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    redres\xf8\x01\x01\xa2\x02\x04GAPIJ\x8c)\n\x06\x12\x04\x0e\0u\x01\n\xbc\
    \x04\n\x01\x0c\x12\x03\x0e\0\x122\xb1\x04\x20Copyright\x202015\x20Google\
    ...
    \x02\0\x03\x12\x03.\x10\x11\n\x8c\x01\n\x04\x04\0\x02\x01\x12\x032\x02\
    \x12\x1a\x7f\x20Required.\x20The\x20monitored\x20resource\x20type.\x20Fo\
    r\x20example,\x20the\x20type\n\x20`\"cloudsql_database\"`\x20represents\
    \x20databases\x20in\x20Google\x20Cloud\x20SQL.\n\n\x0c\n\x05\x04\0\x02\
    \x01\x05\x12\x032\x02\x08\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x032\t\r\n\
    \x0c\n\x05\x04\0\x02\x01\x03\x12\x032\x10\x11\n\xf5\x01\n\x04\x04\0\x02\
    \x02\x12\x038\x02\x1a\x1a\xe7\x01\x20Optional.\x20A\x20concise\x20name\
    \x20for\x20the\x20monitored\x20resource\x20type\x20that\x20might\x20be\n\
    \x20displayed\x20in\x20user\x20interfaces.\x20It\x20should\x20be\x20a\
    \x20Title\x20Cased\x20Noun\x20Phrase,\n\x20without\x20any\x20article\x20\
    or\x20other\x20determiners.\x20For\x20example,\n\x20`\"Google\x20Cloud\
    ...
    \xe1\x01\n\x04\x04\0\x02\x04\x12\x03A\x02&\x1a\xd3\x01\x20Required.\x20A\
    \x20set\x20of\x20labels\x20used\x20to\x20describe\x20instances\x20of\x20\
    this\x20monitored\n\x20resource\x20type.\x20For\x20example,\x20an\x20ind\
    ividual\x20Google\x20Cloud\x20SQL\x20database\x20is\n\x20identified\x20b\
    y\x20values\x20for\x20the\x20labels\x20`\"database_id\"`\x20and\x20`\"zo\
    ne\"`.\n\n\x0c\n\x05\x04\0\x02\x04\x04\x12\x03A\x02\n\n\x0c\n\x05\x04\0\
    \x02\x04\x06\x12\x03A\x0b\x1a\n\x0c\n\x05\x04\0\x02\x04\x01\x12\x03A\x1b\
    !\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03A$%\nO\n\x04\x04\0\x02\x05\x12\
    \x03D\x02\x1f\x1aB\x20Optional.\x20The\x20launch\x20stage\x20of\x20the\
    \x20monitored\x20resource\x20definition.\n\n\x0c\n\x05\x04\0\x02\x05\x06\
    \x12\x03D\x02\r\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03D\x0e\x1a\n\x0c\n\
    \x05\x04\0\x02\x05\x03\x12\x03D\x1d\x1e\n\xcb\x06\n\x02\x04\x01\x12\x04T\
    \0^\x01\x1a\xbe\x06\x20An\x20object\x20representing\x20a\x20resource\x20\
    that\x20can\x20be\x20used\x20for\x20monitoring,\x20logging,\n\x20billing\
    ,\x20or\x20other\x20purposes.\x20Examples\x20include\x20virtual\x20machi\
    ne\x20instances,\n\x20databases,\x20and\x20storage\x20devices\x20such\
    \x20as\x20disks.\x20The\x20`type`\x20field\x20identifies\x20a\n\x20[Moni\
    toredResourceDescriptor][google.api.MonitoredResourceDescriptor]\x20obje\
    ct\x20that\x20describes\x20the\x20resource's\n\x20schema.\x20Information\
    \x20in\x20the\x20`labels`\x20field\x20identifies\x20the\x20actual\x20res\
    ource\x20and\n\x20its\x20attributes\x20according\x20to\x20the\x20schema.\
    \x20For\x20example,\x20a\x20particular\x20Compute\n\x20Engine\x20VM\x20i\
    nstance\x20could\x20be\x20represented\x20by\x20the\x20following\x20objec\
    t,\x20because\x20the\n\x20[MonitoredResourceDescriptor][google.api.Monit\
    oredResourceDescriptor]\x20for\x20`\"gce_instance\"`\x20has\x20labels\n\
    \x20`\"instance_id\"`\x20and\x20`\"zone\"`:\n\n\x20\x20\x20\x20\x20{\x20\
    \"type\":\x20\"gce_instance\",\n\x20\x20\x20\x20\x20\x20\x20\"labels\":\
    \x20{\x20\"instance_id\":\x20\"12345678901234\",\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\"zone\":\x20\"u\
    s-central1-a\"\x20}}\n\n\n\n\x03\x04\x01\x01\x12\x03T\x08\x19\n\xfb\x01\
    \n\x04\x04\x01\x02\0\x12\x03X\x02\x12\x1a\xed\x01\x20Required.\x20The\
    \x20monitored\x20resource\x20type.\x20This\x20field\x20must\x20match\n\
    \x20the\x20`type`\x20field\x20of\x20a\x20[MonitoredResourceDescriptor][g\
    oogle.api.MonitoredResourceDescriptor]\x20object.\x20For\n\x20example,\
    \x20the\x20type\x20of\x20a\x20Compute\x20Engine\x20VM\x20instance\x20is\
    \x20`gce_instance`.\n\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03X\x02\x08\n\
    \x0c\n\x05\x04\x01\x02\0\x01\x12\x03X\t\r\n\x0c\n\x05\x04\x01\x02\0\x03\
    \x12\x03X\x10\x11\n\xd7\x01\n\x04\x04\x01\x02\x01\x12\x03]\x02!\x1a\xc9\
    \x01\x20Required.\x20Values\x20for\x20all\x20of\x20the\x20labels\x20list\
    ed\x20in\x20the\x20associated\x20monitored\n\x20resource\x20descriptor.\
    ...
    \x04\x01\x02\x01\x01\x12\x03]\x16\x1c\n\x0c\n\x05\x04\x01\x02\x01\x03\
    \x12\x03]\x1f\x20\n\xb9\x03\n\x02\x04\x02\x12\x04f\0u\x01\x1a\xac\x03\
    \x20Auxiliary\x20metadata\x20for\x20a\x20[MonitoredResource][google.api.\
    MonitoredResource]\x20object.\n\x20[MonitoredResource][google.api.Monito\
    redResource]\x20objects\x20contain\x20the\x20minimum\x20set\x20of\x20inf\
    ormation\x20to\n\x20uniquely\x20identify\x20a\x20monitored\x20resource\
    \x20instance.\x20There\x20is\x20some\x20other\x20useful\n\x20auxiliary\
    \x20metadata.\x20Monitoring\x20and\x20Logging\x20use\x20an\x20ingestion\
    \n\x20pipeline\x20to\x20extract\x20metadata\x20for\x20cloud\x20resources\
    \x20of\x20all\x20types,\x20and\x20store\n\x20the\x20metadata\x20in\x20th\
    is\x20message.\n\n\n\n\x03\x04\x02\x01\x12\x03f\x08!\n\xa1\x03\n\x04\x04\
    \x02\x02\0\x12\x03q\x02+\x1a\x93\x03\x20Output\x20only.\x20Values\x20for\
    \x20predefined\x20system\x20metadata\x20labels.\n\x20System\x20labels\
    \x20are\x20a\x20kind\x20of\x20metadata\x20extracted\x20by\x20Google,\x20\
    including\n\x20\"machine_image\",\x20\"vpc\",\x20\"subnet_id\",\n\x20\"s\
    ecurity_group\",\x20\"name\",\x20etc.\n\x20System\x20label\x20values\x20\
    can\x20be\x20only\x20strings,\x20Boolean\x20values,\x20or\x20a\x20list\
    \x20of\n\x20strings.\x20For\x20example:\n\n\x20\x20\x20\x20\x20{\x20\"na\
    me\":\x20\"my-test-instance\",\n\x20\x20\x20\x20\x20\x20\x20\"security_g\
    roup\":\x20[\"a\",\x20\"b\",\x20\"c\"],\n\x20\x20\x20\x20\x20\x20\x20\"s\
    pot_instance\":\x20false\x20}\n\n\x0c\n\x05\x04\x02\x02\0\x06\x12\x03q\
    \x02\x18\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03q\x19&\n\x0c\n\x05\x04\x02\
    \x02\0\x03\x12\x03q)*\nB\n\x04\x04\x02\x02\x01\x12\x03t\x02&\x1a5\x20Out\
    put\x20only.\x20A\x20map\x20of\x20user-defined\x20metadata\x20labels.\n\
    \n\x0c\n\x05\x04\x02\x02\x01\x06\x12\x03t\x02\x15\n\x0c\n\x05\x04\x02\
    \x02\x01\x01\x12\x03t\x16!\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03t$%b\
    \x06proto3\
";
