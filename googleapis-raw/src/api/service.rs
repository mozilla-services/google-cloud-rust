...
pub struct Service {
    ...
    pub publishing: ::protobuf::SingularPtrField<super::client::Publishing>,
...
impl Service {
    ...
    pub fn get_publishing(&self) -> &super::client::Publishing {
        self.publishing.as_ref().unwrap_or_else(|| <super::client::Publishing as ::protobuf::Message>::default_instance())
    }
    ...
    pub fn has_publishing(&self) -> bool {
        self.publishing.is_some()
    }

    // Param is passed by value, moved
    pub fn set_publishing(&mut self, v: super::client::Publishing) {
        self.publishing = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_publishing(&mut self) -> &mut super::client::Publishing {
        if self.publishing.is_none() {
            self.publishing.set_default();
        }
        self.publishing.as_mut().unwrap()
    }

    // Take field
    pub fn take_publishing(&mut self) -> super::client::Publishing {
        self.publishing.take().unwrap_or_else(|| super::client::Publishing::new())
    }
...
impl ::protobuf::Message for Service {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                45 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.publishing)?;
                },
                20 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.publishing.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::client::Publishing>>(
                "publishing",
