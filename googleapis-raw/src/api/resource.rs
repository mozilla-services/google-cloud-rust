...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nnotations\xf8\x01\x01\xa2\x02\x04GAPIJ\xe2T\n\x07\x12\x05\x0e\0\xaa\x02\
    ...
    \x12\x06\x99\x01\0\x83\x02\x01\x1a\x83\x20\x20A\x20simple\x20descriptor\
    \x20of\x20a\x20resource\x20type.\n\n\x20ResourceDescriptor\x20annotates\
    \x20a\x20resource\x20message\x20(either\x20by\x20means\x20of\x20a\n\x20p\
    rotobuf\x20annotation\x20or\x20use\x20in\x20the\x20service\x20config),\
    \x20and\x20associates\x20the\n\x20resource's\x20schema,\x20the\x20resour\
    ce\x20type,\x20and\x20the\x20pattern\x20of\x20the\x20resource\x20name.\n\
    \n\x20Example:\n\n\x20\x20\x20\x20\x20message\x20Topic\x20{\n\x20\x20\
    \x20\x20\x20\x20\x20//\x20Indicates\x20this\x20message\x20defines\x20a\
    \x20resource\x20schema.\n\x20\x20\x20\x20\x20\x20\x20//\x20Declares\x20t\
    he\x20resource\x20type\x20in\x20the\x20format\x20of\x20{service}/{kind}.\
    \n\x20\x20\x20\x20\x20\x20\x20//\x20For\x20Kubernetes\x20resources,\x20t\
    he\x20format\x20is\x20{api\x20group}/{kind}.\n\x20\x20\x20\x20\x20\x20\
    \x20option\x20(google.api.resource)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20type:\x20\"pubsub.googleapis.com/Topic\"\n\x20\x20\x20\x20\
    ...
    \x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20\x20\x20};\n\x20\x20\x20\
    \x20\x20}\n\n\x20The\x20ResourceDescriptor\x20Yaml\x20config\x20will\x20\
    ...
    oject\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20parent_name_extract\
    or:\x20\"projects/{project}\"\n\n\x20Sometimes,\x20resources\x20have\x20\
    multiple\x20patterns,\x20typically\x20because\x20they\x20can\n\x20live\
    \x20under\x20multiple\x20parents.\n\n\x20Example:\n\n\x20\x20\x20\x20\
    ...
    \x04\xc4\x01\x10\x11\n\xc5\x05\n\x04\x04\0\x02\x01\x12\x04\xd9\x01\x02\
    \x1e\x1a\xb6\x05\x20Optional.\x20The\x20relative\x20resource\x20name\x20\
    pattern\x20associated\x20with\x20this\x20resource\n\x20type.\x20The\x20D\
    NS\x20prefix\x20of\x20the\x20full\x20resource\x20name\x20shouldn't\x20be\
    \x20specified\x20here.\n\n\x20The\x20path\x20pattern\x20must\x20follow\
    \x20the\x20syntax,\x20which\x20aligns\x20with\x20HTTP\x20binding\n\x20sy\
    ntax:\n\n\x20\x20\x20\x20\x20Template\x20=\x20Segment\x20{\x20\"/\"\x20S\
    egment\x20}\x20;\n\x20\x20\x20\x20\x20Segment\x20=\x20LITERAL\x20|\x20Va\
    riable\x20;\n\x20\x20\x20\x20\x20Variable\x20=\x20\"{\"\x20LITERAL\x20\"\
    }\"\x20;\n\n\x20Examples:\n\n\x20\x20\x20\x20\x20-\x20\"projects/{projec\
    t}/topics/{topic}\"\n\x20\x20\x20\x20\x20-\x20\"projects/{project}/knowl\
    edgeBases/{knowledge_base}\"\n\n\x20The\x20components\x20in\x20braces\
    \x20correspond\x20to\x20the\x20IDs\x20for\x20each\x20resource\x20in\x20t\
    he\n\x20hierarchy.\x20It\x20is\x20expected\x20that,\x20if\x20multiple\
    \x20patterns\x20are\x20provided,\n\x20the\x20same\x20component\x20name\
    \x20(e.g.\x20\"project\")\x20refers\x20to\x20IDs\x20of\x20the\x20same\n\
    \x20type\x20of\x20resource.\n\n\r\n\x05\x04\0\x02\x01\x04\x12\x04\xd9\
    \x01\x02\n\n\r\n\x05\x04\0\x02\x01\x05\x12\x04\xd9\x01\x0b\x11\n\r\n\x05\
    \x04\0\x02\x01\x01\x12\x04\xd9\x01\x12\x19\n\r\n\x05\x04\0\x02\x01\x03\
    \x12\x04\xd9\x01\x1c\x1d\n\x87\x01\n\x04\x04\0\x02\x02\x12\x04\xdd\x01\
    ...
    \x02\x02\x05\x12\x04\xdd\x01\x02\x08\n\r\n\x05\x04\0\x02\x02\x01\x12\x04\
    \xdd\x01\t\x13\n\r\n\x05\x04\0\x02\x02\x03\x12\x04\xdd\x01\x16\x17\n\xcc\
    \x04\n\x04\x04\0\x02\x03\x12\x04\xee\x01\x02\x16\x1a\xbd\x04\x20Optional\
    ...
    TTERN\n\x20\x20\x20\x20\x20\x20\x20};\n\x20\x20\x20\x20\x20}\n\n\r\n\x05\
    \x04\0\x02\x03\x06\x12\x04\xee\x01\x02\t\n\r\n\x05\x04\0\x02\x03\x01\x12\
    \x04\xee\x01\n\x11\n\r\n\x05\x04\0\x02\x03\x03\x12\x04\xee\x01\x14\x15\n\
    \xe1\x03\n\x04\x04\0\x02\x04\x12\x04\xf8\x01\x02\x14\x1a\xd2\x03\x20The\
    \x20plural\x20name\x20used\x20in\x20the\x20resource\x20name\x20and\x20pe\
    rmission\x20names,\x20such\x20as\n\x20'projects'\x20for\x20the\x20resour\
    ce\x20name\x20of\x20'projects/{project}'\x20and\x20the\x20permission\n\
    \x20name\x20of\x20'cloudresourcemanager.googleapis.com/projects.get'.\
    \x20It\x20is\x20the\x20same\n\x20concept\x20of\x20the\x20`plural`\x20fie\
    ...
    Note:\x20The\x20plural\x20form\x20is\x20required\x20even\x20for\x20singl\
    eton\x20resources.\x20See\n\x20https://aip.dev/156\n\n\r\n\x05\x04\0\x02\
    \x04\x05\x12\x04\xf8\x01\x02\x08\n\r\n\x05\x04\0\x02\x04\x01\x12\x04\xf8\
    \x01\t\x0f\n\r\n\x05\x04\0\x02\x04\x03\x12\x04\xf8\x01\x12\x13\n\xf9\x01\
    \n\x04\x04\0\x02\x05\x12\x04\xfd\x01\x02\x16\x1a\xea\x01\x20The\x20same\
    \x20concept\x20of\x20the\x20`singular`\x20field\x20in\x20k8s\x20CRD\x20s\
    pec\n\x20https://kubernetes.io/docs/tasks/access-kubernetes-api/custom-r\
    esources/custom-resource-definitions/\n\x20Such\x20as\x20\"project\"\x20\
    for\x20the\x20`resourcemanager.googleapis.com/Project`\x20type.\n\n\r\n\
    \x05\x04\0\x02\x05\x05\x12\x04\xfd\x01\x02\x08\n\r\n\x05\x04\0\x02\x05\
    \x01\x12\x04\xfd\x01\t\x11\n\r\n\x05\x04\0\x02\x05\x03\x12\x04\xfd\x01\
    \x14\x15\n\xb4\x01\n\x04\x04\0\x02\x06\x12\x04\x82\x02\x02\x1c\x1a\xa5\
    \x01\x20Style\x20flag(s)\x20for\x20this\x20resource.\n\x20These\x20indic\
    ate\x20that\x20a\x20resource\x20is\x20expected\x20to\x20conform\x20to\
    \x20a\x20given\n\x20style.\x20See\x20the\x20specific\x20style\x20flags\
    ...
    \x06\x03\x12\x04\x82\x02\x19\x1b\ni\n\x02\x04\x01\x12\x06\x87\x02\0\xaa\
    \x02\x01\x1a[\x20Defines\x20a\x20proto\x20annotation\x20that\x20describe\
    s\x20a\x20string\x20field\x20that\x20refers\x20to\n\x20an\x20API\x20reso\
    urce.\n\n\x0b\n\x03\x04\x01\x01\x12\x04\x87\x02\x08\x19\n\x85\x04\n\x04\
    \x04\x01\x02\0\x12\x04\x9c\x02\x02\x12\x1a\xf6\x03\x20The\x20resource\
    \x20type\x20that\x20the\x20annotated\x20field\x20references.\n\n\x20Exam\
    ple:\n\n\x20\x20\x20\x20\x20message\x20Subscription\x20{\n\x20\x20\x20\
    \x20\x20\x20\x20string\x20topic\x20=\x202\x20[(google.api.resource_refer\
    ence)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20type:\x20\"pubsub.g\
    oogleapis.com/Topic\"\n\x20\x20\x20\x20\x20\x20\x20}];\n\x20\x20\x20\x20\
    \x20}\n\n\x20Occasionally,\x20a\x20field\x20may\x20reference\x20an\x20ar\
    bitrary\x20resource.\x20In\x20this\x20case,\n\x20APIs\x20use\x20the\x20s\
    pecial\x20value\x20*\x20in\x20their\x20resource\x20reference.\n\n\x20Exa\
    mple:\n\n\x20\x20\x20\x20\x20message\x20GetIamPolicyRequest\x20{\n\x20\
    \x20\x20\x20\x20\x20\x20string\x20resource\x20=\x202\x20[(google.api.res\
    ource_reference)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20type:\
    \x20\"*\"\n\x20\x20\x20\x20\x20\x20\x20}];\n\x20\x20\x20\x20\x20}\n\n\r\
    \n\x05\x04\x01\x02\0\x05\x12\x04\x9c\x02\x02\x08\n\r\n\x05\x04\x01\x02\0\
    \x01\x12\x04\x9c\x02\t\r\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\x9c\x02\x10\
    \x11\n\xf0\x02\n\x04\x04\x01\x02\x01\x12\x04\xa9\x02\x02\x18\x1a\xe1\x02\
    \x20The\x20resource\x20type\x20of\x20a\x20child\x20collection\x20that\
    \x20the\x20annotated\x20field\n\x20references.\x20This\x20is\x20useful\
    \x20for\x20annotating\x20the\x20`parent`\x20field\x20that\n\x20doesn't\
    \x20have\x20a\x20fixed\x20resource\x20type.\n\n\x20Example:\n\n\x20\x20\
    \x20\x20\x20message\x20ListLogEntriesRequest\x20{\n\x20\x20\x20\x20\x20\
    \x20\x20string\x20parent\x20=\x201\x20[(google.api.resource_reference)\
    \x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20child_type:\x20\"logging\
    .googleapis.com/LogEntry\"\n\x20\x20\x20\x20\x20\x20\x20};\n\x20\x20\x20\
    \x20\x20}\n\n\r\n\x05\x04\x01\x02\x01\x05\x12\x04\xa9\x02\x02\x08\n\r\n\
    \x05\x04\x01\x02\x01\x01\x12\x04\xa9\x02\t\x13\n\r\n\x05\x04\x01\x02\x01\
    \x03\x12\x04\xa9\x02\x16\x17b\x06proto3\
";
