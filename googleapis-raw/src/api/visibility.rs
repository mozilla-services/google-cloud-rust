...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    isibility\xf8\x01\x01\xa2\x02\x04GAPIJ\x92\x1a\n\x06\x12\x04\x0e\0n\x01\
    ...
    \x07%\n\x0b\n\x03\x07\x05\x04\x12\x046\x024'\n\n\n\x03\x07\x05\x06\x12\
    \x036\x02\x1b\n\n\n\x03\x07\x05\x01\x12\x036\x1c*\n\n\n\x03\x07\x05\x03\
    \x12\x036-5\n\xac\x06\n\x02\x04\0\x12\x04O\0T\x01\x1a\x9f\x06\x20`Visibi\
    lity`\x20defines\x20restrictions\x20for\x20the\x20visibility\x20of\x20se\
    rvice\n\x20elements.\x20\x20Restrictions\x20are\x20specified\x20using\
    \x20visibility\x20labels\n\x20(e.g.,\x20PREVIEW)\x20that\x20are\x20elsew\
    here\x20linked\x20to\x20users\x20and\x20projects.\n\n\x20Users\x20and\
    \x20projects\x20can\x20have\x20access\x20to\x20more\x20than\x20one\x20vi\
    sibility\x20label.\x20The\n\x20effective\x20visibility\x20for\x20multipl\
    e\x20labels\x20is\x20the\x20union\x20of\x20each\x20label's\n\x20elements\
    ,\x20plus\x20any\x20unrestricted\x20elements.\n\n\x20If\x20an\x20element\
    \x20and\x20its\x20parents\x20have\x20no\x20restrictions,\x20visibility\
    ...
    \x20\x20\x20\x20\x20-\x20selector:\x20google.calendar.Calendar.Delegate\
    \n\x20\x20\x20\x20\x20\x20\x20\x20\x20restriction:\x20INTERNAL\n\n\x20He\
    re,\x20all\x20methods\x20are\x20publicly\x20visible\x20except\x20for\x20\
    the\x20restricted\x20methods\n\x20EnhancedSearch\x20and\x20Delegate.\n\n\
    \n\n\x03\x04\0\x01\x12\x03O\x08\x12\n\x9b\x01\n\x04\x04\0\x02\0\x12\x03S\
    \x02$\x1a\x8d\x01\x20A\x20list\x20of\x20visibility\x20rules\x20that\x20a\
    pply\x20to\x20individual\x20API\x20elements.\n\n\x20**NOTE:**\x20All\x20\
    service\x20configuration\x20rules\x20follow\x20\"last\x20one\x20wins\"\
    \x20order.\n\n\x0c\n\x05\x04\0\x02\0\x04\x12\x03S\x02\n\n\x0c\n\x05\x04\
    \0\x02\0\x06\x12\x03S\x0b\x19\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03S\x1a\
    \x1f\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03S\"#\na\n\x02\x04\x01\x12\x04X\0\
    n\x01\x1aU\x20A\x20visibility\x20rule\x20provides\x20visibility\x20confi\
    guration\x20for\x20an\x20individual\x20API\n\x20element.\n\n\n\n\x03\x04\
    \x01\x01\x12\x03X\x08\x16\n\xab\x01\n\x04\x04\x01\x02\0\x12\x03\\\x02\
    \x16\x1a\x9d\x01\x20Selects\x20methods,\x20messages,\x20fields,\x20enums\
    ,\x20etc.\x20to\x20which\x20this\x20rule\x20applies.\n\n\x20Refer\x20to\
    \x20[selector][google.api.DocumentationRule.selector]\x20for\x20syntax\
    \x20details.\n\n\r\n\x05\x04\x01\x02\0\x04\x12\x04\\\x02X\x18\n\x0c\n\
    \x05\x04\x01\x02\0\x05\x12\x03\\\x02\x08\n\x0c\n\x05\x04\x01\x02\0\x01\
    \x12\x03\\\t\x11\n\x0c\n\x05\x04\x01\x02\0\x03\x12\x03\\\x14\x15\n\x8d\
    \x04\n\x04\x04\x01\x02\x01\x12\x03m\x02\x19\x1a\xff\x03\x20A\x20comma-se\
    ...
    h\x20INTERNAL.\n\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04m\x02\\\x16\n\x0c\
