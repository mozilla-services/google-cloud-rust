...
// @@protoc_insertion_point(message:google.api.Visibility)
...
pub struct Visibility {
    ...
    // @@protoc_insertion_point(field:google.api.Visibility.rules)
    pub rules: ::std::vec::Vec<VisibilityRule>,
    // special fields
    // @@protoc_insertion_point(special_field:google.api.Visibility.special_fields)
...
///  element.
// @@protoc_insertion_point(message:google.api.VisibilityRule)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct VisibilityRule {
    ...
    ///  details.
    // @@protoc_insertion_point(field:google.api.VisibilityRule.selector)
    pub selector: ::std::string::String,
    // @@protoc_insertion_point(field:google.api.VisibilityRule.restriction)
    pub restriction: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:google.api.VisibilityRule.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl VisibilityRule {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<VisibilityRule>(
            "VisibilityRule",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for VisibilityRule {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                18 => {
                    self.restriction = is.read_string()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn default_instance() -> &'static VisibilityRule {
        static instance: VisibilityRule = VisibilityRule {
            selector: ::std::string::String::new(),
            restriction: ::std::string::String::new(),
            special_fields: ::protobuf::SpecialFields::new(),
        };
        &instance
    }
...
impl ::protobuf::MessageFull for VisibilityRule {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("VisibilityRule").unwrap()).clone()
    }
}

impl ::std::fmt::Display for VisibilityRule {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
pub mod exts {
    ...
    pub const enum_visibility: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::EnumOptions, super::VisibilityRule> = ::protobuf::ext::ExtFieldOptional::new(72295727, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_MESSAGE);

    pub const value_visibility: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::EnumValueOptions, super::VisibilityRule> = ::protobuf::ext::ExtFieldOptional::new(72295727, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_MESSAGE);

    pub const field_visibility: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::FieldOptions, super::VisibilityRule> = ::protobuf::ext::ExtFieldOptional::new(72295727, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_MESSAGE);

    pub const message_visibility: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::MessageOptions, super::VisibilityRule> = ::protobuf::ext::ExtFieldOptional::new(72295727, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_MESSAGE);

    pub const method_visibility: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::MethodOptions, super::VisibilityRule> = ::protobuf::ext::ExtFieldOptional::new(72295727, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_MESSAGE);

    pub const api_visibility: ::protobuf::ext::ExtFieldOptional<::protobuf::descriptor::ServiceOptions, super::VisibilityRule> = ::protobuf::ext::ExtFieldOptional::new(72295727, ::protobuf::descriptor::field_descriptor_proto::Type::TYPE_MESSAGE);
}
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(VisibilityRule::generated_message_descriptor_data());
