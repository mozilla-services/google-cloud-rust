...
pub struct MethodSettings {
    ...
    pub auto_populated_fields: ::protobuf::RepeatedField<::std::string::String>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl MethodSettings {
    ...
    pub fn get_auto_populated_fields(&self) -> &[::std::string::String] {
        &self.auto_populated_fields
    }
    pub fn clear_auto_populated_fields(&mut self) {
        self.auto_populated_fields.clear();
    }

    // Param is passed by value, moved
    pub fn set_auto_populated_fields(&mut self, v: ::protobuf::RepeatedField<::std::string::String>) {
        self.auto_populated_fields = v;
    }

    // Mutable pointer to the field.
    pub fn mut_auto_populated_fields(&mut self) -> &mut ::protobuf::RepeatedField<::std::string::String> {
        &mut self.auto_populated_fields
    }

    // Take field
    pub fn take_auto_populated_fields(&mut self) -> ::protobuf::RepeatedField<::std::string::String> {
        ::std::mem::replace(&mut self.auto_populated_fields, ::protobuf::RepeatedField::new())
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_repeated_string_into(wire_type, is, &mut self.auto_populated_fields)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gle.api.CommonLanguageSettingsR\x06common\"\xc2\x03\n\x0eMethodSettings\
    \x12\x1a\n\x08selector\x18\x01\x20\x01(\tR\x08selector\x12I\n\x0clong_ru\
    nning\x18\x02\x20\x01(\x0b2&.google.api.MethodSettings.LongRunningR\x0bl\
    ongRunning\x122\n\x15auto_populated_fields\x18\x03\x20\x03(\tR\x13autoPo\
    pulatedFields\x1a\x94\x02\n\x0bLongRunning\x12G\n\x12initial_poll_delay\
    \x18\x01\x20\x01(\x0b2\x19.google.protobuf.DurationR\x10initialPollDelay\
    \x122\n\x15poll_delay_multiplier\x18\x02\x20\x01(\x02R\x13pollDelayMulti\
    plier\x12?\n\x0emax_poll_delay\x18\x03\x20\x01(\x0b2\x19.google.protobuf\
    .DurationR\x0cmaxPollDelay\x12G\n\x12total_poll_timeout\x18\x04\x20\x01(\
    \x0b2\x19.google.protobuf.DurationR\x10totalPollTimeout*\xa3\x01\n\x19Cl\
    ientLibraryOrganization\x12+\n'CLIENT_LIBRARY_ORGANIZATION_UNSPECIFIED\
    \x10\0\x12\t\n\x05CLOUD\x10\x01\x12\x07\n\x03ADS\x10\x02\x12\n\n\x06PHOT\
    OS\x10\x03\x12\x0f\n\x0bSTREET_VIEW\x10\x04\x12\x0c\n\x08SHOPPING\x10\
    \x05\x12\x07\n\x03GEO\x10\x06\x12\x11\n\rGENERATIVE_AI\x10\x07*g\n\x18Cl\
    ientLibraryDestination\x12*\n&CLIENT_LIBRARY_DESTINATION_UNSPECIFIED\x10\
    \0\x12\n\n\x06GITHUB\x10\n\x12\x13\n\x0fPACKAGE_MANAGER\x10\x14:J\n\x10m\
    ethod_signature\x18\x9b\x08\x20\x03(\t\x12\x1e.google.protobuf.MethodOpt\
    ionsR\x0fmethodSignature:C\n\x0cdefault_host\x18\x99\x08\x20\x01(\t\x12\
    \x1f.google.protobuf.ServiceOptionsR\x0bdefaultHost:C\n\x0coauth_scopes\
    \x18\x9a\x08\x20\x01(\t\x12\x1f.google.protobuf.ServiceOptionsR\x0boauth\
    ScopesBi\n\x0ecom.google.apiB\x0bClientProtoP\x01ZAgoogle.golang.org/gen\
    proto/googleapis/api/annotations;annotations\xa2\x02\x04GAPIJ\xf3m\n\x07\
    \x12\x05\x0e\0\x96\x03\x01\n\xbc\x04\n\x01\x0c\x12\x03\x0e\0\x122\xb1\
    ...
    \x12\x04\xac\x02\"#\nC\n\x02\x04\x0b\x12\x06\xb0\x02\0\xec\x02\x01\x1a5\
    ...
    \xeb\x02\x02,\x1a\x81\x03\x20List\x20of\x20top-level\x20fields\x20of\x20\
    the\x20request\x20message,\x20that\x20should\x20be\n\x20automatically\
    \x20populated\x20by\x20the\x20client\x20libraries\x20based\x20on\x20thei\
    r\n\x20(google.api.field_info).format.\x20Currently\x20supported\x20form\
    at:\x20UUID4.\n\n\x20Example\x20of\x20a\x20YAML\x20configuration:\n\n\
    \x20\x20publishing:\n\x20\x20\x20\x20method_settings:\n\x20\x20\x20\x20\
    \x20\x20-\x20selector:\x20google.example.v1.ExampleService.CreateExample\
    \n\x20\x20\x20\x20\x20\x20\x20\x20auto_populated_fields:\n\x20\x20\x20\
    \x20\x20\x20\x20\x20-\x20request_id\n\n\r\n\x05\x04\x0b\x02\x02\x04\x12\
    \x04\xeb\x02\x02\n\n\r\n\x05\x04\x0b\x02\x02\x05\x12\x04\xeb\x02\x0b\x11\
    \n\r\n\x05\x04\x0b\x02\x02\x01\x12\x04\xeb\x02\x12'\n\r\n\x05\x04\x0b\
    \x02\x02\x03\x12\x04\xeb\x02*+\n\x8f\x01\n\x02\x05\0\x12\x06\xf0\x02\0\
    \x88\x03\x01\x1a\x80\x01\x20The\x20organization\x20for\x20which\x20the\
    \x20client\x20libraries\x20are\x20being\x20published.\n\x20Affects\x20th\
    e\x20url\x20where\x20generated\x20docs\x20are\x20published,\x20etc.\n\n\
    \x0b\n\x03\x05\0\x01\x12\x04\xf0\x02\x05\x1e\n\x1b\n\x04\x05\0\x02\0\x12\
    \x04\xf2\x02\x02.\x1a\r\x20Not\x20useful.\n\n\r\n\x05\x05\0\x02\0\x01\
    \x12\x04\xf2\x02\x02)\n\r\n\x05\x05\0\x02\0\x02\x12\x04\xf2\x02,-\n*\n\
    \x04\x05\0\x02\x01\x12\x04\xf5\x02\x02\x0c\x1a\x1c\x20Google\x20Cloud\
    \x20Platform\x20Org.\n\n\r\n\x05\x05\0\x02\x01\x01\x12\x04\xf5\x02\x02\
    \x07\n\r\n\x05\x05\0\x02\x01\x02\x12\x04\xf5\x02\n\x0b\n&\n\x04\x05\0\
    \x02\x02\x12\x04\xf8\x02\x02\n\x1a\x18\x20Ads\x20(Advertising)\x20Org.\n\
    \n\r\n\x05\x05\0\x02\x02\x01\x12\x04\xf8\x02\x02\x05\n\r\n\x05\x05\0\x02\
    \x02\x02\x12\x04\xf8\x02\x08\t\n\x1b\n\x04\x05\0\x02\x03\x12\x04\xfb\x02\
    \x02\r\x1a\r\x20Photos\x20Org.\n\n\r\n\x05\x05\0\x02\x03\x01\x12\x04\xfb\
    \x02\x02\x08\n\r\n\x05\x05\0\x02\x03\x02\x12\x04\xfb\x02\x0b\x0c\n\x20\n\
    \x04\x05\0\x02\x04\x12\x04\xfe\x02\x02\x12\x1a\x12\x20Street\x20View\x20\
    Org.\n\n\r\n\x05\x05\0\x02\x04\x01\x12\x04\xfe\x02\x02\r\n\r\n\x05\x05\0\
    \x02\x04\x02\x12\x04\xfe\x02\x10\x11\n\x1d\n\x04\x05\0\x02\x05\x12\x04\
    \x81\x03\x02\x0f\x1a\x0f\x20Shopping\x20Org.\n\n\r\n\x05\x05\0\x02\x05\
    \x01\x12\x04\x81\x03\x02\n\n\r\n\x05\x05\0\x02\x05\x02\x12\x04\x81\x03\r\
    \x0e\n\x18\n\x04\x05\0\x02\x06\x12\x04\x84\x03\x02\n\x1a\n\x20Geo\x20Org\
    .\n\n\r\n\x05\x05\0\x02\x06\x01\x12\x04\x84\x03\x02\x05\n\r\n\x05\x05\0\
    \x02\x06\x02\x12\x04\x84\x03\x08\t\nF\n\x04\x05\0\x02\x07\x12\x04\x87\
    \x03\x02\x14\x1a8\x20Generative\x20AI\x20-\x20https://developers.generat\
    iveai.google\n\n\r\n\x05\x05\0\x02\x07\x01\x12\x04\x87\x03\x02\x0f\n\r\n\
    \x05\x05\0\x02\x07\x02\x12\x04\x87\x03\x12\x13\n>\n\x02\x05\x01\x12\x06\
    \x8b\x03\0\x96\x03\x01\x1a0\x20To\x20where\x20should\x20client\x20librar\
    ies\x20be\x20published?\n\n\x0b\n\x03\x05\x01\x01\x12\x04\x8b\x03\x05\
    \x1d\n^\n\x04\x05\x01\x02\0\x12\x04\x8e\x03\x02-\x1aP\x20Client\x20libra\
    ries\x20will\x20neither\x20be\x20generated\x20nor\x20published\x20to\x20\
    package\n\x20managers.\n\n\r\n\x05\x05\x01\x02\0\x01\x12\x04\x8e\x03\x02\
    (\n\r\n\x05\x05\x01\x02\0\x02\x12\x04\x8e\x03+,\n}\n\x04\x05\x01\x02\x01\
    \x12\x04\x92\x03\x02\x0e\x1ao\x20Generate\x20the\x20client\x20library\
    \x20in\x20a\x20repo\x20under\x20github.com/googleapis,\n\x20but\x20don't\
    \x20publish\x20it\x20to\x20package\x20managers.\n\n\r\n\x05\x05\x01\x02\
    \x01\x01\x12\x04\x92\x03\x02\x08\n\r\n\x05\x05\x01\x02\x01\x02\x12\x04\
    \x92\x03\x0b\r\nU\n\x04\x05\x01\x02\x02\x12\x04\x95\x03\x02\x17\x1aG\x20\
    Publish\x20the\x20library\x20to\x20package\x20managers\x20like\x20nuget.\
    org\x20and\x20npmjs.com.\n\n\r\n\x05\x05\x01\x02\x02\x01\x12\x04\x95\x03\
    \x02\x11\n\r\n\x05\x05\x01\x02\x02\x02\x12\x04\x95\x03\x14\x16b\x06proto\
    3\
";
