...
// @@protoc_insertion_point(enum:google.api.ErrorReason)
pub enum ErrorReason {
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.ERROR_REASON_UNSPECIFIED)
    ERROR_REASON_UNSPECIFIED = 0,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.SERVICE_DISABLED)
    SERVICE_DISABLED = 1,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.BILLING_DISABLED)
    BILLING_DISABLED = 2,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.API_KEY_INVALID)
    API_KEY_INVALID = 3,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.API_KEY_SERVICE_BLOCKED)
    API_KEY_SERVICE_BLOCKED = 4,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.API_KEY_HTTP_REFERRER_BLOCKED)
    API_KEY_HTTP_REFERRER_BLOCKED = 7,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.API_KEY_IP_ADDRESS_BLOCKED)
    API_KEY_IP_ADDRESS_BLOCKED = 8,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.API_KEY_ANDROID_APP_BLOCKED)
    API_KEY_ANDROID_APP_BLOCKED = 9,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.API_KEY_IOS_APP_BLOCKED)
    API_KEY_IOS_APP_BLOCKED = 13,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.RATE_LIMIT_EXCEEDED)
    RATE_LIMIT_EXCEEDED = 5,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.RESOURCE_QUOTA_EXCEEDED)
    RESOURCE_QUOTA_EXCEEDED = 6,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.LOCATION_TAX_POLICY_VIOLATED)
    LOCATION_TAX_POLICY_VIOLATED = 10,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.USER_PROJECT_DENIED)
    USER_PROJECT_DENIED = 11,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.CONSUMER_SUSPENDED)
    CONSUMER_SUSPENDED = 12,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.CONSUMER_INVALID)
    CONSUMER_INVALID = 14,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.SECURITY_POLICY_VIOLATED)
    SECURITY_POLICY_VIOLATED = 15,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.ACCESS_TOKEN_EXPIRED)
    ACCESS_TOKEN_EXPIRED = 16,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.ACCESS_TOKEN_SCOPE_INSUFFICIENT)
    ACCESS_TOKEN_SCOPE_INSUFFICIENT = 17,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.ACCOUNT_STATE_INVALID)
    ACCOUNT_STATE_INVALID = 18,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.ACCESS_TOKEN_TYPE_UNSUPPORTED)
    ACCESS_TOKEN_TYPE_UNSUPPORTED = 19,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.CREDENTIALS_MISSING)
    CREDENTIALS_MISSING = 20,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.RESOURCE_PROJECT_INVALID)
    RESOURCE_PROJECT_INVALID = 21,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.SESSION_COOKIE_INVALID)
    SESSION_COOKIE_INVALID = 23,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.USER_BLOCKED_BY_ADMIN)
    USER_BLOCKED_BY_ADMIN = 24,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.RESOURCE_USAGE_RESTRICTION_VIOLATED)
    RESOURCE_USAGE_RESTRICTION_VIOLATED = 25,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.SYSTEM_PARAMETER_UNSUPPORTED)
    SYSTEM_PARAMETER_UNSUPPORTED = 26,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.ORG_RESTRICTION_VIOLATION)
    ORG_RESTRICTION_VIOLATION = 27,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.ORG_RESTRICTION_HEADER_INVALID)
    ORG_RESTRICTION_HEADER_INVALID = 28,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.SERVICE_NOT_VISIBLE)
    SERVICE_NOT_VISIBLE = 29,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.GCP_SUSPENDED)
    GCP_SUSPENDED = 30,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.LOCATION_POLICY_VIOLATED)
    LOCATION_POLICY_VIOLATED = 31,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.MISSING_ORIGIN)
    MISSING_ORIGIN = 33,
    // @@protoc_insertion_point(enum_value:google.api.ErrorReason.OVERLOADED_CREDENTIALS)
    OVERLOADED_CREDENTIALS = 34,
}

impl ::protobuf::Enum for ErrorReason {
    const NAME: &'static str = "ErrorReason";
    ...
    fn from_i32(value: i32) -> ::std::option::Option<ErrorReason> {
        match value {
            ...
            31 => ::std::option::Option::Some(ErrorReason::LOCATION_POLICY_VIOLATED),
            33 => ::std::option::Option::Some(ErrorReason::MISSING_ORIGIN),
            34 => ::std::option::Option::Some(ErrorReason::OVERLOADED_CREDENTIALS),
            _ => ::std::option::Option::None
        }
    }

    fn from_str(str: &str) -> ::std::option::Option<ErrorReason> {
        match str {
            "ERROR_REASON_UNSPECIFIED" => ::std::option::Option::Some(ErrorReason::ERROR_REASON_UNSPECIFIED),
            "SERVICE_DISABLED" => ::std::option::Option::Some(ErrorReason::SERVICE_DISABLED),
            "BILLING_DISABLED" => ::std::option::Option::Some(ErrorReason::BILLING_DISABLED),
            "API_KEY_INVALID" => ::std::option::Option::Some(ErrorReason::API_KEY_INVALID),
            "API_KEY_SERVICE_BLOCKED" => ::std::option::Option::Some(ErrorReason::API_KEY_SERVICE_BLOCKED),
            "API_KEY_HTTP_REFERRER_BLOCKED" => ::std::option::Option::Some(ErrorReason::API_KEY_HTTP_REFERRER_BLOCKED),
            "API_KEY_IP_ADDRESS_BLOCKED" => ::std::option::Option::Some(ErrorReason::API_KEY_IP_ADDRESS_BLOCKED),
            "API_KEY_ANDROID_APP_BLOCKED" => ::std::option::Option::Some(ErrorReason::API_KEY_ANDROID_APP_BLOCKED),
            "API_KEY_IOS_APP_BLOCKED" => ::std::option::Option::Some(ErrorReason::API_KEY_IOS_APP_BLOCKED),
            "RATE_LIMIT_EXCEEDED" => ::std::option::Option::Some(ErrorReason::RATE_LIMIT_EXCEEDED),
            "RESOURCE_QUOTA_EXCEEDED" => ::std::option::Option::Some(ErrorReason::RESOURCE_QUOTA_EXCEEDED),
            "LOCATION_TAX_POLICY_VIOLATED" => ::std::option::Option::Some(ErrorReason::LOCATION_TAX_POLICY_VIOLATED),
            "USER_PROJECT_DENIED" => ::std::option::Option::Some(ErrorReason::USER_PROJECT_DENIED),
            "CONSUMER_SUSPENDED" => ::std::option::Option::Some(ErrorReason::CONSUMER_SUSPENDED),
            "CONSUMER_INVALID" => ::std::option::Option::Some(ErrorReason::CONSUMER_INVALID),
            "SECURITY_POLICY_VIOLATED" => ::std::option::Option::Some(ErrorReason::SECURITY_POLICY_VIOLATED),
            "ACCESS_TOKEN_EXPIRED" => ::std::option::Option::Some(ErrorReason::ACCESS_TOKEN_EXPIRED),
            "ACCESS_TOKEN_SCOPE_INSUFFICIENT" => ::std::option::Option::Some(ErrorReason::ACCESS_TOKEN_SCOPE_INSUFFICIENT),
            "ACCOUNT_STATE_INVALID" => ::std::option::Option::Some(ErrorReason::ACCOUNT_STATE_INVALID),
            "ACCESS_TOKEN_TYPE_UNSUPPORTED" => ::std::option::Option::Some(ErrorReason::ACCESS_TOKEN_TYPE_UNSUPPORTED),
            "CREDENTIALS_MISSING" => ::std::option::Option::Some(ErrorReason::CREDENTIALS_MISSING),
            "RESOURCE_PROJECT_INVALID" => ::std::option::Option::Some(ErrorReason::RESOURCE_PROJECT_INVALID),
            "SESSION_COOKIE_INVALID" => ::std::option::Option::Some(ErrorReason::SESSION_COOKIE_INVALID),
            "USER_BLOCKED_BY_ADMIN" => ::std::option::Option::Some(ErrorReason::USER_BLOCKED_BY_ADMIN),
            "RESOURCE_USAGE_RESTRICTION_VIOLATED" => ::std::option::Option::Some(ErrorReason::RESOURCE_USAGE_RESTRICTION_VIOLATED),
            "SYSTEM_PARAMETER_UNSUPPORTED" => ::std::option::Option::Some(ErrorReason::SYSTEM_PARAMETER_UNSUPPORTED),
            "ORG_RESTRICTION_VIOLATION" => ::std::option::Option::Some(ErrorReason::ORG_RESTRICTION_VIOLATION),
            "ORG_RESTRICTION_HEADER_INVALID" => ::std::option::Option::Some(ErrorReason::ORG_RESTRICTION_HEADER_INVALID),
            "SERVICE_NOT_VISIBLE" => ::std::option::Option::Some(ErrorReason::SERVICE_NOT_VISIBLE),
            "GCP_SUSPENDED" => ::std::option::Option::Some(ErrorReason::GCP_SUSPENDED),
            "LOCATION_POLICY_VIOLATED" => ::std::option::Option::Some(ErrorReason::LOCATION_POLICY_VIOLATED),
            "MISSING_ORIGIN" => ::std::option::Option::Some(ErrorReason::MISSING_ORIGIN),
            "OVERLOADED_CREDENTIALS" => ::std::option::Option::Some(ErrorReason::OVERLOADED_CREDENTIALS),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [ErrorReason] = &[
        ...
        ErrorReason::MISSING_ORIGIN,
        ErrorReason::OVERLOADED_CREDENTIALS,
    ];
}

impl ::protobuf::EnumFull for ErrorReason {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("ErrorReason").unwrap()).clone()
    }

    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ErrorReason::ERROR_REASON_UNSPECIFIED => 0,
            ErrorReason::SERVICE_DISABLED => 1,
            ErrorReason::BILLING_DISABLED => 2,
            ErrorReason::API_KEY_INVALID => 3,
            ErrorReason::API_KEY_SERVICE_BLOCKED => 4,
            ErrorReason::API_KEY_HTTP_REFERRER_BLOCKED => 5,
            ErrorReason::API_KEY_IP_ADDRESS_BLOCKED => 6,
            ErrorReason::API_KEY_ANDROID_APP_BLOCKED => 7,
            ErrorReason::API_KEY_IOS_APP_BLOCKED => 8,
            ErrorReason::RATE_LIMIT_EXCEEDED => 9,
            ErrorReason::RESOURCE_QUOTA_EXCEEDED => 10,
            ErrorReason::LOCATION_TAX_POLICY_VIOLATED => 11,
            ErrorReason::USER_PROJECT_DENIED => 12,
            ErrorReason::CONSUMER_SUSPENDED => 13,
            ErrorReason::CONSUMER_INVALID => 14,
            ErrorReason::SECURITY_POLICY_VIOLATED => 15,
            ErrorReason::ACCESS_TOKEN_EXPIRED => 16,
            ErrorReason::ACCESS_TOKEN_SCOPE_INSUFFICIENT => 17,
            ErrorReason::ACCOUNT_STATE_INVALID => 18,
            ErrorReason::ACCESS_TOKEN_TYPE_UNSUPPORTED => 19,
            ErrorReason::CREDENTIALS_MISSING => 20,
            ErrorReason::RESOURCE_PROJECT_INVALID => 21,
            ErrorReason::SESSION_COOKIE_INVALID => 22,
            ErrorReason::USER_BLOCKED_BY_ADMIN => 23,
            ErrorReason::RESOURCE_USAGE_RESTRICTION_VIOLATED => 24,
            ErrorReason::SYSTEM_PARAMETER_UNSUPPORTED => 25,
            ErrorReason::ORG_RESTRICTION_VIOLATION => 26,
            ErrorReason::ORG_RESTRICTION_HEADER_INVALID => 27,
            ErrorReason::SERVICE_NOT_VISIBLE => 28,
            ErrorReason::GCP_SUSPENDED => 29,
            ErrorReason::LOCATION_POLICY_VIOLATED => 30,
            ErrorReason::MISSING_ORIGIN => 31,
            ErrorReason::OVERLOADED_CREDENTIALS => 32,
        };
...
impl ErrorReason {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<ErrorReason>("ErrorReason")
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1d\x12\x11\n\rGCP_SUSPENDED\x10\x1e\x12\x1c\n\x18LOCATION_POLICY_VIOLA\
    TED\x10\x1f\x12\x12\n\x0eMISSING_ORIGIN\x10!\x12\x1a\n\x16OVERLOADED_CRE\
    DENTIALS\x10\"Bp\n\x0ecom.google.apiB\x10ErrorReasonProtoP\x01ZCgoogle.g\
    olang.org/genproto/googleapis/api/error_reason;error_reason\xa2\x02\x04G\
    ...
    \xbf\x05\n\x02\x05\0\x12\x05\"\0\xed\x04\x01\x1a\xb1\x05\x20Defines\x20t\
    ...
    \x04\xb8\x04\x12\x14\n\xef\x04\n\x04\x05\0\x02\x1e\x12\x04\xcb\x04\x02\
    \x20\x1a\xe0\x04\x20The\x20request\x20violates\x20the\x20location\x20pol\
    icies\x20when\x20creating\x20resources\x20in\n\x20the\x20restricted\x20r\
    egion.\n\n\x20Example\x20of\x20an\x20ErrorInfo\x20when\x20creating\x20th\
    e\x20Cloud\x20Storage\x20Bucket\x20by\n\x20\"projects/123\"\x20for\x20se\
    rvice\x20storage.googleapis.com:\n\n\x20\x20\x20\x20\x20{\x20\"reason\":\
    \x20\"LOCATION_POLICY_VIOLATED\",\n\x20\x20\x20\x20\x20\x20\x20\"domain\
    \":\x20\"googleapis.com\",\n\x20\x20\x20\x20\x20\x20\x20\"metadata\":\
    \x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\"consumer\":\x20\"projects/1\
    23\",\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\"service\":\x20\"storage.goo\
    gleapis.com\",\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\n\
    \x20This\x20response\x20indicates\x20creating\x20the\x20Cloud\x20Storage\
    \x20Bucket\x20in\n\x20\"locations/asia-northeast3\"\x20violates\x20at\
    \x20least\x20one\x20location\x20policy.\n\x20The\x20troubleshooting\x20g\
    uidance\x20is\x20provided\x20in\x20the\x20Help\x20links.\n\n\r\n\x05\x05\
    \0\x02\x1e\x01\x12\x04\xcb\x04\x02\x1a\n\r\n\x05\x05\0\x02\x1e\x02\x12\
    \x04\xcb\x04\x1d\x1f\n\xde\x02\n\x04\x05\0\x02\x1f\x12\x04\xdb\x04\x02\
    \x16\x1a\xcf\x02\x20The\x20request\x20is\x20denied\x20because\x20origin\
    \x20request\x20header\x20is\x20missing.\n\n\x20Example\x20of\x20an\x20Er\
    rorInfo\x20when\n\x20accessing\x20\"pubsub.googleapis.com\"\x20service\
    \x20with\x20an\x20empty\x20\"Origin\"\x20request\n\x20header.\n\n\x20{\n\
    \x20\x20\x20reason:\x20\"MISSING_ORIGIN\"\n\x20\x20\x20domain:\x20\"goog\
    leapis.com\"\n\x20\x20\x20metadata\x20{\n\x20\x20\x20\x20\x20\"consumer\
    \":\"projects/123456\"\n\x20\x20\x20\x20\x20\"service\":\x20\"pubsub.goo\
    gleapis.com\"\n\x20\x20\x20}\n\x20}\n\n\r\n\x05\x05\0\x02\x1f\x01\x12\
    \x04\xdb\x04\x02\x10\n\r\n\x05\x05\0\x02\x1f\x02\x12\x04\xdb\x04\x13\x15\
    \n\xec\x03\n\x04\x05\0\x02\x20\x12\x04\xec\x04\x02\x1e\x1a\xdd\x03\x20Th\
    e\x20request\x20is\x20denied\x20because\x20the\x20request\x20contains\
    \x20more\x20than\x20one\x20credential\n\x20type\x20that\x20are\x20indivi\
    dually\x20acceptable,\x20but\x20not\x20together.\x20The\x20customer\n\
    \x20should\x20retry\x20their\x20request\x20with\x20only\x20one\x20set\
    \x20of\x20credentials.\n\n\x20Example\x20of\x20an\x20ErrorInfo\x20when\n\
    \x20accessing\x20\"pubsub.googleapis.com\"\x20service\x20with\x20overloa\
    ded\x20credentials.\n\n\x20{\n\x20\x20\x20reason:\x20\"OVERLOADED_CREDEN\
    TIALS\"\n\x20\x20\x20domain:\x20\"googleapis.com\"\n\x20\x20\x20metadata\
    \x20{\n\x20\x20\x20\x20\x20\"consumer\":\"projects/123456\"\n\x20\x20\
    \x20\x20\x20\"service\":\x20\"pubsub.googleapis.com\"\n\x20\x20\x20}\n\
    \x20}\n\n\r\n\x05\x05\0\x02\x20\x01\x12\x04\xec\x04\x02\x18\n\r\n\x05\
    \x05\0\x02\x20\x02\x12\x04\xec\x04\x1b\x1db\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            enums.push(ErrorReason::generated_enum_descriptor_data());
