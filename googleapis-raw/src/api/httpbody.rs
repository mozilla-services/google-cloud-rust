...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    leapis/api/httpbody;httpbody\xf8\x01\x01\xa2\x02\x04GAPIJ\xa0\x13\n\x06\
    ...
    \"\n\x9d\n\n\x02\x04\0\x12\x04C\0M\x01\x1a\x90\n\x20Message\x20that\x20r\
    ...
    ource(google.api.HttpBody)\x20returns\x20(google.protobuf.Empty);\n\x20\
    \x20\x20\x20\x20}\n\n\x20Example\x20with\x20streaming\x20methods:\n\n\
    \x20\x20\x20\x20\x20service\x20CaldavService\x20{\n\x20\x20\x20\x20\x20\
    \x20\x20rpc\x20GetCalendar(stream\x20google.api.HttpBody)\n\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20returns\x20(stream\x20google.api.HttpBody);\n\
    \x20\x20\x20\x20\x20\x20\x20rpc\x20UpdateCalendar(stream\x20google.api.H\
    ttpBody)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20returns\x20(stream\x20goog\
    le.api.HttpBody);\n\x20\x20\x20\x20\x20}\n\n\x20Use\x20of\x20this\x20typ\
    e\x20only\x20changes\x20how\x20the\x20request\x20and\x20response\x20bodi\
    es\x20are\n\x20handled,\x20all\x20other\x20features\x20will\x20continue\
    \x20to\x20work\x20unchanged.\n\n\n\n\x03\x04\0\x01\x12\x03C\x08\x10\nV\n\
    \x04\x04\0\x02\0\x12\x03E\x02\x1a\x1aI\x20The\x20HTTP\x20Content-Type\
    \x20string\x20representing\x20the\x20content\x20type\x20of\x20the\x20bod\
    y.\n\n\r\n\x05\x04\0\x02\0\x04\x12\x04E\x02C\x12\n\x0c\n\x05\x04\0\x02\0\
    \x05\x12\x03E\x02\x08\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03E\t\x15\n\x0c\n\
    \x05\x04\0\x02\0\x03\x12\x03E\x18\x19\n%\n\x04\x04\0\x02\x01\x12\x03H\
    \x02\x11\x1a\x18\x20HTTP\x20body\x20binary\x20data.\n\n\r\n\x05\x04\0\
    \x02\x01\x04\x12\x04H\x02E\x1a\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03H\
    \x02\x07\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03H\x08\x0c\n\x0c\n\x05\x04\
    \0\x02\x01\x03\x12\x03H\x0f\x10\nm\n\x04\x04\0\x02\x02\x12\x03L\x02.\x1a\
    `\x20Application\x20specific\x20response\x20metadata.\x20Must\x20be\x20s\
    et\x20in\x20the\x20first\x20response\n\x20for\x20streaming\x20APIs.\n\n\
