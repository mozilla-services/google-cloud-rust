...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    leapis/api/httpbody;httpbody\xf8\x01\x01\xa2\x02\x04GAPIJ\xb0\x13\n\x06\
    ...
    \x20\x20\x20\x20\x20rpc\x20GetResource(GetResourceRequest)\n\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20returns\x20(google.api.HttpBody);\n\x20\x20\x20\
    \x20\x20\x20\x20rpc\x20UpdateResource(google.api.HttpBody)\n\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20returns\x20(google.protobuf.Empty);\n\n\x20\x20\
    \x20\x20\x20}\n\n\x20Example\x20with\x20streaming\x20methods:\n\n\x20\
    \x20\x20\x20\x20service\x20CaldavService\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20rpc\x20GetCalendar(stream\x20google.api.HttpBody)\n\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20returns\x20(stream\x20google.api.HttpBody);\n\x20\
    \x20\x20\x20\x20\x20\x20rpc\x20UpdateCalendar(stream\x20google.api.HttpB\
    ody)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20returns\x20(stream\x20google.a\
    pi.HttpBody);\n\n\x20\x20\x20\x20\x20}\n\n\x20Use\x20of\x20this\x20type\
    \x20only\x20changes\x20how\x20the\x20request\x20and\x20response\x20bodie\
    s\x20are\n\x20handled,\x20all\x20other\x20features\x20will\x20continue\
    \x20to\x20work\x20unchanged.\n\n\n\n\x03\x04\0\x01\x12\x03F\x08\x10\nZ\n\
    \x04\x04\0\x02\0\x12\x03H\x02\x1a\x1aM\x20The\x20HTTP\x20Content-Type\
    \x20header\x20value\x20specifying\x20the\x20content\x20type\x20of\x20the\
    \x20body.\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03H\x02\x08\n\x0c\n\x05\x04\
    \0\x02\0\x01\x12\x03H\t\x15\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03H\x18\x19\
    \n<\n\x04\x04\0\x02\x01\x12\x03K\x02\x11\x1a/\x20The\x20HTTP\x20request/\
    response\x20body\x20as\x20raw\x20binary.\n\n\x0c\n\x05\x04\0\x02\x01\x05\
    \x12\x03K\x02\x07\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03K\x08\x0c\n\x0c\n\
    \x05\x04\0\x02\x01\x03\x12\x03K\x0f\x10\nm\n\x04\x04\0\x02\x02\x12\x03O\
    \x02.\x1a`\x20Application\x20specific\x20response\x20metadata.\x20Must\
    \x20be\x20set\x20in\x20the\x20first\x20response\n\x20for\x20streaming\
    \x20APIs.\n\n\x0c\n\x05\x04\0\x02\x02\x04\x12\x03O\x02\n\n\x0c\n\x05\x04\
    \0\x02\x02\x06\x12\x03O\x0b\x1e\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03O\
