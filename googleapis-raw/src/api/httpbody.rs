...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20that\x20represents\x20an\x20arbitrary\x20HTTP\x20body.\x20It\x20shou\
    ld\x20only\x20be\x20used\x20for\n\x20payload\x20formats\x20that\x20can't\
    \x20be\x20represented\x20as\x20JSON,\x20such\x20as\x20raw\x20binary\x20o\
    r\n\x20an\x20HTML\x20page.\n\n\n\x20This\x20message\x20can\x20be\x20used\
    \x20both\x20in\x20streaming\x20and\x20non-streaming\x20API\x20methods\
    \x20in\n\x20the\x20request\x20as\x20well\x20as\x20the\x20response.\n\n\
    \x20It\x20can\x20be\x20used\x20as\x20a\x20top-level\x20request\x20field,\
    \x20which\x20is\x20convenient\x20if\x20one\n\x20wants\x20to\x20extract\
    \x20parameters\x20from\x20either\x20the\x20URL\x20or\x20HTTP\x20template\
    \x20into\x20the\n\x20request\x20fields\x20and\x20also\x20want\x20access\
    \x20to\x20the\x20raw\x20HTTP\x20body.\n\n\x20Example:\n\n\x20\x20\x20\
    \x20\x20message\x20GetResourceRequest\x20{\n\x20\x20\x20\x20\x20\x20\x20\
    //\x20A\x20unique\x20request\x20id.\n\x20\x20\x20\x20\x20\x20\x20string\
    \x20request_id\x20=\x201;\n\n\x20\x20\x20\x20\x20\x20\x20//\x20The\x20ra\
    w\x20HTTP\x20body\x20is\x20bound\x20to\x20this\x20field.\n\x20\x20\x20\
    \x20\x20\x20\x20google.api.HttpBody\x20http_body\x20=\x202;\n\x20\x20\
    \x20\x20\x20}\n\n\x20\x20\x20\x20\x20service\x20ResourceService\x20{\n\
    \x20\x20\x20\x20\x20\x20\x20rpc\x20GetResource(GetResourceRequest)\x20re\
    turns\x20(google.api.HttpBody);\n\x20\x20\x20\x20\x20\x20\x20rpc\x20Upda\
    teResource(google.api.HttpBody)\x20returns\n\x20\x20\x20\x20\x20\x20\x20\
    (google.protobuf.Empty);\n\x20\x20\x20\x20\x20}\n\n\x20Example\x20with\
    \x20streaming\x20methods:\n\n\x20\x20\x20\x20\x20service\x20CaldavServic\
    e\x20{\n\x20\x20\x20\x20\x20\x20\x20rpc\x20GetCalendar(stream\x20google.\
    api.HttpBody)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20returns\x20(stream\
    \x20google.api.HttpBody);\n\x20\x20\x20\x20\x20\x20\x20rpc\x20UpdateCale\
    ndar(stream\x20google.api.HttpBody)\n\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20returns\x20(stream\x20google.api.HttpBody);\n\x20\x20\x20\x20\x20}\n\
    \n\x20Use\x20of\x20this\x20type\x20only\x20changes\x20how\x20the\x20requ\
    est\x20and\x20response\x20bodies\x20are\n\x20handled,\x20all\x20other\
    \x20features\x20will\x20continue\x20to\x20work\x20unchanged.\n\n\n\n\x03\
    \x04\0\x01\x12\x03C\x08\x10\nZ\n\x04\x04\0\x02\0\x12\x03E\x02\x1a\x1aM\
    \x20The\x20HTTP\x20Content-Type\x20header\x20value\x20specifying\x20the\
    \x20content\x20type\x20of\x20the\x20body.\n\n\r\n\x05\x04\0\x02\0\x04\
    \x12\x04E\x02C\x12\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03E\x02\x08\n\x0c\n\
    \x05\x04\0\x02\0\x01\x12\x03E\t\x15\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03E\
    \x18\x19\n<\n\x04\x04\0\x02\x01\x12\x03H\x02\x11\x1a/\x20The\x20HTTP\x20\
    request/response\x20body\x20as\x20raw\x20binary.\n\n\r\n\x05\x04\0\x02\
    \x01\x04\x12\x04H\x02E\x1a\n\x0c\n\x05\x04\0\x02\x01\x05\x12\x03H\x02\
    \x07\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03H\x08\x0c\n\x0c\n\x05\x04\0\
    \x02\x01\x03\x12\x03H\x0f\x10\nm\n\x04\x04\0\x02\x02\x12\x03L\x02.\x1a`\
    \x20Application\x20specific\x20response\x20metadata.\x20Must\x20be\x20se\
    t\x20in\x20the\x20first\x20response\n\x20for\x20streaming\x20APIs.\n\n\
    \x0c\n\x05\x04\0\x02\x02\x04\x12\x03L\x02\n\n\x0c\n\x05\x04\0\x02\x02\
    \x06\x12\x03L\x0b\x1e\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03L\x1f)\n\x0c\
    \n\x05\x04\0\x02\x02\x03\x12\x03L,-b\x06proto3\
";
