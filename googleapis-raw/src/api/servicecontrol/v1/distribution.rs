...
pub struct Distribution {
    ...
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.Distribution.exemplars)
    pub exemplars: ::std::vec::Vec<super::api_distribution::distribution::Exemplar>,
