...
// @@protoc_insertion_point(message:google.api.servicecontrol.v1.HttpRequest)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct HttpRequest {
    // message fields
    ///  The request method. Examples: `"GET"`, `"HEAD"`, `"PUT"`, `"POST"`.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.request_method)
    pub request_method: ::std::string::String,
    ///  The scheme (http, https), the host name, the path, and the query
    ///  portion of the URL that was requested.
    ///  Example: `"http://example.com/some/info?color=red"`.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.request_url)
    pub request_url: ::std::string::String,
    ///  The size of the HTTP request message in bytes, including the request
    ///  headers and the request body.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.request_size)
    pub request_size: i64,
    ///  The response code indicating the status of the response.
    ///  Examples: 200, 404.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.status)
    pub status: i32,
    ///  The size of the HTTP response message sent back to the client, in bytes,
    ///  including the response headers and the response body.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.response_size)
    pub response_size: i64,
    ///  The user agent sent by the client. Example:
    ///  `"Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Q312461; .NET
    ///  CLR 1.0.3705)"`.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.user_agent)
    pub user_agent: ::std::string::String,
    ///  The IP address (IPv4 or IPv6) of the client that issued the HTTP
    ///  request. Examples: `"192.168.1.1"`, `"FE80::0202:B3FF:FE1E:8329"`.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.remote_ip)
    pub remote_ip: ::std::string::String,
    ///  The IP address (IPv4 or IPv6) of the origin server that the request was
    ///  sent to.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.server_ip)
    pub server_ip: ::std::string::String,
    ///  The referer URL of the request, as defined in
    ///  [HTTP/1.1 Header Field
    ///  Definitions](http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html).
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.referer)
    pub referer: ::std::string::String,
    ///  The request processing latency on the server, from the time the request was
    ///  received until the response was sent.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.latency)
    pub latency: ::protobuf::MessageField<::protobuf::well_known_types::duration::Duration>,
    ///  Whether or not a cache lookup was attempted.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.cache_lookup)
    pub cache_lookup: bool,
    ///  Whether or not an entity was served from cache
    ///  (with or without validation).
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.cache_hit)
    pub cache_hit: bool,
    ///  Whether or not the response was validated with the origin server before
    ///  being served from cache. This field is only meaningful if `cache_hit` is
    ///  True.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.cache_validated_with_origin_server)
    pub cache_validated_with_origin_server: bool,
    ///  The number of HTTP response bytes inserted into cache. Set only when a
    ///  cache fill was attempted.
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.cache_fill_bytes)
    pub cache_fill_bytes: i64,
    ///  Protocol used for the request. Examples: "HTTP/1.1", "HTTP/2", "websocket"
    // @@protoc_insertion_point(field:google.api.servicecontrol.v1.HttpRequest.protocol)
    pub protocol: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:google.api.servicecontrol.v1.HttpRequest.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    google.com/go/servicecontrol/apiv1/servicecontrolpb;servicecontrolpb\xaa\
