...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    eapis/api/servicecontrol/v1;servicecontrol\xf8\x01\x01\xaa\x02\x1eGoogle\
    .Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\
    \xea\x02!Google::Cloud::ServiceControl::V1J\xa3L\n\x07\x12\x05\x0e\0\xf4\
    ...
    \x02\0\x04\x12\x04C\x02>\x1e\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03C\x02\
    \x08\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03C\t\x15\n\x0c\n\x05\x04\0\x02\0\
    \x03\x12\x03C\x18\x19\n=\n\x04\x04\0\x02\x01\x12\x03F\x02(\x1a0\x20Opera\
    tion\x20that\x20describes\x20the\x20quota\x20allocation.\n\n\r\n\x05\x04\
    \0\x02\x01\x04\x12\x04F\x02C\x1a\n\x0c\n\x05\x04\0\x02\x01\x06\x12\x03F\
    \x02\x10\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03F\x11#\n\x0c\n\x05\x04\0\
    \x02\x01\x03\x12\x03F&'\n\xba\x01\n\x04\x04\0\x02\x02\x12\x03K\x02\x1f\
    \x1a\xac\x01\x20Specifies\x20which\x20version\x20of\x20service\x20config\
    uration\x20should\x20be\x20used\x20to\x20process\n\x20the\x20request.\
    \x20If\x20unspecified\x20or\x20no\x20matching\x20version\x20can\x20be\
    \x20found,\x20the\x20latest\n\x20one\x20will\x20be\x20used.\n\n\r\n\x05\
    \x04\0\x02\x02\x04\x12\x04K\x02F(\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03K\
    ...
    \x20in\x20nanos\x20+\x20UUID\n\n\x0e\n\x05\x04\x01\x02\0\x04\x12\x05\x84\
    \x01\x02y\x03\n\r\n\x05\x04\x01\x02\0\x05\x12\x04\x84\x01\x02\x08\n\r\n\
    \x05\x04\x01\x02\0\x01\x12\x04\x84\x01\t\x15\n\r\n\x05\x04\x01\x02\0\x03\
    \x12\x04\x84\x01\x18\x19\n\xfa\x03\n\x04\x04\x01\x02\x01\x12\x04\x91\x01\
    \x02\x19\x1a\xeb\x03\x20Fully\x20qualified\x20name\x20of\x20the\x20API\
    \x20method\x20for\x20which\x20this\x20quota\x20operation\x20is\n\x20requ\
    ested.\x20This\x20name\x20is\x20used\x20for\x20matching\x20quota\x20rule\
    s\x20or\x20metric\x20rules\x20and\n\x20billing\x20status\x20rules\x20def\
    ined\x20in\x20service\x20configuration.\n\n\x20This\x20field\x20should\
    \x20not\x20be\x20set\x20if\x20any\x20of\x20the\x20following\x20is\x20tru\
    e:\n\x20(1)\x20the\x20quota\x20operation\x20is\x20performed\x20on\x20non\
    -API\x20resources.\n\x20(2)\x20quota_metrics\x20is\x20set\x20because\x20\
    the\x20caller\x20is\x20doing\x20quota\x20override.\n\n\n\x20Example\x20o\
    f\x20an\x20RPC\x20method\x20name:\n\x20\x20\x20\x20\x20google.example.li\
    brary.v1.LibraryService.CreateShelf\n\n\x0f\n\x05\x04\x01\x02\x01\x04\
    \x12\x06\x91\x01\x02\x84\x01\x1a\n\r\n\x05\x04\x01\x02\x01\x05\x12\x04\
    \x91\x01\x02\x08\n\r\n\x05\x04\x01\x02\x01\x01\x12\x04\x91\x01\t\x14\n\r\
    \n\x05\x04\x01\x02\x01\x03\x12\x04\x91\x01\x17\x18\n\xdd\x01\n\x04\x04\
    \x01\x02\x02\x12\x04\x99\x01\x02\x19\x1a\xce\x01\x20Identity\x20of\x20th\
    e\x20consumer\x20for\x20whom\x20this\x20quota\x20operation\x20is\x20bein\
    g\x20performed.\n\n\x20This\x20can\x20be\x20in\x20one\x20of\x20the\x20fo\
    llowing\x20formats:\n\x20\x20\x20project:<project_id>,\n\x20\x20\x20proj\
    ect_number:<project_number>,\n\x20\x20\x20api_key:<api_key>.\n\n\x0f\n\
    \x05\x04\x01\x02\x02\x04\x12\x06\x99\x01\x02\x91\x01\x19\n\r\n\x05\x04\
    \x01\x02\x02\x05\x12\x04\x99\x01\x02\x08\n\r\n\x05\x04\x01\x02\x02\x01\
    \x12\x04\x99\x01\t\x14\n\r\n\x05\x04\x01\x02\x02\x03\x12\x04\x99\x01\x17\
    \x18\n0\n\x04\x04\x01\x02\x03\x12\x04\x9c\x01\x02!\x1a\"\x20Labels\x20de\
    scribing\x20the\x20operation.\n\n\x0f\n\x05\x04\x01\x02\x03\x04\x12\x06\
    \x9c\x01\x02\x99\x01\x19\n\r\n\x05\x04\x01\x02\x03\x06\x12\x04\x9c\x01\
    \x02\x15\n\r\n\x05\x04\x01\x02\x03\x01\x12\x04\x9c\x01\x16\x1c\n\r\n\x05\
    \x04\x01\x02\x03\x03\x12\x04\x9c\x01\x1f\x20\n\xd0\x04\n\x04\x04\x01\x02\
    \x04\x12\x04\xaa\x01\x02,\x1a\xc1\x04\x20Represents\x20information\x20ab\
    out\x20this\x20operation.\x20Each\x20MetricValueSet\n\x20corresponds\x20\
    to\x20a\x20metric\x20defined\x20in\x20the\x20service\x20configuration.\n\
    \x20The\x20data\x20type\x20used\x20in\x20the\x20MetricValueSet\x20must\
    \x20agree\x20with\n\x20the\x20data\x20type\x20specified\x20in\x20the\x20\
    metric\x20definition.\n\n\x20Within\x20a\x20single\x20operation,\x20it\
    \x20is\x20not\x20allowed\x20to\x20have\x20more\x20than\x20one\n\x20Metri\
    cValue\x20instances\x20that\x20have\x20the\x20same\x20metric\x20names\
    \x20and\x20identical\n\x20label\x20value\x20combinations.\x20If\x20a\x20\
    request\x20has\x20such\x20duplicated\x20MetricValue\n\x20instances,\x20t\
    he\x20entire\x20request\x20is\x20rejected\x20with\n\x20an\x20invalid\x20\
    argument\x20error.\n\n\x20This\x20field\x20is\x20mutually\x20exclusive\
    \x20with\x20method_name.\n\n\r\n\x05\x04\x01\x02\x04\x04\x12\x04\xaa\x01\
    \x02\n\n\r\n\x05\x04\x01\x02\x04\x06\x12\x04\xaa\x01\x0b\x19\n\r\n\x05\
    \x04\x01\x02\x04\x01\x12\x04\xaa\x01\x1a'\n\r\n\x05\x04\x01\x02\x04\x03\
    \x12\x04\xaa\x01*+\n.\n\x04\x04\x01\x02\x05\x12\x04\xad\x01\x02\x1b\x1a\
    \x20\x20Quota\x20mode\x20for\x20this\x20operation.\n\n\x0f\n\x05\x04\x01\
    \x02\x05\x04\x12\x06\xad\x01\x02\xaa\x01,\n\r\n\x05\x04\x01\x02\x05\x06\
    \x12\x04\xad\x01\x02\x0b\n\r\n\x05\x04\x01\x02\x05\x01\x12\x04\xad\x01\
    \x0c\x16\n\r\n\x05\x04\x01\x02\x05\x03\x12\x04\xad\x01\x19\x1a\n>\n\x02\
    \x04\x02\x12\x06\xb1\x01\0\xc7\x01\x01\x1a0\x20Response\x20message\x20fo\
    r\x20the\x20AllocateQuota\x20method.\n\n\x0b\n\x03\x04\x02\x01\x12\x04\
    \xb1\x01\x08\x1d\ny\n\x04\x04\x02\x02\0\x12\x04\xb4\x01\x02\x1a\x1ak\x20\
    The\x20same\x20operation_id\x20value\x20used\x20in\x20the\x20AllocateQuo\
    taRequest.\x20Used\x20for\n\x20logging\x20and\x20diagnostics\x20purposes\
    .\n\n\x0f\n\x05\x04\x02\x02\0\x04\x12\x06\xb4\x01\x02\xb1\x01\x1f\n\r\n\
    \x05\x04\x02\x02\0\x05\x12\x04\xb4\x01\x02\x08\n\r\n\x05\x04\x02\x02\0\
    \x01\x12\x04\xb4\x01\t\x15\n\r\n\x05\x04\x02\x02\0\x03\x12\x04\xb4\x01\
    \x18\x19\n7\n\x04\x04\x02\x02\x01\x12\x04\xb7\x01\x02*\x1a)\x20Indicates\
    \x20the\x20decision\x20of\x20the\x20allocate.\n\n\r\n\x05\x04\x02\x02\
    \x01\x04\x12\x04\xb7\x01\x02\n\n\r\n\x05\x04\x02\x02\x01\x06\x12\x04\xb7\
    \x01\x0b\x15\n\r\n\x05\x04\x02\x02\x01\x01\x12\x04\xb7\x01\x16%\n\r\n\
    \x05\x04\x02\x02\x01\x03\x12\x04\xb7\x01()\n\xd9\x03\n\x04\x04\x02\x02\
    \x02\x12\x04\xc3\x01\x02,\x1a\xca\x03\x20Quota\x20metrics\x20to\x20indic\
    ...
    \x12\x04\xc6\x01\x02\x1f\x1a6\x20ID\x20of\x20the\x20actual\x20config\x20\
    used\x20to\x20process\x20the\x20request.\n\n\x0f\n\x05\x04\x02\x02\x03\
    \x04\x12\x06\xc6\x01\x02\xc3\x01,\n\r\n\x05\x04\x02\x02\x03\x05\x12\x04\
    ...
    Error\x20code.\n\n\x0f\n\x05\x04\x03\x02\0\x04\x12\x06\xe7\x01\x02\xe4\
    \x01\x03\n\r\n\x05\x04\x03\x02\0\x06\x12\x04\xe7\x01\x02\x06\n\r\n\x05\
    \x04\x03\x02\0\x01\x12\x04\xe7\x01\x07\x0b\n\r\n\x05\x04\x03\x02\0\x03\
    \x12\x04\xe7\x01\x0e\x0f\n\xc7\x01\n\x04\x04\x03\x02\x01\x12\x04\xec\x01\
    \x02\x15\x1a\xb8\x01\x20Subject\x20to\x20whom\x20this\x20error\x20applie\
    s.\x20See\x20the\x20specific\x20enum\x20for\x20more\x20details\n\x20on\
    \x20this\x20field.\x20For\x20example,\x20\"clientip:<ip\x20address\x20of\
    \x20client>\"\x20or\n\x20\"project:<Google\x20developer\x20project\x20id\
    >\".\n\n\x0f\n\x05\x04\x03\x02\x01\x04\x12\x06\xec\x01\x02\xe7\x01\x10\n\
    \r\n\x05\x04\x03\x02\x01\x05\x12\x04\xec\x01\x02\x08\n\r\n\x05\x04\x03\
    \x02\x01\x01\x12\x04\xec\x01\t\x10\n\r\n\x05\x04\x03\x02\x01\x03\x12\x04\
    \xec\x01\x13\x14\nO\n\x04\x04\x03\x02\x02\x12\x04\xef\x01\x02\x19\x1aA\
    \x20Free-form\x20text\x20that\x20provides\x20details\x20on\x20the\x20cau\
    se\x20of\x20the\x20error.\n\n\x0f\n\x05\x04\x03\x02\x02\x04\x12\x06\xef\
    \x01\x02\xec\x01\x15\n\r\n\x05\x04\x03\x02\x02\x05\x12\x04\xef\x01\x02\
    \x08\n\r\n\x05\x04\x03\x02\x02\x01\x12\x04\xef\x01\t\x14\n\r\n\x05\x04\
    \x03\x02\x02\x03\x12\x04\xef\x01\x17\x18\nu\n\x04\x04\x03\x02\x03\x12\
    \x04\xf3\x01\x02\x1f\x1ag\x20Contains\x20additional\x20information\x20ab\
    out\x20the\x20quota\x20error.\n\x20If\x20available,\x20`status.code`\x20\
    will\x20be\x20non\x20zero.\n\n\x0f\n\x05\x04\x03\x02\x03\x04\x12\x06\xf3\
    \x01\x02\xef\x01\x19\n\r\n\x05\x04\x03\x02\x03\x06\x12\x04\xf3\x01\x02\
    \x13\n\r\n\x05\x04\x03\x02\x03\x01\x12\x04\xf3\x01\x14\x1a\n\r\n\x05\x04\
    \x03\x02\x03\x03\x12\x04\xf3\x01\x1d\x1eb\x06proto3\
";
