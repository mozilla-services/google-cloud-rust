...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x06\0\x12\x04\x1f\01\x01\x1a\x8e\x02\x20[Google\x20Quota\x20Control\x20\
    API](/service-control/overview)\n\n\x20Allows\x20clients\x20to\x20alloca\
    te\x20and\x20release\x20quota\x20against\x20a\x20[managed\n\x20service](\
    https://cloud.google.com/service-management/reference/rpc/google.api/ser\
    vicemanagement.v1#google.api.servicemanagement.v1.ManagedService).\n\n\n\
    \n\x03\x06\0\x01\x12\x03\x1f\x08\x17\n\xa2\x04\n\x04\x06\0\x02\0\x12\x04\
    +\x020\x03\x1a\x93\x04\x20Attempts\x20to\x20allocate\x20quota\x20for\x20\
    the\x20specified\x20consumer.\x20It\x20should\x20be\x20called\n\x20befor\
    e\x20the\x20operation\x20is\x20executed.\n\n\x20This\x20method\x20requir\
    es\x20the\x20`servicemanagement.services.quota`\n\x20permission\x20on\
    \x20the\x20specified\x20service.\x20For\x20more\x20information,\x20see\n\
    \x20[Cloud\x20IAM](https://cloud.google.com/iam).\n\n\x20**NOTE:**\x20Th\
    e\x20client\x20**must**\x20fail-open\x20on\x20server\x20errors\x20`INTER\
