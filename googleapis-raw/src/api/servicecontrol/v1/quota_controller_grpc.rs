...
pub trait QuotaController {
    fn allocate_quota(&mut self, ctx: ::grpcio::RpcContext, _req: super::quota_controller::AllocateQuotaRequest, sink: ::grpcio::UnarySink<super::quota_controller::AllocateQuotaResponse>) {
