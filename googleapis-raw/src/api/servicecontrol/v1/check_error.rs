    ...
    impl ::protobuf::Enum for Code {
        ...
        fn from_str(str: &str) -> ::std::option::Option<Code> {
            match str {
                ...
                "ABUSER_DETECTED" => ::std::option::Option::Some(Code::ABUSER_DETECTED),
                ...
                "SECURITY_POLICY_VIOLATED" => ::std::option::Option::Some(Code::SECURITY_POLICY_VIOLATED),
                "INVALID_CREDENTIAL" => ::std::option::Option::Some(Code::INVALID_CREDENTIAL),
                "LOCATION_POLICY_VIOLATED" => ::std::option::Option::Some(Code::LOCATION_POLICY_VIOLATED),
                ...
                "QUOTA_CHECK_UNAVAILABLE" => ::std::option::Option::Some(Code::QUOTA_CHECK_UNAVAILABLE),
                "CLOUD_RESOURCE_MANAGER_BACKEND_UNAVAILABLE" => ::std::option::Option::Some(Code::CLOUD_RESOURCE_MANAGER_BACKEND_UNAVAILABLE),
                "SECURITY_POLICY_BACKEND_UNAVAILABLE" => ::std::option::Option::Some(Code::SECURITY_POLICY_BACKEND_UNAVAILABLE),
                "LOCATION_POLICY_BACKEND_UNAVAILABLE" => ::std::option::Option::Some(Code::LOCATION_POLICY_BACKEND_UNAVAILABLE),
                _ => ::std::option::Option::None
            }
        }
