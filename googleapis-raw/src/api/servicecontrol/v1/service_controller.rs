...
impl CheckResponse_CheckInfo {
    ...
    pub fn get_api_key_uid(&self) -> &str {
        &self.api_key_uid
    }
    pub fn clear_api_key_uid(&mut self) {
        self.api_key_uid.clear();
    }

    // Param is passed by value, moved
    pub fn set_api_key_uid(&mut self, v: ::std::string::String) {
        self.api_key_uid = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_api_key_uid(&mut self) -> &mut ::std::string::String {
        &mut self.api_key_uid
    }

    // Take field
    pub fn take_api_key_uid(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.api_key_uid, ::std::string::String::new())
    }
}
...
impl ::protobuf::Message for CheckResponse_CheckInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.api_key_uid)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "api_key_uid",
                |m: &CheckResponse_CheckInfo| { &m.api_key_uid },
                |m: &mut CheckResponse_CheckInfo| { &mut m.api_key_uid },
            ));
