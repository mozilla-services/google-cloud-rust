...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x06\0\x12\x04\"\0M\x01\x1a\x8c\x02\x20[Google\x20Service\x20Control\x20\
    API](/service-control/overview)\n\n\x20Lets\x20clients\x20check\x20and\
    \x20report\x20operations\x20against\x20a\x20[managed\n\x20service](https\
    ://cloud.google.com/service-management/reference/rpc/google.api/servicem\
    anagement.v1#google.api.servicemanagement.v1.ManagedService).\n\n\n\n\
    \x03\x06\0\x01\x12\x03\"\x08\x19\n\xf1\x04\n\x04\x06\0\x02\0\x12\x041\
    \x026\x03\x1a\xe2\x04\x20Checks\x20an\x20operation\x20with\x20Google\x20\
    Service\x20Control\x20to\x20decide\x20whether\n\x20the\x20given\x20opera\
    tion\x20should\x20proceed.\x20It\x20should\x20be\x20called\x20before\x20\
    the\n\x20operation\x20is\x20executed.\n\n\x20If\x20feasible,\x20the\x20c\
    lient\x20should\x20cache\x20the\x20check\x20results\x20and\x20reuse\x20t\
    hem\x20for\n\x2060\x20seconds.\x20In\x20case\x20of\x20server\x20errors,\
    \x20the\x20client\x20can\x20rely\x20on\x20the\x20cached\n\x20results\x20\
    for\x20longer\x20time.\n\n\x20NOTE:\x20the\x20[CheckRequest][google.api.\
    servicecontrol.v1.CheckRequest]\x20has\x20the\n\x20size\x20limit\x20of\
    \x2064KB.\n\n\x20This\x20method\x20requires\x20the\x20`servicemanagement\
    .services.check`\x20permission\n\x20on\x20the\x20specified\x20service.\
    ...
    \x02\x01\x12\x04G\x02L\x03\x1a\xde\x05\x20Reports\x20operation\x20result\
    ...
    \x02\x01\x02\x12\x03G\r\x1a\n\x0c\n\x05\x06\0\x02\x01\x03\x12\x03G%3\n\r\
    \n\x05\x06\0\x02\x01\x04\x12\x04H\x04K\x06\n\x11\n\t\x06\0\x02\x01\x04\
    \xb0\xca\xbc\"\x12\x04H\x04K\x06\n3\n\x02\x04\0\x12\x04P\0b\x01\x1a'\x20\
    Request\x20message\x20for\x20the\x20Check\x20method.\n\n\n\n\x03\x04\0\
    \x01\x12\x03P\x08\x14\n\x90\x02\n\x04\x04\0\x02\0\x12\x03W\x02\x1a\x1a\
    \x82\x02\x20The\x20service\x20name\x20as\x20specified\x20in\x20its\x20se\
    rvice\x20configuration.\x20For\x20example,\n\x20`\"pubsub.googleapis.com\
    \"`.\n\n\x20See\n\x20[google.api.Service](https://cloud.google.com/servi\
    ce-management/reference/rpc/google.api#google.api.Service)\n\x20for\x20t\
    he\x20definition\x20of\x20a\x20service\x20name.\n\n\r\n\x05\x04\0\x02\0\
