...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1a\xc1\x05\x20`Endpoint`\x20describes\x20a\x20network\x20endpoint\x20t\
    hat\x20serves\x20a\x20set\x20of\x20APIs.\n\x20A\x20service\x20may\x20exp\
    ose\x20any\x20number\x20of\x20endpoints,\x20and\x20all\x20endpoints\x20s\
    hare\x20the\n\x20same\x20service\x20configuration,\x20such\x20as\x20quot\
    a\x20configuration\x20and\x20monitoring\n\x20configuration.\n\n\x20Examp\
    le\x20service\x20configuration:\n\n\x20\x20\x20\x20\x20name:\x20library-\
