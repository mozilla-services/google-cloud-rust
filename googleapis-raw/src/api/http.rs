...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    otations\xf8\x01\x01\xa2\x02\x04GAPIJ\xfer\n\x07\x12\x05\x0e\0\xf2\x02\
    ...
    \x05\x04\0\x02\x01\x03\x12\x03()*\n\x87S\n\x02\x04\x01\x12\x06\xb3\x02\0\
    \xe9\x02\x01\x1a\xf8R\x20gRPC\x20Transcoding\n\n\x20gRPC\x20Transcoding\
    \x20is\x20a\x20feature\x20for\x20mapping\x20between\x20a\x20gRPC\x20meth\
    od\x20and\x20one\x20or\n\x20more\x20HTTP\x20REST\x20endpoints.\x20It\x20\
    allows\x20developers\x20to\x20build\x20a\x20single\x20API\x20service\n\
    \x20that\x20supports\x20both\x20gRPC\x20APIs\x20and\x20REST\x20APIs.\x20\
    Many\x20systems,\x20including\x20[Google\n\x20APIs](https://github.com/g\
    oogleapis/googleapis),\n\x20[Cloud\x20Endpoints](https://cloud.google.co\
    m/endpoints),\x20[gRPC\n\x20Gateway](https://github.com/grpc-ecosystem/g\
    rpc-gateway),\n\x20and\x20[Envoy](https://github.com/envoyproxy/envoy)\
    \x20proxy\x20support\x20this\x20feature\n\x20and\x20use\x20it\x20for\x20\
    large\x20scale\x20production\x20services.\n\n\x20`HttpRule`\x20defines\
    \x20the\x20schema\x20of\x20the\x20gRPC/REST\x20mapping.\x20The\x20mappin\
    ...
    RPC:\x20`GetMessage(name:\x20\"messages/123456\")`\n\n\x20Any\x20fields\
    ...
    ET\x20/v1/messages/123456?revision=2&sub.subfield=foo`\n\x20-\x20gRPC:\
    \x20`GetMessage(message_id:\x20\"123456\"\x20revision:\x202\x20sub:\n\
    \x20SubMessage(subfield:\x20\"foo\"))`\n\n\x20Note\x20that\x20fields\x20\
    which\x20are\x20mapped\x20to\x20URL\x20query\x20parameters\x20must\x20ha\
    ve\x20a\n\x20primitive\x20type\x20or\x20a\x20repeated\x20primitive\x20ty\
    pe\x20or\x20a\x20non-repeated\x20message\x20type.\n\x20In\x20the\x20case\
    ...
    CH\x20/v1/messages/123456\x20{\x20\"text\":\x20\"Hi!\"\x20}`\n\x20-\x20g\
    RPC:\x20`UpdateMessage(message_id:\x20\"123456\"\x20message\x20{\x20text\
    :\x20\"Hi!\"\x20})`\n\n\x20The\x20special\x20name\x20`*`\x20can\x20be\
    \x20used\x20in\x20the\x20body\x20mapping\x20to\x20define\x20that\n\x20ev\
    ery\x20field\x20not\x20bound\x20by\x20the\x20path\x20template\x20should\
    \x20be\x20mapped\x20to\x20the\n\x20request\x20body.\x20\x20This\x20enabl\
    es\x20the\x20following\x20alternative\x20definition\x20of\n\x20the\x20up\
    date\x20method:\n\n\x20\x20\x20\x20\x20service\x20Messaging\x20{\n\x20\
    \x20\x20\x20\x20\x20\x20rpc\x20UpdateMessage(Message)\x20returns\x20(Mes\
    sage)\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20option\x20(google.api.ht\
    tp)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20patch:\x20\"/\
    v1/messages/{message_id}\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    body:\x20\"*\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20};\n\x20\x20\x20\x20\
    \x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20message\x20Mes\
    ...
    \x20is\x20enabled:\n\n\x20-\x20HTTP:\x20`PATCH\x20/v1/messages/123456\
    \x20{\x20\"text\":\x20\"Hi!\"\x20}`\n\x20-\x20gRPC:\x20`UpdateMessage(me\
    ssage_id:\x20\"123456\"\x20text:\x20\"Hi!\")`\n\n\x20Note\x20that\x20whe\
    n\x20using\x20`*`\x20in\x20the\x20body\x20mapping,\x20it\x20is\x20not\
    ...
    TP:\x20`GET\x20/v1/users/me/messages/123456`\n\x20-\x20gRPC:\x20`GetMess\
    age(user_id:\x20\"me\"\x20message_id:\x20\"123456\")`\n\n\x20Rules\x20fo\
    r\x20HTTP\x20mapping\n\n\x201.\x20Leaf\x20request\x20fields\x20(recursiv\
    e\x20expansion\x20nested\x20messages\x20in\x20the\x20request\n\x20\x20\
    ...
    \x20Template\x20=\x20\"/\"\x20Segments\x20[\x20Verb\x20]\x20;\n\x20\x20\
    \x20\x20\x20Segments\x20=\x20Segment\x20{\x20\"/\"\x20Segment\x20}\x20;\
    \n\x20\x20\x20\x20\x20Segment\x20\x20=\x20\"*\"\x20|\x20\"**\"\x20|\x20L\
    ITERAL\x20|\x20Variable\x20;\n\x20\x20\x20\x20\x20Variable\x20=\x20\"{\"\
    \x20FieldPath\x20[\x20\"=\"\x20Segments\x20]\x20\"}\"\x20;\n\x20\x20\x20\
    \x20\x20FieldPath\x20=\x20IDENT\x20{\x20\".\"\x20IDENT\x20}\x20;\n\x20\
    \x20\x20\x20\x20Verb\x20\x20\x20\x20\x20=\x20\":\"\x20LITERAL\x20;\n\n\
    \x20The\x20syntax\x20`*`\x20matches\x20a\x20single\x20URL\x20path\x20seg\
    ment.\x20The\x20syntax\x20`**`\x20matches\n\x20zero\x20or\x20more\x20URL\
    \x20path\x20segments,\x20which\x20must\x20be\x20the\x20last\x20part\x20o\
    f\x20the\x20URL\x20path\n\x20except\x20the\x20`Verb`.\n\n\x20The\x20synt\
    ax\x20`Variable`\x20matches\x20part\x20of\x20the\x20URL\x20path\x20as\
    \x20specified\x20by\x20its\n\x20template.\x20A\x20variable\x20template\
    \x20must\x20not\x20contain\x20other\x20variables.\x20If\x20a\x20variable\
    \n\x20matches\x20a\x20single\x20path\x20segment,\x20its\x20template\x20m\
    ay\x20be\x20omitted,\x20e.g.\x20`{var}`\n\x20is\x20equivalent\x20to\x20`\
    {var=*}`.\n\n\x20The\x20syntax\x20`LITERAL`\x20matches\x20literal\x20tex\
    t\x20in\x20the\x20URL\x20path.\x20If\x20the\x20`LITERAL`\n\x20contains\
    \x20any\x20reserved\x20character,\x20such\x20characters\x20should\x20be\
    \x20percent-encoded\n\x20before\x20the\x20matching.\n\n\x20If\x20a\x20va\
    riable\x20contains\x20exactly\x20one\x20path\x20segment,\x20such\x20as\
    \x20`\"{var}\"`\x20or\n\x20`\"{var=*}\"`,\x20when\x20such\x20a\x20variab\
    le\x20is\x20expanded\x20into\x20a\x20URL\x20path\x20on\x20the\x20client\
    \n\x20side,\x20all\x20characters\x20except\x20`[-_.~0-9a-zA-Z]`\x20are\
    \x20percent-encoded.\x20The\n\x20server\x20side\x20does\x20the\x20revers\
    e\x20decoding.\x20Such\x20variables\x20show\x20up\x20in\x20the\n\x20[Dis\
    covery\n\x20Document](https://developers.google.com/discovery/v1/referen\
    ce/apis)\x20as\n\x20`{var}`.\n\n\x20If\x20a\x20variable\x20contains\x20m\
    ultiple\x20path\x20segments,\x20such\x20as\x20`\"{var=foo/*}\"`\n\x20or\
    \x20`\"{var=**}\"`,\x20when\x20such\x20a\x20variable\x20is\x20expanded\
    \x20into\x20a\x20URL\x20path\x20on\x20the\n\x20client\x20side,\x20all\
    \x20characters\x20except\x20`[-_.~/0-9a-zA-Z]`\x20are\x20percent-encoded\
    .\n\x20The\x20server\x20side\x20does\x20the\x20reverse\x20decoding,\x20e\
    xcept\x20\"%2F\"\x20and\x20\"%2f\"\x20are\x20left\n\x20unchanged.\x20Suc\
    h\x20variables\x20show\x20up\x20in\x20the\n\x20[Discovery\n\x20Document]\
    (https://developers.google.com/discovery/v1/reference/apis)\x20as\n\x20`\
    {+var}`.\n\n\x20Using\x20gRPC\x20API\x20Service\x20Configuration\n\n\x20\
    gRPC\x20API\x20Service\x20Configuration\x20(service\x20config)\x20is\x20\
    a\x20configuration\x20language\n\x20for\x20configuring\x20a\x20gRPC\x20s\
    ervice\x20to\x20become\x20a\x20user-facing\x20product.\x20The\n\x20servi\
    ce\x20config\x20is\x20simply\x20the\x20YAML\x20representation\x20of\x20t\
    he\x20`google.api.Service`\n\x20proto\x20message.\n\n\x20As\x20an\x20alt\
    ernative\x20to\x20annotating\x20your\x20proto\x20file,\x20you\x20can\x20\
    configure\x20gRPC\n\x20transcoding\x20in\x20your\x20service\x20config\
    \x20YAML\x20files.\x20You\x20do\x20this\x20by\x20specifying\x20a\n\x20`H\
    ttpRule`\x20that\x20maps\x20the\x20gRPC\x20method\x20to\x20a\x20REST\x20\
    endpoint,\x20achieving\x20the\x20same\n\x20effect\x20as\x20the\x20proto\
    \x20annotation.\x20This\x20can\x20be\x20particularly\x20useful\x20if\x20\
    you\n\x20have\x20a\x20proto\x20that\x20is\x20reused\x20in\x20multiple\
    \x20services.\x20Note\x20that\x20any\x20transcoding\n\x20specified\x20in\
    \x20the\x20service\x20config\x20will\x20override\x20any\x20matching\x20t\
    ranscoding\n\x20configuration\x20in\x20the\x20proto.\n\n\x20The\x20follo\
    wing\x20example\x20selects\x20a\x20gRPC\x20method\x20and\x20applies\x20a\
    n\x20`HttpRule`\x20to\x20it:\n\n\x20\x20\x20\x20\x20http:\n\x20\x20\x20\
    \x20\x20\x20\x20rules:\n\x20\x20\x20\x20\x20\x20\x20\x20\x20-\x20selecto\
    r:\x20example.v1.Messaging.GetMessage\n\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20get:\x20/v1/messages/{message_id}/{sub.subfield}\n\n\x20Spec\
    ial\x20notes\n\n\x20When\x20gRPC\x20Transcoding\x20is\x20used\x20to\x20m\
    ap\x20a\x20gRPC\x20to\x20JSON\x20REST\x20endpoints,\x20the\n\x20proto\
    \x20to\x20JSON\x20conversion\x20must\x20follow\x20the\x20[proto3\n\x20sp\
    ecification](https://developers.google.com/protocol-buffers/docs/proto3#\
    json).\n\n\x20While\x20the\x20single\x20segment\x20variable\x20follows\
    \x20the\x20semantics\x20of\n\x20[RFC\x206570](https://tools.ietf.org/htm\
    l/rfc6570)\x20Section\x203.2.2\x20Simple\x20String\n\x20Expansion,\x20th\
    e\x20multi\x20segment\x20variable\x20**does\x20not**\x20follow\x20RFC\
    \x206570\x20Section\n\x203.2.3\x20Reserved\x20Expansion.\x20The\x20reaso\
    n\x20is\x20that\x20the\x20Reserved\x20Expansion\n\x20does\x20not\x20expa\
    nd\x20special\x20characters\x20like\x20`?`\x20and\x20`#`,\x20which\x20wo\
    uld\x20lead\n\x20to\x20invalid\x20URLs.\x20As\x20the\x20result,\x20gRPC\
    \x20Transcoding\x20uses\x20a\x20custom\x20encoding\n\x20for\x20multi\x20\
    segment\x20variables.\n\n\x20The\x20path\x20variables\x20**must\x20not**\
    \x20refer\x20to\x20any\x20repeated\x20or\x20mapped\x20field,\n\x20becaus\
    e\x20client\x20libraries\x20are\x20not\x20capable\x20of\x20handling\x20s\
    uch\x20variable\x20expansion.\n\n\x20The\x20path\x20variables\x20**must\
    \x20not**\x20capture\x20the\x20leading\x20\"/\"\x20character.\x20The\x20\
    reason\n\x20is\x20that\x20the\x20most\x20common\x20use\x20case\x20\"{var\
    }\"\x20does\x20not\x20capture\x20the\x20leading\x20\"/\"\n\x20character.\
    \x20For\x20consistency,\x20all\x20path\x20variables\x20must\x20share\x20\
    the\x20same\x20behavior.\n\n\x20Repeated\x20message\x20fields\x20must\
    \x20not\x20be\x20mapped\x20to\x20URL\x20query\x20parameters,\x20because\
    \n\x20no\x20client\x20library\x20can\x20support\x20such\x20complicated\
    \x20mapping.\n\n\x20If\x20an\x20API\x20needs\x20to\x20use\x20a\x20JSON\
    \x20array\x20for\x20request\x20or\x20response\x20body,\x20it\x20can\x20m\
    ap\n\x20the\x20request\x20or\x20response\x20body\x20to\x20a\x20repeated\
    \x20field.\x20However,\x20some\x20gRPC\n\x20Transcoding\x20implementatio\
    ns\x20may\x20not\x20support\x20this\x20feature.\n\n\x0b\n\x03\x04\x01\
    \x01\x12\x04\xb3\x02\x08\x10\n\x8f\x01\n\x04\x04\x01\x02\0\x12\x04\xb8\
    \x02\x02\x16\x1a\x80\x01\x20Selects\x20a\x20method\x20to\x20which\x20thi\
    s\x20rule\x20applies.\n\n\x20Refer\x20to\x20[selector][google.api.Docume\
    ntationRule.selector]\x20for\x20syntax\n\x20details.\n\n\r\n\x05\x04\x01\
    \x02\0\x05\x12\x04\xb8\x02\x02\x08\n\r\n\x05\x04\x01\x02\0\x01\x12\x04\
    \xb8\x02\t\x11\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\xb8\x02\x14\x15\n\xd0\
    \x01\n\x04\x04\x01\x08\0\x12\x06\xbd\x02\x02\xd3\x02\x03\x1a\xbf\x01\x20\
    ...
    \x12\x04\xc0\x02\x04\x13\x1aN\x20Maps\x20to\x20HTTP\x20GET.\x20Used\x20f\
    or\x20listing\x20and\x20getting\x20information\x20about\n\x20resources.\
    \n\n\r\n\x05\x04\x01\x02\x01\x05\x12\x04\xc0\x02\x04\n\n\r\n\x05\x04\x01\
    \x02\x01\x01\x12\x04\xc0\x02\x0b\x0e\n\r\n\x05\x04\x01\x02\x01\x03\x12\
    \x04\xc0\x02\x11\x12\n@\n\x04\x04\x01\x02\x02\x12\x04\xc3\x02\x04\x13\
    ...
    \x02\x03\x12\x04\xc3\x02\x11\x12\nX\n\x04\x04\x01\x02\x03\x12\x04\xc6\
    ...
