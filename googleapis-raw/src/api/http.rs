...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    otations\xf8\x01\x01\xa2\x02\x04GAPIJ\xa8s\n\x07\x12\x05\x0e\0\xf6\x02\
    \x01\n\xbc\x04\n\x01\x0c\x12\x03\x0e\0\x122\xb1\x04\x20Copyright\x202015\
    ...
    \x05\x04\0\x02\x01\x03\x12\x03()*\n\xb3S\n\x02\x04\x01\x12\x06\xb8\x02\0\
    \xed\x02\x01\x1a\xa4S\x20#\x20gRPC\x20Transcoding\n\n\x20gRPC\x20Transco\
    ...
    ttpRule.body].\x20They\x20are\x20passed\x20via\x20the\x20HTTP\n\x20\x20\
    \x20\x20\x20\x20request\x20body.\n\x20\x20\x20\x20-\x20All\x20other\x20f\
    ields\x20are\x20passed\x20via\x20the\x20URL\x20query\x20parameters,\x20a\
    nd\x20the\n\x20\x20\x20\x20\x20\x20parameter\x20name\x20is\x20the\x20fie\
    ld\x20path\x20in\x20the\x20request\x20message.\x20A\x20repeated\n\x20\
    \x20\x20\x20\x20\x20field\x20can\x20be\x20represented\x20as\x20multiple\
    \x20query\x20parameters\x20under\x20the\x20same\n\x20\x20\x20\x20\x20\
    \x20name.\n\x20\x202.\x20If\x20[HttpRule.body][google.api.HttpRule.body]\
    \x20is\x20\"*\",\x20there\x20is\x20no\x20URL\x20query\x20parameter,\x20a\
    ll\x20fields\n\x20\x20\x20\x20\x20are\x20passed\x20via\x20URL\x20path\
    \x20and\x20HTTP\x20request\x20body.\n\x20\x203.\x20If\x20[HttpRule.body]\
    [google.api.HttpRule.body]\x20is\x20omitted,\x20there\x20is\x20no\x20HTT\
    P\x20request\x20body,\x20all\n\x20\x20\x20\x20\x20fields\x20are\x20passe\
    d\x20via\x20URL\x20path\x20and\x20URL\x20query\x20parameters.\n\n\x20###\
    \x20Path\x20template\x20syntax\n\n\x20\x20\x20\x20\x20Template\x20=\x20\
    \"/\"\x20Segments\x20[\x20Verb\x20]\x20;\n\x20\x20\x20\x20\x20Segments\
    \x20=\x20Segment\x20{\x20\"/\"\x20Segment\x20}\x20;\n\x20\x20\x20\x20\
    \x20Segment\x20\x20=\x20\"*\"\x20|\x20\"**\"\x20|\x20LITERAL\x20|\x20Var\
    iable\x20;\n\x20\x20\x20\x20\x20Variable\x20=\x20\"{\"\x20FieldPath\x20[\
    \x20\"=\"\x20Segments\x20]\x20\"}\"\x20;\n\x20\x20\x20\x20\x20FieldPath\
    \x20=\x20IDENT\x20{\x20\".\"\x20IDENT\x20}\x20;\n\x20\x20\x20\x20\x20Ver\
    b\x20\x20\x20\x20\x20=\x20\":\"\x20LITERAL\x20;\n\n\x20The\x20syntax\x20\
    `*`\x20matches\x20a\x20single\x20URL\x20path\x20segment.\x20The\x20synta\
    ...
    \x01\x01\x12\x04\xb8\x02\x08\x10\n\x8d\x01\n\x04\x04\x01\x02\0\x12\x04\
    \xbc\x02\x02\x16\x1a\x7f\x20Selects\x20a\x20method\x20to\x20which\x20thi\
    ...
    \x01\n\x04\x04\x01\x08\0\x12\x06\xc1\x02\x02\xd7\x02\x03\x1a\xbf\x01\x20\
    ...
    \x12\x04\xc4\x02\x04\x13\x1aN\x20Maps\x20to\x20HTTP\x20GET.\x20Used\x20f\
    or\x20listing\x20and\x20getting\x20information\x20about\n\x20resources.\
    \n\n\r\n\x05\x04\x01\x02\x01\x05\x12\x04\xc4\x02\x04\n\n\r\n\x05\x04\x01\
