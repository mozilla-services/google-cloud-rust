...
impl MessageStoragePolicy {
    ...
    pub fn get_enforce_in_transit(&self) -> bool {
        self.enforce_in_transit
    }
    pub fn clear_enforce_in_transit(&mut self) {
        self.enforce_in_transit = false;
    }

    // Param is passed by value, moved
    pub fn set_enforce_in_transit(&mut self, v: bool) {
        self.enforce_in_transit = v;
    }
}
...
pub struct IngestionDataSourceSettings {
    ...
    pub source: ::std::option::Option<IngestionDataSourceSettings_oneof_source>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
pub enum IngestionDataSourceSettings_oneof_source {
    aws_kinesis(IngestionDataSourceSettings_AwsKinesis),
}
...
impl IngestionDataSourceSettings {
    ...
    pub fn get_aws_kinesis(&self) -> &IngestionDataSourceSettings_AwsKinesis {
        match self.source {
            ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(ref v)) => v,
            _ => <IngestionDataSourceSettings_AwsKinesis as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    pub fn has_aws_kinesis(&self) -> bool {
        match self.source {
            ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_aws_kinesis(&mut self, v: IngestionDataSourceSettings_AwsKinesis) {
        self.source = ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(v))
    }

    // Mutable pointer to the field.
    pub fn mut_aws_kinesis(&mut self) -> &mut IngestionDataSourceSettings_AwsKinesis {
        if let ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(_)) = self.source {
        } else {
            self.source = ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(IngestionDataSourceSettings_AwsKinesis::new()));
        }
        match self.source {
            ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_aws_kinesis(&mut self) -> IngestionDataSourceSettings_AwsKinesis {
        if self.has_aws_kinesis() {
            match self.source.take() {
                ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(v)) => v,
                _ => panic!(),
            }
        } else {
            IngestionDataSourceSettings_AwsKinesis::new()
        }
    }
}
...
impl ::protobuf::Message for IngestionDataSourceSettings {
    fn is_initialized(&self) -> bool {
        if let Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(ref v)) = self.source {
            if !v.is_initialized() {
                return false;
            }
        }
        ...
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ...
                    self.source = ::std::option::Option::Some(IngestionDataSourceSettings_oneof_source::aws_kinesis(is.read_message()?));
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let ::std::option::Option::Some(ref v) = self.source {
            match v {
                &IngestionDataSourceSettings_oneof_source::aws_kinesis(ref v) => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_singular_message_accessor::<_, IngestionDataSourceSettings_AwsKinesis>(
                "aws_kinesis",
                IngestionDataSourceSettings::has_aws_kinesis,
                IngestionDataSourceSettings::get_aws_kinesis,
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<IngestionDataSourceSettings>(
    ...
    fn default_instance() -> &'static IngestionDataSourceSettings {
        static instance: ::protobuf::rt::LazyV2<IngestionDataSourceSettings> = ::protobuf::rt::LazyV2::INIT;
        instance.get(IngestionDataSourceSettings::new)
    }
}

impl ::protobuf::Clear for IngestionDataSourceSettings {
    fn clear(&mut self) {
        self.source = ::std::option::Option::None;
        self.unknown_fields.clear();
    }
...
#[derive(PartialEq,Clone,Default)]
pub struct IngestionDataSourceSettings_AwsKinesis {
    // message fields
    pub state: IngestionDataSourceSettings_AwsKinesis_State,
...
impl<'a> ::std::default::Default for &'a IngestionDataSourceSettings_AwsKinesis {
    fn default() -> &'a IngestionDataSourceSettings_AwsKinesis {
        <IngestionDataSourceSettings_AwsKinesis as ::protobuf::Message>::default_instance()
    }
}

impl IngestionDataSourceSettings_AwsKinesis {
    pub fn new() -> IngestionDataSourceSettings_AwsKinesis {
        ::std::default::Default::default()
    }

    // .google.pubsub.v1.IngestionDataSourceSettings.AwsKinesis.State state = 1;


    pub fn get_state(&self) -> IngestionDataSourceSettings_AwsKinesis_State {
        self.state
    }
    pub fn clear_state(&mut self) {
        self.state = IngestionDataSourceSettings_AwsKinesis_State::STATE_UNSPECIFIED;
    }

    // Param is passed by value, moved
    pub fn set_state(&mut self, v: IngestionDataSourceSettings_AwsKinesis_State) {
        self.state = v;
    }
    ...
    pub fn get_stream_arn(&self) -> &str {
        &self.stream_arn
    }
    pub fn clear_stream_arn(&mut self) {
        self.stream_arn.clear();
    }

    // Param is passed by value, moved
    pub fn set_stream_arn(&mut self, v: ::std::string::String) {
        self.stream_arn = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_stream_arn(&mut self) -> &mut ::std::string::String {
        &mut self.stream_arn
    }

    // Take field
    pub fn take_stream_arn(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.stream_arn, ::std::string::String::new())
    }

    // string consumer_arn = 3;


    pub fn get_consumer_arn(&self) -> &str {
        &self.consumer_arn
    }
    pub fn clear_consumer_arn(&mut self) {
        self.consumer_arn.clear();
    }

    // Param is passed by value, moved
    pub fn set_consumer_arn(&mut self, v: ::std::string::String) {
        self.consumer_arn = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_consumer_arn(&mut self) -> &mut ::std::string::String {
        &mut self.consumer_arn
    }

    // Take field
    pub fn take_consumer_arn(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.consumer_arn, ::std::string::String::new())
    }
    ...
    pub fn clear_aws_role_arn(&mut self) {
        self.aws_role_arn.clear();
    }

    // Param is passed by value, moved
    pub fn set_aws_role_arn(&mut self, v: ::std::string::String) {
        self.aws_role_arn = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_aws_role_arn(&mut self) -> &mut ::std::string::String {
        &mut self.aws_role_arn
    }

    // Take field
    pub fn take_aws_role_arn(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.aws_role_arn, ::std::string::String::new())
    }

    // string gcp_service_account = 5;


    pub fn get_gcp_service_account(&self) -> &str {
        &self.gcp_service_account
    }
    pub fn clear_gcp_service_account(&mut self) {
        self.gcp_service_account.clear();
    }

    // Param is passed by value, moved
    pub fn set_gcp_service_account(&mut self, v: ::std::string::String) {
        self.gcp_service_account = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_gcp_service_account(&mut self) -> &mut ::std::string::String {
        &mut self.gcp_service_account
    }

    // Take field
    pub fn take_gcp_service_account(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.gcp_service_account, ::std::string::String::new())
    }
}

impl ::protobuf::Message for IngestionDataSourceSettings_AwsKinesis {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.stream_arn)?;
                },
                3 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.consumer_arn)?;
                },
                4 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.aws_role_arn)?;
                },
                5 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.gcp_service_account)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        if self.state != IngestionDataSourceSettings_AwsKinesis_State::STATE_UNSPECIFIED {
    ...
    fn new() -> IngestionDataSourceSettings_AwsKinesis {
        IngestionDataSourceSettings_AwsKinesis::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<IngestionDataSourceSettings_AwsKinesis_State>>(
                "state",
                |m: &IngestionDataSourceSettings_AwsKinesis| { &m.state },
                |m: &mut IngestionDataSourceSettings_AwsKinesis| { &mut m.state },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "stream_arn",
                |m: &IngestionDataSourceSettings_AwsKinesis| { &m.stream_arn },
                |m: &mut IngestionDataSourceSettings_AwsKinesis| { &mut m.stream_arn },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "consumer_arn",
                |m: &IngestionDataSourceSettings_AwsKinesis| { &m.consumer_arn },
                |m: &mut IngestionDataSourceSettings_AwsKinesis| { &mut m.consumer_arn },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "aws_role_arn",
                |m: &IngestionDataSourceSettings_AwsKinesis| { &m.aws_role_arn },
                |m: &mut IngestionDataSourceSettings_AwsKinesis| { &mut m.aws_role_arn },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "gcp_service_account",
                |m: &IngestionDataSourceSettings_AwsKinesis| { &m.gcp_service_account },
                |m: &mut IngestionDataSourceSettings_AwsKinesis| { &mut m.gcp_service_account },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<IngestionDataSourceSettings_AwsKinesis>(
    ...
    fn default_instance() -> &'static IngestionDataSourceSettings_AwsKinesis {
        static instance: ::protobuf::rt::LazyV2<IngestionDataSourceSettings_AwsKinesis> = ::protobuf::rt::LazyV2::INIT;
        instance.get(IngestionDataSourceSettings_AwsKinesis::new)
    }
}

impl ::protobuf::Clear for IngestionDataSourceSettings_AwsKinesis {
    fn clear(&mut self) {
        self.state = IngestionDataSourceSettings_AwsKinesis_State::STATE_UNSPECIFIED;
        self.stream_arn.clear();
        self.consumer_arn.clear();
...
impl ::std::fmt::Debug for IngestionDataSourceSettings_AwsKinesis {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for IngestionDataSourceSettings_AwsKinesis {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
pub enum IngestionDataSourceSettings_AwsKinesis_State {
    STATE_UNSPECIFIED = 0,
    ACTIVE = 1,
...
impl ::protobuf::ProtobufEnum for IngestionDataSourceSettings_AwsKinesis_State {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<IngestionDataSourceSettings_AwsKinesis_State> {
        match value {
            0 => ::std::option::Option::Some(IngestionDataSourceSettings_AwsKinesis_State::STATE_UNSPECIFIED),
            1 => ::std::option::Option::Some(IngestionDataSourceSettings_AwsKinesis_State::ACTIVE),
            2 => ::std::option::Option::Some(IngestionDataSourceSettings_AwsKinesis_State::KINESIS_PERMISSION_DENIED),
            3 => ::std::option::Option::Some(IngestionDataSourceSettings_AwsKinesis_State::PUBLISH_PERMISSION_DENIED),
            4 => ::std::option::Option::Some(IngestionDataSourceSettings_AwsKinesis_State::STREAM_NOT_FOUND),
            5 => ::std::option::Option::Some(IngestionDataSourceSettings_AwsKinesis_State::CONSUMER_NOT_FOUND),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [IngestionDataSourceSettings_AwsKinesis_State] = &[
            IngestionDataSourceSettings_AwsKinesis_State::STATE_UNSPECIFIED,
            IngestionDataSourceSettings_AwsKinesis_State::ACTIVE,
            IngestionDataSourceSettings_AwsKinesis_State::KINESIS_PERMISSION_DENIED,
            IngestionDataSourceSettings_AwsKinesis_State::PUBLISH_PERMISSION_DENIED,
            IngestionDataSourceSettings_AwsKinesis_State::STREAM_NOT_FOUND,
            IngestionDataSourceSettings_AwsKinesis_State::CONSUMER_NOT_FOUND,
        ];
        values
    }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<IngestionDataSourceSettings_AwsKinesis_State>("IngestionDataSourceSettings.AwsKinesis.State", file_descriptor_proto())
        })
    }
}

impl ::std::marker::Copy for IngestionDataSourceSettings_AwsKinesis_State {
}

impl ::std::default::Default for IngestionDataSourceSettings_AwsKinesis_State {
    fn default() -> Self {
        IngestionDataSourceSettings_AwsKinesis_State::STATE_UNSPECIFIED
    }
}

impl ::protobuf::reflect::ProtobufValue for IngestionDataSourceSettings_AwsKinesis_State {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
...
pub struct Topic {
    ...
    pub state: Topic_State,
    pub ingestion_data_source_settings: ::protobuf::SingularPtrField<IngestionDataSourceSettings>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl Topic {
    ...
    // .google.pubsub.v1.Topic.State state = 9;


    pub fn get_state(&self) -> Topic_State {
        self.state
    }
    pub fn clear_state(&mut self) {
        self.state = Topic_State::STATE_UNSPECIFIED;
    }

    // Param is passed by value, moved
    pub fn set_state(&mut self, v: Topic_State) {
        self.state = v;
    }

    // .google.pubsub.v1.IngestionDataSourceSettings ingestion_data_source_settings = 10;


    pub fn get_ingestion_data_source_settings(&self) -> &IngestionDataSourceSettings {
        self.ingestion_data_source_settings.as_ref().unwrap_or_else(|| <IngestionDataSourceSettings as ::protobuf::Message>::default_instance())
    }
    pub fn clear_ingestion_data_source_settings(&mut self) {
        self.ingestion_data_source_settings.clear();
    }

    pub fn has_ingestion_data_source_settings(&self) -> bool {
        self.ingestion_data_source_settings.is_some()
    }

    // Param is passed by value, moved
    pub fn set_ingestion_data_source_settings(&mut self, v: IngestionDataSourceSettings) {
        self.ingestion_data_source_settings = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_ingestion_data_source_settings(&mut self) -> &mut IngestionDataSourceSettings {
        if self.ingestion_data_source_settings.is_none() {
            self.ingestion_data_source_settings.set_default();
        }
        self.ingestion_data_source_settings.as_mut().unwrap()
    }

    // Take field
    pub fn take_ingestion_data_source_settings(&mut self) -> IngestionDataSourceSettings {
        self.ingestion_data_source_settings.take().unwrap_or_else(|| IngestionDataSourceSettings::new())
    }
}
...
impl ::protobuf::Message for Topic {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.ingestion_data_source_settings {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                10 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.ingestion_data_source_settings)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.state != Topic_State::STATE_UNSPECIFIED {
            my_size += ::protobuf::rt::enum_size(9, self.state);
        }
        if let Some(ref v) = self.ingestion_data_source_settings.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<Topic_State>>(
                "state",
                |m: &Topic| { &m.state },
                |m: &mut Topic| { &mut m.state },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<IngestionDataSourceSettings>>(
...
#[derive(Clone,PartialEq,Eq,Debug,Hash)]
pub enum Topic_State {
    STATE_UNSPECIFIED = 0,
    ACTIVE = 1,
    INGESTION_RESOURCE_ERROR = 2,
}

impl ::protobuf::ProtobufEnum for Topic_State {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<Topic_State> {
        match value {
            0 => ::std::option::Option::Some(Topic_State::STATE_UNSPECIFIED),
            1 => ::std::option::Option::Some(Topic_State::ACTIVE),
            2 => ::std::option::Option::Some(Topic_State::INGESTION_RESOURCE_ERROR),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [Topic_State] = &[
            Topic_State::STATE_UNSPECIFIED,
            Topic_State::ACTIVE,
            Topic_State::INGESTION_RESOURCE_ERROR,
        ];
        values
    }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::LazyV2<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::LazyV2::INIT;
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<Topic_State>("Topic.State", file_descriptor_proto())
        })
    }
}

impl ::std::marker::Copy for Topic_State {
}

impl ::std::default::Default for Topic_State {
    fn default() -> Self {
        Topic_State::STATE_UNSPECIFIED
    }
}

impl ::protobuf::reflect::ProtobufValue for Topic_State {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Enum(::protobuf::ProtobufEnum::descriptor(self))
    }
}
...
impl ::protobuf::ProtobufEnum for BigQueryConfig_State {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<BigQueryConfig_State> {
        match value {
            ...
            5 => ::std::option::Option::Some(BigQueryConfig_State::IN_TRANSIT_LOCATION_RESTRICTION),
            _ => ::std::option::Option::None
        }
    }
    ...
    fn values() -> &'static [Self] {
        static values: &'static [BigQueryConfig_State] = &[
            ...
            BigQueryConfig_State::IN_TRANSIT_LOCATION_RESTRICTION,
        ];
        values
    }
...
impl ::protobuf::ProtobufEnum for CloudStorageConfig_State {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<CloudStorageConfig_State> {
        match value {
            ...
            4 => ::std::option::Option::Some(CloudStorageConfig_State::IN_TRANSIT_LOCATION_RESTRICTION),
            _ => ::std::option::Option::None
        }
    }
    ...
    fn values() -> &'static [Self] {
        static values: &'static [CloudStorageConfig_State] = &[
            ...
            CloudStorageConfig_State::IN_TRANSIT_LOCATION_RESTRICTION,
        ];
        values
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _revision_id\x18\x04\x20\x01(\tR\x0elastRevisionIdB\x03\xe0A\x01\"\xb4\
    \x04\n\x1bIngestionDataSourceSettings\x12`\n\x0baws_kinesis\x18\x01\x20\
    \x01(\x0b28.google.pubsub.v1.IngestionDataSourceSettings.AwsKinesisH\0R\
    \nawsKinesisB\x03\xe0A\x01\x1a\xa8\x03\n\nAwsKinesis\x12Y\n\x05state\x18\
    \x01\x20\x01(\x0e2>.google.pubsub.v1.IngestionDataSourceSettings.AwsKine\
    sis.StateR\x05stateB\x03\xe0A\x03\x12\"\n\nstream_arn\x18\x02\x20\x01(\t\
    R\tstreamArnB\x03\xe0A\x02\x12&\n\x0cconsumer_arn\x18\x03\x20\x01(\tR\
    \x0bconsumerArnB\x03\xe0A\x02\x12%\n\x0caws_role_arn\x18\x04\x20\x01(\tR\
    \nawsRoleArnB\x03\xe0A\x02\x123\n\x13gcp_service_account\x18\x05\x20\x01\
    (\tR\x11gcpServiceAccountB\x03\xe0A\x02\"\x96\x01\n\x05State\x12\x15\n\
    \x11STATE_UNSPECIFIED\x10\0\x12\n\n\x06ACTIVE\x10\x01\x12\x1d\n\x19KINES\
    IS_PERMISSION_DENIED\x10\x02\x12\x1d\n\x19PUBLISH_PERMISSION_DENIED\x10\
    \x03\x12\x14\n\x10STREAM_NOT_FOUND\x10\x04\x12\x16\n\x12CONSUMER_NOT_FOU\
    ND\x10\x05B\x08\n\x06source\"\xd2\x06\n\x05Topic\x12\x17\n\x04name\x18\
    \x01\x20\x01(\tR\x04nameB\x03\xe0A\x02\x12@\n\x06labels\x18\x02\x20\x03(\
    \x0b2#.google.pubsub.v1.Topic.LabelsEntryR\x06labelsB\x03\xe0A\x01\x12a\
    \n\x16message_storage_policy\x18\x03\x20\x01(\x0b2&.google.pubsub.v1.Mes\
    sageStoragePolicyR\x14messageStoragePolicyB\x03\xe0A\x01\x12%\n\x0ckms_k\
    ey_name\x18\x05\x20\x01(\tR\nkmsKeyNameB\x03\xe0A\x01\x12N\n\x0fschema_s\
    ettings\x18\x06\x20\x01(\x0b2\x20.google.pubsub.v1.SchemaSettingsR\x0esc\
    hemaSettingsB\x03\xe0A\x01\x12(\n\rsatisfies_pzs\x18\x07\x20\x01(\x08R\
    \x0csatisfiesPzsB\x03\xe0A\x01\x12\\\n\x1amessage_retention_duration\x18\
    \x08\x20\x01(\x0b2\x19.google.protobuf.DurationR\x18messageRetentionDura\
    tionB\x03\xe0A\x01\x128\n\x05state\x18\t\x20\x01(\x0e2\x1d.google.pubsub\
    .v1.Topic.StateR\x05stateB\x03\xe0A\x03\x12w\n\x1eingestion_data_source_\
    settings\x18\n\x20\x01(\x0b2-.google.pubsub.v1.IngestionDataSourceSettin\
    gsR\x1bingestionDataSourceSettingsB\x03\xe0A\x01\x1a9\n\x0bLabelsEntry\
    \x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\
    \x20\x01(\tR\x05value:\x028\x01\"H\n\x05State\x12\x15\n\x11STATE_UNSPECI\
    FIED\x10\0\x12\n\n\x06ACTIVE\x10\x01\x12\x1c\n\x18INGESTION_RESOURCE_ERR\
    OR\x10\x02:T\xeaAQ\n\x1bpubsub.googleapis.com/Topic\x12!projects/{projec\
    t}/topics/{topic}\x12\x0f_deleted-topic_\"\xc3\x02\n\rPubsubMessage\x12\
    \x17\n\x04data\x18\x01\x20\x01(\x0cR\x04dataB\x03\xe0A\x01\x12T\n\nattri\
    butes\x18\x02\x20\x03(\x0b2/.google.pubsub.v1.PubsubMessage.AttributesEn\
    tryR\nattributesB\x03\xe0A\x01\x12\x1d\n\nmessage_id\x18\x03\x20\x01(\tR\
    \tmessageId\x12=\n\x0cpublish_time\x18\x04\x20\x01(\x0b2\x1a.google.prot\
    obuf.TimestampR\x0bpublishTime\x12&\n\x0cordering_key\x18\x05\x20\x01(\t\
    R\x0borderingKeyB\x03\xe0A\x01\x1a=\n\x0fAttributesEntry\x12\x10\n\x03ke\
    y\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05v\
    alue:\x028\x01\"L\n\x0fGetTopicRequest\x129\n\x05topic\x18\x01\x20\x01(\
    \tR\x05topicB#\xfaA\x1d\n\x1bpubsub.googleapis.com/Topic\xe0A\x02\"\x8a\
    \x01\n\x12UpdateTopicRequest\x122\n\x05topic\x18\x01\x20\x01(\x0b2\x17.g\
    oogle.pubsub.v1.TopicR\x05topicB\x03\xe0A\x02\x12@\n\x0bupdate_mask\x18\
    ...
    \x08messages\x18\x02\x20\x03(\x0b2\x1f.google.pubsub.v1.PubsubMessageR\
    \x08messagesB\x03\xe0A\x02\"7\n\x0fPublishResponse\x12$\n\x0bmessage_ids\
    ...
    \x20\x01(\tR\tpageTokenB\x03\xe0A\x01\"w\n\x12ListTopicsResponse\x124\n\
    \x06topics\x18\x01\x20\x03(\x0b2\x17.google.pubsub.v1.TopicR\x06topicsB\
    \x03\xe0A\x01\x12+\n\x0fnext_page_token\x18\x02\x20\x01(\tR\rnextPageTok\
    enB\x03\xe0A\x01\"\xa0\x01\n\x1dListTopicSubscriptionsRequest\x129\n\x05\
    topic\x18\x01\x20\x01(\tR\x05topicB#\xfaA\x1d\n\x1bpubsub.googleapis.com\
    /Topic\xe0A\x02\x12\x20\n\tpage_size\x18\x02\x20\x01(\x05R\x08pageSizeB\
    \x03\xe0A\x01\x12\"\n\npage_token\x18\x03\x20\x01(\tR\tpageTokenB\x03\
    \xe0A\x01\"\x9f\x01\n\x1eListTopicSubscriptionsResponse\x12P\n\rsubscrip\
    tions\x18\x01\x20\x03(\tR\rsubscriptionsB*\xfaA$\n\"pubsub.googleapis.co\
    m/Subscription\xe0A\x01\x12+\n\x0fnext_page_token\x18\x02\x20\x01(\tR\rn\
    extPageTokenB\x03\xe0A\x01\"\x9c\x01\n\x19ListTopicSnapshotsRequest\x129\
    \n\x05topic\x18\x01\x20\x01(\tR\x05topicB#\xfaA\x1d\n\x1bpubsub.googleap\
    is.com/Topic\xe0A\x02\x12\x20\n\tpage_size\x18\x02\x20\x01(\x05R\x08page\
    SizeB\x03\xe0A\x01\x12\"\n\npage_token\x18\x03\x20\x01(\tR\tpageTokenB\
    \x03\xe0A\x01\"l\n\x1aListTopicSnapshotsResponse\x12!\n\tsnapshots\x18\
    \x01\x20\x03(\tR\tsnapshotsB\x03\xe0A\x01\x12+\n\x0fnext_page_token\x18\
    \x02\x20\x01(\tR\rnextPageTokenB\x03\xe0A\x01\"O\n\x12DeleteTopicRequest\
    \x129\n\x05topic\x18\x01\x20\x01(\tR\x05topicB#\xfaA\x1d\n\x1bpubsub.goo\
    gleapis.com/Topic\xe0A\x02\"k\n\x19DetachSubscriptionRequest\x12N\n\x0cs\
    ubscription\x18\x01\x20\x01(\tR\x0csubscriptionB*\xfaA$\n\"pubsub.google\
    apis.com/Subscription\xe0A\x02\"\x1c\n\x1aDetachSubscriptionResponse\"\
    \x9e\x0b\n\x0cSubscription\x12\x17\n\x04name\x18\x01\x20\x01(\tR\x04name\
    B\x03\xe0A\x02\x129\n\x05topic\x18\x02\x20\x01(\tR\x05topicB#\xfaA\x1d\n\
    \x1bpubsub.googleapis.com/Topic\xe0A\x02\x12B\n\x0bpush_config\x18\x04\
    \x20\x01(\x0b2\x1c.google.pubsub.v1.PushConfigR\npushConfigB\x03\xe0A\
    \x01\x12N\n\x0fbigquery_config\x18\x12\x20\x01(\x0b2\x20.google.pubsub.v\
    1.BigQueryConfigR\x0ebigqueryConfigB\x03\xe0A\x01\x12[\n\x14cloud_storag\
    e_config\x18\x16\x20\x01(\x0b2$.google.pubsub.v1.CloudStorageConfigR\x12\
    cloudStorageConfigB\x03\xe0A\x01\x125\n\x14ack_deadline_seconds\x18\x05\
    \x20\x01(\x05R\x12ackDeadlineSecondsB\x03\xe0A\x01\x127\n\x15retain_acke\
    d_messages\x18\x07\x20\x01(\x08R\x13retainAckedMessagesB\x03\xe0A\x01\
    \x12\\\n\x1amessage_retention_duration\x18\x08\x20\x01(\x0b2\x19.google.\
    protobuf.DurationR\x18messageRetentionDurationB\x03\xe0A\x01\x12G\n\x06l\
    abels\x18\t\x20\x03(\x0b2*.google.pubsub.v1.Subscription.LabelsEntryR\
    \x06labelsB\x03\xe0A\x01\x12;\n\x17enable_message_ordering\x18\n\x20\x01\
    (\x08R\x15enableMessageOrderingB\x03\xe0A\x01\x12T\n\x11expiration_polic\
    y\x18\x0b\x20\x01(\x0b2\".google.pubsub.v1.ExpirationPolicyR\x10expirati\
    onPolicyB\x03\xe0A\x01\x12\x1b\n\x06filter\x18\x0c\x20\x01(\tR\x06filter\
    B\x03\xe0A\x01\x12U\n\x12dead_letter_policy\x18\r\x20\x01(\x0b2\".google\
    .pubsub.v1.DeadLetterPolicyR\x10deadLetterPolicyB\x03\xe0A\x01\x12E\n\
    \x0cretry_policy\x18\x0e\x20\x01(\x0b2\x1d.google.pubsub.v1.RetryPolicyR\
    \x0bretryPolicyB\x03\xe0A\x01\x12\x1f\n\x08detached\x18\x0f\x20\x01(\x08\
    R\x08detachedB\x03\xe0A\x01\x12D\n\x1cenable_exactly_once_delivery\x18\
    \x10\x20\x01(\x08R\x19enableExactlyOnceDeliveryB\x03\xe0A\x01\x12g\n\x20\
    topic_message_retention_duration\x18\x11\x20\x01(\x0b2\x19.google.protob\
    uf.DurationR\x1dtopicMessageRetentionDurationB\x03\xe0A\x03\x12?\n\x05st\
    ate\x18\x13\x20\x01(\x0e2$.google.pubsub.v1.Subscription.StateR\x05state\
    ...
    hemaB\x03\xe0A\x01\"\x8a\x01\n\x05State\x12\x15\n\x11STATE_UNSPECIFIED\
    \x10\0\x12\n\n\x06ACTIVE\x10\x01\x12\x15\n\x11PERMISSION_DENIED\x10\x02\
    \x12\r\n\tNOT_FOUND\x10\x03\x12\x13\n\x0fSCHEMA_MISMATCH\x10\x04\x12#\n\
    \x1fIN_TRANSIT_LOCATION_RESTRICTION\x10\x05\"\xbb\x05\n\x12CloudStorageC\
    onfig\x12\x1b\n\x06bucket\x18\x01\x20\x01(\tR\x06bucketB\x03\xe0A\x02\
    \x12,\n\x0ffilename_prefix\x18\x02\x20\x01(\tR\x0efilenamePrefixB\x03\
    \xe0A\x01\x12,\n\x0ffilename_suffix\x18\x03\x20\x01(\tR\x0efilenameSuffi\
    xB\x03\xe0A\x01\x12W\n\x0btext_config\x18\x04\x20\x01(\x0b2/.google.pubs\
    ub.v1.CloudStorageConfig.TextConfigH\0R\ntextConfigB\x03\xe0A\x01\x12W\n\
    \x0bavro_config\x18\x05\x20\x01(\x0b2/.google.pubsub.v1.CloudStorageConf\
    ig.AvroConfigH\0R\navroConfigB\x03\xe0A\x01\x12A\n\x0cmax_duration\x18\
    \x06\x20\x01(\x0b2\x19.google.protobuf.DurationR\x0bmaxDurationB\x03\xe0\
    A\x01\x12\x20\n\tmax_bytes\x18\x07\x20\x01(\x03R\x08maxBytesB\x03\xe0A\
    \x01\x12E\n\x05state\x18\t\x20\x01(\x0e2*.google.pubsub.v1.CloudStorageC\
    onfig.StateR\x05stateB\x03\xe0A\x03\x1a\x0c\n\nTextConfig\x1a8\n\nAvroCo\
    nfig\x12*\n\x0ewrite_metadata\x18\x01\x20\x01(\x08R\rwriteMetadataB\x03\
    \xe0A\x01\"u\n\x05State\x12\x15\n\x11STATE_UNSPECIFIED\x10\0\x12\n\n\x06\
    ACTIVE\x10\x01\x12\x15\n\x11PERMISSION_DENIED\x10\x02\x12\r\n\tNOT_FOUND\
    \x10\x03\x12#\n\x1fIN_TRANSIT_LOCATION_RESTRICTION\x10\x04B\x0f\n\routpu\
    t_format\"\x9d\x01\n\x0fReceivedMessage\x12\x1a\n\x06ack_id\x18\x01\x20\
    \x01(\tR\x05ackIdB\x03\xe0A\x01\x12>\n\x07message\x18\x02\x20\x01(\x0b2\
    \x1f.google.pubsub.v1.PubsubMessageR\x07messageB\x03\xe0A\x01\x12.\n\x10\
    delivery_attempt\x18\x03\x20\x01(\x05R\x0fdeliveryAttemptB\x03\xe0A\x01\
    ...
    \x01\x20\x01(\x0b2\x1e.google.pubsub.v1.SubscriptionR\x0csubscriptionB\
    \x03\xe0A\x02\x12@\n\x0bupdate_mask\x18\x02\x20\x01(\x0b2\x1a.google.pro\
    tobuf.FieldMaskR\nupdateMaskB\x03\xe0A\x02\"\xaf\x01\n\x18ListSubscripti\
    onsRequest\x12M\n\x07project\x18\x01\x20\x01(\tR\x07projectB3\xfaA-\n+cl\
    oudresourcemanager.googleapis.com/Project\xe0A\x02\x12\x20\n\tpage_size\
    \x18\x02\x20\x01(\x05R\x08pageSizeB\x03\xe0A\x01\x12\"\n\npage_token\x18\
    \x03\x20\x01(\tR\tpageTokenB\x03\xe0A\x01\"\x93\x01\n\x19ListSubscriptio\
    nsResponse\x12I\n\rsubscriptions\x18\x01\x20\x03(\x0b2\x1e.google.pubsub\
    .v1.SubscriptionR\rsubscriptionsB\x03\xe0A\x01\x12+\n\x0fnext_page_token\
    \x18\x02\x20\x01(\tR\rnextPageTokenB\x03\xe0A\x01\"k\n\x19DeleteSubscrip\
    tionRequest\x12N\n\x0csubscription\x18\x01\x20\x01(\tR\x0csubscriptionB*\
    \xfaA$\n\"pubsub.googleapis.com/Subscription\xe0A\x02\"\xad\x01\n\x17Mod\
    ifyPushConfigRequest\x12N\n\x0csubscription\x18\x01\x20\x01(\tR\x0csubsc\
    riptionB*\xfaA$\n\"pubsub.googleapis.com/Subscription\xe0A\x02\x12B\n\
    ...
    Subscription\xe0A\x02\x124\n\x12return_immediately\x18\x02\x20\x01(\x08R\
    \x11returnImmediatelyB\x05\x18\x01\xe0A\x01\x12&\n\x0cmax_messages\x18\
    \x03\x20\x01(\x05R\x0bmaxMessagesB\x03\xe0A\x02\"c\n\x0cPullResponse\x12\
    S\n\x11received_messages\x18\x01\x20\x03(\x0b2!.google.pubsub.v1.Receive\
    dMessageR\x10receivedMessagesB\x03\xe0A\x01\"\xbf\x01\n\x18ModifyAckDead\
    lineRequest\x12N\n\x0csubscription\x18\x01\x20\x01(\tR\x0csubscriptionB*\
    ...
    \x12\x1c\n\x07ack_ids\x18\x02\x20\x03(\tR\x06ackIdsB\x03\xe0A\x02\"\xdb\
    \x03\n\x14StreamingPullRequest\x12N\n\x0csubscription\x18\x01\x20\x01(\t\
    R\x0csubscriptionB*\xfaA$\n\"pubsub.googleapis.com/Subscription\xe0A\x02\
    \x12\x1c\n\x07ack_ids\x18\x02\x20\x03(\tR\x06ackIdsB\x03\xe0A\x01\x12;\n\
    \x17modify_deadline_seconds\x18\x03\x20\x03(\x05R\x15modifyDeadlineSecon\
    dsB\x03\xe0A\x01\x12:\n\x17modify_deadline_ack_ids\x18\x04\x20\x03(\tR\
    \x14modifyDeadlineAckIdsB\x03\xe0A\x01\x12B\n\x1bstream_ack_deadline_sec\
    onds\x18\x05\x20\x01(\x05R\x18streamAckDeadlineSecondsB\x03\xe0A\x02\x12\
    \x20\n\tclient_id\x18\x06\x20\x01(\tR\x08clientIdB\x03\xe0A\x01\x12=\n\
    \x18max_outstanding_messages\x18\x07\x20\x01(\x03R\x16maxOutstandingMess\
    agesB\x03\xe0A\x01\x127\n\x15max_outstanding_bytes\x18\x08\x20\x01(\x03R\
    \x13maxOutstandingBytesB\x03\xe0A\x01\"\xa4\x08\n\x15StreamingPullRespon\
    se\x12S\n\x11received_messages\x18\x01\x20\x03(\x0b2!.google.pubsub.v1.R\
    eceivedMessageR\x10receivedMessagesB\x03\xe0A\x01\x12\x7f\n\x18acknowled\
    ge_confirmation\x18\x05\x20\x01(\x0b2?.google.pubsub.v1.StreamingPullRes\
    ponse.AcknowledgeConfirmationR\x17acknowledgeConfirmationB\x03\xe0A\x01\
    \x12\x93\x01\n\x20modify_ack_deadline_confirmation\x18\x03\x20\x01(\x0b2\
    E.google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmationR\
    \x1dmodifyAckDeadlineConfirmationB\x03\xe0A\x01\x12|\n\x17subscription_p\
    roperties\x18\x04\x20\x01(\x0b2>.google.pubsub.v1.StreamingPullResponse.\
    SubscriptionPropertiesR\x16subscriptionPropertiesB\x03\xe0A\x01\x1a\xd3\
    \x01\n\x17AcknowledgeConfirmation\x12\x1c\n\x07ack_ids\x18\x01\x20\x03(\
    \tR\x06ackIdsB\x03\xe0A\x01\x12+\n\x0finvalid_ack_ids\x18\x02\x20\x03(\t\
    R\rinvalidAckIdsB\x03\xe0A\x01\x12/\n\x11unordered_ack_ids\x18\x03\x20\
    \x03(\tR\x0funorderedAckIdsB\x03\xe0A\x01\x12<\n\x18temporary_failed_ack\
    _ids\x18\x04\x20\x03(\tR\x15temporaryFailedAckIdsB\x03\xe0A\x01\x1a\xa8\
    \x01\n\x1dModifyAckDeadlineConfirmation\x12\x1c\n\x07ack_ids\x18\x01\x20\
    \x03(\tR\x06ackIdsB\x03\xe0A\x01\x12+\n\x0finvalid_ack_ids\x18\x02\x20\
    \x03(\tR\rinvalidAckIdsB\x03\xe0A\x01\x12<\n\x18temporary_failed_ack_ids\
    \x18\x03\x20\x03(\tR\x15temporaryFailedAckIdsB\x03\xe0A\x01\x1a\x9f\x01\
    \n\x16SubscriptionProperties\x12F\n\x1dexactly_once_delivery_enabled\x18\
    \x01\x20\x01(\x08R\x1aexactlyOnceDeliveryEnabledB\x03\xe0A\x01\x12=\n\
    \x18message_ordering_enabled\x18\x02\x20\x01(\x08R\x16messageOrderingEna\
    bledB\x03\xe0A\x01\"\xb0\x02\n\x15CreateSnapshotRequest\x12:\n\x04name\
    \x18\x01\x20\x01(\tR\x04nameB&\xfaA\x20\n\x1epubsub.googleapis.com/Snaps\
    hot\xe0A\x02\x12N\n\x0csubscription\x18\x02\x20\x01(\tR\x0csubscriptionB\
    *\xfaA$\n\"pubsub.googleapis.com/Subscription\xe0A\x02\x12P\n\x06labels\
    \x18\x03\x20\x03(\x0b23.google.pubsub.v1.CreateSnapshotRequest.LabelsEnt\
    ryR\x06labelsB\x03\xe0A\x01\x1a9\n\x0bLabelsEntry\x12\x10\n\x03key\x18\
    \x01\x20\x01(\tR\x03key\x12\x14\n\x05value\x18\x02\x20\x01(\tR\x05value:\
    \x028\x01\"\x96\x01\n\x15UpdateSnapshotRequest\x12;\n\x08snapshot\x18\
    \x01\x20\x01(\x0b2\x1a.google.pubsub.v1.SnapshotR\x08snapshotB\x03\xe0A\
    \x02\x12@\n\x0bupdate_mask\x18\x02\x20\x01(\x0b2\x1a.google.protobuf.Fie\
    ldMaskR\nupdateMaskB\x03\xe0A\x02\"\xee\x02\n\x08Snapshot\x12\x17\n\x04n\
    ame\x18\x01\x20\x01(\tR\x04nameB\x03\xe0A\x01\x129\n\x05topic\x18\x02\
    ...
    estampR\nexpireTimeB\x03\xe0A\x01\x12C\n\x06labels\x18\x04\x20\x03(\x0b2\
    &.google.pubsub.v1.Snapshot.LabelsEntryR\x06labelsB\x03\xe0A\x01\x1a9\n\
    \x0bLabelsEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\
    ...
    tB&\xfaA\x20\n\x1epubsub.googleapis.com/Snapshot\xe0A\x02\"\xab\x01\n\
    ...
    age_token\x18\x03\x20\x01(\tR\tpageTokenB\x03\xe0A\x01\"\x83\x01\n\x15Li\
    stSnapshotsResponse\x12=\n\tsnapshots\x18\x01\x20\x03(\x0b2\x1a.google.p\
    ubsub.v1.SnapshotR\tsnapshotsB\x03\xe0A\x01\x12+\n\x0fnext_page_token\
    \x18\x02\x20\x01(\tR\rnextPageTokenB\x03\xe0A\x01\"[\n\x15DeleteSnapshot\
    Request\x12B\n\x08snapshot\x18\x01\x20\x01(\tR\x08snapshotB&\xfaA\x20\n\
    \x1epubsub.googleapis.com/Snapshot\xe0A\x02\"\xe4\x01\n\x0bSeekRequest\
    \x12N\n\x0csubscription\x18\x01\x20\x01(\tR\x0csubscriptionB*\xfaA$\n\"p\
    ubsub.googleapis.com/Subscription\xe0A\x02\x125\n\x04time\x18\x02\x20\
    \x01(\x0b2\x1a.google.protobuf.TimestampH\0R\x04timeB\x03\xe0A\x01\x12D\
    \n\x08snapshot\x18\x03\x20\x01(\tH\0R\x08snapshotB&\xfaA\x20\n\x1epubsub\
    .googleapis.com/Snapshot\xe0A\x01B\x08\n\x06target\"\x0e\n\x0cSeekRespon\
    se2\xb8\x0b\n\tPublisher\x12q\n\x0bCreateTopic\x12\x17.google.pubsub.v1.\
    Topic\x1a\x17.google.pubsub.v1.Topic\"0\x82\xd3\xe4\x93\x02#\x1a\x1e/v1/\
    {name=projects/*/topics/*}:\x01*\xdaA\x04name\x12\x91\x01\n\x0bUpdateTop\
    ic\x12$.google.pubsub.v1.UpdateTopicRequest\x1a\x17.google.pubsub.v1.Top\
    ic\"C\x82\xd3\xe4\x93\x02)2$/v1/{topic.name=projects/*/topics/*}:\x01*\
    \xdaA\x11topic,update_mask\x12\x93\x01\n\x07Publish\x12\x20.google.pubsu\
    b.v1.PublishRequest\x1a!.google.pubsub.v1.PublishResponse\"C\x82\xd3\xe4\
    \x93\x02,\"'/v1/{topic=projects/*/topics/*}:publish:\x01*\xdaA\x0etopic,\
    messages\x12w\n\x08GetTopic\x12!.google.pubsub.v1.GetTopicRequest\x1a\
    \x17.google.pubsub.v1.Topic\"/\x82\xd3\xe4\x93\x02!\x12\x1f/v1/{topic=pr\
    ojects/*/topics/*}\xdaA\x05topic\x12\x8a\x01\n\nListTopics\x12#.google.p\
    ubsub.v1.ListTopicsRequest\x1a$.google.pubsub.v1.ListTopicsResponse\"1\
    \x82\xd3\xe4\x93\x02!\x12\x1f/v1/{project=projects/*}/topics\xdaA\x07pro\
    ject\x12\xba\x01\n\x16ListTopicSubscriptions\x12/.google.pubsub.v1.ListT\
    opicSubscriptionsRequest\x1a0.google.pubsub.v1.ListTopicSubscriptionsRes\
    ponse\"=\x82\xd3\xe4\x93\x02/\x12-/v1/{topic=projects/*/topics/*}/subscr\
    iptions\xdaA\x05topic\x12\xaa\x01\n\x12ListTopicSnapshots\x12+.google.pu\
    bsub.v1.ListTopicSnapshotsRequest\x1a,.google.pubsub.v1.ListTopicSnapsho\
    tsResponse\"9\x82\xd3\xe4\x93\x02+\x12)/v1/{topic=projects/*/topics/*}/s\
    napshots\xdaA\x05topic\x12|\n\x0bDeleteTopic\x12$.google.pubsub.v1.Delet\
    eTopicRequest\x1a\x16.google.protobuf.Empty\"/\x82\xd3\xe4\x93\x02!*\x1f\
    /v1/{topic=projects/*/topics/*}\xdaA\x05topic\x12\xad\x01\n\x12DetachSub\
    scription\x12+.google.pubsub.v1.DetachSubscriptionRequest\x1a,.google.pu\
    bsub.v1.DetachSubscriptionResponse\"<\x82\xd3\xe4\x93\x026\"4/v1/{subscr\
    iption=projects/*/subscriptions/*}:detach\x1ap\xd2AUhttps://www.googleap\
    is.com/auth/cloud-platform,https://www.googleapis.com/auth/pubsub\xcaA\
    \x15pubsub.googleapis.com2\xd2\x15\n\nSubscriber\x12\xb4\x01\n\x12Create\
    Subscription\x12\x1e.google.pubsub.v1.Subscription\x1a\x1e.google.pubsub\
    .v1.Subscription\"^\x82\xd3\xe4\x93\x02*\x1a%/v1/{name=projects/*/subscr\
    iptions/*}:\x01*\xdaA+name,topic,push_config,ack_deadline_seconds\x12\
    \xa1\x01\n\x0fGetSubscription\x12(.google.pubsub.v1.GetSubscriptionReque\
    st\x1a\x1e.google.pubsub.v1.Subscription\"D\x82\xd3\xe4\x93\x02/\x12-/v1\
    /{subscription=projects/*/subscriptions/*}\xdaA\x0csubscription\x12\xbb\
    \x01\n\x12UpdateSubscription\x12+.google.pubsub.v1.UpdateSubscriptionReq\
    uest\x1a\x1e.google.pubsub.v1.Subscription\"X\x82\xd3\xe4\x93\x02722/v1/\
    {subscription.name=projects/*/subscriptions/*}:\x01*\xdaA\x18subscriptio\
    n,update_mask\x12\xa6\x01\n\x11ListSubscriptions\x12*.google.pubsub.v1.L\
    istSubscriptionsRequest\x1a+.google.pubsub.v1.ListSubscriptionsResponse\
    \"8\x82\xd3\xe4\x93\x02(\x12&/v1/{project=projects/*}/subscriptions\xdaA\
    \x07project\x12\x9f\x01\n\x12DeleteSubscription\x12+.google.pubsub.v1.De\
    leteSubscriptionRequest\x1a\x16.google.protobuf.Empty\"D\x82\xd3\xe4\x93\
    \x02/*-/v1/{subscription=projects/*/subscriptions/*}\xdaA\x0csubscriptio\
    n\x12\xcf\x01\n\x11ModifyAckDeadline\x12*.google.pubsub.v1.ModifyAckDead\
    lineRequest\x1a\x16.google.protobuf.Empty\"v\x82\xd3\xe4\x93\x02D\"?/v1/\
    {subscription=projects/*/subscriptions/*}:modifyAckDeadline:\x01*\xdaA)s\
    ubscription,ack_ids,ack_deadline_seconds\x12\xa8\x01\n\x0bAcknowledge\
    \x12$.google.pubsub.v1.AcknowledgeRequest\x1a\x16.google.protobuf.Empty\
    \"[\x82\xd3\xe4\x93\x02>\"9/v1/{subscription=projects/*/subscriptions/*}\
    :acknowledge:\x01*\xdaA\x14subscription,ack_ids\x12\xd0\x01\n\x04Pull\
    \x12\x1d.google.pubsub.v1.PullRequest\x1a\x1e.google.pubsub.v1.PullRespo\
    nse\"\x88\x01\x82\xd3\xe4\x93\x027\"2/v1/{subscription=projects/*/subscr\
    iptions/*}:pull:\x01*\xdaA,subscription,return_immediately,max_messages\
    \xdaA\x19subscription,max_messages\x12f\n\rStreamingPull\x12&.google.pub\
    sub.v1.StreamingPullRequest\x1a'.google.pubsub.v1.StreamingPullResponse\
    \"\0(\x010\x01\x12\xbb\x01\n\x10ModifyPushConfig\x12).google.pubsub.v1.M\
    odifyPushConfigRequest\x1a\x16.google.protobuf.Empty\"d\x82\xd3\xe4\x93\
    \x02C\">/v1/{subscription=projects/*/subscriptions/*}:modifyPushConfig:\
    \x01*\xdaA\x18subscription,push_config\x12\x89\x01\n\x0bGetSnapshot\x12$\
    .google.pubsub.v1.GetSnapshotRequest\x1a\x1a.google.pubsub.v1.Snapshot\"\
    8\x82\xd3\xe4\x93\x02'\x12%/v1/{snapshot=projects/*/snapshots/*}\xdaA\
    \x08snapshot\x12\x96\x01\n\rListSnapshots\x12&.google.pubsub.v1.ListSnap\
    shotsRequest\x1a'.google.pubsub.v1.ListSnapshotsResponse\"4\x82\xd3\xe4\
    \x93\x02$\x12\"/v1/{project=projects/*}/snapshots\xdaA\x07project\x12\
    \x97\x01\n\x0eCreateSnapshot\x12'.google.pubsub.v1.CreateSnapshotRequest\
    \x1a\x1a.google.pubsub.v1.Snapshot\"@\x82\xd3\xe4\x93\x02&\x1a!/v1/{name\
    =projects/*/snapshots/*}:\x01*\xdaA\x11name,subscription\x12\xa3\x01\n\
    \x0eUpdateSnapshot\x12'.google.pubsub.v1.UpdateSnapshotRequest\x1a\x1a.g\
    oogle.pubsub.v1.Snapshot\"L\x82\xd3\xe4\x93\x02/2*/v1/{snapshot.name=pro\
    jects/*/snapshots/*}:\x01*\xdaA\x14snapshot,update_mask\x12\x8b\x01\n\
    ...
    pis.com/auth/pubsub\xcaA\x15pubsub.googleapis.comB\xaa\x01\n\x14com.goog\
    le.pubsub.v1B\x0bPubsubProtoP\x01Z2cloud.google.com/go/pubsub/apiv1/pubs\
    ubpb;pubsubpb\xf8\x01\x01\xaa\x02\x16Google.Cloud.PubSub.V1\xca\x02\x16G\
    oogle\\Cloud\\PubSub\\V1\xea\x02\x19Google::Cloud::PubSub::V1J\xac\xbd\
    \x04\n\x07\x12\x05\x0e\0\xd3\r\x17\n\xbc\x04\n\x01\x0c\x12\x03\x0e\0\x12\
    2\xb1\x04\x20Copyright\x202023\x20Google\x20LLC\n\n\x20Licensed\x20under\
    ...
    \xa1\x01\n\x04\x06\0\x02\0\x12\x04/\x025\x03\x1a\x92\x01\x20Creates\x20t\
    he\x20given\x20topic\x20with\x20the\x20given\x20name.\x20See\x20the\x20[\
    resource\x20name\x20rules]\n\x20(https://cloud.google.com/pubsub/docs/pu\
    bsub-basics#resource_names).\n\n\x0c\n\x05\x06\0\x02\0\x01\x12\x03/\x06\
    ...
    \x9c\x01\n\x04\x06\0\x02\x01\x12\x049\x02?\x03\x1a\x8d\x01\x20Updates\
    \x20an\x20existing\x20topic\x20by\x20updating\x20the\x20fields\x20specif\
    ied\x20in\x20the\x20update\n\x20mask.\x20Note\x20that\x20certain\x20prop\
    erties\x20of\x20a\x20topic\x20are\x20not\x20modifiable.\n\n\x0c\n\x05\
    \x06\0\x02\x01\x01\x12\x039\x06\x11\n\x0c\n\x05\x06\0\x02\x01\x02\x12\
    \x039\x12$\n\x0c\n\x05\x06\0\x02\x01\x03\x12\x039/4\n\r\n\x05\x06\0\x02\
    \x01\x04\x12\x04:\x04=\x06\n\x11\n\t\x06\0\x02\x01\x04\xb0\xca\xbc\"\x12\
    \x04:\x04=\x06\n\x0c\n\x05\x06\0\x02\x01\x04\x12\x03>\x04?\n\x0f\n\x08\
    \x06\0\x02\x01\x04\x9b\x08\0\x12\x03>\x04?\ni\n\x04\x06\0\x02\x02\x12\
    \x04C\x02I\x03\x1a[\x20Adds\x20one\x20or\x20more\x20messages\x20to\x20th\
    e\x20topic.\x20Returns\x20`NOT_FOUND`\x20if\x20the\x20topic\n\x20does\
    ...
    \0\x02\x02\x04\xb0\xca\xbc\"\x12\x04D\x04G\x06\n\x0c\n\x05\x06\0\x02\x02\
    \x04\x12\x03H\x04<\n\x0f\n\x08\x06\0\x02\x02\x04\x9b\x08\0\x12\x03H\x04<\
    \n2\n\x04\x06\0\x02\x03\x12\x04L\x02Q\x03\x1a$\x20Gets\x20the\x20configu\
    ration\x20of\x20a\x20topic.\n\n\x0c\n\x05\x06\0\x02\x03\x01\x12\x03L\x06\
    ...
    \x06\0\x02\x03\x04\x12\x03P\x043\n\x0f\n\x08\x06\0\x02\x03\x04\x9b\x08\0\
    \x12\x03P\x043\n&\n\x04\x06\0\x02\x04\x12\x04T\x02Y\x03\x1a\x18\x20Lists\
    \x20matching\x20topics.\n\n\x0c\n\x05\x06\0\x02\x04\x01\x12\x03T\x06\x10\
    \n\x0c\n\x05\x06\0\x02\x04\x02\x12\x03T\x11\"\n\x0c\n\x05\x06\0\x02\x04\
    \x03\x12\x03T-?\n\r\n\x05\x06\0\x02\x04\x04\x12\x04U\x04W\x06\n\x11\n\t\
    \x06\0\x02\x04\x04\xb0\xca\xbc\"\x12\x04U\x04W\x06\n\x0c\n\x05\x06\0\x02\
    \x04\x04\x12\x03X\x045\n\x0f\n\x08\x06\0\x02\x04\x04\x9b\x08\0\x12\x03X\
    \x045\nL\n\x04\x06\0\x02\x05\x12\x04\\\x02b\x03\x1a>\x20Lists\x20the\x20\
    names\x20of\x20the\x20attached\x20subscriptions\x20on\x20this\x20topic.\
    \n\n\x0c\n\x05\x06\0\x02\x05\x01\x12\x03\\\x06\x1c\n\x0c\n\x05\x06\0\x02\
    \x05\x02\x12\x03\\\x1d:\n\x0c\n\x05\x06\0\x02\x05\x03\x12\x03]\x0f-\n\r\
    \n\x05\x06\0\x02\x05\x04\x12\x04^\x04`\x06\n\x11\n\t\x06\0\x02\x05\x04\
    \xb0\xca\xbc\"\x12\x04^\x04`\x06\n\x0c\n\x05\x06\0\x02\x05\x04\x12\x03a\
    \x043\n\x0f\n\x08\x06\0\x02\x05\x04\x9b\x08\0\x12\x03a\x043\n\xd9\x02\n\
    \x04\x06\0\x02\x06\x12\x04i\x02o\x03\x1a\xca\x02\x20Lists\x20the\x20name\
    s\x20of\x20the\x20snapshots\x20on\x20this\x20topic.\x20Snapshots\x20are\
    \x20used\x20in\n\x20[Seek](https://cloud.google.com/pubsub/docs/replay-o\
    verview)\x20operations,\n\x20which\x20allow\x20you\x20to\x20manage\x20me\
    ssage\x20acknowledgments\x20in\x20bulk.\x20That\x20is,\x20you\x20can\n\
    ...
    \x06\x04\x12\x03n\x043\n\x0f\n\x08\x06\0\x02\x06\x04\x9b\x08\0\x12\x03n\
    \x043\n\xf3\x02\n\x04\x06\0\x02\x07\x12\x04v\x02{\x03\x1a\xe4\x02\x20Del\
    etes\x20the\x20topic\x20with\x20the\x20given\x20name.\x20Returns\x20`NOT\
    _FOUND`\x20if\x20the\x20topic\n\x20does\x20not\x20exist.\x20After\x20a\
    \x20topic\x20is\x20deleted,\x20a\x20new\x20topic\x20may\x20be\x20created\
    \x20with\n\x20the\x20same\x20name;\x20this\x20is\x20an\x20entirely\x20ne\
    w\x20topic\x20with\x20none\x20of\x20the\x20old\n\x20configuration\x20or\
    \x20subscriptions.\x20Existing\x20subscriptions\x20to\x20this\x20topic\
    \x20are\n\x20not\x20deleted,\x20but\x20their\x20`topic`\x20field\x20is\
    \x20set\x20to\x20`_deleted-topic_`.\n\n\x0c\n\x05\x06\0\x02\x07\x01\x12\
    \x03v\x06\x11\n\x0c\n\x05\x06\0\x02\x07\x02\x12\x03v\x12$\n\x0c\n\x05\
    \x06\0\x02\x07\x03\x12\x03v/D\n\r\n\x05\x06\0\x02\x07\x04\x12\x04w\x04y\
    \x06\n\x11\n\t\x06\0\x02\x07\x04\xb0\xca\xbc\"\x12\x04w\x04y\x06\n\x0c\n\
    \x05\x06\0\x02\x07\x04\x12\x03z\x043\n\x0f\n\x08\x06\0\x02\x07\x04\x9b\
    \x08\0\x12\x03z\x043\n\x93\x02\n\x04\x06\0\x02\x08\x12\x06\x81\x01\x02\
    \x86\x01\x03\x1a\x82\x02\x20Detaches\x20a\x20subscription\x20from\x20thi\
    s\x20topic.\x20All\x20messages\x20retained\x20in\x20the\n\x20subscriptio\
    n\x20are\x20dropped.\x20Subsequent\x20`Pull`\x20and\x20`StreamingPull`\
    \x20requests\n\x20will\x20return\x20FAILED_PRECONDITION.\x20If\x20the\
    \x20subscription\x20is\x20a\x20push\n\x20subscription,\x20pushes\x20to\
    ...
    \x08\x04\x12\x06\x83\x01\x04\x85\x01\x06\n\x13\n\t\x06\0\x02\x08\x04\xb0\
    \xca\xbc\"\x12\x06\x83\x01\x04\x85\x01\x06\nU\n\x02\x04\0\x12\x06\x8a\
    \x01\0\x9a\x01\x01\x1aG\x20A\x20policy\x20constraining\x20the\x20storage\
    \x20of\x20messages\x20published\x20to\x20the\x20topic.\n\n\x0b\n\x03\x04\
    \0\x01\x12\x04\x8a\x01\x08\x1c\n\x99\x03\n\x04\x04\0\x02\0\x12\x06\x91\
    \x01\x02\x92\x01/\x1a\x88\x03\x20Optional.\x20A\x20list\x20of\x20IDs\x20\
    of\x20Google\x20Cloud\x20regions\x20where\x20messages\x20that\x20are\n\
    \x20published\x20to\x20the\x20topic\x20may\x20be\x20persisted\x20in\x20s\
    torage.\x20Messages\x20published\x20by\n\x20publishers\x20running\x20in\
    \x20non-allowed\x20Google\x20Cloud\x20regions\x20(or\x20running\x20outsi\
    de\n\x20of\x20Google\x20Cloud\x20altogether)\x20are\x20routed\x20for\x20\
    storage\x20in\x20one\x20of\x20the\x20allowed\n\x20regions.\x20An\x20empt\
    y\x20list\x20means\x20that\x20no\x20regions\x20are\x20allowed,\x20and\
    \x20is\x20not\x20a\n\x20valid\x20configuration.\n\n\r\n\x05\x04\0\x02\0\
    \x04\x12\x04\x91\x01\x02\n\n\r\n\x05\x04\0\x02\0\x05\x12\x04\x91\x01\x0b\
    \x11\n\r\n\x05\x04\0\x02\0\x01\x12\x04\x91\x01\x12-\n\r\n\x05\x04\0\x02\
    \0\x03\x12\x04\x91\x0101\n\r\n\x05\x04\0\x02\0\x08\x12\x04\x92\x01\x06.\
    \n\x10\n\x08\x04\0\x02\0\x08\x9c\x08\0\x12\x04\x92\x01\x07-\n\xbd\x02\n\
    \x04\x04\0\x02\x01\x12\x04\x99\x01\x02G\x1a\xae\x02\x20Optional.\x20If\
    \x20true,\x20`allowed_persistence_regions`\x20is\x20also\x20used\x20to\
    \x20enforce\n\x20in-transit\x20guarantees\x20for\x20messages.\x20That\
    \x20is,\x20Pub/Sub\x20will\x20fail\n\x20Publish\x20operations\x20on\x20t\
    his\x20topic\x20and\x20subscribe\x20operations\n\x20on\x20any\x20subscri\
    ption\x20attached\x20to\x20this\x20topic\x20in\x20any\x20region\x20that\
    \x20is\n\x20not\x20in\x20`allowed_persistence_regions`.\n\n\r\n\x05\x04\
    \0\x02\x01\x05\x12\x04\x99\x01\x02\x06\n\r\n\x05\x04\0\x02\x01\x01\x12\
    \x04\x99\x01\x07\x19\n\r\n\x05\x04\0\x02\x01\x03\x12\x04\x99\x01\x1c\x1d\
    \n\r\n\x05\x04\0\x02\x01\x08\x12\x04\x99\x01\x1eF\n\x10\n\x08\x04\0\x02\
    \x01\x08\x9c\x08\0\x12\x04\x99\x01\x1fE\nL\n\x02\x04\x01\x12\x06\x9d\x01\
    \0\xb3\x01\x01\x1a>\x20Settings\x20for\x20validating\x20messages\x20publ\
    ished\x20against\x20a\x20schema.\n\n\x0b\n\x03\x04\x01\x01\x12\x04\x9d\
    \x01\x08\x16\n\xef\x01\n\x04\x04\x01\x02\0\x12\x06\xa2\x01\x02\xa5\x01\
    \x04\x1a\xde\x01\x20Required.\x20The\x20name\x20of\x20the\x20schema\x20t\
    hat\x20messages\x20published\x20should\x20be\n\x20validated\x20against.\
    \x20Format\x20is\x20`projects/{project}/schemas/{schema}`.\x20The\n\x20v\
    alue\x20of\x20this\x20field\x20will\x20be\x20`_deleted-schema_`\x20if\
    \x20the\x20schema\x20has\x20been\n\x20deleted.\n\n\r\n\x05\x04\x01\x02\0\
    \x05\x12\x04\xa2\x01\x02\x08\n\r\n\x05\x04\x01\x02\0\x01\x12\x04\xa2\x01\
    \t\x0f\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\xa2\x01\x12\x13\n\x0f\n\x05\
    \x04\x01\x02\0\x08\x12\x06\xa2\x01\x14\xa5\x01\x03\n\x10\n\x08\x04\x01\
    \x02\0\x08\x9c\x08\0\x12\x04\xa3\x01\x04*\n\x0f\n\x07\x04\x01\x02\0\x08\
    \x9f\x08\x12\x04\xa4\x01\x04N\nN\n\x04\x04\x01\x02\x01\x12\x04\xa8\x01\
    \x02A\x1a@\x20Optional.\x20The\x20encoding\x20of\x20messages\x20validate\
    d\x20against\x20`schema`.\n\n\r\n\x05\x04\x01\x02\x01\x06\x12\x04\xa8\
    \x01\x02\n\n\r\n\x05\x04\x01\x02\x01\x01\x12\x04\xa8\x01\x0b\x13\n\r\n\
    \x05\x04\x01\x02\x01\x03\x12\x04\xa8\x01\x16\x17\n\r\n\x05\x04\x01\x02\
    \x01\x08\x12\x04\xa8\x01\x18@\n\x10\n\x08\x04\x01\x02\x01\x08\x9c\x08\0\
    \x12\x04\xa8\x01\x19?\n\xd0\x01\n\x04\x04\x01\x02\x02\x12\x04\xad\x01\
    \x02H\x1a\xc1\x01\x20Optional.\x20The\x20minimum\x20(inclusive)\x20revis\
    ...
    \x20against\n\x20last_revision\x20or\x20any\x20revision\x20created\x20be\
    fore.\n\n\r\n\x05\x04\x01\x02\x02\x05\x12\x04\xad\x01\x02\x08\n\r\n\x05\
    \x04\x01\x02\x02\x01\x12\x04\xad\x01\t\x1a\n\r\n\x05\x04\x01\x02\x02\x03\
    \x12\x04\xad\x01\x1d\x1e\n\r\n\x05\x04\x01\x02\x02\x08\x12\x04\xad\x01\
    \x1fG\n\x10\n\x08\x04\x01\x02\x02\x08\x9c\x08\0\x12\x04\xad\x01\x20F\n\
    \xd0\x01\n\x04\x04\x01\x02\x03\x12\x04\xb2\x01\x02G\x1a\xc1\x01\x20Optio\
    nal.\x20The\x20maximum\x20(inclusive)\x20revision\x20allowed\x20for\x20v\
    alidating\x20messages.\n\x20If\x20empty\x20or\x20not\x20present,\x20allo\
    w\x20any\x20revision\x20to\x20be\x20validated\x20against\n\x20first_revi\
    sion\x20or\x20any\x20revision\x20created\x20after.\n\n\r\n\x05\x04\x01\
    \x02\x03\x05\x12\x04\xb2\x01\x02\x08\n\r\n\x05\x04\x01\x02\x03\x01\x12\
    \x04\xb2\x01\t\x19\n\r\n\x05\x04\x01\x02\x03\x03\x12\x04\xb2\x01\x1c\x1d\
    \n\r\n\x05\x04\x01\x02\x03\x08\x12\x04\xb2\x01\x1eF\n\x10\n\x08\x04\x01\
    \x02\x03\x08\x9c\x08\0\x12\x04\xb2\x01\x1fE\nA\n\x02\x04\x02\x12\x06\xb6\
    \x01\0\xf4\x01\x01\x1a3\x20Settings\x20for\x20an\x20ingestion\x20data\
    \x20source\x20on\x20a\x20topic.\n\n\x0b\n\x03\x04\x02\x01\x12\x04\xb6\
    \x01\x08#\nE\n\x04\x04\x02\x03\0\x12\x06\xb8\x01\x02\xed\x01\x03\x1a5\
    \x20Ingestion\x20settings\x20for\x20Amazon\x20Kinesis\x20Data\x20Streams\
    .\n\n\r\n\x05\x04\x02\x03\0\x01\x12\x04\xb8\x01\n\x14\nS\n\x06\x04\x02\
    \x03\0\x04\0\x12\x06\xba\x01\x04\xd6\x01\x05\x1aA\x20Possible\x20states\
    \x20for\x20ingestion\x20from\x20Amazon\x20Kinesis\x20Data\x20Streams.\n\
    \n\x0f\n\x07\x04\x02\x03\0\x04\0\x01\x12\x04\xba\x01\t\x0e\n8\n\x08\x04\
    \x02\x03\0\x04\0\x02\0\x12\x04\xbc\x01\x06\x1c\x1a&\x20Default\x20value.\
    \x20This\x20value\x20is\x20unused.\n\n\x11\n\t\x04\x02\x03\0\x04\0\x02\0\
    \x01\x12\x04\xbc\x01\x06\x17\n\x11\n\t\x04\x02\x03\0\x04\0\x02\0\x02\x12\
    \x04\xbc\x01\x1a\x1b\n(\n\x08\x04\x02\x03\0\x04\0\x02\x01\x12\x04\xbf\
    \x01\x06\x11\x1a\x16\x20Ingestion\x20is\x20active.\n\n\x11\n\t\x04\x02\
    \x03\0\x04\0\x02\x01\x01\x12\x04\xbf\x01\x06\x0c\n\x11\n\t\x04\x02\x03\0\
    \x04\0\x02\x01\x02\x12\x04\xbf\x01\x0f\x10\n\xc3\x03\n\x08\x04\x02\x03\0\
    \x04\0\x02\x02\x12\x04\xca\x01\x06$\x1a\xb0\x03\x20Permission\x20denied\
    \x20encountered\x20while\x20consuming\x20data\x20from\x20Kinesis.\n\x20T\
    his\x20can\x20happen\x20if:\n\x20\x20\x20-\x20The\x20provided\x20`aws_ro\
    le_arn`\x20does\x20not\x20exist\x20or\x20does\x20not\x20have\x20the\n\
    \x20\x20\x20\x20\x20appropriate\x20permissions\x20attached.\n\x20\x20\
    \x20-\x20The\x20provided\x20`aws_role_arn`\x20is\x20not\x20set\x20up\x20\
    properly\x20for\x20Identity\n\x20\x20\x20\x20\x20Federation\x20using\x20\
    `gcp_service_account`.\n\x20\x20\x20-\x20The\x20Pub/Sub\x20SA\x20is\x20n\
    ot\x20granted\x20the\n\x20\x20\x20\x20\x20`iam.serviceAccounts.getOpenId\
    Token`\x20permission\x20on\n\x20\x20\x20\x20\x20`gcp_service_account`.\n\
    \n\x11\n\t\x04\x02\x03\0\x04\0\x02\x02\x01\x12\x04\xca\x01\x06\x1f\n\x11\
    \n\t\x04\x02\x03\0\x04\0\x02\x02\x02\x12\x04\xca\x01\"#\n\xf6\x01\n\x08\
    \x04\x02\x03\0\x04\0\x02\x03\x12\x04\xcf\x01\x06$\x1a\xe3\x01\x20Permiss\
    ion\x20denied\x20encountered\x20while\x20publishing\x20to\x20the\x20topi\
    c.\x20This\x20can\n\x20happen\x20due\x20to\x20Pub/Sub\x20SA\x20has\x20no\
    t\x20been\x20granted\x20the\x20[appropriate\x20publish\n\x20permissions]\
    (https://cloud.google.com/pubsub/docs/access-control#pubsub.publisher)\n\
    \n\x11\n\t\x04\x02\x03\0\x04\0\x02\x03\x01\x12\x04\xcf\x01\x06\x1f\n\x11\
    \n\t\x04\x02\x03\0\x04\0\x02\x03\x02\x12\x04\xcf\x01\"#\n6\n\x08\x04\x02\
    \x03\0\x04\0\x02\x04\x12\x04\xd2\x01\x06\x1b\x1a$\x20The\x20Kinesis\x20s\
    tream\x20does\x20not\x20exist.\n\n\x11\n\t\x04\x02\x03\0\x04\0\x02\x04\
    \x01\x12\x04\xd2\x01\x06\x16\n\x11\n\t\x04\x02\x03\0\x04\0\x02\x04\x02\
    \x12\x04\xd2\x01\x19\x1a\n8\n\x08\x04\x02\x03\0\x04\0\x02\x05\x12\x04\
    \xd5\x01\x06\x1d\x1a&\x20The\x20Kinesis\x20consumer\x20does\x20not\x20ex\
    ist.\n\n\x11\n\t\x04\x02\x03\0\x04\0\x02\x05\x01\x12\x04\xd5\x01\x06\x18\
    \n\x11\n\t\x04\x02\x03\0\x04\0\x02\x05\x02\x12\x04\xd5\x01\x1b\x1c\nn\n\
    \x06\x04\x02\x03\0\x02\0\x12\x04\xda\x01\x04@\x1a^\x20Output\x20only.\
    \x20An\x20output-only\x20field\x20that\x20indicates\x20the\x20state\x20o\
    f\x20the\x20Kinesis\n\x20ingestion\x20source.\n\n\x0f\n\x07\x04\x02\x03\
    \0\x02\0\x06\x12\x04\xda\x01\x04\t\n\x0f\n\x07\x04\x02\x03\0\x02\0\x01\
    \x12\x04\xda\x01\n\x0f\n\x0f\n\x07\x04\x02\x03\0\x02\0\x03\x12\x04\xda\
    \x01\x12\x13\n\x0f\n\x07\x04\x02\x03\0\x02\0\x08\x12\x04\xda\x01\x14?\n\
    \x12\n\n\x04\x02\x03\0\x02\0\x08\x9c\x08\0\x12\x04\xda\x01\x15>\nG\n\x06\
    \x04\x02\x03\0\x02\x01\x12\x04\xdd\x01\x04C\x1a7\x20Required.\x20The\x20\
    Kinesis\x20stream\x20ARN\x20to\x20ingest\x20data\x20from.\n\n\x0f\n\x07\
    \x04\x02\x03\0\x02\x01\x05\x12\x04\xdd\x01\x04\n\n\x0f\n\x07\x04\x02\x03\
    \0\x02\x01\x01\x12\x04\xdd\x01\x0b\x15\n\x0f\n\x07\x04\x02\x03\0\x02\x01\
    \x03\x12\x04\xdd\x01\x18\x19\n\x0f\n\x07\x04\x02\x03\0\x02\x01\x08\x12\
    \x04\xdd\x01\x1aB\n\x12\n\n\x04\x02\x03\0\x02\x01\x08\x9c\x08\0\x12\x04\
    \xdd\x01\x1bA\n\xa1\x01\n\x06\x04\x02\x03\0\x02\x02\x12\x04\xe1\x01\x04E\
    \x1a\x90\x01\x20Required.\x20The\x20Kinesis\x20consumer\x20ARN\x20to\x20\
    used\x20for\x20ingestion\x20in\x20Enhanced\n\x20Fan-Out\x20mode.\x20The\
    \x20consumer\x20must\x20be\x20already\x20created\x20and\x20ready\x20to\
    \x20be\x20used.\n\n\x0f\n\x07\x04\x02\x03\0\x02\x02\x05\x12\x04\xe1\x01\
    \x04\n\n\x0f\n\x07\x04\x02\x03\0\x02\x02\x01\x12\x04\xe1\x01\x0b\x17\n\
    \x0f\n\x07\x04\x02\x03\0\x02\x02\x03\x12\x04\xe1\x01\x1a\x1b\n\x0f\n\x07\
    \x04\x02\x03\0\x02\x02\x08\x12\x04\xe1\x01\x1cD\n\x12\n\n\x04\x02\x03\0\
    \x02\x02\x08\x9c\x08\0\x12\x04\xe1\x01\x1dC\n\xda\x01\n\x06\x04\x02\x03\
    \0\x02\x03\x12\x04\xe6\x01\x04E\x1a\xc9\x01\x20Required.\x20AWS\x20role\
    \x20ARN\x20to\x20be\x20used\x20for\x20Federated\x20Identity\x20authentic\
    ation\n\x20with\x20Kinesis.\x20Check\x20the\x20Pub/Sub\x20docs\x20for\
    \x20how\x20to\x20set\x20up\x20this\x20role\x20and\x20the\n\x20required\
    \x20permissions\x20that\x20need\x20to\x20be\x20attached\x20to\x20it.\n\n\
    \x0f\n\x07\x04\x02\x03\0\x02\x03\x05\x12\x04\xe6\x01\x04\n\n\x0f\n\x07\
    \x04\x02\x03\0\x02\x03\x01\x12\x04\xe6\x01\x0b\x17\n\x0f\n\x07\x04\x02\
    \x03\0\x02\x03\x03\x12\x04\xe6\x01\x1a\x1b\n\x0f\n\x07\x04\x02\x03\0\x02\
    \x03\x08\x12\x04\xe6\x01\x1cD\n\x12\n\n\x04\x02\x03\0\x02\x03\x08\x9c\
    \x08\0\x12\x04\xe6\x01\x1dC\n\x9d\x02\n\x06\x04\x02\x03\0\x02\x04\x12\
    \x04\xec\x01\x04L\x1a\x8c\x02\x20Required.\x20The\x20GCP\x20service\x20a\
    ccount\x20to\x20be\x20used\x20for\x20Federated\x20Identity\n\x20authenti\
    cation\x20with\x20Kinesis\x20(via\x20a\x20`AssumeRoleWithWebIdentity`\
    \x20call\x20for\n\x20the\x20provided\x20role).\x20The\x20`aws_role_arn`\
    \x20must\x20be\x20set\x20up\x20with\n\x20`accounts.google.com:sub`\x20eq\
    uals\x20to\x20this\x20service\x20account\x20number.\n\n\x0f\n\x07\x04\
    \x02\x03\0\x02\x04\x05\x12\x04\xec\x01\x04\n\n\x0f\n\x07\x04\x02\x03\0\
    \x02\x04\x01\x12\x04\xec\x01\x0b\x1e\n\x0f\n\x07\x04\x02\x03\0\x02\x04\
    \x03\x12\x04\xec\x01!\"\n\x0f\n\x07\x04\x02\x03\0\x02\x04\x08\x12\x04\
    \xec\x01#K\n\x12\n\n\x04\x02\x03\0\x02\x04\x08\x9c\x08\0\x12\x04\xec\x01\
    $J\n=\n\x04\x04\x02\x08\0\x12\x06\xf0\x01\x02\xf3\x01\x03\x1a-\x20Only\
    \x20one\x20source\x20type\x20can\x20have\x20settings\x20set.\n\n\r\n\x05\
    \x04\x02\x08\0\x01\x12\x04\xf0\x01\x08\x0e\n6\n\x04\x04\x02\x02\0\x12\
    \x04\xf2\x01\x04H\x1a(\x20Optional.\x20Amazon\x20Kinesis\x20Data\x20Stre\
    ams.\n\n\r\n\x05\x04\x02\x02\0\x06\x12\x04\xf2\x01\x04\x0e\n\r\n\x05\x04\
    \x02\x02\0\x01\x12\x04\xf2\x01\x0f\x1a\n\r\n\x05\x04\x02\x02\0\x03\x12\
    \x04\xf2\x01\x1d\x1e\n\r\n\x05\x04\x02\x02\0\x08\x12\x04\xf2\x01\x1fG\n\
    \x10\n\x08\x04\x02\x02\0\x08\x9c\x08\0\x12\x04\xf2\x01\x20F\n!\n\x02\x04\
    \x03\x12\x06\xf7\x01\0\xbd\x02\x01\x1a\x13\x20A\x20topic\x20resource.\n\
    \n\x0b\n\x03\x04\x03\x01\x12\x04\xf7\x01\x08\r\n\r\n\x03\x04\x03\x07\x12\
    \x06\xf8\x01\x02\xfc\x01\x04\n\x0f\n\x05\x04\x03\x07\x9d\x08\x12\x06\xf8\
    \x01\x02\xfc\x01\x04\n)\n\x04\x04\x03\x04\0\x12\x06\xff\x01\x02\x8a\x02\
    \x03\x1a\x19\x20The\x20state\x20of\x20the\x20topic.\n\n\r\n\x05\x04\x03\
    \x04\0\x01\x12\x04\xff\x01\x07\x0c\n6\n\x06\x04\x03\x04\0\x02\0\x12\x04\
    \x81\x02\x04\x1a\x1a&\x20Default\x20value.\x20This\x20value\x20is\x20unu\
    sed.\n\n\x0f\n\x07\x04\x03\x04\0\x02\0\x01\x12\x04\x81\x02\x04\x15\n\x0f\
    \n\x07\x04\x03\x04\0\x02\0\x02\x12\x04\x81\x02\x18\x19\n@\n\x06\x04\x03\
    \x04\0\x02\x01\x12\x04\x84\x02\x04\x0f\x1a0\x20The\x20topic\x20does\x20n\
    ot\x20have\x20any\x20persistent\x20errors.\n\n\x0f\n\x07\x04\x03\x04\0\
    \x02\x01\x01\x12\x04\x84\x02\x04\n\n\x0f\n\x07\x04\x03\x04\0\x02\x01\x02\
    \x12\x04\x84\x02\r\x0e\n\xad\x01\n\x06\x04\x03\x04\0\x02\x02\x12\x04\x89\
    \x02\x04!\x1a\x9c\x01\x20Ingestion\x20from\x20the\x20data\x20source\x20h\
    as\x20encountered\x20a\x20permanent\x20error.\n\x20See\x20the\x20more\
    \x20detailed\x20error\x20state\x20in\x20the\x20corresponding\x20ingestio\
    n\n\x20source\x20configuration.\n\n\x0f\n\x07\x04\x03\x04\0\x02\x02\x01\
    \x12\x04\x89\x02\x04\x1c\n\x0f\n\x07\x04\x03\x04\0\x02\x02\x02\x12\x04\
    \x89\x02\x1f\x20\n\x8c\x03\n\x04\x04\x03\x02\0\x12\x04\x92\x02\x02;\x1a\
    \xfd\x02\x20Required.\x20The\x20name\x20of\x20the\x20topic.\x20It\x20mus\
    t\x20have\x20the\x20format\n\x20`\"projects/{project}/topics/{topic}\"`.\
    \x20`{topic}`\x20must\x20start\x20with\x20a\x20letter,\n\x20and\x20conta\
    in\x20only\x20letters\x20(`[A-Za-z]`),\x20numbers\x20(`[0-9]`),\x20dashe\
    s\x20(`-`),\n\x20underscores\x20(`_`),\x20periods\x20(`.`),\x20tildes\
    \x20(`~`),\x20plus\x20(`+`)\x20or\x20percent\n\x20signs\x20(`%`).\x20It\
    \x20must\x20be\x20between\x203\x20and\x20255\x20characters\x20in\x20leng\
    th,\x20and\x20it\n\x20must\x20not\x20start\x20with\x20`\"goog\"`.\n\n\r\
    \n\x05\x04\x03\x02\0\x05\x12\x04\x92\x02\x02\x08\n\r\n\x05\x04\x03\x02\0\
    \x01\x12\x04\x92\x02\t\r\n\r\n\x05\x04\x03\x02\0\x03\x12\x04\x92\x02\x10\
    \x11\n\r\n\x05\x04\x03\x02\0\x08\x12\x04\x92\x02\x12:\n\x10\n\x08\x04\
    \x03\x02\0\x08\x9c\x08\0\x12\x04\x92\x02\x139\nl\n\x04\x04\x03\x02\x01\
    \x12\x04\x96\x02\x02J\x1a^\x20Optional.\x20See\x20[Creating\x20and\x20ma\
    naging\x20labels]\n\x20(https://cloud.google.com/pubsub/docs/labels).\n\
    \n\r\n\x05\x04\x03\x02\x01\x06\x12\x04\x96\x02\x02\x15\n\r\n\x05\x04\x03\
    \x02\x01\x01\x12\x04\x96\x02\x16\x1c\n\r\n\x05\x04\x03\x02\x01\x03\x12\
    \x04\x96\x02\x1f\x20\n\r\n\x05\x04\x03\x02\x01\x08\x12\x04\x96\x02!I\n\
    \x10\n\x08\x04\x03\x02\x01\x08\x9c\x08\0\x12\x04\x96\x02\"H\n\xc3\x01\n\
    \x04\x04\x03\x02\x02\x12\x06\x9b\x02\x02\x9c\x02/\x1a\xb2\x01\x20Optiona\
    l.\x20Policy\x20constraining\x20the\x20set\x20of\x20Google\x20Cloud\x20P\
    latform\x20regions\n\x20where\x20messages\x20published\x20to\x20the\x20t\
    opic\x20may\x20be\x20stored.\x20If\x20not\x20present,\x20then\n\x20no\
    \x20constraints\x20are\x20in\x20effect.\n\n\r\n\x05\x04\x03\x02\x02\x06\
    \x12\x04\x9b\x02\x02\x16\n\r\n\x05\x04\x03\x02\x02\x01\x12\x04\x9b\x02\
    \x17-\n\r\n\x05\x04\x03\x02\x02\x03\x12\x04\x9b\x0201\n\r\n\x05\x04\x03\
    \x02\x02\x08\x12\x04\x9c\x02\x06.\n\x10\n\x08\x04\x03\x02\x02\x08\x9c\
    \x08\0\x12\x04\x9c\x02\x07-\n\xd5\x01\n\x04\x04\x03\x02\x03\x12\x04\xa2\
    \x02\x02C\x1a\xc6\x01\x20Optional.\x20The\x20resource\x20name\x20of\x20t\
    he\x20Cloud\x20KMS\x20CryptoKey\x20to\x20be\x20used\x20to\n\x20protect\
    \x20access\x20to\x20messages\x20published\x20on\x20this\x20topic.\n\n\
    \x20The\x20expected\x20format\x20is\x20`projects/*/locations/*/keyRings/\
    */cryptoKeys/*`.\n\n\r\n\x05\x04\x03\x02\x03\x05\x12\x04\xa2\x02\x02\x08\
    \n\r\n\x05\x04\x03\x02\x03\x01\x12\x04\xa2\x02\t\x15\n\r\n\x05\x04\x03\
    \x02\x03\x03\x12\x04\xa2\x02\x18\x19\n\r\n\x05\x04\x03\x02\x03\x08\x12\
    \x04\xa2\x02\x1aB\n\x10\n\x08\x04\x03\x02\x03\x08\x9c\x08\0\x12\x04\xa2\
    \x02\x1bA\nV\n\x04\x04\x03\x02\x04\x12\x04\xa5\x02\x02N\x1aH\x20Optional\
    .\x20Settings\x20for\x20validating\x20messages\x20published\x20against\
    \x20a\x20schema.\n\n\r\n\x05\x04\x03\x02\x04\x06\x12\x04\xa5\x02\x02\x10\
    \n\r\n\x05\x04\x03\x02\x04\x01\x12\x04\xa5\x02\x11\x20\n\r\n\x05\x04\x03\
    \x02\x04\x03\x12\x04\xa5\x02#$\n\r\n\x05\x04\x03\x02\x04\x08\x12\x04\xa5\
    \x02%M\n\x10\n\x08\x04\x03\x02\x04\x08\x9c\x08\0\x12\x04\xa5\x02&L\n\x95\
    \x01\n\x04\x04\x03\x02\x05\x12\x04\xa9\x02\x02B\x1a\x86\x01\x20Optional.\
    \x20Reserved\x20for\x20future\x20use.\x20This\x20field\x20is\x20set\x20o\
    nly\x20in\x20responses\x20from\n\x20the\x20server;\x20it\x20is\x20ignore\
    d\x20if\x20it\x20is\x20set\x20in\x20any\x20requests.\n\n\r\n\x05\x04\x03\
    \x02\x05\x05\x12\x04\xa9\x02\x02\x06\n\r\n\x05\x04\x03\x02\x05\x01\x12\
    \x04\xa9\x02\x07\x14\n\r\n\x05\x04\x03\x02\x05\x03\x12\x04\xa9\x02\x17\
    \x18\n\r\n\x05\x04\x03\x02\x05\x08\x12\x04\xa9\x02\x19A\n\x10\n\x08\x04\
    \x03\x02\x05\x08\x9c\x08\0\x12\x04\xa9\x02\x1a@\n\xdf\x04\n\x04\x04\x03\
    \x02\x06\x12\x06\xb4\x02\x02\xb5\x02/\x1a\xce\x04\x20Optional.\x20Indica\
    tes\x20the\x20minimum\x20duration\x20to\x20retain\x20a\x20message\x20aft\
    er\x20it\x20is\n\x20published\x20to\x20the\x20topic.\x20If\x20this\x20fi\
    eld\x20is\x20set,\x20messages\x20published\x20to\x20the\n\x20topic\x20in\
    \x20the\x20last\x20`message_retention_duration`\x20are\x20always\x20avai\
    lable\x20to\n\x20subscribers.\x20For\x20instance,\x20it\x20allows\x20any\
    \x20attached\x20subscription\x20to\x20[seek\x20to\n\x20a\n\x20timestamp]\
    (https://cloud.google.com/pubsub/docs/replay-overview#seek_to_a_time)\n\
    \x20that\x20is\x20up\x20to\x20`message_retention_duration`\x20in\x20the\
    \x20past.\x20If\x20this\x20field\x20is\n\x20not\x20set,\x20message\x20re\
    tention\x20is\x20controlled\x20by\x20settings\x20on\x20individual\n\x20s\
    ubscriptions.\x20Cannot\x20be\x20more\x20than\x2031\x20days\x20or\x20les\
    s\x20than\x2010\x20minutes.\n\n\r\n\x05\x04\x03\x02\x06\x06\x12\x04\xb4\
    \x02\x02\x1a\n\r\n\x05\x04\x03\x02\x06\x01\x12\x04\xb4\x02\x1b5\n\r\n\
    \x05\x04\x03\x02\x06\x03\x12\x04\xb4\x0289\n\r\n\x05\x04\x03\x02\x06\x08\
    \x12\x04\xb5\x02\x06.\n\x10\n\x08\x04\x03\x02\x06\x08\x9c\x08\0\x12\x04\
    \xb5\x02\x07-\nT\n\x04\x04\x03\x02\x07\x12\x04\xb8\x02\x02>\x1aF\x20Outp\
    ut\x20only.\x20An\x20output-only\x20field\x20indicating\x20the\x20state\
    \x20of\x20the\x20topic.\n\n\r\n\x05\x04\x03\x02\x07\x06\x12\x04\xb8\x02\
    \x02\x07\n\r\n\x05\x04\x03\x02\x07\x01\x12\x04\xb8\x02\x08\r\n\r\n\x05\
    \x04\x03\x02\x07\x03\x12\x04\xb8\x02\x10\x11\n\r\n\x05\x04\x03\x02\x07\
    \x08\x12\x04\xb8\x02\x12=\n\x10\n\x08\x04\x03\x02\x07\x08\x9c\x08\0\x12\
    \x04\xb8\x02\x13<\nV\n\x04\x04\x03\x02\x08\x12\x06\xbb\x02\x02\xbc\x02/\
    \x1aF\x20Optional.\x20Settings\x20for\x20ingestion\x20from\x20a\x20data\
    \x20source\x20into\x20this\x20topic.\n\n\r\n\x05\x04\x03\x02\x08\x06\x12\
    \x04\xbb\x02\x02\x1d\n\r\n\x05\x04\x03\x02\x08\x01\x12\x04\xbb\x02\x1e<\
    \n\r\n\x05\x04\x03\x02\x08\x03\x12\x04\xbb\x02?A\n\r\n\x05\x04\x03\x02\
    \x08\x08\x12\x04\xbc\x02\x06.\n\x10\n\x08\x04\x03\x02\x08\x08\x9c\x08\0\
    \x12\x04\xbc\x02\x07-\n\xf9\x03\n\x02\x04\x04\x12\x06\xc7\x02\0\xe5\x02\
    \x01\x1a\xea\x03\x20A\x20message\x20that\x20is\x20published\x20by\x20pub\
    lishers\x20and\x20consumed\x20by\x20subscribers.\x20The\n\x20message\x20\
    must\x20contain\x20either\x20a\x20non-empty\x20data\x20field\x20or\x20at\
    \x20least\x20one\x20attribute.\n\x20Note\x20that\x20client\x20libraries\
    \x20represent\x20this\x20object\x20differently\n\x20depending\x20on\x20t\
    he\x20language.\x20See\x20the\x20corresponding\x20[client\x20library\n\
    \x20documentation](https://cloud.google.com/pubsub/docs/reference/librar\
    ies)\x20for\n\x20more\x20information.\x20See\x20[quotas\x20and\x20limits\
    ]\n\x20(https://cloud.google.com/pubsub/quotas)\x20for\x20more\x20inform\
    ation\x20about\x20message\n\x20limits.\n\n\x0b\n\x03\x04\x04\x01\x12\x04\
    \xc7\x02\x08\x15\n{\n\x04\x04\x04\x02\0\x12\x04\xca\x02\x02:\x1am\x20Opt\
    ional.\x20The\x20message\x20data\x20field.\x20If\x20this\x20field\x20is\
    \x20empty,\x20the\x20message\x20must\n\x20contain\x20at\x20least\x20one\
    \x20attribute.\n\n\r\n\x05\x04\x04\x02\0\x05\x12\x04\xca\x02\x02\x07\n\r\
    \n\x05\x04\x04\x02\0\x01\x12\x04\xca\x02\x08\x0c\n\r\n\x05\x04\x04\x02\0\
    \x03\x12\x04\xca\x02\x0f\x10\n\r\n\x05\x04\x04\x02\0\x08\x12\x04\xca\x02\
    \x119\n\x10\n\x08\x04\x04\x02\0\x08\x9c\x08\0\x12\x04\xca\x02\x128\n\xb3\
    \x01\n\x04\x04\x04\x02\x01\x12\x04\xcf\x02\x02N\x1a\xa4\x01\x20Optional.\
    \x20Attributes\x20for\x20this\x20message.\x20If\x20this\x20field\x20is\
    \x20empty,\x20the\x20message\n\x20must\x20contain\x20non-empty\x20data.\
    \x20This\x20can\x20be\x20used\x20to\x20filter\x20messages\x20on\x20the\n\
    \x20subscription.\n\n\r\n\x05\x04\x04\x02\x01\x06\x12\x04\xcf\x02\x02\
    \x15\n\r\n\x05\x04\x04\x02\x01\x01\x12\x04\xcf\x02\x16\x20\n\r\n\x05\x04\
    \x04\x02\x01\x03\x12\x04\xcf\x02#$\n\r\n\x05\x04\x04\x02\x01\x08\x12\x04\
    \xcf\x02%M\n\x10\n\x08\x04\x04\x02\x01\x08\x9c\x08\0\x12\x04\xcf\x02&L\n\
    \xb3\x02\n\x04\x04\x04\x02\x02\x12\x04\xd5\x02\x02\x18\x1a\xa4\x02\x20ID\
    \x20of\x20this\x20message,\x20assigned\x20by\x20the\x20server\x20when\
    ...
    \x20`Publish`\x20call.\n\n\r\n\x05\x04\x04\x02\x02\x05\x12\x04\xd5\x02\
    \x02\x08\n\r\n\x05\x04\x04\x02\x02\x01\x12\x04\xd5\x02\t\x13\n\r\n\x05\
    \x04\x04\x02\x02\x03\x12\x04\xd5\x02\x16\x17\n\xbb\x01\n\x04\x04\x04\x02\
    \x03\x12\x04\xda\x02\x02-\x1a\xac\x01\x20The\x20time\x20at\x20which\x20t\
    ...
    blish`\x20call.\n\n\r\n\x05\x04\x04\x02\x03\x06\x12\x04\xda\x02\x02\x1b\
    \n\r\n\x05\x04\x04\x02\x03\x01\x12\x04\xda\x02\x1c(\n\r\n\x05\x04\x04\
    \x02\x03\x03\x12\x04\xda\x02+,\n\x9e\x04\n\x04\x04\x04\x02\x04\x12\x04\
    \xe4\x02\x02C\x1a\x8f\x04\x20Optional.\x20If\x20non-empty,\x20identifies\
    \x20related\x20messages\x20for\x20which\x20publish\x20order\n\x20should\
    \x20be\x20respected.\x20If\x20a\x20`Subscription`\x20has\x20`enable_mess\
    age_ordering`\x20set\n\x20to\x20`true`,\x20messages\x20published\x20with\
    \x20the\x20same\x20non-empty\x20`ordering_key`\x20value\n\x20will\x20be\
    \x20delivered\x20to\x20subscribers\x20in\x20the\x20order\x20in\x20which\
    \x20they\x20are\x20received\x20by\n\x20the\x20Pub/Sub\x20system.\x20All\
    \x20`PubsubMessage`s\x20published\x20in\x20a\x20given\n\x20`PublishReque\
    st`\x20must\x20specify\x20the\x20same\x20`ordering_key`\x20value.\x20For\
    \x20more\n\x20information,\x20see\x20[ordering\n\x20messages](https://cl\
    oud.google.com/pubsub/docs/ordering).\n\n\r\n\x05\x04\x04\x02\x04\x05\
    \x12\x04\xe4\x02\x02\x08\n\r\n\x05\x04\x04\x02\x04\x01\x12\x04\xe4\x02\t\
    \x15\n\r\n\x05\x04\x04\x02\x04\x03\x12\x04\xe4\x02\x18\x19\n\r\n\x05\x04\
    \x04\x02\x04\x08\x12\x04\xe4\x02\x1aB\n\x10\n\x08\x04\x04\x02\x04\x08\
    \x9c\x08\0\x12\x04\xe4\x02\x1bA\n0\n\x02\x04\x05\x12\x06\xe8\x02\0\xef\
    \x02\x01\x1a\"\x20Request\x20for\x20the\x20GetTopic\x20method.\n\n\x0b\n\
    \x03\x04\x05\x01\x12\x04\xe8\x02\x08\x17\ni\n\x04\x04\x05\x02\0\x12\x06\
    \xeb\x02\x02\xee\x02\x04\x1aY\x20Required.\x20The\x20name\x20of\x20the\
    \x20topic\x20to\x20get.\n\x20Format\x20is\x20`projects/{project}/topics/\
    {topic}`.\n\n\r\n\x05\x04\x05\x02\0\x05\x12\x04\xeb\x02\x02\x08\n\r\n\
    \x05\x04\x05\x02\0\x01\x12\x04\xeb\x02\t\x0e\n\r\n\x05\x04\x05\x02\0\x03\
    \x12\x04\xeb\x02\x11\x12\n\x0f\n\x05\x04\x05\x02\0\x08\x12\x06\xeb\x02\
    \x13\xee\x02\x03\n\x10\n\x08\x04\x05\x02\0\x08\x9c\x08\0\x12\x04\xec\x02\
    \x04*\n\x0f\n\x07\x04\x05\x02\0\x08\x9f\x08\x12\x04\xed\x02\x04M\n3\n\
    \x02\x04\x06\x12\x06\xf2\x02\0\xfd\x02\x01\x1a%\x20Request\x20for\x20the\
    \x20UpdateTopic\x20method.\n\n\x0b\n\x03\x04\x06\x01\x12\x04\xf2\x02\x08\
    \x1a\n3\n\x04\x04\x06\x02\0\x12\x04\xf4\x02\x02;\x1a%\x20Required.\x20Th\
    e\x20updated\x20topic\x20object.\n\n\r\n\x05\x04\x06\x02\0\x06\x12\x04\
    \xf4\x02\x02\x07\n\r\n\x05\x04\x06\x02\0\x01\x12\x04\xf4\x02\x08\r\n\r\n\
    \x05\x04\x06\x02\0\x03\x12\x04\xf4\x02\x10\x11\n\r\n\x05\x04\x06\x02\0\
    \x08\x12\x04\xf4\x02\x12:\n\x10\n\x08\x04\x06\x02\0\x08\x9c\x08\0\x12\
    \x04\xf4\x02\x139\n\xe5\x02\n\x04\x04\x06\x02\x01\x12\x06\xfb\x02\x02\
    \xfc\x02/\x1a\xd4\x02\x20Required.\x20Indicates\x20which\x20fields\x20in\
    ...
    \x20level.\n\n\r\n\x05\x04\x06\x02\x01\x06\x12\x04\xfb\x02\x02\x1b\n\r\n\
    \x05\x04\x06\x02\x01\x01\x12\x04\xfb\x02\x1c'\n\r\n\x05\x04\x06\x02\x01\
    \x03\x12\x04\xfb\x02*+\n\r\n\x05\x04\x06\x02\x01\x08\x12\x04\xfc\x02\x06\
    .\n\x10\n\x08\x04\x06\x02\x01\x08\x9c\x08\0\x12\x04\xfc\x02\x07-\n/\n\
    \x02\x04\x07\x12\x06\x80\x03\0\x8a\x03\x01\x1a!\x20Request\x20for\x20the\
    \x20Publish\x20method.\n\n\x0b\n\x03\x04\x07\x01\x12\x04\x80\x03\x08\x16\
    \n\x88\x01\n\x04\x04\x07\x02\0\x12\x06\x83\x03\x02\x86\x03\x04\x1ax\x20R\
    ...
    topics/{topic}`.\n\n\r\n\x05\x04\x07\x02\0\x05\x12\x04\x83\x03\x02\x08\n\
    \r\n\x05\x04\x07\x02\0\x01\x12\x04\x83\x03\t\x0e\n\r\n\x05\x04\x07\x02\0\
    \x03\x12\x04\x83\x03\x11\x12\n\x0f\n\x05\x04\x07\x02\0\x08\x12\x06\x83\
    \x03\x13\x86\x03\x03\n\x10\n\x08\x04\x07\x02\0\x08\x9c\x08\0\x12\x04\x84\
    \x03\x04*\n\x0f\n\x07\x04\x07\x02\0\x08\x9f\x08\x12\x04\x85\x03\x04M\n2\
    \n\x04\x04\x07\x02\x01\x12\x04\x89\x03\x02O\x1a$\x20Required.\x20The\x20\
    messages\x20to\x20publish.\n\n\r\n\x05\x04\x07\x02\x01\x04\x12\x04\x89\
    \x03\x02\n\n\r\n\x05\x04\x07\x02\x01\x06\x12\x04\x89\x03\x0b\x18\n\r\n\
    \x05\x04\x07\x02\x01\x01\x12\x04\x89\x03\x19!\n\r\n\x05\x04\x07\x02\x01\
    \x03\x12\x04\x89\x03$%\n\r\n\x05\x04\x07\x02\x01\x08\x12\x04\x89\x03&N\n\
    \x10\n\x08\x04\x07\x02\x01\x08\x9c\x08\0\x12\x04\x89\x03'M\n2\n\x02\x04\
    \x08\x12\x06\x8d\x03\0\x92\x03\x01\x1a$\x20Response\x20for\x20the\x20`Pu\
    blish`\x20method.\n\n\x0b\n\x03\x04\x08\x01\x12\x04\x8d\x03\x08\x17\n\
    \xb2\x01\n\x04\x04\x08\x02\0\x12\x04\x91\x03\x02K\x1a\xa3\x01\x20Optiona\
    ...
    in\x20the\x20topic.\n\n\r\n\x05\x04\x08\x02\0\x04\x12\x04\x91\x03\x02\n\
    \n\r\n\x05\x04\x08\x02\0\x05\x12\x04\x91\x03\x0b\x11\n\r\n\x05\x04\x08\
    \x02\0\x01\x12\x04\x91\x03\x12\x1d\n\r\n\x05\x04\x08\x02\0\x03\x12\x04\
    \x91\x03\x20!\n\r\n\x05\x04\x08\x02\0\x08\x12\x04\x91\x03\"J\n\x10\n\x08\
    \x04\x08\x02\0\x08\x9c\x08\0\x12\x04\x91\x03#I\n4\n\x02\x04\t\x12\x06\
    \x95\x03\0\xa6\x03\x01\x1a&\x20Request\x20for\x20the\x20`ListTopics`\x20\
    method.\n\n\x0b\n\x03\x04\t\x01\x12\x04\x95\x03\x08\x19\np\n\x04\x04\t\
    \x02\0\x12\x06\x98\x03\x02\x9d\x03\x04\x1a`\x20Required.\x20The\x20name\
    \x20of\x20the\x20project\x20in\x20which\x20to\x20list\x20topics.\n\x20Fo\
    rmat\x20is\x20`projects/{project-id}`.\n\n\r\n\x05\x04\t\x02\0\x05\x12\
    \x04\x98\x03\x02\x08\n\r\n\x05\x04\t\x02\0\x01\x12\x04\x98\x03\t\x10\n\r\
    \n\x05\x04\t\x02\0\x03\x12\x04\x98\x03\x13\x14\n\x0f\n\x05\x04\t\x02\0\
    \x08\x12\x06\x98\x03\x15\x9d\x03\x03\n\x10\n\x08\x04\t\x02\0\x08\x9c\x08\
    \0\x12\x04\x99\x03\x04*\n\x11\n\x07\x04\t\x02\0\x08\x9f\x08\x12\x06\x9a\
    \x03\x04\x9c\x03\x05\n=\n\x04\x04\t\x02\x01\x12\x04\xa0\x03\x02?\x1a/\
    \x20Optional.\x20Maximum\x20number\x20of\x20topics\x20to\x20return.\n\n\
    \r\n\x05\x04\t\x02\x01\x05\x12\x04\xa0\x03\x02\x07\n\r\n\x05\x04\t\x02\
    \x01\x01\x12\x04\xa0\x03\x08\x11\n\r\n\x05\x04\t\x02\x01\x03\x12\x04\xa0\
    \x03\x14\x15\n\r\n\x05\x04\t\x02\x01\x08\x12\x04\xa0\x03\x16>\n\x10\n\
    \x08\x04\t\x02\x01\x08\x9c\x08\0\x12\x04\xa0\x03\x17=\n\xce\x01\n\x04\
    \x04\t\x02\x02\x12\x04\xa5\x03\x02A\x1a\xbf\x01\x20Optional.\x20The\x20v\
    alue\x20returned\x20by\x20the\x20last\x20`ListTopicsResponse`;\x20indica\
    tes\n\x20that\x20this\x20is\x20a\x20continuation\x20of\x20a\x20prior\x20\
    `ListTopics`\x20call,\x20and\x20that\x20the\n\x20system\x20should\x20ret\
    urn\x20the\x20next\x20page\x20of\x20data.\n\n\r\n\x05\x04\t\x02\x02\x05\
    \x12\x04\xa5\x03\x02\x08\n\r\n\x05\x04\t\x02\x02\x01\x12\x04\xa5\x03\t\
    \x13\n\r\n\x05\x04\t\x02\x02\x03\x12\x04\xa5\x03\x16\x17\n\r\n\x05\x04\t\
    \x02\x02\x08\x12\x04\xa5\x03\x18@\n\x10\n\x08\x04\t\x02\x02\x08\x9c\x08\
    \0\x12\x04\xa5\x03\x19?\n5\n\x02\x04\n\x12\x06\xa9\x03\0\xb0\x03\x01\x1a\
    '\x20Response\x20for\x20the\x20`ListTopics`\x20method.\n\n\x0b\n\x03\x04\
    \n\x01\x12\x04\xa9\x03\x08\x1a\n/\n\x04\x04\n\x02\0\x12\x04\xab\x03\x02E\
    \x1a!\x20Optional.\x20The\x20resulting\x20topics.\n\n\r\n\x05\x04\n\x02\
    \0\x04\x12\x04\xab\x03\x02\n\n\r\n\x05\x04\n\x02\0\x06\x12\x04\xab\x03\
    \x0b\x10\n\r\n\x05\x04\n\x02\0\x01\x12\x04\xab\x03\x11\x17\n\r\n\x05\x04\
    \n\x02\0\x03\x12\x04\xab\x03\x1a\x1b\n\r\n\x05\x04\n\x02\0\x08\x12\x04\
    \xab\x03\x1cD\n\x10\n\x08\x04\n\x02\0\x08\x9c\x08\0\x12\x04\xab\x03\x1dC\
    \n\xa3\x01\n\x04\x04\n\x02\x01\x12\x04\xaf\x03\x02F\x1a\x94\x01\x20Optio\
    nal.\x20If\x20not\x20empty,\x20indicates\x20that\x20there\x20may\x20be\
    \x20more\x20topics\x20that\x20match\n\x20the\x20request;\x20this\x20valu\
    e\x20should\x20be\x20passed\x20in\x20a\x20new\x20`ListTopicsRequest`.\n\
    \n\r\n\x05\x04\n\x02\x01\x05\x12\x04\xaf\x03\x02\x08\n\r\n\x05\x04\n\x02\
    \x01\x01\x12\x04\xaf\x03\t\x18\n\r\n\x05\x04\n\x02\x01\x03\x12\x04\xaf\
    \x03\x1b\x1c\n\r\n\x05\x04\n\x02\x01\x08\x12\x04\xaf\x03\x1dE\n\x10\n\
    \x08\x04\n\x02\x01\x08\x9c\x08\0\x12\x04\xaf\x03\x1eD\n@\n\x02\x04\x0b\
    \x12\x06\xb3\x03\0\xc2\x03\x01\x1a2\x20Request\x20for\x20the\x20`ListTop\
    icSubscriptions`\x20method.\n\n\x0b\n\x03\x04\x0b\x01\x12\x04\xb3\x03\
    \x08%\n\x85\x01\n\x04\x04\x0b\x02\0\x12\x06\xb6\x03\x02\xb9\x03\x04\x1au\
    ...
    opics/{topic}`.\n\n\r\n\x05\x04\x0b\x02\0\x05\x12\x04\xb6\x03\x02\x08\n\
    \r\n\x05\x04\x0b\x02\0\x01\x12\x04\xb6\x03\t\x0e\n\r\n\x05\x04\x0b\x02\0\
    \x03\x12\x04\xb6\x03\x11\x12\n\x0f\n\x05\x04\x0b\x02\0\x08\x12\x06\xb6\
    \x03\x13\xb9\x03\x03\n\x10\n\x08\x04\x0b\x02\0\x08\x9c\x08\0\x12\x04\xb7\
    \x03\x04*\n\x0f\n\x07\x04\x0b\x02\0\x08\x9f\x08\x12\x04\xb8\x03\x04M\nI\
    \n\x04\x04\x0b\x02\x01\x12\x04\xbc\x03\x02?\x1a;\x20Optional.\x20Maximum\
    \x20number\x20of\x20subscription\x20names\x20to\x20return.\n\n\r\n\x05\
    \x04\x0b\x02\x01\x05\x12\x04\xbc\x03\x02\x07\n\r\n\x05\x04\x0b\x02\x01\
    \x01\x12\x04\xbc\x03\x08\x11\n\r\n\x05\x04\x0b\x02\x01\x03\x12\x04\xbc\
    \x03\x14\x15\n\r\n\x05\x04\x0b\x02\x01\x08\x12\x04\xbc\x03\x16>\n\x10\n\
    \x08\x04\x0b\x02\x01\x08\x9c\x08\0\x12\x04\xbc\x03\x17=\n\xe6\x01\n\x04\
    \x04\x0b\x02\x02\x12\x04\xc1\x03\x02A\x1a\xd7\x01\x20Optional.\x20The\
    \x20value\x20returned\x20by\x20the\x20last\x20`ListTopicSubscriptionsRes\
    ponse`;\n\x20indicates\x20that\x20this\x20is\x20a\x20continuation\x20of\
    \x20a\x20prior\x20`ListTopicSubscriptions`\n\x20call,\x20and\x20that\x20\
    the\x20system\x20should\x20return\x20the\x20next\x20page\x20of\x20data.\
    \n\n\r\n\x05\x04\x0b\x02\x02\x05\x12\x04\xc1\x03\x02\x08\n\r\n\x05\x04\
    \x0b\x02\x02\x01\x12\x04\xc1\x03\t\x13\n\r\n\x05\x04\x0b\x02\x02\x03\x12\
    \x04\xc1\x03\x16\x17\n\r\n\x05\x04\x0b\x02\x02\x08\x12\x04\xc1\x03\x18@\
    \n\x10\n\x08\x04\x0b\x02\x02\x08\x9c\x08\0\x12\x04\xc1\x03\x19?\nA\n\x02\
    \x04\x0c\x12\x06\xc5\x03\0\xd3\x03\x01\x1a3\x20Response\x20for\x20the\
    \x20`ListTopicSubscriptions`\x20method.\n\n\x0b\n\x03\x04\x0c\x01\x12\
    \x04\xc5\x03\x08&\ng\n\x04\x04\x0c\x02\0\x12\x06\xc8\x03\x02\xcd\x03\x04\
    \x1aW\x20Optional.\x20The\x20names\x20of\x20subscriptions\x20attached\
    \x20to\x20the\x20topic\x20specified\x20in\x20the\n\x20request.\n\n\r\n\
    \x05\x04\x0c\x02\0\x04\x12\x04\xc8\x03\x02\n\n\r\n\x05\x04\x0c\x02\0\x05\
    \x12\x04\xc8\x03\x0b\x11\n\r\n\x05\x04\x0c\x02\0\x01\x12\x04\xc8\x03\x12\
    \x1f\n\r\n\x05\x04\x0c\x02\0\x03\x12\x04\xc8\x03\"#\n\x0f\n\x05\x04\x0c\
    \x02\0\x08\x12\x06\xc8\x03$\xcd\x03\x03\n\x10\n\x08\x04\x0c\x02\0\x08\
    \x9c\x08\0\x12\x04\xc9\x03\x04*\n\x11\n\x07\x04\x0c\x02\0\x08\x9f\x08\
    \x12\x06\xca\x03\x04\xcc\x03\x05\n\xd1\x01\n\x04\x04\x0c\x02\x01\x12\x04\
    \xd2\x03\x02F\x1a\xc2\x01\x20Optional.\x20If\x20not\x20empty,\x20indicat\
    es\x20that\x20there\x20may\x20be\x20more\x20subscriptions\x20that\n\x20m\
    atch\x20the\x20request;\x20this\x20value\x20should\x20be\x20passed\x20in\
    \x20a\x20new\n\x20`ListTopicSubscriptionsRequest`\x20to\x20get\x20more\
    \x20subscriptions.\n\n\r\n\x05\x04\x0c\x02\x01\x05\x12\x04\xd2\x03\x02\
    \x08\n\r\n\x05\x04\x0c\x02\x01\x01\x12\x04\xd2\x03\t\x18\n\r\n\x05\x04\
    \x0c\x02\x01\x03\x12\x04\xd2\x03\x1b\x1c\n\r\n\x05\x04\x0c\x02\x01\x08\
    \x12\x04\xd2\x03\x1dE\n\x10\n\x08\x04\x0c\x02\x01\x08\x9c\x08\0\x12\x04\
    \xd2\x03\x1eD\n<\n\x02\x04\r\x12\x06\xd6\x03\0\xe5\x03\x01\x1a.\x20Reque\
    st\x20for\x20the\x20`ListTopicSnapshots`\x20method.\n\n\x0b\n\x03\x04\r\
    \x01\x12\x04\xd6\x03\x08!\n\x81\x01\n\x04\x04\r\x02\0\x12\x06\xd9\x03\
    \x02\xdc\x03\x04\x1aq\x20Required.\x20The\x20name\x20of\x20the\x20topic\
    \x20that\x20snapshots\x20are\x20attached\x20to.\n\x20Format\x20is\x20`pr\
    ojects/{project}/topics/{topic}`.\n\n\r\n\x05\x04\r\x02\0\x05\x12\x04\
    \xd9\x03\x02\x08\n\r\n\x05\x04\r\x02\0\x01\x12\x04\xd9\x03\t\x0e\n\r\n\
    \x05\x04\r\x02\0\x03\x12\x04\xd9\x03\x11\x12\n\x0f\n\x05\x04\r\x02\0\x08\
    \x12\x06\xd9\x03\x13\xdc\x03\x03\n\x10\n\x08\x04\r\x02\0\x08\x9c\x08\0\
    \x12\x04\xda\x03\x04*\n\x0f\n\x07\x04\r\x02\0\x08\x9f\x08\x12\x04\xdb\
    \x03\x04M\nE\n\x04\x04\r\x02\x01\x12\x04\xdf\x03\x02?\x1a7\x20Optional.\
    \x20Maximum\x20number\x20of\x20snapshot\x20names\x20to\x20return.\n\n\r\
    \n\x05\x04\r\x02\x01\x05\x12\x04\xdf\x03\x02\x07\n\r\n\x05\x04\r\x02\x01\
    \x01\x12\x04\xdf\x03\x08\x11\n\r\n\x05\x04\r\x02\x01\x03\x12\x04\xdf\x03\
    \x14\x15\n\r\n\x05\x04\r\x02\x01\x08\x12\x04\xdf\x03\x16>\n\x10\n\x08\
    \x04\r\x02\x01\x08\x9c\x08\0\x12\x04\xdf\x03\x17=\n\xde\x01\n\x04\x04\r\
    \x02\x02\x12\x04\xe4\x03\x02A\x1a\xcf\x01\x20Optional.\x20The\x20value\
    \x20returned\x20by\x20the\x20last\x20`ListTopicSnapshotsResponse`;\n\x20\
    indicates\x20that\x20this\x20is\x20a\x20continuation\x20of\x20a\x20prior\
    \x20`ListTopicSnapshots`\x20call,\n\x20and\x20that\x20the\x20system\x20s\
    hould\x20return\x20the\x20next\x20page\x20of\x20data.\n\n\r\n\x05\x04\r\
    \x02\x02\x05\x12\x04\xe4\x03\x02\x08\n\r\n\x05\x04\r\x02\x02\x01\x12\x04\
    \xe4\x03\t\x13\n\r\n\x05\x04\r\x02\x02\x03\x12\x04\xe4\x03\x16\x17\n\r\n\
    \x05\x04\r\x02\x02\x08\x12\x04\xe4\x03\x18@\n\x10\n\x08\x04\r\x02\x02\
    \x08\x9c\x08\0\x12\x04\xe4\x03\x19?\n=\n\x02\x04\x0e\x12\x06\xe8\x03\0\
    \xf0\x03\x01\x1a/\x20Response\x20for\x20the\x20`ListTopicSnapshots`\x20m\
    ethod.\n\n\x0b\n\x03\x04\x0e\x01\x12\x04\xe8\x03\x08\"\nL\n\x04\x04\x0e\
    \x02\0\x12\x04\xea\x03\x02I\x1a>\x20Optional.\x20The\x20names\x20of\x20t\
    he\x20snapshots\x20that\x20match\x20the\x20request.\n\n\r\n\x05\x04\x0e\
    \x02\0\x04\x12\x04\xea\x03\x02\n\n\r\n\x05\x04\x0e\x02\0\x05\x12\x04\xea\
    \x03\x0b\x11\n\r\n\x05\x04\x0e\x02\0\x01\x12\x04\xea\x03\x12\x1b\n\r\n\
    \x05\x04\x0e\x02\0\x03\x12\x04\xea\x03\x1e\x1f\n\r\n\x05\x04\x0e\x02\0\
    \x08\x12\x04\xea\x03\x20H\n\x10\n\x08\x04\x0e\x02\0\x08\x9c\x08\0\x12\
    \x04\xea\x03!G\n\xc5\x01\n\x04\x04\x0e\x02\x01\x12\x04\xef\x03\x02F\x1a\
    \xb6\x01\x20Optional.\x20If\x20not\x20empty,\x20indicates\x20that\x20the\
    re\x20may\x20be\x20more\x20snapshots\x20that\n\x20match\x20the\x20reques\
    t;\x20this\x20value\x20should\x20be\x20passed\x20in\x20a\x20new\n\x20`Li\
    stTopicSnapshotsRequest`\x20to\x20get\x20more\x20snapshots.\n\n\r\n\x05\
    \x04\x0e\x02\x01\x05\x12\x04\xef\x03\x02\x08\n\r\n\x05\x04\x0e\x02\x01\
    \x01\x12\x04\xef\x03\t\x18\n\r\n\x05\x04\x0e\x02\x01\x03\x12\x04\xef\x03\
    \x1b\x1c\n\r\n\x05\x04\x0e\x02\x01\x08\x12\x04\xef\x03\x1dE\n\x10\n\x08\
    \x04\x0e\x02\x01\x08\x9c\x08\0\x12\x04\xef\x03\x1eD\n5\n\x02\x04\x0f\x12\
    \x06\xf3\x03\0\xfa\x03\x01\x1a'\x20Request\x20for\x20the\x20`DeleteTopic\
    `\x20method.\n\n\x0b\n\x03\x04\x0f\x01\x12\x04\xf3\x03\x08\x1a\nh\n\x04\
    \x04\x0f\x02\0\x12\x06\xf6\x03\x02\xf9\x03\x04\x1aX\x20Required.\x20Name\
    \x20of\x20the\x20topic\x20to\x20delete.\n\x20Format\x20is\x20`projects/{\
    project}/topics/{topic}`.\n\n\r\n\x05\x04\x0f\x02\0\x05\x12\x04\xf6\x03\
    \x02\x08\n\r\n\x05\x04\x0f\x02\0\x01\x12\x04\xf6\x03\t\x0e\n\r\n\x05\x04\
    \x0f\x02\0\x03\x12\x04\xf6\x03\x11\x12\n\x0f\n\x05\x04\x0f\x02\0\x08\x12\
    \x06\xf6\x03\x13\xf9\x03\x03\n\x10\n\x08\x04\x0f\x02\0\x08\x9c\x08\0\x12\
    \x04\xf7\x03\x04*\n\x0f\n\x07\x04\x0f\x02\0\x08\x9f\x08\x12\x04\xf8\x03\
    \x04M\n:\n\x02\x04\x10\x12\x06\xfd\x03\0\x86\x04\x01\x1a,\x20Request\x20\
    for\x20the\x20DetachSubscription\x20method.\n\n\x0b\n\x03\x04\x10\x01\
    \x12\x04\xfd\x03\x08!\nu\n\x04\x04\x10\x02\0\x12\x06\x80\x04\x02\x85\x04\
    \x04\x1ae\x20Required.\x20The\x20subscription\x20to\x20detach.\n\x20Form\
    at\x20is\x20`projects/{project}/subscriptions/{subscription}`.\n\n\r\n\
    \x05\x04\x10\x02\0\x05\x12\x04\x80\x04\x02\x08\n\r\n\x05\x04\x10\x02\0\
    \x01\x12\x04\x80\x04\t\x15\n\r\n\x05\x04\x10\x02\0\x03\x12\x04\x80\x04\
    \x18\x19\n\x0f\n\x05\x04\x10\x02\0\x08\x12\x06\x80\x04\x1a\x85\x04\x03\n\
    \x10\n\x08\x04\x10\x02\0\x08\x9c\x08\0\x12\x04\x81\x04\x04*\n\x11\n\x07\
    \x04\x10\x02\0\x08\x9f\x08\x12\x06\x82\x04\x04\x84\x04\x05\nS\n\x02\x04\
    \x11\x12\x04\x8a\x04\0%\x1aG\x20Response\x20for\x20the\x20DetachSubscrip\
    tion\x20method.\n\x20Reserved\x20for\x20future\x20use.\n\n\x0b\n\x03\x04\
    \x11\x01\x12\x04\x8a\x04\x08\"\n\xe2\x01\n\x02\x06\x01\x12\x06\x8f\x04\0\
    \xef\x05\x01\x1a\xd3\x01\x20The\x20service\x20that\x20an\x20application\
    ...
    \x04\x8f\x04\x08\x12\n\x0b\n\x03\x06\x01\x03\x12\x04\x90\x04\x02=\n\r\n\
    \x05\x06\x01\x03\x99\x08\x12\x04\x90\x04\x02=\n\r\n\x03\x06\x01\x03\x12\
    \x06\x91\x04\x02\x93\x04/\n\x0f\n\x05\x06\x01\x03\x9a\x08\x12\x06\x91\
    \x04\x02\x93\x04/\n\xaa\x05\n\x04\x06\x01\x02\0\x12\x06\xa0\x04\x02\xa7\
    \x04\x03\x1a\x99\x05\x20Creates\x20a\x20subscription\x20to\x20a\x20given\
    \x20topic.\x20See\x20the\x20[resource\x20name\x20rules]\n\x20(https://cl\
    oud.google.com/pubsub/docs/pubsub-basics#resource_names).\n\x20If\x20the\
    \x20subscription\x20already\x20exists,\x20returns\x20`ALREADY_EXISTS`.\n\
    ...
    \x20as\x20the\x20topic,\x20conforming\n\x20to\x20the\x20[resource\x20nam\
    e\x20format]\n\x20(https://cloud.google.com/pubsub/docs/pubsub-basics#re\
    ...
    n\x20the\x20request.\n\n\r\n\x05\x06\x01\x02\0\x01\x12\x04\xa0\x04\x06\
    \x18\n\r\n\x05\x06\x01\x02\0\x02\x12\x04\xa0\x04\x19%\n\r\n\x05\x06\x01\
    \x02\0\x03\x12\x04\xa0\x040<\n\x0f\n\x05\x06\x01\x02\0\x04\x12\x06\xa1\
    \x04\x04\xa4\x04\x06\n\x13\n\t\x06\x01\x02\0\x04\xb0\xca\xbc\"\x12\x06\
    \xa1\x04\x04\xa4\x04\x06\n\x0f\n\x05\x06\x01\x02\0\x04\x12\x06\xa5\x04\
    \x04\xa6\x046\n\x12\n\x08\x06\x01\x02\0\x04\x9b\x08\0\x12\x06\xa5\x04\
    \x04\xa6\x046\nC\n\x04\x06\x01\x02\x01\x12\x06\xaa\x04\x02\xaf\x04\x03\
    \x1a3\x20Gets\x20the\x20configuration\x20details\x20of\x20a\x20subscript\
    ion.\n\n\r\n\x05\x06\x01\x02\x01\x01\x12\x04\xaa\x04\x06\x15\n\r\n\x05\
    \x06\x01\x02\x01\x02\x12\x04\xaa\x04\x16,\n\r\n\x05\x06\x01\x02\x01\x03\
    \x12\x04\xaa\x047C\n\x0f\n\x05\x06\x01\x02\x01\x04\x12\x06\xab\x04\x04\
    \xad\x04\x06\n\x13\n\t\x06\x01\x02\x01\x04\xb0\xca\xbc\"\x12\x06\xab\x04\
    \x04\xad\x04\x06\n\r\n\x05\x06\x01\x02\x01\x04\x12\x04\xae\x04\x04:\n\
    \x10\n\x08\x06\x01\x02\x01\x04\x9b\x08\0\x12\x04\xae\x04\x04:\n\xc1\x01\
    \n\x04\x06\x01\x02\x02\x12\x06\xb4\x04\x02\xba\x04\x03\x1a\xb0\x01\x20Up\
    dates\x20an\x20existing\x20subscription\x20by\x20updating\x20the\x20fiel\
    ds\x20specified\x20in\x20the\n\x20update\x20mask.\x20Note\x20that\x20cer\
    tain\x20properties\x20of\x20a\x20subscription,\x20such\x20as\x20its\n\
    \x20topic,\x20are\x20not\x20modifiable.\n\n\r\n\x05\x06\x01\x02\x02\x01\
    \x12\x04\xb4\x04\x06\x18\n\r\n\x05\x06\x01\x02\x02\x02\x12\x04\xb4\x04\
    \x192\n\r\n\x05\x06\x01\x02\x02\x03\x12\x04\xb4\x04=I\n\x0f\n\x05\x06\
    \x01\x02\x02\x04\x12\x06\xb5\x04\x04\xb8\x04\x06\n\x13\n\t\x06\x01\x02\
    \x02\x04\xb0\xca\xbc\"\x12\x06\xb5\x04\x04\xb8\x04\x06\n\r\n\x05\x06\x01\
    \x02\x02\x04\x12\x04\xb9\x04\x04F\n\x10\n\x08\x06\x01\x02\x02\x04\x9b\
    \x08\0\x12\x04\xb9\x04\x04F\n/\n\x04\x06\x01\x02\x03\x12\x06\xbd\x04\x02\
    \xc3\x04\x03\x1a\x1f\x20Lists\x20matching\x20subscriptions.\n\n\r\n\x05\
    \x06\x01\x02\x03\x01\x12\x04\xbd\x04\x06\x17\n\r\n\x05\x06\x01\x02\x03\
    \x02\x12\x04\xbd\x04\x180\n\r\n\x05\x06\x01\x02\x03\x03\x12\x04\xbe\x04\
    \x0f(\n\x0f\n\x05\x06\x01\x02\x03\x04\x12\x06\xbf\x04\x04\xc1\x04\x06\n\
    \x13\n\t\x06\x01\x02\x03\x04\xb0\xca\xbc\"\x12\x06\xbf\x04\x04\xc1\x04\
    \x06\n\r\n\x05\x06\x01\x02\x03\x04\x12\x04\xc2\x04\x045\n\x10\n\x08\x06\
    \x01\x02\x03\x04\x9b\x08\0\x12\x04\xc2\x04\x045\n\xef\x02\n\x04\x06\x01\
    \x02\x04\x12\x06\xca\x04\x02\xd0\x04\x03\x1a\xde\x02\x20Deletes\x20an\
    \x20existing\x20subscription.\x20All\x20messages\x20retained\x20in\x20th\
    e\x20subscription\n\x20are\x20immediately\x20dropped.\x20Calls\x20to\x20\
    `Pull`\x20after\x20deletion\x20will\x20return\n\x20`NOT_FOUND`.\x20After\
    \x20a\x20subscription\x20is\x20deleted,\x20a\x20new\x20one\x20may\x20be\
    \x20created\x20with\n\x20the\x20same\x20name,\x20but\x20the\x20new\x20on\
    e\x20has\x20no\x20association\x20with\x20the\x20old\n\x20subscription\
    \x20or\x20its\x20topic\x20unless\x20the\x20same\x20topic\x20is\x20specif\
    ied.\n\n\r\n\x05\x06\x01\x02\x04\x01\x12\x04\xca\x04\x06\x18\n\r\n\x05\
    \x06\x01\x02\x04\x02\x12\x04\xca\x04\x192\n\r\n\x05\x06\x01\x02\x04\x03\
    \x12\x04\xcb\x04\x0f$\n\x0f\n\x05\x06\x01\x02\x04\x04\x12\x06\xcc\x04\
    \x04\xce\x04\x06\n\x13\n\t\x06\x01\x02\x04\x04\xb0\xca\xbc\"\x12\x06\xcc\
    \x04\x04\xce\x04\x06\n\r\n\x05\x06\x01\x02\x04\x04\x12\x04\xcf\x04\x04:\
    \n\x10\n\x08\x06\x01\x02\x04\x04\x9b\x08\0\x12\x04\xcf\x04\x04:\n\xe7\
    \x02\n\x04\x06\x01\x02\x05\x12\x06\xd7\x04\x02\xdf\x04\x03\x1a\xd6\x02\
    \x20Modifies\x20the\x20ack\x20deadline\x20for\x20a\x20specific\x20messag\
    e.\x20This\x20method\x20is\x20useful\n\x20to\x20indicate\x20that\x20more\
    \x20time\x20is\x20needed\x20to\x20process\x20a\x20message\x20by\x20the\n\
    \x20subscriber,\x20or\x20to\x20make\x20the\x20message\x20available\x20fo\
    r\x20redelivery\x20if\x20the\n\x20processing\x20was\x20interrupted.\x20N\
    ote\x20that\x20this\x20does\x20not\x20modify\x20the\n\x20subscription-le\
    vel\x20`ackDeadlineSeconds`\x20used\x20for\x20subsequent\x20messages.\n\
    \n\r\n\x05\x06\x01\x02\x05\x01\x12\x04\xd7\x04\x06\x17\n\r\n\x05\x06\x01\
    \x02\x05\x02\x12\x04\xd7\x04\x180\n\r\n\x05\x06\x01\x02\x05\x03\x12\x04\
    \xd8\x04\x0f$\n\x0f\n\x05\x06\x01\x02\x05\x04\x12\x06\xd9\x04\x04\xdc\
    \x04\x06\n\x13\n\t\x06\x01\x02\x05\x04\xb0\xca\xbc\"\x12\x06\xd9\x04\x04\
    \xdc\x04\x06\n\x0f\n\x05\x06\x01\x02\x05\x04\x12\x06\xdd\x04\x04\xde\x04\
    4\n\x12\n\x08\x06\x01\x02\x05\x04\x9b\x08\0\x12\x06\xdd\x04\x04\xde\x044\
    \n\xed\x02\n\x04\x06\x01\x02\x06\x12\x06\xe8\x04\x02\xee\x04\x03\x1a\xdc\
    \x02\x20Acknowledges\x20the\x20messages\x20associated\x20with\x20the\x20\
    `ack_ids`\x20in\x20the\n\x20`AcknowledgeRequest`.\x20The\x20Pub/Sub\x20s\
    ystem\x20can\x20remove\x20the\x20relevant\x20messages\n\x20from\x20the\
    \x20subscription.\n\n\x20Acknowledging\x20a\x20message\x20whose\x20ack\
    \x20deadline\x20has\x20expired\x20may\x20succeed,\n\x20but\x20such\x20a\
    \x20message\x20may\x20be\x20redelivered\x20later.\x20Acknowledging\x20a\
    \x20message\x20more\n\x20than\x20once\x20will\x20not\x20result\x20in\x20\
    an\x20error.\n\n\r\n\x05\x06\x01\x02\x06\x01\x12\x04\xe8\x04\x06\x11\n\r\
    \n\x05\x06\x01\x02\x06\x02\x12\x04\xe8\x04\x12$\n\r\n\x05\x06\x01\x02\
    \x06\x03\x12\x04\xe8\x04/D\n\x0f\n\x05\x06\x01\x02\x06\x04\x12\x06\xe9\
    \x04\x04\xec\x04\x06\n\x13\n\t\x06\x01\x02\x06\x04\xb0\xca\xbc\"\x12\x06\
    \xe9\x04\x04\xec\x04\x06\n\r\n\x05\x06\x01\x02\x06\x04\x12\x04\xed\x04\
    \x04B\n\x10\n\x08\x06\x01\x02\x06\x04\x9b\x08\0\x12\x04\xed\x04\x04B\n1\
    \n\x04\x06\x01\x02\x07\x12\x06\xf1\x04\x02\xf9\x04\x03\x1a!\x20Pulls\x20\
    messages\x20from\x20the\x20server.\n\n\r\n\x05\x06\x01\x02\x07\x01\x12\
    \x04\xf1\x04\x06\n\n\r\n\x05\x06\x01\x02\x07\x02\x12\x04\xf1\x04\x0b\x16\
    \n\r\n\x05\x06\x01\x02\x07\x03\x12\x04\xf1\x04!-\n\x0f\n\x05\x06\x01\x02\
    \x07\x04\x12\x06\xf2\x04\x04\xf5\x04\x06\n\x13\n\t\x06\x01\x02\x07\x04\
    \xb0\xca\xbc\"\x12\x06\xf2\x04\x04\xf5\x04\x06\n\x0f\n\x05\x06\x01\x02\
    \x07\x04\x12\x06\xf6\x04\x04\xf7\x047\n\x12\n\x08\x06\x01\x02\x07\x04\
    \x9b\x08\0\x12\x06\xf6\x04\x04\xf7\x047\n\r\n\x05\x06\x01\x02\x07\x04\
    \x12\x04\xf8\x04\x04G\n\x10\n\x08\x06\x01\x02\x07\x04\x9b\x08\x01\x12\
    \x04\xf8\x04\x04G\n\xe2\x03\n\x04\x06\x01\x02\x08\x12\x06\x82\x05\x02\
    \x83\x05/\x1a\xd1\x03\x20Establishes\x20a\x20stream\x20with\x20the\x20se\
    rver,\x20which\x20sends\x20messages\x20down\x20to\x20the\n\x20client.\
    \x20The\x20client\x20streams\x20acknowledgements\x20and\x20ack\x20deadli\
    ne\x20modifications\n\x20back\x20to\x20the\x20server.\x20The\x20server\
    \x20will\x20close\x20the\x20stream\x20and\x20return\x20the\x20status\n\
    \x20on\x20any\x20error.\x20The\x20server\x20may\x20close\x20the\x20strea\
    m\x20with\x20status\x20`UNAVAILABLE`\x20to\n\x20reassign\x20server-side\
    \x20resources,\x20in\x20which\x20case,\x20the\x20client\x20should\n\x20r\
    e-establish\x20the\x20stream.\x20Flow\x20control\x20can\x20be\x20achieve\
    d\x20by\x20configuring\x20the\n\x20underlying\x20RPC\x20channel.\n\n\r\n\
    \x05\x06\x01\x02\x08\x01\x12\x04\x82\x05\x06\x13\n\r\n\x05\x06\x01\x02\
    \x08\x05\x12\x04\x82\x05\x14\x1a\n\r\n\x05\x06\x01\x02\x08\x02\x12\x04\
    \x82\x05\x1b/\n\r\n\x05\x06\x01\x02\x08\x06\x12\x04\x83\x05\x0f\x15\n\r\
    \n\x05\x06\x01\x02\x08\x03\x12\x04\x83\x05\x16+\n\xf7\x02\n\x04\x06\x01\
    \x02\t\x12\x06\x8b\x05\x02\x92\x05\x03\x1a\xe6\x02\x20Modifies\x20the\
    ...
    nfig`.\n\n\r\n\x05\x06\x01\x02\t\x01\x12\x04\x8b\x05\x06\x16\n\r\n\x05\
    \x06\x01\x02\t\x02\x12\x04\x8b\x05\x17.\n\r\n\x05\x06\x01\x02\t\x03\x12\
    \x04\x8c\x05\x0f$\n\x0f\n\x05\x06\x01\x02\t\x04\x12\x06\x8d\x05\x04\x90\
    \x05\x06\n\x13\n\t\x06\x01\x02\t\x04\xb0\xca\xbc\"\x12\x06\x8d\x05\x04\
    \x90\x05\x06\n\r\n\x05\x06\x01\x02\t\x04\x12\x04\x91\x05\x04F\n\x10\n\
    \x08\x06\x01\x02\t\x04\x9b\x08\0\x12\x04\x91\x05\x04F\n\xd9\x02\n\x04\
    \x06\x01\x02\n\x12\x06\x99\x05\x02\x9e\x05\x03\x1a\xc8\x02\x20Gets\x20th\
    ...
    \x20set\x20the\x20acknowledgment\x20state\x20of\x20messages\x20in\x20an\
    \x20existing\x20subscription\x20to\x20the\n\x20state\x20captured\x20by\
    \x20a\x20snapshot.\n\n\r\n\x05\x06\x01\x02\n\x01\x12\x04\x99\x05\x06\x11\
    \n\r\n\x05\x06\x01\x02\n\x02\x12\x04\x99\x05\x12$\n\r\n\x05\x06\x01\x02\
    \n\x03\x12\x04\x99\x05/7\n\x0f\n\x05\x06\x01\x02\n\x04\x12\x06\x9a\x05\
    \x04\x9c\x05\x06\n\x13\n\t\x06\x01\x02\n\x04\xb0\xca\xbc\"\x12\x06\x9a\
    \x05\x04\x9c\x05\x06\n\r\n\x05\x06\x01\x02\n\x04\x12\x04\x9d\x05\x046\n\
    \x10\n\x08\x06\x01\x02\n\x04\x9b\x08\0\x12\x04\x9d\x05\x046\n\xca\x02\n\
    \x04\x06\x01\x02\x0b\x12\x06\xa5\x05\x02\xaa\x05\x03\x1a\xb9\x02\x20List\
    ...
    hot.\n\n\r\n\x05\x06\x01\x02\x0b\x01\x12\x04\xa5\x05\x06\x13\n\r\n\x05\
    \x06\x01\x02\x0b\x02\x12\x04\xa5\x05\x14(\n\r\n\x05\x06\x01\x02\x0b\x03\
    \x12\x04\xa5\x053H\n\x0f\n\x05\x06\x01\x02\x0b\x04\x12\x06\xa6\x05\x04\
    \xa8\x05\x06\n\x13\n\t\x06\x01\x02\x0b\x04\xb0\xca\xbc\"\x12\x06\xa6\x05\
    \x04\xa8\x05\x06\n\r\n\x05\x06\x01\x02\x0b\x04\x12\x04\xa9\x05\x045\n\
    \x10\n\x08\x06\x01\x02\x0b\x04\x9b\x08\0\x12\x04\xa9\x05\x045\n\xad\x08\
    \n\x04\x06\x01\x02\x0c\x12\x06\xbc\x05\x02\xc2\x05\x03\x1a\x9c\x08\x20Cr\
    ...
    \n\n\r\n\x05\x06\x01\x02\x0c\x01\x12\x04\xbc\x05\x06\x14\n\r\n\x05\x06\
    \x01\x02\x0c\x02\x12\x04\xbc\x05\x15*\n\r\n\x05\x06\x01\x02\x0c\x03\x12\
    \x04\xbc\x055=\n\x0f\n\x05\x06\x01\x02\x0c\x04\x12\x06\xbd\x05\x04\xc0\
    \x05\x06\n\x13\n\t\x06\x01\x02\x0c\x04\xb0\xca\xbc\"\x12\x06\xbd\x05\x04\
    \xc0\x05\x06\n\r\n\x05\x06\x01\x02\x0c\x04\x12\x04\xc1\x05\x04?\n\x10\n\
    \x08\x06\x01\x02\x0c\x04\x9b\x08\0\x12\x04\xc1\x05\x04?\n\xfe\x02\n\x04\
    \x06\x01\x02\r\x12\x06\xca\x05\x02\xd0\x05\x03\x1a\xed\x02\x20Updates\
    \x20an\x20existing\x20snapshot\x20by\x20updating\x20the\x20fields\x20spe\
    cified\x20in\x20the\x20update\n\x20mask.\x20Snapshots\x20are\x20used\x20\
    in\n\x20[Seek](https://cloud.google.com/pubsub/docs/replay-overview)\x20\
    operations,\n\x20which\x20allow\x20you\x20to\x20manage\x20message\x20ack\
    nowledgments\x20in\x20bulk.\x20That\x20is,\x20you\x20can\n\x20set\x20the\
    \x20acknowledgment\x20state\x20of\x20messages\x20in\x20an\x20existing\
    \x20subscription\x20to\x20the\n\x20state\x20captured\x20by\x20a\x20snaps\
    hot.\n\n\r\n\x05\x06\x01\x02\r\x01\x12\x04\xca\x05\x06\x14\n\r\n\x05\x06\
    \x01\x02\r\x02\x12\x04\xca\x05\x15*\n\r\n\x05\x06\x01\x02\r\x03\x12\x04\
    \xca\x055=\n\x0f\n\x05\x06\x01\x02\r\x04\x12\x06\xcb\x05\x04\xce\x05\x06\
    \n\x13\n\t\x06\x01\x02\r\x04\xb0\xca\xbc\"\x12\x06\xcb\x05\x04\xce\x05\
    \x06\n\r\n\x05\x06\x01\x02\r\x04\x12\x04\xcf\x05\x04B\n\x10\n\x08\x06\
    \x01\x02\r\x04\x9b\x08\0\x12\x04\xcf\x05\x04B\n\xee\x04\n\x04\x06\x01\
    \x02\x0e\x12\x06\xdb\x05\x02\xe0\x05\x03\x1a\xdd\x04\x20Removes\x20an\
    \x20existing\x20snapshot.\x20Snapshots\x20are\x20used\x20in\x20[Seek]\n\
    \x20(https://cloud.google.com/pubsub/docs/replay-overview)\x20operations\
    ,\x20which\n\x20allow\x20you\x20to\x20manage\x20message\x20acknowledgmen\
    ts\x20in\x20bulk.\x20That\x20is,\x20you\x20can\x20set\n\x20the\x20acknow\
    ledgment\x20state\x20of\x20messages\x20in\x20an\x20existing\x20subscript\
    ion\x20to\x20the\n\x20state\x20captured\x20by\x20a\x20snapshot.\n\x20Whe\
    n\x20the\x20snapshot\x20is\x20deleted,\x20all\x20messages\x20retained\
    \x20in\x20the\x20snapshot\n\x20are\x20immediately\x20dropped.\x20After\
    \x20a\x20snapshot\x20is\x20deleted,\x20a\x20new\x20one\x20may\x20be\n\
    \x20created\x20with\x20the\x20same\x20name,\x20but\x20the\x20new\x20one\
    \x20has\x20no\x20association\x20with\x20the\x20old\n\x20snapshot\x20or\
    \x20its\x20subscription,\x20unless\x20the\x20same\x20subscription\x20is\
    \x20specified.\n\n\r\n\x05\x06\x01\x02\x0e\x01\x12\x04\xdb\x05\x06\x14\n\
    \r\n\x05\x06\x01\x02\x0e\x02\x12\x04\xdb\x05\x15*\n\r\n\x05\x06\x01\x02\
    \x0e\x03\x12\x04\xdb\x055J\n\x0f\n\x05\x06\x01\x02\x0e\x04\x12\x06\xdc\
    \x05\x04\xde\x05\x06\n\x13\n\t\x06\x01\x02\x0e\x04\xb0\xca\xbc\"\x12\x06\
    \xdc\x05\x04\xde\x05\x06\n\r\n\x05\x06\x01\x02\x0e\x04\x12\x04\xdf\x05\
    \x046\n\x10\n\x08\x06\x01\x02\x0e\x04\x9b\x08\0\x12\x04\xdf\x05\x046\n\
    \xea\x03\n\x04\x06\x01\x02\x0f\x12\x06\xe9\x05\x02\xee\x05\x03\x1a\xd9\
    \x03\x20Seeks\x20an\x20existing\x20subscription\x20to\x20a\x20point\x20i\
    n\x20time\x20or\x20to\x20a\x20given\x20snapshot,\n\x20whichever\x20is\
    \x20provided\x20in\x20the\x20request.\x20Snapshots\x20are\x20used\x20in\
    \x20[Seek]\n\x20(https://cloud.google.com/pubsub/docs/replay-overview)\
    \x20operations,\x20which\n\x20allow\x20you\x20to\x20manage\x20message\
    ...
    napshot.\x20Note\x20that\x20both\x20the\x20subscription\x20and\x20the\n\
    \x20snapshot\x20must\x20be\x20on\x20the\x20same\x20topic.\n\n\r\n\x05\
    \x06\x01\x02\x0f\x01\x12\x04\xe9\x05\x06\n\n\r\n\x05\x06\x01\x02\x0f\x02\
    \x12\x04\xe9\x05\x0b\x16\n\r\n\x05\x06\x01\x02\x0f\x03\x12\x04\xe9\x05!-\
    \n\x0f\n\x05\x06\x01\x02\x0f\x04\x12\x06\xea\x05\x04\xed\x05\x06\n\x13\n\
    \t\x06\x01\x02\x0f\x04\xb0\xca\xbc\"\x12\x06\xea\x05\x04\xed\x05\x06\n\
    \xe4\x01\n\x02\x04\x12\x12\x06\xf4\x05\0\x9c\x07\x01\x1a\xd5\x01\x20A\
    \x20subscription\x20resource.\x20If\x20none\x20of\x20`push_config`,\x20`\
    bigquery_config`,\x20or\n\x20`cloud_storage_config`\x20is\x20set,\x20the\
    n\x20the\x20subscriber\x20will\x20pull\x20and\x20ack\x20messages\n\x20us\
    ing\x20API\x20methods.\x20At\x20most\x20one\x20of\x20these\x20fields\x20\
    may\x20be\x20set.\n\n\x0b\n\x03\x04\x12\x01\x12\x04\xf4\x05\x08\x14\n\r\
    \n\x03\x04\x12\x07\x12\x06\xf5\x05\x02\xf8\x05\x04\n\x0f\n\x05\x04\x12\
    \x07\x9d\x08\x12\x06\xf5\x05\x02\xf8\x05\x04\n5\n\x04\x04\x12\x04\0\x12\
    \x06\xfb\x05\x02\x86\x06\x03\x1a%\x20Possible\x20states\x20for\x20a\x20s\
    ubscription.\n\n\r\n\x05\x04\x12\x04\0\x01\x12\x04\xfb\x05\x07\x0c\n6\n\
    \x06\x04\x12\x04\0\x02\0\x12\x04\xfd\x05\x04\x1a\x1a&\x20Default\x20valu\
    e.\x20This\x20value\x20is\x20unused.\n\n\x0f\n\x07\x04\x12\x04\0\x02\0\
    \x01\x12\x04\xfd\x05\x04\x15\n\x0f\n\x07\x04\x12\x04\0\x02\0\x02\x12\x04\
    \xfd\x05\x18\x19\n@\n\x06\x04\x12\x04\0\x02\x01\x12\x04\x80\x06\x04\x0f\
    \x1a0\x20The\x20subscription\x20can\x20actively\x20receive\x20messages\n\
    \n\x0f\n\x07\x04\x12\x04\0\x02\x01\x01\x12\x04\x80\x06\x04\n\n\x0f\n\x07\
    \x04\x12\x04\0\x02\x01\x02\x12\x04\x80\x06\r\x0e\n\xc6\x01\n\x06\x04\x12\
    \x04\0\x02\x02\x12\x04\x85\x06\x04\x17\x1a\xb5\x01\x20The\x20subscriptio\
    n\x20cannot\x20receive\x20messages\x20because\x20of\x20an\x20error\x20wi\
    th\x20the\n\x20resource\x20to\x20which\x20it\x20pushes\x20messages.\x20S\
    ee\x20the\x20more\x20detailed\x20error\x20state\n\x20in\x20the\x20corres\
    ponding\x20configuration.\n\n\x0f\n\x07\x04\x12\x04\0\x02\x02\x01\x12\
    \x04\x85\x06\x04\x12\n\x0f\n\x07\x04\x12\x04\0\x02\x02\x02\x12\x04\x85\
    \x06\x15\x16\n\xa8\x03\n\x04\x04\x12\x02\0\x12\x04\x8e\x06\x02;\x1a\x99\
    ...
    \x20with\x20`\"goog\"`.\n\n\r\n\x05\x04\x12\x02\0\x05\x12\x04\x8e\x06\
    \x02\x08\n\r\n\x05\x04\x12\x02\0\x01\x12\x04\x8e\x06\t\r\n\r\n\x05\x04\
    \x12\x02\0\x03\x12\x04\x8e\x06\x10\x11\n\r\n\x05\x04\x12\x02\0\x08\x12\
    \x04\x8e\x06\x12:\n\x10\n\x08\x04\x12\x02\0\x08\x9c\x08\0\x12\x04\x8e\
    \x06\x139\n\xe8\x01\n\x04\x04\x12\x02\x01\x12\x06\x93\x06\x02\x96\x06\
    ...
    \x12\x04\x93\x06\x02\x08\n\r\n\x05\x04\x12\x02\x01\x01\x12\x04\x93\x06\t\
    \x0e\n\r\n\x05\x04\x12\x02\x01\x03\x12\x04\x93\x06\x11\x12\n\x0f\n\x05\
    \x04\x12\x02\x01\x08\x12\x06\x93\x06\x13\x96\x06\x03\n\x10\n\x08\x04\x12\
    \x02\x01\x08\x9c\x08\0\x12\x04\x94\x06\x04*\n\x0f\n\x07\x04\x12\x02\x01\
    \x08\x9f\x08\x12\x04\x95\x06\x04M\no\n\x04\x04\x12\x02\x02\x12\x04\x9a\
    \x06\x02F\x1aa\x20Optional.\x20If\x20push\x20delivery\x20is\x20used\x20w\
    ith\x20this\x20subscription,\x20this\x20field\x20is\n\x20used\x20to\x20c\
    onfigure\x20it.\n\n\r\n\x05\x04\x12\x02\x02\x06\x12\x04\x9a\x06\x02\x0c\
    \n\r\n\x05\x04\x12\x02\x02\x01\x12\x04\x9a\x06\r\x18\n\r\n\x05\x04\x12\
    \x02\x02\x03\x12\x04\x9a\x06\x1b\x1c\n\r\n\x05\x04\x12\x02\x02\x08\x12\
    \x04\x9a\x06\x1dE\n\x10\n\x08\x04\x12\x02\x02\x08\x9c\x08\0\x12\x04\x9a\
    \x06\x1eD\nv\n\x04\x04\x12\x02\x03\x12\x04\x9e\x06\x02O\x1ah\x20Optional\
    .\x20If\x20delivery\x20to\x20BigQuery\x20is\x20used\x20with\x20this\x20s\
    ubscription,\x20this\n\x20field\x20is\x20used\x20to\x20configure\x20it.\
    \n\n\r\n\x05\x04\x12\x02\x03\x06\x12\x04\x9e\x06\x02\x10\n\r\n\x05\x04\
    \x12\x02\x03\x01\x12\x04\x9e\x06\x11\x20\n\r\n\x05\x04\x12\x02\x03\x03\
    \x12\x04\x9e\x06#%\n\r\n\x05\x04\x12\x02\x03\x08\x12\x04\x9e\x06&N\n\x10\
    \n\x08\x04\x12\x02\x03\x08\x9c\x08\0\x12\x04\x9e\x06'M\n\x84\x01\n\x04\
    \x04\x12\x02\x04\x12\x06\xa2\x06\x02\xa3\x06/\x1at\x20Optional.\x20If\
    ...
    igure\x20it.\n\n\r\n\x05\x04\x12\x02\x04\x06\x12\x04\xa2\x06\x02\x14\n\r\
    \n\x05\x04\x12\x02\x04\x01\x12\x04\xa2\x06\x15)\n\r\n\x05\x04\x12\x02\
    \x04\x03\x12\x04\xa2\x06,.\n\r\n\x05\x04\x12\x02\x04\x08\x12\x04\xa3\x06\
    \x06.\n\x10\n\x08\x04\x12\x02\x04\x08\x9c\x08\0\x12\x04\xa3\x06\x07-\n\
    \xcc\x08\n\x04\x04\x12\x02\x05\x12\x04\xb9\x06\x02J\x1a\xbd\x08\x20Optio\
    ...
    \xb9\x06\x02\x07\n\r\n\x05\x04\x12\x02\x05\x01\x12\x04\xb9\x06\x08\x1c\n\
    \r\n\x05\x04\x12\x02\x05\x03\x12\x04\xb9\x06\x1f\x20\n\r\n\x05\x04\x12\
    \x02\x05\x08\x12\x04\xb9\x06!I\n\x10\n\x08\x04\x12\x02\x05\x08\x9c\x08\0\
    \x12\x04\xb9\x06\"H\n\xb7\x03\n\x04\x04\x12\x02\x06\x12\x04\xc1\x06\x02J\
    ...
    wledged\x20messages.\n\n\r\n\x05\x04\x12\x02\x06\x05\x12\x04\xc1\x06\x02\
    \x06\n\r\n\x05\x04\x12\x02\x06\x01\x12\x04\xc1\x06\x07\x1c\n\r\n\x05\x04\
    \x12\x02\x06\x03\x12\x04\xc1\x06\x1f\x20\n\r\n\x05\x04\x12\x02\x06\x08\
    \x12\x04\xc1\x06!I\n\x10\n\x08\x04\x12\x02\x06\x08\x9c\x08\0\x12\x04\xc1\
    \x06\"H\n\xff\x02\n\x04\x04\x12\x02\x07\x12\x06\xc8\x06\x02\xc9\x06/\x1a\
    \xee\x02\x20Optional.\x20How\x20long\x20to\x20retain\x20unacknowledged\
    ...
    han\x207\x20days\x20or\x20less\x20than\x2010\x20minutes.\n\n\r\n\x05\x04\
    \x12\x02\x07\x06\x12\x04\xc8\x06\x02\x1a\n\r\n\x05\x04\x12\x02\x07\x01\
    \x12\x04\xc8\x06\x1b5\n\r\n\x05\x04\x12\x02\x07\x03\x12\x04\xc8\x0689\n\
    \r\n\x05\x04\x12\x02\x07\x08\x12\x04\xc9\x06\x06.\n\x10\n\x08\x04\x12\
    \x02\x07\x08\x9c\x08\0\x12\x04\xc9\x06\x07-\nk\n\x04\x04\x12\x02\x08\x12\
    \x04\xcd\x06\x02J\x1a]\x20Optional.\x20See\x20[Creating\x20and\x20managi\
    ng\n\x20labels](https://cloud.google.com/pubsub/docs/labels).\n\n\r\n\
    \x05\x04\x12\x02\x08\x06\x12\x04\xcd\x06\x02\x15\n\r\n\x05\x04\x12\x02\
    \x08\x01\x12\x04\xcd\x06\x16\x1c\n\r\n\x05\x04\x12\x02\x08\x03\x12\x04\
    \xcd\x06\x1f\x20\n\r\n\x05\x04\x12\x02\x08\x08\x12\x04\xcd\x06!I\n\x10\n\
    \x08\x04\x12\x02\x08\x08\x9c\x08\0\x12\x04\xcd\x06\"H\n\xfc\x01\n\x04\
    \x04\x12\x02\t\x12\x04\xd3\x06\x02M\x1a\xed\x01\x20Optional.\x20If\x20tr\
    ...
    \x12\x04\xd3\x06\x02\x06\n\r\n\x05\x04\x12\x02\t\x01\x12\x04\xd3\x06\x07\
    \x1e\n\r\n\x05\x04\x12\x02\t\x03\x12\x04\xd3\x06!#\n\r\n\x05\x04\x12\x02\
    \t\x08\x12\x04\xd3\x06$L\n\x10\n\x08\x04\x12\x02\t\x08\x9c\x08\0\x12\x04\
    \xd3\x06%K\n\x9d\x04\n\x04\x04\x12\x02\n\x12\x06\xdc\x06\x02\xdd\x06/\
    ...
    \n\x06\x12\x04\xdc\x06\x02\x12\n\r\n\x05\x04\x12\x02\n\x01\x12\x04\xdc\
    \x06\x13$\n\r\n\x05\x04\x12\x02\n\x03\x12\x04\xdc\x06')\n\r\n\x05\x04\
    \x12\x02\n\x08\x12\x04\xdd\x06\x06.\n\x10\n\x08\x04\x12\x02\n\x08\x9c\
    \x08\0\x12\x04\xdd\x06\x07-\n\xac\x02\n\x04\x04\x12\x02\x0b\x12\x04\xe4\
    \x06\x02>\x1a\x9d\x02\x20Optional.\x20An\x20expression\x20written\x20in\
    ...
    \x12\x02\x0b\x05\x12\x04\xe4\x06\x02\x08\n\r\n\x05\x04\x12\x02\x0b\x01\
    \x12\x04\xe4\x06\t\x0f\n\r\n\x05\x04\x12\x02\x0b\x03\x12\x04\xe4\x06\x12\
    \x14\n\r\n\x05\x04\x12\x02\x0b\x08\x12\x04\xe4\x06\x15=\n\x10\n\x08\x04\
    \x12\x02\x0b\x08\x9c\x08\0\x12\x04\xe4\x06\x16<\n\x96\x03\n\x04\x04\x12\
    \x02\x0c\x12\x06\xee\x06\x02\xef\x06/\x1a\x85\x03\x20Optional.\x20A\x20p\
    ...
    on.\n\n\r\n\x05\x04\x12\x02\x0c\x06\x12\x04\xee\x06\x02\x12\n\r\n\x05\
    \x04\x12\x02\x0c\x01\x12\x04\xee\x06\x13%\n\r\n\x05\x04\x12\x02\x0c\x03\
    \x12\x04\xee\x06(*\n\r\n\x05\x04\x12\x02\x0c\x08\x12\x04\xef\x06\x06.\n\
    \x10\n\x08\x04\x12\x02\x0c\x08\x9c\x08\0\x12\x04\xef\x06\x07-\n\xef\x02\
    \n\x04\x04\x12\x02\r\x12\x04\xf8\x06\x02I\x1a\xe0\x02\x20Optional.\x20A\
    ...
    \n\x05\x04\x12\x02\r\x06\x12\x04\xf8\x06\x02\r\n\r\n\x05\x04\x12\x02\r\
    \x01\x12\x04\xf8\x06\x0e\x1a\n\r\n\x05\x04\x12\x02\r\x03\x12\x04\xf8\x06\
    \x1d\x1f\n\r\n\x05\x04\x12\x02\r\x08\x12\x04\xf8\x06\x20H\n\x10\n\x08\
    \x04\x12\x02\r\x08\x9c\x08\0\x12\x04\xf8\x06!G\n\xd4\x02\n\x04\x04\x12\
    \x02\x0e\x12\x04\xff\x06\x02>\x1a\xc5\x02\x20Optional.\x20Indicates\x20w\
    ...
    .\n\n\r\n\x05\x04\x12\x02\x0e\x05\x12\x04\xff\x06\x02\x06\n\r\n\x05\x04\
    \x12\x02\x0e\x01\x12\x04\xff\x06\x07\x0f\n\r\n\x05\x04\x12\x02\x0e\x03\
    \x12\x04\xff\x06\x12\x14\n\r\n\x05\x04\x12\x02\x0e\x08\x12\x04\xff\x06\
    \x15=\n\x10\n\x08\x04\x12\x02\x0e\x08\x9c\x08\0\x12\x04\xff\x06\x16<\n\
    \xf4\x04\n\x04\x04\x12\x02\x0f\x12\x06\x8d\x07\x02\x8e\x07/\x1a\xe3\x04\
    ...
    \x12\x04\x8d\x07\x02\x06\n\r\n\x05\x04\x12\x02\x0f\x01\x12\x04\x8d\x07\
    \x07#\n\r\n\x05\x04\x12\x02\x0f\x03\x12\x04\x8d\x07&(\n\r\n\x05\x04\x12\
    \x02\x0f\x08\x12\x04\x8e\x07\x06.\n\x10\n\x08\x04\x12\x02\x0f\x08\x9c\
    \x08\0\x12\x04\x8e\x07\x07-\n\xc7\x03\n\x04\x04\x12\x02\x10\x12\x06\x96\
    \x07\x02\x97\x072\x1a\xb6\x03\x20Output\x20only.\x20Indicates\x20the\x20\
    ...
    in\x20any\x20requests.\n\n\r\n\x05\x04\x12\x02\x10\x06\x12\x04\x96\x07\
    \x02\x1a\n\r\n\x05\x04\x12\x02\x10\x01\x12\x04\x96\x07\x1b;\n\r\n\x05\
    \x04\x12\x02\x10\x03\x12\x04\x96\x07>@\n\r\n\x05\x04\x12\x02\x10\x08\x12\
    \x04\x97\x07\x061\n\x10\n\x08\x04\x12\x02\x10\x08\x9c\x08\0\x12\x04\x97\
    \x07\x070\ns\n\x04\x04\x12\x02\x11\x12\x04\x9b\x07\x02?\x1ae\x20Output\
    \x20only.\x20An\x20output-only\x20field\x20indicating\x20whether\x20or\
    \x20not\x20the\n\x20subscription\x20can\x20receive\x20messages.\n\n\r\n\
    \x05\x04\x12\x02\x11\x06\x12\x04\x9b\x07\x02\x07\n\r\n\x05\x04\x12\x02\
    \x11\x01\x12\x04\x9b\x07\x08\r\n\r\n\x05\x04\x12\x02\x11\x03\x12\x04\x9b\
    \x07\x10\x12\n\r\n\x05\x04\x12\x02\x11\x08\x12\x04\x9b\x07\x13>\n\x10\n\
    \x08\x04\x12\x02\x11\x08\x9c\x08\0\x12\x04\x9b\x07\x14=\n\x87\x04\n\x02\
    \x04\x13\x12\x06\xa9\x07\0\xb4\x07\x01\x1a\xf8\x03\x20A\x20policy\x20tha\
    t\x20specifies\x20how\x20Pub/Sub\x20retries\x20message\x20delivery.\n\n\
    \x20Retry\x20delay\x20will\x20be\x20exponential\x20based\x20on\x20provid\
    ed\x20minimum\x20and\x20maximum\n\x20backoffs.\x20https://en.wikipedia.o\
    rg/wiki/Exponential_backoff.\n\n\x20RetryPolicy\x20will\x20be\x20trigger\
    ed\x20on\x20NACKs\x20or\x20acknowledgement\x20deadline\x20exceeded\n\x20\
    events\x20for\x20a\x20given\x20message.\n\n\x20Retry\x20Policy\x20is\x20\
    implemented\x20on\x20a\x20best\x20effort\x20basis.\x20At\x20times,\x20th\
    e\x20delay\n\x20between\x20consecutive\x20deliveries\x20may\x20not\x20ma\
    tch\x20the\x20configuration.\x20That\x20is,\n\x20delay\x20can\x20be\x20m\
    ore\x20or\x20less\x20than\x20configured\x20backoff.\n\n\x0b\n\x03\x04\
    \x13\x01\x12\x04\xa9\x07\x08\x13\n\xa5\x01\n\x04\x04\x13\x02\0\x12\x06\
    \xac\x07\x02\xad\x07/\x1a\x94\x01\x20Optional.\x20The\x20minimum\x20dela\
    y\x20between\x20consecutive\x20deliveries\x20of\x20a\x20given\n\x20messa\
    ge.\x20Value\x20should\x20be\x20between\x200\x20and\x20600\x20seconds.\
    \x20Defaults\x20to\x2010\x20seconds.\n\n\r\n\x05\x04\x13\x02\0\x06\x12\
    \x04\xac\x07\x02\x1a\n\r\n\x05\x04\x13\x02\0\x01\x12\x04\xac\x07\x1b*\n\
    \r\n\x05\x04\x13\x02\0\x03\x12\x04\xac\x07-.\n\r\n\x05\x04\x13\x02\0\x08\
    \x12\x04\xad\x07\x06.\n\x10\n\x08\x04\x13\x02\0\x08\x9c\x08\0\x12\x04\
    \xad\x07\x07-\n\xa7\x01\n\x04\x04\x13\x02\x01\x12\x06\xb2\x07\x02\xb3\
    \x07/\x1a\x96\x01\x20Optional.\x20The\x20maximum\x20delay\x20between\x20\
    consecutive\x20deliveries\x20of\x20a\x20given\n\x20message.\x20Value\x20\
    should\x20be\x20between\x200\x20and\x20600\x20seconds.\x20Defaults\x20to\
    \x20600\n\x20seconds.\n\n\r\n\x05\x04\x13\x02\x01\x06\x12\x04\xb2\x07\
    \x02\x1a\n\r\n\x05\x04\x13\x02\x01\x01\x12\x04\xb2\x07\x1b*\n\r\n\x05\
    \x04\x13\x02\x01\x03\x12\x04\xb2\x07-.\n\r\n\x05\x04\x13\x02\x01\x08\x12\
    \x04\xb3\x07\x06.\n\x10\n\x08\x04\x13\x02\x01\x08\x9c\x08\0\x12\x04\xb3\
    \x07\x07-\n\xf9\x01\n\x02\x04\x14\x12\x06\xbb\x07\0\xd5\x07\x01\x1a\xea\
    \x01\x20Dead\x20lettering\x20is\x20done\x20on\x20a\x20best\x20effort\x20\
    basis.\x20The\x20same\x20message\x20might\x20be\n\x20dead\x20lettered\
    \x20multiple\x20times.\n\n\x20If\x20validation\x20on\x20any\x20of\x20the\
    \x20fields\x20fails\x20at\x20subscription\x20creation/updation,\n\x20the\
    \x20create/update\x20subscription\x20request\x20will\x20fail.\n\n\x0b\n\
    \x03\x04\x14\x01\x12\x04\xbb\x07\x08\x18\n\xaa\x04\n\x04\x04\x14\x02\0\
    \x12\x04\xc5\x07\x02H\x1a\x9b\x04\x20Optional.\x20The\x20name\x20of\x20t\
    he\x20topic\x20to\x20which\x20dead\x20letter\x20messages\x20should\x20be\
    \n\x20published.\x20Format\x20is\x20`projects/{project}/topics/{topic}`.\
    The\x20Pub/Sub\n\x20service\x20account\x20associated\x20with\x20the\x20e\
    nclosing\x20subscription's\x20parent\x20project\n\x20(i.e.,\x20service-{\
    project_number}@gcp-sa-pubsub.iam.gserviceaccount.com)\x20must\n\x20have\
    ...
    \n\r\n\x05\x04\x14\x02\0\x05\x12\x04\xc5\x07\x02\x08\n\r\n\x05\x04\x14\
    \x02\0\x01\x12\x04\xc5\x07\t\x1a\n\r\n\x05\x04\x14\x02\0\x03\x12\x04\xc5\
    \x07\x1d\x1e\n\r\n\x05\x04\x14\x02\0\x08\x12\x04\xc5\x07\x1fG\n\x10\n\
    \x08\x04\x14\x02\0\x08\x9c\x08\0\x12\x04\xc5\x07\x20F\n\x8e\x04\n\x04\
    \x04\x14\x02\x01\x12\x04\xd4\x07\x02K\x1a\xff\x03\x20Optional.\x20The\
    \x20maximum\x20number\x20of\x20delivery\x20attempts\x20for\x20any\x20mes\
    sage.\x20The\n\x20value\x20must\x20be\x20between\x205\x20and\x20100.\n\n\
    \x20The\x20number\x20of\x20delivery\x20attempts\x20is\x20defined\x20as\
    \x201\x20+\x20(the\x20sum\x20of\x20number\x20of\n\x20NACKs\x20and\x20num\
    ber\x20of\x20times\x20the\x20acknowledgement\x20deadline\x20has\x20been\
    \x20exceeded\n\x20for\x20the\x20message).\n\n\x20A\x20NACK\x20is\x20any\
    \x20call\x20to\x20ModifyAckDeadline\x20with\x20a\x200\x20deadline.\x20No\
    te\x20that\n\x20client\x20libraries\x20may\x20automatically\x20extend\
    \x20ack_deadlines.\n\n\x20This\x20field\x20will\x20be\x20honored\x20on\
    \x20a\x20best\x20effort\x20basis.\n\n\x20If\x20this\x20parameter\x20is\
    \x200,\x20a\x20default\x20value\x20of\x205\x20is\x20used.\n\n\r\n\x05\
    \x04\x14\x02\x01\x05\x12\x04\xd4\x07\x02\x07\n\r\n\x05\x04\x14\x02\x01\
    \x01\x12\x04\xd4\x07\x08\x1d\n\r\n\x05\x04\x14\x02\x01\x03\x12\x04\xd4\
    \x07\x20!\n\r\n\x05\x04\x14\x02\x01\x08\x12\x04\xd4\x07\"J\n\x10\n\x08\
    \x04\x14\x02\x01\x08\x9c\x08\0\x12\x04\xd4\x07#I\nt\n\x02\x04\x15\x12\
    \x06\xd9\x07\0\xe1\x07\x01\x1af\x20A\x20policy\x20that\x20specifies\x20t\
    he\x20conditions\x20for\x20resource\x20expiration\x20(i.e.,\n\x20automat\
    ic\x20resource\x20deletion).\n\n\x0b\n\x03\x04\x15\x01\x12\x04\xd9\x07\
    \x08\x18\n\x93\x03\n\x04\x04\x15\x02\0\x12\x04\xe0\x07\x02L\x1a\x84\x03\
    \x20Optional.\x20Specifies\x20the\x20\"time-to-live\"\x20duration\x20for\
    \x20an\x20associated\x20resource.\n\x20The\x20resource\x20expires\x20if\
    \x20it\x20is\x20not\x20active\x20for\x20a\x20period\x20of\x20`ttl`.\x20T\
    he\n\x20definition\x20of\x20\"activity\"\x20depends\x20on\x20the\x20type\
    \x20of\x20the\x20associated\x20resource.\n\x20The\x20minimum\x20and\x20m\
    aximum\x20allowed\x20values\x20for\x20`ttl`\x20depend\x20on\x20the\x20ty\
    pe\x20of\x20the\n\x20associated\x20resource,\x20as\x20well.\x20If\x20`tt\
    l`\x20is\x20not\x20set,\x20the\x20associated\x20resource\n\x20never\x20e\
    xpires.\n\n\r\n\x05\x04\x15\x02\0\x06\x12\x04\xe0\x07\x02\x1a\n\r\n\x05\
    \x04\x15\x02\0\x01\x12\x04\xe0\x07\x1b\x1e\n\r\n\x05\x04\x15\x02\0\x03\
    \x12\x04\xe0\x07!\"\n\r\n\x05\x04\x15\x02\0\x08\x12\x04\xe0\x07#K\n\x10\
    \n\x08\x04\x15\x02\0\x08\x9c\x08\0\x12\x04\xe0\x07$J\n;\n\x02\x04\x16\
    \x12\x06\xe4\x07\0\xb9\x08\x01\x1a-\x20Configuration\x20for\x20a\x20push\
    \x20delivery\x20endpoint.\n\n\x0b\n\x03\x04\x16\x01\x12\x04\xe4\x07\x08\
    \x12\n\x9a\x01\n\x04\x04\x16\x03\0\x12\x06\xe8\x07\x02\xf8\x07\x03\x1a\
    \x89\x01\x20Contains\x20information\x20needed\x20for\x20generating\x20an\
    \n\x20[OpenID\x20Connect\n\x20token](https://developers.google.com/ident\
    ity/protocols/OpenIDConnect).\n\n\r\n\x05\x04\x16\x03\0\x01\x12\x04\xe8\
    \x07\n\x13\n\x88\x02\n\x06\x04\x16\x03\0\x02\0\x12\x04\xee\x07\x04N\x1a\
    \xf7\x01\x20Optional.\x20[Service\x20account\n\x20email](https://cloud.g\
    oogle.com/iam/docs/service-accounts)\n\x20used\x20for\x20generating\x20t\
    he\x20OIDC\x20token.\x20For\x20more\x20information\n\x20on\x20setting\
    \x20up\x20authentication,\x20see\n\x20[Push\x20subscriptions](https://cl\
    oud.google.com/pubsub/docs/push).\n\n\x0f\n\x07\x04\x16\x03\0\x02\0\x05\
    \x12\x04\xee\x07\x04\n\n\x0f\n\x07\x04\x16\x03\0\x02\0\x01\x12\x04\xee\
    \x07\x0b\x20\n\x0f\n\x07\x04\x16\x03\0\x02\0\x03\x12\x04\xee\x07#$\n\x0f\
    \n\x07\x04\x16\x03\0\x02\0\x08\x12\x04\xee\x07%M\n\x12\n\n\x04\x16\x03\0\
    \x02\0\x08\x9c\x08\0\x12\x04\xee\x07&L\n\xbb\x03\n\x06\x04\x16\x03\0\x02\
    \x01\x12\x04\xf7\x07\x04A\x1a\xaa\x03\x20Optional.\x20Audience\x20to\x20\
    be\x20used\x20when\x20generating\x20OIDC\x20token.\x20The\x20audience\n\
    \x20claim\x20identifies\x20the\x20recipients\x20that\x20the\x20JWT\x20is\
    \x20intended\x20for.\x20The\n\x20audience\x20value\x20is\x20a\x20single\
    \x20case-sensitive\x20string.\x20Having\x20multiple\x20values\n\x20(arra\
    y)\x20for\x20the\x20audience\x20field\x20is\x20not\x20supported.\x20More\
    \x20info\x20about\x20the\x20OIDC\n\x20JWT\x20token\x20audience\x20here:\
    \n\x20https://tools.ietf.org/html/rfc7519#section-4.1.3\x20Note:\x20if\
    \x20not\x20specified,\n\x20the\x20Push\x20endpoint\x20URL\x20will\x20be\
    \x20used.\n\n\x0f\n\x07\x04\x16\x03\0\x02\x01\x05\x12\x04\xf7\x07\x04\n\
    \n\x0f\n\x07\x04\x16\x03\0\x02\x01\x01\x12\x04\xf7\x07\x0b\x13\n\x0f\n\
    \x07\x04\x16\x03\0\x02\x01\x03\x12\x04\xf7\x07\x16\x17\n\x0f\n\x07\x04\
    \x16\x03\0\x02\x01\x08\x12\x04\xf7\x07\x18@\n\x12\n\n\x04\x16\x03\0\x02\
    \x01\x08\x9c\x08\0\x12\x04\xf7\x07\x19?\n\xc5\x01\n\x04\x04\x16\x03\x01\
    \x12\x04\xfd\x07\x02\x1a\x1a\xb6\x01\x20The\x20payload\x20to\x20the\x20p\
    ush\x20endpoint\x20is\x20in\x20the\x20form\x20of\x20the\x20JSON\x20repre\
    sentation\n\x20of\x20a\x20PubsubMessage\n\x20(https://cloud.google.com/p\
    ubsub/docs/reference/rpc/google.pubsub.v1#pubsubmessage).\n\n\r\n\x05\
    \x04\x16\x03\x01\x01\x12\x04\xfd\x07\n\x17\nF\n\x04\x04\x16\x03\x02\x12\
    \x06\x80\x08\x02\x85\x08\x03\x1a6\x20Sets\x20the\x20`data`\x20field\x20a\
    s\x20the\x20HTTP\x20body\x20for\x20delivery.\n\n\r\n\x05\x04\x16\x03\x02\
    \x01\x12\x04\x80\x08\n\x13\n\xdd\x01\n\x06\x04\x16\x03\x02\x02\0\x12\x04\
    \x84\x08\x04E\x1a\xcc\x01\x20Optional.\x20When\x20true,\x20writes\x20the\
    \x20Pub/Sub\x20message\x20metadata\x20to\n\x20`x-goog-pubsub-<KEY>:<VAL>\
    `\x20headers\x20of\x20the\x20HTTP\x20request.\x20Writes\x20the\n\x20Pub/\
    Sub\x20message\x20attributes\x20to\x20`<KEY>:<VAL>`\x20headers\x20of\x20\
    the\x20HTTP\x20request.\n\n\x0f\n\x07\x04\x16\x03\x02\x02\0\x05\x12\x04\
    \x84\x08\x04\x08\n\x0f\n\x07\x04\x16\x03\x02\x02\0\x01\x12\x04\x84\x08\t\
    \x17\n\x0f\n\x07\x04\x16\x03\x02\x02\0\x03\x12\x04\x84\x08\x1a\x1b\n\x0f\
    \n\x07\x04\x16\x03\x02\x02\0\x08\x12\x04\x84\x08\x1cD\n\x12\n\n\x04\x16\
    \x03\x02\x02\0\x08\x9c\x08\0\x12\x04\x84\x08\x1dC\n\xa1\x01\n\x04\x04\
    \x16\x02\0\x12\x04\x89\x08\x02D\x1a\x92\x01\x20Optional.\x20A\x20URL\x20\
    locating\x20the\x20endpoint\x20to\x20which\x20messages\x20should\x20be\
    \x20pushed.\n\x20For\x20example,\x20a\x20Webhook\x20endpoint\x20might\
    \x20use\x20`https://example.com/push`.\n\n\r\n\x05\x04\x16\x02\0\x05\x12\
    \x04\x89\x08\x02\x08\n\r\n\x05\x04\x16\x02\0\x01\x12\x04\x89\x08\t\x16\n\
    \r\n\x05\x04\x16\x02\0\x03\x12\x04\x89\x08\x19\x1a\n\r\n\x05\x04\x16\x02\
    \0\x08\x12\x04\x89\x08\x1bC\n\x10\n\x08\x04\x16\x02\0\x08\x9c\x08\0\x12\
    \x04\x89\x08\x1cB\n\xf5\x07\n\x04\x04\x16\x02\x01\x12\x04\xa0\x08\x02N\
    \x1a\xe6\x07\x20Optional.\x20Endpoint\x20configuration\x20attributes\x20\
    that\x20can\x20be\x20used\x20to\x20control\n\x20different\x20aspects\x20\
    of\x20the\x20message\x20delivery.\n\n\x20The\x20only\x20currently\x20sup\
    ported\x20attribute\x20is\x20`x-goog-version`,\x20which\x20you\x20can\n\
    \x20use\x20to\x20change\x20the\x20format\x20of\x20the\x20pushed\x20messa\
    ge.\x20This\x20attribute\n\x20indicates\x20the\x20version\x20of\x20the\
    \x20data\x20expected\x20by\x20the\x20endpoint.\x20This\n\x20controls\x20\
    the\x20shape\x20of\x20the\x20pushed\x20message\x20(i.e.,\x20its\x20field\
    s\x20and\x20metadata).\n\n\x20If\x20not\x20present\x20during\x20the\x20`\
    CreateSubscription`\x20call,\x20it\x20will\x20default\x20to\n\x20the\x20\
    version\x20of\x20the\x20Pub/Sub\x20API\x20used\x20to\x20make\x20such\x20\
    call.\x20If\x20not\x20present\x20in\x20a\n\x20`ModifyPushConfig`\x20call\
    ,\x20its\x20value\x20will\x20not\x20be\x20changed.\x20`GetSubscription`\
    \n\x20calls\x20will\x20always\x20return\x20a\x20valid\x20version,\x20eve\
    n\x20if\x20the\x20subscription\x20was\n\x20created\x20without\x20this\
    \x20attribute.\n\n\x20The\x20only\x20supported\x20values\x20for\x20the\
    \x20`x-goog-version`\x20attribute\x20are:\n\n\x20*\x20`v1beta1`:\x20uses\
    \x20the\x20push\x20format\x20defined\x20in\x20the\x20v1beta1\x20Pub/Sub\
    \x20API.\n\x20*\x20`v1`\x20or\x20`v1beta2`:\x20uses\x20the\x20push\x20fo\
    rmat\x20defined\x20in\x20the\x20v1\x20Pub/Sub\x20API.\n\n\x20For\x20exam\
    ple:\n\x20`attributes\x20{\x20\"x-goog-version\":\x20\"v1\"\x20}`\n\n\r\
    \n\x05\x04\x16\x02\x01\x06\x12\x04\xa0\x08\x02\x15\n\r\n\x05\x04\x16\x02\
    \x01\x01\x12\x04\xa0\x08\x16\x20\n\r\n\x05\x04\x16\x02\x01\x03\x12\x04\
    \xa0\x08#$\n\r\n\x05\x04\x16\x02\x01\x08\x12\x04\xa0\x08%M\n\x10\n\x08\
    \x04\x16\x02\x01\x08\x9c\x08\0\x12\x04\xa0\x08&L\n\xc4\x02\n\x04\x04\x16\
    \x08\0\x12\x06\xa7\x08\x02\xac\x08\x03\x1a\xb3\x02\x20An\x20authenticati\
    ...
    \x20to\x20allow\x20requests\x20only\x20from\x20the\x20Pub/Sub\x20system,\
    \x20for\x20example.\n\x20This\x20field\x20is\x20optional\x20and\x20shoul\
    d\x20be\x20set\x20only\x20by\x20users\x20interested\x20in\n\x20authentic\
    ated\x20push.\n\n\r\n\x05\x04\x16\x08\0\x01\x12\x04\xa7\x08\x08\x1d\n\
    \xa8\x01\n\x04\x04\x16\x02\x02\x12\x04\xab\x08\x04F\x1a\x99\x01\x20Optio\
    nal.\x20If\x20specified,\x20Pub/Sub\x20will\x20generate\x20and\x20attach\
    \x20an\x20OIDC\x20JWT\n\x20token\x20as\x20an\x20`Authorization`\x20heade\
    r\x20in\x20the\x20HTTP\x20request\x20for\x20every\x20pushed\n\x20message\
    .\n\n\r\n\x05\x04\x16\x02\x02\x06\x12\x04\xab\x08\x04\r\n\r\n\x05\x04\
    \x16\x02\x02\x01\x12\x04\xab\x08\x0e\x18\n\r\n\x05\x04\x16\x02\x02\x03\
    \x12\x04\xab\x08\x1b\x1c\n\r\n\x05\x04\x16\x02\x02\x08\x12\x04\xab\x08\
    \x1dE\n\x10\n\x08\x04\x16\x02\x02\x08\x9c\x08\0\x12\x04\xab\x08\x1eD\n\
    \x93\x01\n\x04\x04\x16\x08\x01\x12\x06\xb0\x08\x02\xb8\x08\x03\x1a\x82\
    \x01\x20The\x20format\x20of\x20the\x20delivered\x20message\x20to\x20the\
    \x20push\x20endpoint\x20is\x20defined\x20by\n\x20the\x20chosen\x20wrappe\
    r.\x20When\x20unset,\x20`PubsubWrapper`\x20is\x20used.\n\n\r\n\x05\x04\
    \x16\x08\x01\x01\x12\x04\xb0\x08\x08\x0f\n\xd9\x01\n\x04\x04\x16\x02\x03\
    \x12\x04\xb4\x08\x04N\x1a\xca\x01\x20Optional.\x20When\x20set,\x20the\
    \x20payload\x20to\x20the\x20push\x20endpoint\x20is\x20in\x20the\x20form\
    \x20of\n\x20the\x20JSON\x20representation\x20of\x20a\x20PubsubMessage\n\
    \x20(https://cloud.google.com/pubsub/docs/reference/rpc/google.pubsub.v1\
    #pubsubmessage).\n\n\r\n\x05\x04\x16\x02\x03\x06\x12\x04\xb4\x08\x04\x11\
    \n\r\n\x05\x04\x16\x02\x03\x01\x12\x04\xb4\x08\x12\x20\n\r\n\x05\x04\x16\
    \x02\x03\x03\x12\x04\xb4\x08#$\n\r\n\x05\x04\x16\x02\x03\x08\x12\x04\xb4\
    \x08%M\n\x10\n\x08\x04\x16\x02\x03\x08\x9c\x08\0\x12\x04\xb4\x08&L\nT\n\
    \x04\x04\x16\x02\x04\x12\x04\xb7\x08\x04F\x1aF\x20Optional.\x20When\x20s\
    et,\x20the\x20payload\x20to\x20the\x20push\x20endpoint\x20is\x20not\x20w\
    rapped.\n\n\r\n\x05\x04\x16\x02\x04\x06\x12\x04\xb7\x08\x04\r\n\r\n\x05\
    \x04\x16\x02\x04\x01\x12\x04\xb7\x08\x0e\x18\n\r\n\x05\x04\x16\x02\x04\
    \x03\x12\x04\xb7\x08\x1b\x1c\n\r\n\x05\x04\x16\x02\x04\x08\x12\x04\xb7\
    \x08\x1dE\n\x10\n\x08\x04\x16\x02\x04\x08\x9c\x08\0\x12\x04\xb7\x08\x1eD\
    \n:\n\x02\x04\x17\x12\x06\xbc\x08\0\xf7\x08\x01\x1a,\x20Configuration\
    \x20for\x20a\x20BigQuery\x20subscription.\n\n\x0b\n\x03\x04\x17\x01\x12\
    \x04\xbc\x08\x08\x16\n>\n\x04\x04\x17\x04\0\x12\x06\xbe\x08\x02\xd6\x08\
    \x03\x1a.\x20Possible\x20states\x20for\x20a\x20BigQuery\x20subscription.\
    \n\n\r\n\x05\x04\x17\x04\0\x01\x12\x04\xbe\x08\x07\x0c\n6\n\x06\x04\x17\
    \x04\0\x02\0\x12\x04\xc0\x08\x04\x1a\x1a&\x20Default\x20value.\x20This\
    \x20value\x20is\x20unused.\n\n\x0f\n\x07\x04\x17\x04\0\x02\0\x01\x12\x04\
    \xc0\x08\x04\x15\n\x0f\n\x07\x04\x17\x04\0\x02\0\x02\x12\x04\xc0\x08\x18\
    \x19\nI\n\x06\x04\x17\x04\0\x02\x01\x12\x04\xc3\x08\x04\x0f\x1a9\x20The\
    \x20subscription\x20can\x20actively\x20send\x20messages\x20to\x20BigQuer\
    y\n\n\x0f\n\x07\x04\x17\x04\0\x02\x01\x01\x12\x04\xc3\x08\x04\n\n\x0f\n\
    \x07\x04\x17\x04\0\x02\x01\x02\x12\x04\xc3\x08\r\x0e\n\xa3\x03\n\x06\x04\
    \x17\x04\0\x02\x02\x12\x04\xcb\x08\x04\x1a\x1a\x92\x03\x20Cannot\x20writ\
    e\x20to\x20the\x20BigQuery\x20table\x20because\x20of\x20permission\x20de\
    nied\x20errors.\n\x20This\x20can\x20happen\x20if\n\x20-\x20Pub/Sub\x20SA\
    \x20has\x20not\x20been\x20granted\x20the\x20[appropriate\x20BigQuery\x20\
    IAM\n\x20permissions](https://cloud.google.com/pubsub/docs/create-subscr\
    iption#assign_bigquery_service_account)\n\x20-\x20bigquery.googleapis.co\
    m\x20API\x20is\x20not\x20enabled\x20for\x20the\x20project\n\x20([instruc\
    tions](https://cloud.google.com/service-usage/docs/enable-disable))\n\n\
    \x0f\n\x07\x04\x17\x04\0\x02\x02\x01\x12\x04\xcb\x08\x04\x15\n\x0f\n\x07\
    \x04\x17\x04\0\x02\x02\x02\x12\x04\xcb\x08\x18\x19\nO\n\x06\x04\x17\x04\
    \0\x02\x03\x12\x04\xce\x08\x04\x12\x1a?\x20Cannot\x20write\x20to\x20the\
    \x20BigQuery\x20table\x20because\x20it\x20does\x20not\x20exist.\n\n\x0f\
    \n\x07\x04\x17\x04\0\x02\x03\x01\x12\x04\xce\x08\x04\r\n\x0f\n\x07\x04\
    \x17\x04\0\x02\x03\x02\x12\x04\xce\x08\x10\x11\nN\n\x06\x04\x17\x04\0\
    \x02\x04\x12\x04\xd1\x08\x04\x18\x1a>\x20Cannot\x20write\x20to\x20the\
    \x20BigQuery\x20table\x20due\x20to\x20a\x20schema\x20mismatch.\n\n\x0f\n\
    \x07\x04\x17\x04\0\x02\x04\x01\x12\x04\xd1\x08\x04\x13\n\x0f\n\x07\x04\
    \x17\x04\0\x02\x04\x02\x12\x04\xd1\x08\x16\x17\n\x9b\x01\n\x06\x04\x17\
    \x04\0\x02\x05\x12\x04\xd5\x08\x04(\x1a\x8a\x01\x20Cannot\x20write\x20to\
    \x20the\x20destination\x20because\x20enforce_in_transit\x20is\x20set\x20\
    to\x20true\n\x20and\x20the\x20destination\x20locations\x20are\x20not\x20\
    in\x20the\x20allowed\x20regions.\n\n\x0f\n\x07\x04\x17\x04\0\x02\x05\x01\
    \x12\x04\xd5\x08\x04#\n\x0f\n\x07\x04\x17\x04\0\x02\x05\x02\x12\x04\xd5\
    \x08&'\nv\n\x04\x04\x17\x02\0\x12\x04\xda\x08\x02<\x1ah\x20Optional.\x20\
    The\x20name\x20of\x20the\x20table\x20to\x20which\x20to\x20write\x20data,\
    \x20of\x20the\x20form\n\x20{projectId}.{datasetId}.{tableId}\n\n\r\n\x05\
    \x04\x17\x02\0\x05\x12\x04\xda\x08\x02\x08\n\r\n\x05\x04\x17\x02\0\x01\
    \x12\x04\xda\x08\t\x0e\n\r\n\x05\x04\x17\x02\0\x03\x12\x04\xda\x08\x11\
    \x12\n\r\n\x05\x04\x17\x02\0\x08\x12\x04\xda\x08\x13;\n\x10\n\x08\x04\
    \x17\x02\0\x08\x9c\x08\0\x12\x04\xda\x08\x14:\n\xc2\x01\n\x04\x04\x17\
    \x02\x01\x12\x04\xdf\x08\x02E\x1a\xb3\x01\x20Optional.\x20When\x20true,\
    \x20use\x20the\x20topic's\x20schema\x20as\x20the\x20columns\x20to\x20wri\
    te\x20to\x20in\n\x20BigQuery,\x20if\x20it\x20exists.\x20`use_topic_schem\
    a`\x20and\x20`use_table_schema`\x20cannot\x20be\n\x20enabled\x20at\x20th\
    e\x20same\x20time.\n\n\r\n\x05\x04\x17\x02\x01\x05\x12\x04\xdf\x08\x02\
    \x06\n\r\n\x05\x04\x17\x02\x01\x01\x12\x04\xdf\x08\x07\x17\n\r\n\x05\x04\
    \x17\x02\x01\x03\x12\x04\xdf\x08\x1a\x1b\n\r\n\x05\x04\x17\x02\x01\x08\
    \x12\x04\xdf\x08\x1cD\n\x10\n\x08\x04\x17\x02\x01\x08\x9c\x08\0\x12\x04\
    \xdf\x08\x1dC\n\xe5\x02\n\x04\x04\x17\x02\x02\x12\x04\xe6\x08\x02C\x1a\
    \xd6\x02\x20Optional.\x20When\x20true,\x20write\x20the\x20subscription\
    \x20name,\x20message_id,\x20publish_time,\n\x20attributes,\x20and\x20ord\
    ering_key\x20to\x20additional\x20columns\x20in\x20the\x20table.\x20The\n\
    \x20subscription\x20name,\x20message_id,\x20and\x20publish_time\x20field\
    s\x20are\x20put\x20in\x20their\x20own\n\x20columns\x20while\x20all\x20ot\
    her\x20message\x20properties\x20(other\x20than\x20data)\x20are\x20writte\
    n\x20to\n\x20a\x20JSON\x20object\x20in\x20the\x20attributes\x20column.\n\
    \n\r\n\x05\x04\x17\x02\x02\x05\x12\x04\xe6\x08\x02\x06\n\r\n\x05\x04\x17\
    \x02\x02\x01\x12\x04\xe6\x08\x07\x15\n\r\n\x05\x04\x17\x02\x02\x03\x12\
    \x04\xe6\x08\x18\x19\n\r\n\x05\x04\x17\x02\x02\x08\x12\x04\xe6\x08\x1aB\
    \n\x10\n\x08\x04\x17\x02\x02\x08\x9c\x08\0\x12\x04\xe6\x08\x1bA\n\xd3\
    \x02\n\x04\x04\x17\x02\x03\x12\x04\xed\x08\x02H\x1a\xc4\x02\x20Optional.\
    \x20When\x20true\x20and\x20use_topic_schema\x20is\x20true,\x20any\x20fie\
    lds\x20that\x20are\x20a\n\x20part\x20of\x20the\x20topic\x20schema\x20tha\
    t\x20are\x20not\x20part\x20of\x20the\x20BigQuery\x20table\x20schema\x20a\
    re\n\x20dropped\x20when\x20writing\x20to\x20BigQuery.\x20Otherwise,\x20t\
    he\x20schemas\x20must\x20be\x20kept\x20in\n\x20sync\x20and\x20any\x20mes\
    sages\x20with\x20extra\x20fields\x20are\x20not\x20written\x20and\x20rema\
    in\x20in\x20the\n\x20subscription's\x20backlog.\n\n\r\n\x05\x04\x17\x02\
    \x03\x05\x12\x04\xed\x08\x02\x06\n\r\n\x05\x04\x17\x02\x03\x01\x12\x04\
    \xed\x08\x07\x1a\n\r\n\x05\x04\x17\x02\x03\x03\x12\x04\xed\x08\x1d\x1e\n\
    \r\n\x05\x04\x17\x02\x03\x08\x12\x04\xed\x08\x1fG\n\x10\n\x08\x04\x17\
    \x02\x03\x08\x9c\x08\0\x12\x04\xed\x08\x20F\nw\n\x04\x04\x17\x02\x04\x12\
    \x04\xf1\x08\x02>\x1ai\x20Output\x20only.\x20An\x20output-only\x20field\
    \x20that\x20indicates\x20whether\x20or\x20not\x20the\n\x20subscription\
    \x20can\x20receive\x20messages.\n\n\r\n\x05\x04\x17\x02\x04\x06\x12\x04\
    \xf1\x08\x02\x07\n\r\n\x05\x04\x17\x02\x04\x01\x12\x04\xf1\x08\x08\r\n\r\
    \n\x05\x04\x17\x02\x04\x03\x12\x04\xf1\x08\x10\x11\n\r\n\x05\x04\x17\x02\
    \x04\x08\x12\x04\xf1\x08\x12=\n\x10\n\x08\x04\x17\x02\x04\x08\x9c\x08\0\
    \x12\x04\xf1\x08\x13<\n\xbd\x01\n\x04\x04\x17\x02\x05\x12\x04\xf6\x08\
    \x02E\x1a\xae\x01\x20Optional.\x20When\x20true,\x20use\x20the\x20BigQuer\
    y\x20table's\x20schema\x20as\x20the\x20columns\x20to\n\x20write\x20to\
    \x20in\x20BigQuery.\x20`use_table_schema`\x20and\x20`use_topic_schema`\
    \x20cannot\x20be\n\x20enabled\x20at\x20the\x20same\x20time.\n\n\r\n\x05\
    \x04\x17\x02\x05\x05\x12\x04\xf6\x08\x02\x06\n\r\n\x05\x04\x17\x02\x05\
    \x01\x12\x04\xf6\x08\x07\x17\n\r\n\x05\x04\x17\x02\x05\x03\x12\x04\xf6\
    \x08\x1a\x1b\n\r\n\x05\x04\x17\x02\x05\x08\x12\x04\xf6\x08\x1cD\n\x10\n\
    \x08\x04\x17\x02\x05\x08\x9c\x08\0\x12\x04\xf6\x08\x1dC\n?\n\x02\x04\x18\
    \x12\x06\xfa\x08\0\xc8\t\x01\x1a1\x20Configuration\x20for\x20a\x20Cloud\
    \x20Storage\x20subscription.\n\n\x0b\n\x03\x04\x18\x01\x12\x04\xfa\x08\
    \x08\x1a\n\x98\x01\n\x04\x04\x18\x03\0\x12\x04\xfe\x08\x02\x17\x1a\x89\
    \x01\x20Configuration\x20for\x20writing\x20message\x20data\x20in\x20text\
    \x20format.\n\x20Message\x20payloads\x20will\x20be\x20written\x20to\x20f\
    iles\x20as\x20raw\x20text,\x20separated\x20by\x20a\n\x20newline.\n\n\r\n\
    \x05\x04\x18\x03\0\x01\x12\x04\xfe\x08\n\x14\n\x94\x01\n\x04\x04\x18\x03\
    \x01\x12\x06\x82\t\x02\x8a\t\x03\x1a\x83\x01\x20Configuration\x20for\x20\
    writing\x20message\x20data\x20in\x20Avro\x20format.\n\x20Message\x20payl\
    oads\x20and\x20metadata\x20will\x20be\x20written\x20to\x20files\x20as\
    \x20an\x20Avro\x20binary.\n\n\r\n\x05\x04\x18\x03\x01\x01\x12\x04\x82\t\
    \n\x14\n\x85\x03\n\x06\x04\x18\x03\x01\x02\0\x12\x04\x89\t\x04E\x1a\xf4\
    \x02\x20Optional.\x20When\x20true,\x20write\x20the\x20subscription\x20na\
    me,\x20message_id,\n\x20publish_time,\x20attributes,\x20and\x20ordering_\
    key\x20as\x20additional\x20fields\x20in\x20the\n\x20output.\x20The\x20su\
    bscription\x20name,\x20message_id,\x20and\x20publish_time\x20fields\x20a\
    re\n\x20put\x20in\x20their\x20own\x20fields\x20while\x20all\x20other\x20\
    message\x20properties\x20other\x20than\n\x20data\x20(for\x20example,\x20\
    an\x20ordering_key,\x20if\x20present)\x20are\x20added\x20as\x20entries\
    \x20in\n\x20the\x20attributes\x20map.\n\n\x0f\n\x07\x04\x18\x03\x01\x02\
    \0\x05\x12\x04\x89\t\x04\x08\n\x0f\n\x07\x04\x18\x03\x01\x02\0\x01\x12\
    \x04\x89\t\t\x17\n\x0f\n\x07\x04\x18\x03\x01\x02\0\x03\x12\x04\x89\t\x1a\
    \x1b\n\x0f\n\x07\x04\x18\x03\x01\x02\0\x08\x12\x04\x89\t\x1cD\n\x12\n\n\
    \x04\x18\x03\x01\x02\0\x08\x9c\x08\0\x12\x04\x89\t\x1dC\nC\n\x04\x04\x18\
    \x04\0\x12\x06\x8d\t\x02\x9e\t\x03\x1a3\x20Possible\x20states\x20for\x20\
    a\x20Cloud\x20Storage\x20subscription.\n\n\r\n\x05\x04\x18\x04\0\x01\x12\
    \x04\x8d\t\x07\x0c\n6\n\x06\x04\x18\x04\0\x02\0\x12\x04\x8f\t\x04\x1a\
    \x1a&\x20Default\x20value.\x20This\x20value\x20is\x20unused.\n\n\x0f\n\
    \x07\x04\x18\x04\0\x02\0\x01\x12\x04\x8f\t\x04\x15\n\x0f\n\x07\x04\x18\
    \x04\0\x02\0\x02\x12\x04\x8f\t\x18\x19\nO\n\x06\x04\x18\x04\0\x02\x01\
    \x12\x04\x92\t\x04\x0f\x1a?\x20The\x20subscription\x20can\x20actively\
    \x20send\x20messages\x20to\x20Cloud\x20Storage.\n\n\x0f\n\x07\x04\x18\
    \x04\0\x02\x01\x01\x12\x04\x92\t\x04\n\n\x0f\n\x07\x04\x18\x04\0\x02\x01\
    \x02\x12\x04\x92\t\r\x0e\n`\n\x06\x04\x18\x04\0\x02\x02\x12\x04\x96\t\
    \x04\x1a\x1aP\x20Cannot\x20write\x20to\x20the\x20Cloud\x20Storage\x20buc\
    ket\x20because\x20of\x20permission\x20denied\n\x20errors.\n\n\x0f\n\x07\
    \x04\x18\x04\0\x02\x02\x01\x12\x04\x96\t\x04\x15\n\x0f\n\x07\x04\x18\x04\
    \0\x02\x02\x02\x12\x04\x96\t\x18\x19\nU\n\x06\x04\x18\x04\0\x02\x03\x12\
    \x04\x99\t\x04\x12\x1aE\x20Cannot\x20write\x20to\x20the\x20Cloud\x20Stor\
    age\x20bucket\x20because\x20it\x20does\x20not\x20exist.\n\n\x0f\n\x07\
    \x04\x18\x04\0\x02\x03\x01\x12\x04\x99\t\x04\r\n\x0f\n\x07\x04\x18\x04\0\
    \x02\x03\x02\x12\x04\x99\t\x10\x11\n\x9b\x01\n\x06\x04\x18\x04\0\x02\x04\
    \x12\x04\x9d\t\x04(\x1a\x8a\x01\x20Cannot\x20write\x20to\x20the\x20desti\
    nation\x20because\x20enforce_in_transit\x20is\x20set\x20to\x20true\n\x20\
    and\x20the\x20destination\x20locations\x20are\x20not\x20in\x20the\x20all\
    owed\x20regions.\n\n\x0f\n\x07\x04\x18\x04\0\x02\x04\x01\x12\x04\x9d\t\
    \x04#\n\x0f\n\x07\x04\x18\x04\0\x02\x04\x02\x12\x04\x9d\t&'\n\x8c\x02\n\
    \x04\x04\x18\x02\0\x12\x04\xa4\t\x02=\x1a\xfd\x01\x20Required.\x20User-p\
    rovided\x20name\x20for\x20the\x20Cloud\x20Storage\x20bucket.\n\x20The\
    \x20bucket\x20must\x20be\x20created\x20by\x20the\x20user.\x20The\x20buck\
    et\x20name\x20must\x20be\x20without\n\x20any\x20prefix\x20like\x20\"gs:/\
    /\".\x20See\x20the\x20[bucket\x20naming\n\x20requirements]\x20(https://c\
    loud.google.com/storage/docs/buckets#naming).\n\n\r\n\x05\x04\x18\x02\0\
    \x05\x12\x04\xa4\t\x02\x08\n\r\n\x05\x04\x18\x02\0\x01\x12\x04\xa4\t\t\
    \x0f\n\r\n\x05\x04\x18\x02\0\x03\x12\x04\xa4\t\x12\x13\n\r\n\x05\x04\x18\
    \x02\0\x08\x12\x04\xa4\t\x14<\n\x10\n\x08\x04\x18\x02\0\x08\x9c\x08\0\
    \x12\x04\xa4\t\x15;\n\xa8\x01\n\x04\x04\x18\x02\x01\x12\x04\xa8\t\x02F\
    \x1a\x99\x01\x20Optional.\x20User-provided\x20prefix\x20for\x20Cloud\x20\
    Storage\x20filename.\x20See\x20the\x20[object\n\x20naming\x20requirement\
    s](https://cloud.google.com/storage/docs/objects#naming).\n\n\r\n\x05\
    \x04\x18\x02\x01\x05\x12\x04\xa8\t\x02\x08\n\r\n\x05\x04\x18\x02\x01\x01\
    \x12\x04\xa8\t\t\x18\n\r\n\x05\x04\x18\x02\x01\x03\x12\x04\xa8\t\x1b\x1c\
    \n\r\n\x05\x04\x18\x02\x01\x08\x12\x04\xa8\t\x1dE\n\x10\n\x08\x04\x18\
    \x02\x01\x08\x9c\x08\0\x12\x04\xa8\t\x1eD\n\xbe\x01\n\x04\x04\x18\x02\
    \x02\x12\x04\xad\t\x02F\x1a\xaf\x01\x20Optional.\x20User-provided\x20suf\
    fix\x20for\x20Cloud\x20Storage\x20filename.\x20See\x20the\x20[object\n\
    \x20naming\x20requirements](https://cloud.google.com/storage/docs/object\
    s#naming).\n\x20Must\x20not\x20end\x20in\x20\"/\".\n\n\r\n\x05\x04\x18\
    \x02\x02\x05\x12\x04\xad\t\x02\x08\n\r\n\x05\x04\x18\x02\x02\x01\x12\x04\
    \xad\t\t\x18\n\r\n\x05\x04\x18\x02\x02\x03\x12\x04\xad\t\x1b\x1c\n\r\n\
    \x05\x04\x18\x02\x02\x08\x12\x04\xad\t\x1dE\n\x10\n\x08\x04\x18\x02\x02\
    \x08\x9c\x08\0\x12\x04\xad\t\x1eD\n*\n\x04\x04\x18\x08\0\x12\x06\xb0\t\
    \x02\xb8\t\x03\x1a\x1a\x20Defaults\x20to\x20text\x20format.\n\n\r\n\x05\
    \x04\x18\x08\0\x01\x12\x04\xb0\t\x08\x15\n`\n\x04\x04\x18\x02\x03\x12\
    \x04\xb3\t\x04H\x1aR\x20Optional.\x20If\x20set,\x20message\x20data\x20wi\
    ll\x20be\x20written\x20to\x20Cloud\x20Storage\x20in\x20text\n\x20format.\
    \n\n\r\n\x05\x04\x18\x02\x03\x06\x12\x04\xb3\t\x04\x0e\n\r\n\x05\x04\x18\
    \x02\x03\x01\x12\x04\xb3\t\x0f\x1a\n\r\n\x05\x04\x18\x02\x03\x03\x12\x04\
    \xb3\t\x1d\x1e\n\r\n\x05\x04\x18\x02\x03\x08\x12\x04\xb3\t\x1fG\n\x10\n\
    \x08\x04\x18\x02\x03\x08\x9c\x08\0\x12\x04\xb3\t\x20F\n`\n\x04\x04\x18\
    \x02\x04\x12\x04\xb7\t\x04H\x1aR\x20Optional.\x20If\x20set,\x20message\
    \x20data\x20will\x20be\x20written\x20to\x20Cloud\x20Storage\x20in\x20Avr\
    o\n\x20format.\n\n\r\n\x05\x04\x18\x02\x04\x06\x12\x04\xb7\t\x04\x0e\n\r\
    \n\x05\x04\x18\x02\x04\x01\x12\x04\xb7\t\x0f\x1a\n\r\n\x05\x04\x18\x02\
    \x04\x03\x12\x04\xb7\t\x1d\x1e\n\r\n\x05\x04\x18\x02\x04\x08\x12\x04\xb7\
    \t\x1fG\n\x10\n\x08\x04\x18\x02\x04\x08\x9c\x08\0\x12\x04\xb7\t\x20F\n\
    \xdc\x01\n\x04\x04\x18\x02\x05\x12\x06\xbd\t\x02\xbe\t/\x1a\xcb\x01\x20O\
    ptional.\x20The\x20maximum\x20duration\x20that\x20can\x20elapse\x20befor\
    e\x20a\x20new\x20Cloud\x20Storage\n\x20file\x20is\x20created.\x20Min\x20\
    1\x20minute,\x20max\x2010\x20minutes,\x20default\x205\x20minutes.\x20May\
    \x20not\n\x20exceed\x20the\x20subscription's\x20acknowledgement\x20deadl\
    ine.\n\n\r\n\x05\x04\x18\x02\x05\x06\x12\x04\xbd\t\x02\x1a\n\r\n\x05\x04\
    \x18\x02\x05\x01\x12\x04\xbd\t\x1b'\n\r\n\x05\x04\x18\x02\x05\x03\x12\
    \x04\xbd\t*+\n\r\n\x05\x04\x18\x02\x05\x08\x12\x04\xbe\t\x06.\n\x10\n\
    \x08\x04\x18\x02\x05\x08\x9c\x08\0\x12\x04\xbe\t\x07-\n\xe5\x01\n\x04\
    \x04\x18\x02\x06\x12\x04\xc3\t\x02?\x1a\xd6\x01\x20Optional.\x20The\x20m\
    aximum\x20bytes\x20that\x20can\x20be\x20written\x20to\x20a\x20Cloud\x20S\
    torage\x20file\n\x20before\x20a\x20new\x20file\x20is\x20created.\x20Min\
    \x201\x20KB,\x20max\x2010\x20GiB.\x20The\x20max_bytes\x20limit\x20may\n\
    \x20be\x20exceeded\x20in\x20cases\x20where\x20messages\x20are\x20larger\
    \x20than\x20the\x20limit.\n\n\r\n\x05\x04\x18\x02\x06\x05\x12\x04\xc3\t\
    \x02\x07\n\r\n\x05\x04\x18\x02\x06\x01\x12\x04\xc3\t\x08\x11\n\r\n\x05\
    \x04\x18\x02\x06\x03\x12\x04\xc3\t\x14\x15\n\r\n\x05\x04\x18\x02\x06\x08\
    \x12\x04\xc3\t\x16>\n\x10\n\x08\x04\x18\x02\x06\x08\x9c\x08\0\x12\x04\
    \xc3\t\x17=\nw\n\x04\x04\x18\x02\x07\x12\x04\xc7\t\x02>\x1ai\x20Output\
    \x20only.\x20An\x20output-only\x20field\x20that\x20indicates\x20whether\
    \x20or\x20not\x20the\n\x20subscription\x20can\x20receive\x20messages.\n\
    \n\r\n\x05\x04\x18\x02\x07\x06\x12\x04\xc7\t\x02\x07\n\r\n\x05\x04\x18\
    \x02\x07\x01\x12\x04\xc7\t\x08\r\n\r\n\x05\x04\x18\x02\x07\x03\x12\x04\
    \xc7\t\x10\x11\n\r\n\x05\x04\x18\x02\x07\x08\x12\x04\xc7\t\x12=\n\x10\n\
    \x08\x04\x18\x02\x07\x08\x9c\x08\0\x12\x04\xc7\t\x13<\nB\n\x02\x04\x19\
    \x12\x06\xcb\t\0\xe3\t\x01\x1a4\x20A\x20message\x20and\x20its\x20corresp\
    onding\x20acknowledgment\x20ID.\n\n\x0b\n\x03\x04\x19\x01\x12\x04\xcb\t\
    \x08\x17\nR\n\x04\x04\x19\x02\0\x12\x04\xcd\t\x02=\x1aD\x20Optional.\x20\
    This\x20ID\x20can\x20be\x20used\x20to\x20acknowledge\x20the\x20received\
    \x20message.\n\n\r\n\x05\x04\x19\x02\0\x05\x12\x04\xcd\t\x02\x08\n\r\n\
    \x05\x04\x19\x02\0\x01\x12\x04\xcd\t\t\x0f\n\r\n\x05\x04\x19\x02\0\x03\
    \x12\x04\xcd\t\x12\x13\n\r\n\x05\x04\x19\x02\0\x08\x12\x04\xcd\t\x14<\n\
    \x10\n\x08\x04\x19\x02\0\x08\x9c\x08\0\x12\x04\xcd\t\x15;\n&\n\x04\x04\
    \x19\x02\x01\x12\x04\xd0\t\x02E\x1a\x18\x20Optional.\x20The\x20message.\
    \n\n\r\n\x05\x04\x19\x02\x01\x06\x12\x04\xd0\t\x02\x0f\n\r\n\x05\x04\x19\
    \x02\x01\x01\x12\x04\xd0\t\x10\x17\n\r\n\x05\x04\x19\x02\x01\x03\x12\x04\
    \xd0\t\x1a\x1b\n\r\n\x05\x04\x19\x02\x01\x08\x12\x04\xd0\t\x1cD\n\x10\n\
    \x08\x04\x19\x02\x01\x08\x9c\x08\0\x12\x04\xd0\t\x1dC\n\xe9\x05\n\x04\
    \x04\x19\x02\x02\x12\x04\xe2\t\x02F\x1a\xda\x05\x20Optional.\x20The\x20a\
    pproximate\x20number\x20of\x20times\x20that\x20Pub/Sub\x20has\x20attempt\
    ed\x20to\n\x20deliver\x20the\x20associated\x20message\x20to\x20a\x20subs\
    criber.\n\n\x20More\x20precisely,\x20this\x20is\x201\x20+\x20(number\x20\
    of\x20NACKs)\x20+\n\x20(number\x20of\x20ack_deadline\x20exceeds)\x20for\
    \x20this\x20message.\n\n\x20A\x20NACK\x20is\x20any\x20call\x20to\x20Modi\
    fyAckDeadline\x20with\x20a\x200\x20deadline.\x20An\x20ack_deadline\n\x20\
    exceeds\x20event\x20is\x20whenever\x20a\x20message\x20is\x20not\x20ackno\
    wledged\x20within\n\x20ack_deadline.\x20Note\x20that\x20ack_deadline\x20\
    is\x20initially\n\x20Subscription.ackDeadlineSeconds,\x20but\x20may\x20g\
    et\x20extended\x20automatically\x20by\n\x20the\x20client\x20library.\n\n\
    \x20Upon\x20the\x20first\x20delivery\x20of\x20a\x20given\x20message,\x20\
    `delivery_attempt`\x20will\x20have\x20a\n\x20value\x20of\x201.\x20The\
    \x20value\x20is\x20calculated\x20at\x20best\x20effort\x20and\x20is\x20ap\
    proximate.\n\n\x20If\x20a\x20DeadLetterPolicy\x20is\x20not\x20set\x20on\
    \x20the\x20subscription,\x20this\x20will\x20be\x200.\n\n\r\n\x05\x04\x19\
    \x02\x02\x05\x12\x04\xe2\t\x02\x07\n\r\n\x05\x04\x19\x02\x02\x01\x12\x04\
    \xe2\t\x08\x18\n\r\n\x05\x04\x19\x02\x02\x03\x12\x04\xe2\t\x1b\x1c\n\r\n\
    \x05\x04\x19\x02\x02\x08\x12\x04\xe2\t\x1dE\n\x10\n\x08\x04\x19\x02\x02\
    \x08\x9c\x08\0\x12\x04\xe2\t\x1eD\n7\n\x02\x04\x1a\x12\x06\xe6\t\0\xef\t\
    \x01\x1a)\x20Request\x20for\x20the\x20GetSubscription\x20method.\n\n\x0b\
    \n\x03\x04\x1a\x01\x12\x04\xe6\t\x08\x1e\nu\n\x04\x04\x1a\x02\0\x12\x06\
    \xe9\t\x02\xee\t\x04\x1ae\x20Required.\x20The\x20name\x20of\x20the\x20su\
    bscription\x20to\x20get.\n\x20Format\x20is\x20`projects/{project}/subscr\
    iptions/{sub}`.\n\n\r\n\x05\x04\x1a\x02\0\x05\x12\x04\xe9\t\x02\x08\n\r\
    \n\x05\x04\x1a\x02\0\x01\x12\x04\xe9\t\t\x15\n\r\n\x05\x04\x1a\x02\0\x03\
    \x12\x04\xe9\t\x18\x19\n\x0f\n\x05\x04\x1a\x02\0\x08\x12\x06\xe9\t\x1a\
    \xee\t\x03\n\x10\n\x08\x04\x1a\x02\0\x08\x9c\x08\0\x12\x04\xea\t\x04*\n\
    \x11\n\x07\x04\x1a\x02\0\x08\x9f\x08\x12\x06\xeb\t\x04\xed\t\x05\n:\n\
    \x02\x04\x1b\x12\x06\xf2\t\0\xfa\t\x01\x1a,\x20Request\x20for\x20the\x20\
    UpdateSubscription\x20method.\n\n\x0b\n\x03\x04\x1b\x01\x12\x04\xf2\t\
    \x08!\n:\n\x04\x04\x1b\x02\0\x12\x04\xf4\t\x02I\x1a,\x20Required.\x20The\
    \x20updated\x20subscription\x20object.\n\n\r\n\x05\x04\x1b\x02\0\x06\x12\
    \x04\xf4\t\x02\x0e\n\r\n\x05\x04\x1b\x02\0\x01\x12\x04\xf4\t\x0f\x1b\n\r\
    \n\x05\x04\x1b\x02\0\x03\x12\x04\xf4\t\x1e\x1f\n\r\n\x05\x04\x1b\x02\0\
    \x08\x12\x04\xf4\t\x20H\n\x10\n\x08\x04\x1b\x02\0\x08\x9c\x08\0\x12\x04\
    \xf4\t!G\n|\n\x04\x04\x1b\x02\x01\x12\x06\xf8\t\x02\xf9\t/\x1al\x20Requi\
    red.\x20Indicates\x20which\x20fields\x20in\x20the\x20provided\x20subscri\
    ption\x20to\x20update.\n\x20Must\x20be\x20specified\x20and\x20non-empty.\
    \n\n\r\n\x05\x04\x1b\x02\x01\x06\x12\x04\xf8\t\x02\x1b\n\r\n\x05\x04\x1b\
    \x02\x01\x01\x12\x04\xf8\t\x1c'\n\r\n\x05\x04\x1b\x02\x01\x03\x12\x04\
    \xf8\t*+\n\r\n\x05\x04\x1b\x02\x01\x08\x12\x04\xf9\t\x06.\n\x10\n\x08\
    \x04\x1b\x02\x01\x08\x9c\x08\0\x12\x04\xf9\t\x07-\n;\n\x02\x04\x1c\x12\
    \x06\xfd\t\0\x8e\n\x01\x1a-\x20Request\x20for\x20the\x20`ListSubscriptio\
    ns`\x20method.\n\n\x0b\n\x03\x04\x1c\x01\x12\x04\xfd\t\x08\x20\nw\n\x04\
    \x04\x1c\x02\0\x12\x06\x80\n\x02\x85\n\x04\x1ag\x20Required.\x20The\x20n\
    ame\x20of\x20the\x20project\x20in\x20which\x20to\x20list\x20subscription\
    s.\n\x20Format\x20is\x20`projects/{project-id}`.\n\n\r\n\x05\x04\x1c\x02\
    \0\x05\x12\x04\x80\n\x02\x08\n\r\n\x05\x04\x1c\x02\0\x01\x12\x04\x80\n\t\
    \x10\n\r\n\x05\x04\x1c\x02\0\x03\x12\x04\x80\n\x13\x14\n\x0f\n\x05\x04\
    \x1c\x02\0\x08\x12\x06\x80\n\x15\x85\n\x03\n\x10\n\x08\x04\x1c\x02\0\x08\
    \x9c\x08\0\x12\x04\x81\n\x04*\n\x11\n\x07\x04\x1c\x02\0\x08\x9f\x08\x12\
    \x06\x82\n\x04\x84\n\x05\nD\n\x04\x04\x1c\x02\x01\x12\x04\x88\n\x02?\x1a\
    6\x20Optional.\x20Maximum\x20number\x20of\x20subscriptions\x20to\x20retu\
    rn.\n\n\r\n\x05\x04\x1c\x02\x01\x05\x12\x04\x88\n\x02\x07\n\r\n\x05\x04\
    \x1c\x02\x01\x01\x12\x04\x88\n\x08\x11\n\r\n\x05\x04\x1c\x02\x01\x03\x12\
    \x04\x88\n\x14\x15\n\r\n\x05\x04\x1c\x02\x01\x08\x12\x04\x88\n\x16>\n\
    \x10\n\x08\x04\x1c\x02\x01\x08\x9c\x08\0\x12\x04\x88\n\x17=\n\xdc\x01\n\
    \x04\x04\x1c\x02\x02\x12\x04\x8d\n\x02A\x1a\xcd\x01\x20Optional.\x20The\
    \x20value\x20returned\x20by\x20the\x20last\x20`ListSubscriptionsResponse\
    `;\n\x20indicates\x20that\x20this\x20is\x20a\x20continuation\x20of\x20a\
    \x20prior\x20`ListSubscriptions`\x20call,\n\x20and\x20that\x20the\x20sys\
    tem\x20should\x20return\x20the\x20next\x20page\x20of\x20data.\n\n\r\n\
    \x05\x04\x1c\x02\x02\x05\x12\x04\x8d\n\x02\x08\n\r\n\x05\x04\x1c\x02\x02\
    \x01\x12\x04\x8d\n\t\x13\n\r\n\x05\x04\x1c\x02\x02\x03\x12\x04\x8d\n\x16\
    \x17\n\r\n\x05\x04\x1c\x02\x02\x08\x12\x04\x8d\n\x18@\n\x10\n\x08\x04\
    \x1c\x02\x02\x08\x9c\x08\0\x12\x04\x8d\n\x19?\n<\n\x02\x04\x1d\x12\x06\
    \x91\n\0\x9a\n\x01\x1a.\x20Response\x20for\x20the\x20`ListSubscriptions`\
    \x20method.\n\n\x0b\n\x03\x04\x1d\x01\x12\x04\x91\n\x08!\nE\n\x04\x04\
    \x1d\x02\0\x12\x06\x93\n\x02\x94\n/\x1a5\x20Optional.\x20The\x20subscrip\
    tions\x20that\x20match\x20the\x20request.\n\n\r\n\x05\x04\x1d\x02\0\x04\
    \x12\x04\x93\n\x02\n\n\r\n\x05\x04\x1d\x02\0\x06\x12\x04\x93\n\x0b\x17\n\
    \r\n\x05\x04\x1d\x02\0\x01\x12\x04\x93\n\x18%\n\r\n\x05\x04\x1d\x02\0\
    \x03\x12\x04\x93\n()\n\r\n\x05\x04\x1d\x02\0\x08\x12\x04\x94\n\x06.\n\
    \x10\n\x08\x04\x1d\x02\0\x08\x9c\x08\0\x12\x04\x94\n\x07-\n\xcc\x01\n\
    \x04\x04\x1d\x02\x01\x12\x04\x99\n\x02F\x1a\xbd\x01\x20Optional.\x20If\
    \x20not\x20empty,\x20indicates\x20that\x20there\x20may\x20be\x20more\x20\
    subscriptions\x20that\n\x20match\x20the\x20request;\x20this\x20value\x20\
    should\x20be\x20passed\x20in\x20a\x20new\n\x20`ListSubscriptionsRequest`\
    \x20to\x20get\x20more\x20subscriptions.\n\n\r\n\x05\x04\x1d\x02\x01\x05\
    \x12\x04\x99\n\x02\x08\n\r\n\x05\x04\x1d\x02\x01\x01\x12\x04\x99\n\t\x18\
    \n\r\n\x05\x04\x1d\x02\x01\x03\x12\x04\x99\n\x1b\x1c\n\r\n\x05\x04\x1d\
    \x02\x01\x08\x12\x04\x99\n\x1dE\n\x10\n\x08\x04\x1d\x02\x01\x08\x9c\x08\
    \0\x12\x04\x99\n\x1eD\n:\n\x02\x04\x1e\x12\x06\x9d\n\0\xa6\n\x01\x1a,\
    \x20Request\x20for\x20the\x20DeleteSubscription\x20method.\n\n\x0b\n\x03\
    \x04\x1e\x01\x12\x04\x9d\n\x08!\nl\n\x04\x04\x1e\x02\0\x12\x06\xa0\n\x02\
    \xa5\n\x04\x1a\\\x20Required.\x20The\x20subscription\x20to\x20delete.\n\
    \x20Format\x20is\x20`projects/{project}/subscriptions/{sub}`.\n\n\r\n\
    \x05\x04\x1e\x02\0\x05\x12\x04\xa0\n\x02\x08\n\r\n\x05\x04\x1e\x02\0\x01\
    \x12\x04\xa0\n\t\x15\n\r\n\x05\x04\x1e\x02\0\x03\x12\x04\xa0\n\x18\x19\n\
    \x0f\n\x05\x04\x1e\x02\0\x08\x12\x06\xa0\n\x1a\xa5\n\x03\n\x10\n\x08\x04\
    \x1e\x02\0\x08\x9c\x08\0\x12\x04\xa1\n\x04*\n\x11\n\x07\x04\x1e\x02\0\
    \x08\x9f\x08\x12\x06\xa2\n\x04\xa4\n\x05\n8\n\x02\x04\x1f\x12\x06\xa9\n\
    \0\xba\n\x01\x1a*\x20Request\x20for\x20the\x20ModifyPushConfig\x20method\
    .\n\n\x0b\n\x03\x04\x1f\x01\x12\x04\xa9\n\x08\x1f\nn\n\x04\x04\x1f\x02\0\
    \x12\x06\xac\n\x02\xb1\n\x04\x1a^\x20Required.\x20The\x20name\x20of\x20t\
    he\x20subscription.\n\x20Format\x20is\x20`projects/{project}/subscriptio\
    ns/{sub}`.\n\n\r\n\x05\x04\x1f\x02\0\x05\x12\x04\xac\n\x02\x08\n\r\n\x05\
    \x04\x1f\x02\0\x01\x12\x04\xac\n\t\x15\n\r\n\x05\x04\x1f\x02\0\x03\x12\
    \x04\xac\n\x18\x19\n\x0f\n\x05\x04\x1f\x02\0\x08\x12\x06\xac\n\x1a\xb1\n\
    \x03\n\x10\n\x08\x04\x1f\x02\0\x08\x9c\x08\0\x12\x04\xad\n\x04*\n\x11\n\
    \x07\x04\x1f\x02\0\x08\x9f\x08\x12\x06\xae\n\x04\xb0\n\x05\n\xc2\x02\n\
    \x04\x04\x1f\x02\x01\x12\x04\xb9\n\x02F\x1a\xb3\x02\x20Required.\x20The\
    \x20push\x20configuration\x20for\x20future\x20deliveries.\n\n\x20An\x20e\
    mpty\x20`pushConfig`\x20indicates\x20that\x20the\x20Pub/Sub\x20system\
    ...
    \n\x05\x04\x1f\x02\x01\x06\x12\x04\xb9\n\x02\x0c\n\r\n\x05\x04\x1f\x02\
    \x01\x01\x12\x04\xb9\n\r\x18\n\r\n\x05\x04\x1f\x02\x01\x03\x12\x04\xb9\n\
    \x1b\x1c\n\r\n\x05\x04\x1f\x02\x01\x08\x12\x04\xb9\n\x1dE\n\x10\n\x08\
    \x04\x1f\x02\x01\x08\x9c\x08\0\x12\x04\xb9\n\x1eD\n.\n\x02\x04\x20\x12\
    \x06\xbd\n\0\xd5\n\x01\x1a\x20\x20Request\x20for\x20the\x20`Pull`\x20met\
    hod.\n\n\x0b\n\x03\x04\x20\x01\x12\x04\xbd\n\x08\x13\n\x87\x01\n\x04\x04\
    \x20\x02\0\x12\x06\xc0\n\x02\xc5\n\x04\x1aw\x20Required.\x20The\x20subsc\
    ription\x20from\x20which\x20messages\x20should\x20be\x20pulled.\n\x20For\
    mat\x20is\x20`projects/{project}/subscriptions/{sub}`.\n\n\r\n\x05\x04\
    \x20\x02\0\x05\x12\x04\xc0\n\x02\x08\n\r\n\x05\x04\x20\x02\0\x01\x12\x04\
    \xc0\n\t\x15\n\r\n\x05\x04\x20\x02\0\x03\x12\x04\xc0\n\x18\x19\n\x0f\n\
    \x05\x04\x20\x02\0\x08\x12\x06\xc0\n\x1a\xc5\n\x03\n\x10\n\x08\x04\x20\
    \x02\0\x08\x9c\x08\0\x12\x04\xc1\n\x04*\n\x11\n\x07\x04\x20\x02\0\x08\
    \x9f\x08\x12\x06\xc2\n\x04\xc4\n\x05\n\xdf\x03\n\x04\x04\x20\x02\x01\x12\
    \x06\xce\n\x02\xcf\nB\x1a\xce\x03\x20Optional.\x20If\x20this\x20field\
    \x20set\x20to\x20true,\x20the\x20system\x20will\x20respond\x20immediatel\
    y\n\x20even\x20if\x20it\x20there\x20are\x20no\x20messages\x20available\
    \x20to\x20return\x20in\x20the\x20`Pull`\n\x20response.\x20Otherwise,\x20\
    the\x20system\x20may\x20wait\x20(for\x20a\x20bounded\x20amount\x20of\x20\
    time)\n\x20until\x20at\x20least\x20one\x20message\x20is\x20available,\
    \x20rather\x20than\x20returning\x20no\x20messages.\n\x20Warning:\x20sett\
    ing\x20this\x20field\x20to\x20`true`\x20is\x20discouraged\x20because\x20\
    it\x20adversely\n\x20impacts\x20the\x20performance\x20of\x20`Pull`\x20op\
    erations.\x20We\x20recommend\x20that\x20users\x20do\n\x20not\x20set\x20t\
    his\x20field.\n\n\r\n\x05\x04\x20\x02\x01\x05\x12\x04\xce\n\x02\x06\n\r\
    \n\x05\x04\x20\x02\x01\x01\x12\x04\xce\n\x07\x19\n\r\n\x05\x04\x20\x02\
    \x01\x03\x12\x04\xce\n\x1c\x1d\n\r\n\x05\x04\x20\x02\x01\x08\x12\x04\xcf\
    \n\x06A\n\x0e\n\x06\x04\x20\x02\x01\x08\x03\x12\x04\xcf\n\x07\x18\n\x10\
    \n\x08\x04\x20\x02\x01\x08\x9c\x08\0\x12\x04\xcf\n\x1a@\n\xb2\x01\n\x04\
    \x04\x20\x02\x02\x12\x04\xd4\n\x02B\x1a\xa3\x01\x20Required.\x20The\x20m\
    aximum\x20number\x20of\x20messages\x20to\x20return\x20for\x20this\x20req\
    uest.\x20Must\n\x20be\x20a\x20positive\x20integer.\x20The\x20Pub/Sub\x20\
    system\x20may\x20return\x20fewer\x20than\x20the\x20number\n\x20specified\
    .\n\n\r\n\x05\x04\x20\x02\x02\x05\x12\x04\xd4\n\x02\x07\n\r\n\x05\x04\
    \x20\x02\x02\x01\x12\x04\xd4\n\x08\x14\n\r\n\x05\x04\x20\x02\x02\x03\x12\
    \x04\xd4\n\x17\x18\n\r\n\x05\x04\x20\x02\x02\x08\x12\x04\xd4\n\x19A\n\
    \x10\n\x08\x04\x20\x02\x02\x08\x9c\x08\0\x12\x04\xd4\n\x1a@\n/\n\x02\x04\
    !\x12\x06\xd8\n\0\xe0\n\x01\x1a!\x20Response\x20for\x20the\x20`Pull`\x20\
    method.\n\n\x0b\n\x03\x04!\x01\x12\x04\xd8\n\x08\x14\n\xf7\x02\n\x04\x04\
    !\x02\0\x12\x06\xde\n\x02\xdf\n/\x1a\xe6\x02\x20Optional.\x20Received\
    \x20Pub/Sub\x20messages.\x20The\x20list\x20will\x20be\x20empty\x20if\x20\
    there\x20are\x20no\n\x20more\x20messages\x20available\x20in\x20the\x20ba\
    ...
    backlog.\n\n\r\n\x05\x04!\x02\0\x04\x12\x04\xde\n\x02\n\n\r\n\x05\x04!\
    \x02\0\x06\x12\x04\xde\n\x0b\x1a\n\r\n\x05\x04!\x02\0\x01\x12\x04\xde\n\
    \x1b,\n\r\n\x05\x04!\x02\0\x03\x12\x04\xde\n/0\n\r\n\x05\x04!\x02\0\x08\
    \x12\x04\xdf\n\x06.\n\x10\n\x08\x04!\x02\0\x08\x9c\x08\0\x12\x04\xdf\n\
    \x07-\n9\n\x02\x04\"\x12\x06\xe3\n\0\xfa\n\x01\x1a+\x20Request\x20for\
    \x20the\x20ModifyAckDeadline\x20method.\n\n\x0b\n\x03\x04\"\x01\x12\x04\
    \xe3\n\x08\x20\nn\n\x04\x04\"\x02\0\x12\x06\xe6\n\x02\xeb\n\x04\x1a^\x20\
    Required.\x20The\x20name\x20of\x20the\x20subscription.\n\x20Format\x20is\
    ...
    d.\x20List\x20of\x20acknowledgment\x20IDs.\n\n\r\n\x05\x04\"\x02\x01\x04\
    \x12\x04\xee\n\x02\n\n\r\n\x05\x04\"\x02\x01\x05\x12\x04\xee\n\x0b\x11\n\
    \r\n\x05\x04\"\x02\x01\x01\x12\x04\xee\n\x12\x19\n\r\n\x05\x04\"\x02\x01\
    \x03\x12\x04\xee\n\x1c\x1d\n\r\n\x05\x04\"\x02\x01\x08\x12\x04\xee\n\x1e\
    F\n\x10\n\x08\x04\"\x02\x01\x08\x9c\x08\0\x12\x04\xee\n\x1fE\n\xc9\x04\n\
    \x04\x04\"\x02\x02\x12\x04\xf9\n\x02J\x1a\xba\x04\x20Required.\x20The\
    \x20new\x20ack\x20deadline\x20with\x20respect\x20to\x20the\x20time\x20th\
    is\x20request\x20was\n\x20sent\x20to\x20the\x20Pub/Sub\x20system.\x20For\
    \x20example,\x20if\x20the\x20value\x20is\x2010,\x20the\x20new\x20ack\n\
    \x20deadline\x20will\x20expire\x2010\x20seconds\x20after\x20the\x20`Modi\
    fyAckDeadline`\x20call\x20was\n\x20made.\x20Specifying\x20zero\x20might\
    \x20immediately\x20make\x20the\x20message\x20available\x20for\n\x20deliv\
    ery\x20to\x20another\x20subscriber\x20client.\x20This\x20typically\x20re\
    sults\x20in\x20an\n\x20increase\x20in\x20the\x20rate\x20of\x20message\
    \x20redeliveries\x20(that\x20is,\x20duplicates).\n\x20The\x20minimum\x20\
    deadline\x20you\x20can\x20specify\x20is\x200\x20seconds.\n\x20The\x20max\
    imum\x20deadline\x20you\x20can\x20specify\x20in\x20a\x20single\x20reques\
    t\x20is\x20600\x20seconds\n\x20(10\x20minutes).\n\n\r\n\x05\x04\"\x02\
    \x02\x05\x12\x04\xf9\n\x02\x07\n\r\n\x05\x04\"\x02\x02\x01\x12\x04\xf9\n\
    \x08\x1c\n\r\n\x05\x04\"\x02\x02\x03\x12\x04\xf9\n\x1f\x20\n\r\n\x05\x04\
    \"\x02\x02\x08\x12\x04\xf9\n!I\n\x10\n\x08\x04\"\x02\x02\x08\x9c\x08\0\
    \x12\x04\xf9\n\"H\n3\n\x02\x04#\x12\x06\xfd\n\0\x8b\x0b\x01\x1a%\x20Requ\
    est\x20for\x20the\x20Acknowledge\x20method.\n\n\x0b\n\x03\x04#\x01\x12\
    \x04\xfd\n\x08\x1a\n\x86\x01\n\x04\x04#\x02\0\x12\x06\x80\x0b\x02\x85\
    \x0b\x04\x1av\x20Required.\x20The\x20subscription\x20whose\x20message\
    \x20is\x20being\x20acknowledged.\n\x20Format\x20is\x20`projects/{project\
    }/subscriptions/{sub}`.\n\n\r\n\x05\x04#\x02\0\x05\x12\x04\x80\x0b\x02\
    \x08\n\r\n\x05\x04#\x02\0\x01\x12\x04\x80\x0b\t\x15\n\r\n\x05\x04#\x02\0\
    \x03\x12\x04\x80\x0b\x18\x19\n\x0f\n\x05\x04#\x02\0\x08\x12\x06\x80\x0b\
    \x1a\x85\x0b\x03\n\x10\n\x08\x04#\x02\0\x08\x9c\x08\0\x12\x04\x81\x0b\
    \x04*\n\x11\n\x07\x04#\x02\0\x08\x9f\x08\x12\x06\x82\x0b\x04\x84\x0b\x05\
    \n\xa9\x01\n\x04\x04#\x02\x01\x12\x04\x8a\x0b\x02G\x1a\x9a\x01\x20Requir\
    ed.\x20The\x20acknowledgment\x20ID\x20for\x20the\x20messages\x20being\
    \x20acknowledged\x20that\n\x20was\x20returned\x20by\x20the\x20Pub/Sub\
    \x20system\x20in\x20the\x20`Pull`\x20response.\x20Must\x20not\x20be\n\
    \x20empty.\n\n\r\n\x05\x04#\x02\x01\x04\x12\x04\x8a\x0b\x02\n\n\r\n\x05\
    \x04#\x02\x01\x05\x12\x04\x8a\x0b\x0b\x11\n\r\n\x05\x04#\x02\x01\x01\x12\
    \x04\x8a\x0b\x12\x19\n\r\n\x05\x04#\x02\x01\x03\x12\x04\x8a\x0b\x1c\x1d\
    \n\r\n\x05\x04#\x02\x01\x08\x12\x04\x8a\x0b\x1eF\n\x10\n\x08\x04#\x02\
    \x01\x08\x9c\x08\0\x12\x04\x8a\x0b\x1fE\n\xe1\x01\n\x02\x04$\x12\x06\x90\
    \x0b\0\xde\x0b\x01\x1a\xd2\x01\x20Request\x20for\x20the\x20`StreamingPul\
    l`\x20streaming\x20RPC\x20method.\x20This\x20request\x20is\x20used\x20to\
    \n\x20establish\x20the\x20initial\x20stream\x20as\x20well\x20as\x20to\
    \x20stream\x20acknowledgements\x20and\x20ack\n\x20deadline\x20modificati\
    ons\x20from\x20the\x20client\x20to\x20the\x20server.\n\n\x0b\n\x03\x04$\
    \x01\x12\x04\x90\x0b\x08\x1c\n\x88\x02\n\x04\x04$\x02\0\x12\x06\x95\x0b\
    \x02\x9a\x0b\x04\x1a\xf7\x01\x20Required.\x20The\x20subscription\x20for\
    \x20which\x20to\x20initialize\x20the\x20new\x20stream.\x20This\n\x20must\
    \x20be\x20provided\x20in\x20the\x20first\x20request\x20on\x20the\x20stre\
    am,\x20and\x20must\x20not\x20be\x20set\x20in\n\x20subsequent\x20requests\
    \x20from\x20client\x20to\x20server.\n\x20Format\x20is\x20`projects/{proj\
    ect}/subscriptions/{sub}`.\n\n\r\n\x05\x04$\x02\0\x05\x12\x04\x95\x0b\
    \x02\x08\n\r\n\x05\x04$\x02\0\x01\x12\x04\x95\x0b\t\x15\n\r\n\x05\x04$\
    \x02\0\x03\x12\x04\x95\x0b\x18\x19\n\x0f\n\x05\x04$\x02\0\x08\x12\x06\
    \x95\x0b\x1a\x9a\x0b\x03\n\x10\n\x08\x04$\x02\0\x08\x9c\x08\0\x12\x04\
    \x96\x0b\x04*\n\x11\n\x07\x04$\x02\0\x08\x9f\x08\x12\x06\x97\x0b\x04\x99\
    \x0b\x05\n\x90\x03\n\x04\x04$\x02\x01\x12\x04\xa2\x0b\x02G\x1a\x81\x03\
    ...
    \x04$\x02\x01\x04\x12\x04\xa2\x0b\x02\n\n\r\n\x05\x04$\x02\x01\x05\x12\
    \x04\xa2\x0b\x0b\x11\n\r\n\x05\x04$\x02\x01\x01\x12\x04\xa2\x0b\x12\x19\
    \n\r\n\x05\x04$\x02\x01\x03\x12\x04\xa2\x0b\x1c\x1d\n\r\n\x05\x04$\x02\
    \x01\x08\x12\x04\xa2\x0b\x1eF\n\x10\n\x08\x04$\x02\x01\x08\x9c\x08\0\x12\
    \x04\xa2\x0b\x1fE\n\x95\x06\n\x04\x04$\x02\x02\x12\x06\xaf\x0b\x02\xb0\
    \x0b/\x1a\x84\x06\x20Optional.\x20The\x20list\x20of\x20new\x20ack\x20dea\
    dlines\x20for\x20the\x20IDs\x20listed\x20in\n\x20`modify_deadline_ack_id\
    s`.\x20The\x20size\x20of\x20this\x20list\x20must\x20be\x20the\x20same\
    ...
    \x12\x04\xaf\x0b\x02\n\n\r\n\x05\x04$\x02\x02\x05\x12\x04\xaf\x0b\x0b\
    \x10\n\r\n\x05\x04$\x02\x02\x01\x12\x04\xaf\x0b\x11(\n\r\n\x05\x04$\x02\
    \x02\x03\x12\x04\xaf\x0b+,\n\r\n\x05\x04$\x02\x02\x08\x12\x04\xb0\x0b\
    \x06.\n\x10\n\x08\x04$\x02\x02\x08\x9c\x08\0\x12\x04\xb0\x0b\x07-\n\xd4\
    \x02\n\x04\x04$\x02\x03\x12\x06\xb7\x0b\x02\xb8\x0b/\x1a\xc3\x02\x20Opti\
    onal.\x20List\x20of\x20acknowledgement\x20IDs\x20whose\x20deadline\x20wi\
    ll\x20be\x20modified\x20based\n\x20on\x20the\x20corresponding\x20element\
    \x20in\x20`modify_deadline_seconds`.\x20This\x20field\x20can\n\x20be\x20\
    used\x20to\x20indicate\x20that\x20more\x20time\x20is\x20needed\x20to\x20\
    ...
    \xb7\x0b\x02\n\n\r\n\x05\x04$\x02\x03\x05\x12\x04\xb7\x0b\x0b\x11\n\r\n\
    \x05\x04$\x02\x03\x01\x12\x04\xb7\x0b\x12)\n\r\n\x05\x04$\x02\x03\x03\
    \x12\x04\xb7\x0b,-\n\r\n\x05\x04$\x02\x03\x08\x12\x04\xb8\x0b\x06.\n\x10\
    \n\x08\x04$\x02\x03\x08\x9c\x08\0\x12\x04\xb8\x0b\x07-\n\xc0\x02\n\x04\
    \x04$\x02\x04\x12\x06\xbe\x0b\x02\xbf\x0b/\x1a\xaf\x02\x20Required.\x20T\
    he\x20ack\x20deadline\x20to\x20use\x20for\x20the\x20stream.\x20This\x20m\
    ust\x20be\x20provided\x20in\n\x20the\x20first\x20request\x20on\x20the\
    \x20stream,\x20but\x20it\x20can\x20also\x20be\x20updated\x20on\x20subseq\
    uent\n\x20requests\x20from\x20client\x20to\x20server.\x20The\x20minimum\
    \x20deadline\x20you\x20can\x20specify\x20is\x2010\n\x20seconds.\x20The\
    \x20maximum\x20deadline\x20you\x20can\x20specify\x20is\x20600\x20seconds\
    \x20(10\x20minutes).\n\n\r\n\x05\x04$\x02\x04\x05\x12\x04\xbe\x0b\x02\
    \x07\n\r\n\x05\x04$\x02\x04\x01\x12\x04\xbe\x0b\x08#\n\r\n\x05\x04$\x02\
    \x04\x03\x12\x04\xbe\x0b&'\n\r\n\x05\x04$\x02\x04\x08\x12\x04\xbf\x0b\
    \x06.\n\x10\n\x08\x04$\x02\x04\x08\x9c\x08\0\x12\x04\xbf\x0b\x07-\n\xa8\
    \x03\n\x04\x04$\x02\x05\x12\x04\xc7\x0b\x02@\x1a\x99\x03\x20Optional.\
    \x20A\x20unique\x20identifier\x20that\x20is\x20used\x20to\x20distinguish\
    \x20client\x20instances\n\x20from\x20each\x20other.\x20Only\x20needs\x20\
    to\x20be\x20provided\x20on\x20the\x20initial\x20request.\x20When\x20a\n\
    \x20stream\x20disconnects\x20and\x20reconnects\x20for\x20the\x20same\x20\
    stream,\x20the\x20client_id\x20should\n\x20be\x20set\x20to\x20the\x20sam\
    e\x20value\x20so\x20that\x20state\x20associated\x20with\x20the\x20old\
    \x20stream\x20can\n\x20be\x20transferred\x20to\x20the\x20new\x20stream.\
    \x20The\x20same\x20client_id\x20should\x20not\x20be\x20used\x20for\n\x20\
    different\x20client\x20instances.\n\n\r\n\x05\x04$\x02\x05\x05\x12\x04\
    \xc7\x0b\x02\x08\n\r\n\x05\x04$\x02\x05\x01\x12\x04\xc7\x0b\t\x12\n\r\n\
    \x05\x04$\x02\x05\x03\x12\x04\xc7\x0b\x15\x16\n\r\n\x05\x04$\x02\x05\x08\
    \x12\x04\xc7\x0b\x17?\n\x10\n\x08\x04$\x02\x05\x08\x9c\x08\0\x12\x04\xc7\
    \x0b\x18>\n\xe2\x04\n\x04\x04$\x02\x06\x12\x04\xd2\x0b\x02N\x1a\xd3\x04\
    \x20Optional.\x20Flow\x20control\x20settings\x20for\x20the\x20maximum\
    \x20number\x20of\x20outstanding\n\x20messages.\x20When\x20there\x20are\
    \x20`max_outstanding_messages`\x20currently\x20sent\x20to\x20the\n\x20st\
    reaming\x20pull\x20client\x20that\x20have\x20not\x20yet\x20been\x20acked\
    \x20or\x20nacked,\x20the\x20server\n\x20stops\x20sending\x20more\x20mess\
    ages.\x20The\x20sending\x20of\x20messages\x20resumes\x20once\x20the\n\
    \x20number\x20of\x20outstanding\x20messages\x20is\x20less\x20than\x20thi\
    s\x20value.\x20If\x20the\x20value\x20is\n\x20<=\x200,\x20there\x20is\x20\
    no\x20limit\x20to\x20the\x20number\x20of\x20outstanding\x20messages.\x20\
    This\n\x20property\x20can\x20only\x20be\x20set\x20on\x20the\x20initial\
    \x20StreamingPullRequest.\x20If\x20it\x20is\x20set\n\x20on\x20a\x20subse\
    quent\x20request,\x20the\x20stream\x20will\x20be\x20aborted\x20with\x20s\
    tatus\n\x20`INVALID_ARGUMENT`.\n\n\r\n\x05\x04$\x02\x06\x05\x12\x04\xd2\
    \x0b\x02\x07\n\r\n\x05\x04$\x02\x06\x01\x12\x04\xd2\x0b\x08\x20\n\r\n\
    \x05\x04$\x02\x06\x03\x12\x04\xd2\x0b#$\n\r\n\x05\x04$\x02\x06\x08\x12\
    \x04\xd2\x0b%M\n\x10\n\x08\x04$\x02\x06\x08\x9c\x08\0\x12\x04\xd2\x0b&L\
    \n\xf4\x04\n\x04\x04$\x02\x07\x12\x04\xdd\x0b\x02K\x1a\xe5\x04\x20Option\
    al.\x20Flow\x20control\x20settings\x20for\x20the\x20maximum\x20number\
    \x20of\x20outstanding\n\x20bytes.\x20When\x20there\x20are\x20`max_outsta\
    nding_bytes`\x20or\x20more\x20worth\x20of\x20messages\n\x20currently\x20\
    sent\x20to\x20the\x20streaming\x20pull\x20client\x20that\x20have\x20not\
    \x20yet\x20been\x20acked\x20or\n\x20nacked,\x20the\x20server\x20will\x20\
    stop\x20sending\x20more\x20messages.\x20The\x20sending\x20of\x20messages\
    \n\x20resumes\x20once\x20the\x20number\x20of\x20outstanding\x20bytes\x20\
    is\x20less\x20than\x20this\x20value.\x20If\n\x20the\x20value\x20is\x20<=\
    \x200,\x20there\x20is\x20no\x20limit\x20to\x20the\x20number\x20of\x20out\
    standing\x20bytes.\n\x20This\x20property\x20can\x20only\x20be\x20set\x20\
    on\x20the\x20initial\x20StreamingPullRequest.\x20If\x20it\x20is\n\x20set\
    \x20on\x20a\x20subsequent\x20request,\x20the\x20stream\x20will\x20be\x20\
    aborted\x20with\x20status\n\x20`INVALID_ARGUMENT`.\n\n\r\n\x05\x04$\x02\
    \x07\x05\x12\x04\xdd\x0b\x02\x07\n\r\n\x05\x04$\x02\x07\x01\x12\x04\xdd\
    \x0b\x08\x1d\n\r\n\x05\x04$\x02\x07\x03\x12\x04\xdd\x0b\x20!\n\r\n\x05\
    \x04$\x02\x07\x08\x12\x04\xdd\x0b\"J\n\x10\n\x08\x04$\x02\x07\x08\x9c\
    \x08\0\x12\x04\xdd\x0b#I\n\x81\x01\n\x02\x04%\x12\x06\xe2\x0b\0\xa5\x0c\
    \x01\x1as\x20Response\x20for\x20the\x20`StreamingPull`\x20method.\x20Thi\
    s\x20response\x20is\x20used\x20to\x20stream\n\x20messages\x20from\x20the\
    \x20server\x20to\x20the\x20client.\n\n\x0b\n\x03\x04%\x01\x12\x04\xe2\
    \x0b\x08\x1d\nz\n\x04\x04%\x03\0\x12\x06\xe5\x0b\x02\xf6\x0b\x03\x1aj\
    \x20Acknowledgement\x20IDs\x20sent\x20in\x20one\x20or\x20more\x20previou\
    s\x20requests\x20to\x20acknowledge\x20a\n\x20previously\x20received\x20m\
    essage.\n\n\r\n\x05\x04%\x03\0\x01\x12\x04\xe5\x0b\n!\nG\n\x06\x04%\x03\
    \0\x02\0\x12\x04\xe7\x0b\x04I\x1a7\x20Optional.\x20Successfully\x20proce\
    ssed\x20acknowledgement\x20IDs.\n\n\x0f\n\x07\x04%\x03\0\x02\0\x04\x12\
    \x04\xe7\x0b\x04\x0c\n\x0f\n\x07\x04%\x03\0\x02\0\x05\x12\x04\xe7\x0b\r\
    \x13\n\x0f\n\x07\x04%\x03\0\x02\0\x01\x12\x04\xe7\x0b\x14\x1b\n\x0f\n\
    \x07\x04%\x03\0\x02\0\x03\x12\x04\xe7\x0b\x1e\x1f\n\x0f\n\x07\x04%\x03\0\
    \x02\0\x08\x12\x04\xe7\x0b\x20H\n\x12\n\n\x04%\x03\0\x02\0\x08\x9c\x08\0\
    \x12\x04\xe7\x0b!G\n}\n\x06\x04%\x03\0\x02\x01\x12\x06\xeb\x0b\x04\xec\
    \x0b1\x1ak\x20Optional.\x20List\x20of\x20acknowledgement\x20IDs\x20that\
    \x20were\x20malformed\x20or\x20whose\n\x20acknowledgement\x20deadline\
    \x20has\x20expired.\n\n\x0f\n\x07\x04%\x03\0\x02\x01\x04\x12\x04\xeb\x0b\
    \x04\x0c\n\x0f\n\x07\x04%\x03\0\x02\x01\x05\x12\x04\xeb\x0b\r\x13\n\x0f\
    \n\x07\x04%\x03\0\x02\x01\x01\x12\x04\xeb\x0b\x14#\n\x0f\n\x07\x04%\x03\
    \0\x02\x01\x03\x12\x04\xeb\x0b&'\n\x0f\n\x07\x04%\x03\0\x02\x01\x08\x12\
    \x04\xec\x0b\x080\n\x12\n\n\x04%\x03\0\x02\x01\x08\x9c\x08\0\x12\x04\xec\
    \x0b\t/\nQ\n\x06\x04%\x03\0\x02\x02\x12\x06\xef\x0b\x04\xf0\x0b1\x1a?\
    \x20Optional.\x20List\x20of\x20acknowledgement\x20IDs\x20that\x20were\
    \x20out\x20of\x20order.\n\n\x0f\n\x07\x04%\x03\0\x02\x02\x04\x12\x04\xef\
    \x0b\x04\x0c\n\x0f\n\x07\x04%\x03\0\x02\x02\x05\x12\x04\xef\x0b\r\x13\n\
    \x0f\n\x07\x04%\x03\0\x02\x02\x01\x12\x04\xef\x0b\x14%\n\x0f\n\x07\x04%\
    \x03\0\x02\x02\x03\x12\x04\xef\x0b()\n\x0f\n\x07\x04%\x03\0\x02\x02\x08\
    \x12\x04\xf0\x0b\x080\n\x12\n\n\x04%\x03\0\x02\x02\x08\x9c\x08\0\x12\x04\
    \xf0\x0b\t/\nh\n\x06\x04%\x03\0\x02\x03\x12\x06\xf4\x0b\x04\xf5\x0b1\x1a\
    V\x20Optional.\x20List\x20of\x20acknowledgement\x20IDs\x20that\x20failed\
    \x20processing\x20with\n\x20temporary\x20issues.\n\n\x0f\n\x07\x04%\x03\
    \0\x02\x03\x04\x12\x04\xf4\x0b\x04\x0c\n\x0f\n\x07\x04%\x03\0\x02\x03\
    \x05\x12\x04\xf4\x0b\r\x13\n\x0f\n\x07\x04%\x03\0\x02\x03\x01\x12\x04\
    \xf4\x0b\x14,\n\x0f\n\x07\x04%\x03\0\x02\x03\x03\x12\x04\xf4\x0b/0\n\x0f\
    \n\x07\x04%\x03\0\x02\x03\x08\x12\x04\xf5\x0b\x080\n\x12\n\n\x04%\x03\0\
    \x02\x03\x08\x9c\x08\0\x12\x04\xf5\x0b\t/\n{\n\x04\x04%\x03\x01\x12\x06\
    \xfa\x0b\x02\x87\x0c\x03\x1ak\x20Acknowledgement\x20IDs\x20sent\x20in\
    \x20one\x20or\x20more\x20previous\x20requests\x20to\x20modify\x20the\n\
    \x20deadline\x20for\x20a\x20specific\x20message.\n\n\r\n\x05\x04%\x03\
    \x01\x01\x12\x04\xfa\x0b\n'\nG\n\x06\x04%\x03\x01\x02\0\x12\x04\xfc\x0b\
    \x04I\x1a7\x20Optional.\x20Successfully\x20processed\x20acknowledgement\
    \x20IDs.\n\n\x0f\n\x07\x04%\x03\x01\x02\0\x04\x12\x04\xfc\x0b\x04\x0c\n\
    \x0f\n\x07\x04%\x03\x01\x02\0\x05\x12\x04\xfc\x0b\r\x13\n\x0f\n\x07\x04%\
    \x03\x01\x02\0\x01\x12\x04\xfc\x0b\x14\x1b\n\x0f\n\x07\x04%\x03\x01\x02\
    \0\x03\x12\x04\xfc\x0b\x1e\x1f\n\x0f\n\x07\x04%\x03\x01\x02\0\x08\x12\
    \x04\xfc\x0b\x20H\n\x12\n\n\x04%\x03\x01\x02\0\x08\x9c\x08\0\x12\x04\xfc\
    \x0b!G\n}\n\x06\x04%\x03\x01\x02\x01\x12\x06\x80\x0c\x04\x81\x0c1\x1ak\
    \x20Optional.\x20List\x20of\x20acknowledgement\x20IDs\x20that\x20were\
    \x20malformed\x20or\x20whose\n\x20acknowledgement\x20deadline\x20has\x20\
    expired.\n\n\x0f\n\x07\x04%\x03\x01\x02\x01\x04\x12\x04\x80\x0c\x04\x0c\
    \n\x0f\n\x07\x04%\x03\x01\x02\x01\x05\x12\x04\x80\x0c\r\x13\n\x0f\n\x07\
    \x04%\x03\x01\x02\x01\x01\x12\x04\x80\x0c\x14#\n\x0f\n\x07\x04%\x03\x01\
    \x02\x01\x03\x12\x04\x80\x0c&'\n\x0f\n\x07\x04%\x03\x01\x02\x01\x08\x12\
    \x04\x81\x0c\x080\n\x12\n\n\x04%\x03\x01\x02\x01\x08\x9c\x08\0\x12\x04\
    \x81\x0c\t/\nh\n\x06\x04%\x03\x01\x02\x02\x12\x06\x85\x0c\x04\x86\x0c1\
    \x1aV\x20Optional.\x20List\x20of\x20acknowledgement\x20IDs\x20that\x20fa\
    iled\x20processing\x20with\n\x20temporary\x20issues.\n\n\x0f\n\x07\x04%\
    \x03\x01\x02\x02\x04\x12\x04\x85\x0c\x04\x0c\n\x0f\n\x07\x04%\x03\x01\
    \x02\x02\x05\x12\x04\x85\x0c\r\x13\n\x0f\n\x07\x04%\x03\x01\x02\x02\x01\
    \x12\x04\x85\x0c\x14,\n\x0f\n\x07\x04%\x03\x01\x02\x02\x03\x12\x04\x85\
    \x0c/0\n\x0f\n\x07\x04%\x03\x01\x02\x02\x08\x12\x04\x86\x0c\x080\n\x12\n\
    \n\x04%\x03\x01\x02\x02\x08\x9c\x08\0\x12\x04\x86\x0c\t/\nG\n\x04\x04%\
    \x03\x02\x12\x06\x8a\x0c\x02\x92\x0c\x03\x1a7\x20Subscription\x20propert\
    ies\x20sent\x20as\x20part\x20of\x20the\x20response.\n\n\r\n\x05\x04%\x03\
    \x02\x01\x12\x04\x8a\x0c\n\x20\n_\n\x06\x04%\x03\x02\x02\0\x12\x06\x8d\
    \x0c\x04\x8e\x0c1\x1aM\x20Optional.\x20True\x20iff\x20exactly\x20once\
    \x20delivery\x20is\x20enabled\x20for\x20this\n\x20subscription.\n\n\x0f\
    \n\x07\x04%\x03\x02\x02\0\x05\x12\x04\x8d\x0c\x04\x08\n\x0f\n\x07\x04%\
    \x03\x02\x02\0\x01\x12\x04\x8d\x0c\t&\n\x0f\n\x07\x04%\x03\x02\x02\0\x03\
    \x12\x04\x8d\x0c)*\n\x0f\n\x07\x04%\x03\x02\x02\0\x08\x12\x04\x8e\x0c\
    \x080\n\x12\n\n\x04%\x03\x02\x02\0\x08\x9c\x08\0\x12\x04\x8e\x0c\t/\nW\n\
    \x06\x04%\x03\x02\x02\x01\x12\x04\x91\x0c\x04O\x1aG\x20Optional.\x20True\
    \x20iff\x20message\x20ordering\x20is\x20enabled\x20for\x20this\x20subscr\
    iption.\n\n\x0f\n\x07\x04%\x03\x02\x02\x01\x05\x12\x04\x91\x0c\x04\x08\n\
    \x0f\n\x07\x04%\x03\x02\x02\x01\x01\x12\x04\x91\x0c\t!\n\x0f\n\x07\x04%\
    \x03\x02\x02\x01\x03\x12\x04\x91\x0c$%\n\x0f\n\x07\x04%\x03\x02\x02\x01\
    \x08\x12\x04\x91\x0c&N\n\x12\n\n\x04%\x03\x02\x02\x01\x08\x9c\x08\0\x12\
    \x04\x91\x0c'M\nN\n\x04\x04%\x02\0\x12\x06\x95\x0c\x02\x96\x0c/\x1a>\x20\
    Optional.\x20Received\x20Pub/Sub\x20messages.\x20This\x20will\x20not\x20\
    be\x20empty.\n\n\r\n\x05\x04%\x02\0\x04\x12\x04\x95\x0c\x02\n\n\r\n\x05\
    \x04%\x02\0\x06\x12\x04\x95\x0c\x0b\x1a\n\r\n\x05\x04%\x02\0\x01\x12\x04\
    \x95\x0c\x1b,\n\r\n\x05\x04%\x02\0\x03\x12\x04\x95\x0c/0\n\r\n\x05\x04%\
    \x02\0\x08\x12\x04\x96\x0c\x06.\n\x10\n\x08\x04%\x02\0\x08\x9c\x08\0\x12\
    \x04\x96\x0c\x07-\nl\n\x04\x04%\x02\x01\x12\x06\x9a\x0c\x02\x9b\x0c/\x1a\
    \\\x20Optional.\x20This\x20field\x20will\x20only\x20be\x20set\x20if\x20`\
    enable_exactly_once_delivery`\x20is\n\x20set\x20to\x20`true`.\n\n\r\n\
    \x05\x04%\x02\x01\x06\x12\x04\x9a\x0c\x02\x19\n\r\n\x05\x04%\x02\x01\x01\
    \x12\x04\x9a\x0c\x1a2\n\r\n\x05\x04%\x02\x01\x03\x12\x04\x9a\x0c56\n\r\n\
    \x05\x04%\x02\x01\x08\x12\x04\x9b\x0c\x06.\n\x10\n\x08\x04%\x02\x01\x08\
    \x9c\x08\0\x12\x04\x9b\x0c\x07-\nl\n\x04\x04%\x02\x02\x12\x06\x9f\x0c\
    \x02\xa0\x0c/\x1a\\\x20Optional.\x20This\x20field\x20will\x20only\x20be\
    \x20set\x20if\x20`enable_exactly_once_delivery`\x20is\n\x20set\x20to\x20\
    `true`.\n\n\r\n\x05\x04%\x02\x02\x06\x12\x04\x9f\x0c\x02\x1f\n\r\n\x05\
    \x04%\x02\x02\x01\x12\x04\x9f\x0c\x20@\n\r\n\x05\x04%\x02\x02\x03\x12\
    \x04\x9f\x0cCD\n\r\n\x05\x04%\x02\x02\x08\x12\x04\xa0\x0c\x06.\n\x10\n\
    \x08\x04%\x02\x02\x08\x9c\x08\0\x12\x04\xa0\x0c\x07-\nI\n\x04\x04%\x02\
    \x03\x12\x06\xa3\x0c\x02\xa4\x0c/\x1a9\x20Optional.\x20Properties\x20ass\
    ociated\x20with\x20this\x20subscription.\n\n\r\n\x05\x04%\x02\x03\x06\
    \x12\x04\xa3\x0c\x02\x18\n\r\n\x05\x04%\x02\x03\x01\x12\x04\xa3\x0c\x190\
    \n\r\n\x05\x04%\x02\x03\x03\x12\x04\xa3\x0c34\n\r\n\x05\x04%\x02\x03\x08\
    \x12\x04\xa4\x0c\x06.\n\x10\n\x08\x04%\x02\x03\x08\x9c\x08\0\x12\x04\xa4\
    \x0c\x07-\n8\n\x02\x04&\x12\x06\xa8\x0c\0\xc7\x0c\x01\x1a*\x20Request\
    \x20for\x20the\x20`CreateSnapshot`\x20method.\n\n\x0b\n\x03\x04&\x01\x12\
    \x04\xa8\x0c\x08\x1d\n\xa1\x03\n\x04\x04&\x02\0\x12\x06\xaf\x0c\x02\xb2\
    \x0c\x04\x1a\x90\x03\x20Required.\x20User-provided\x20name\x20for\x20thi\
    s\x20snapshot.\x20If\x20the\x20name\x20is\x20not\x20provided\n\x20in\x20\
    the\x20request,\x20the\x20server\x20will\x20assign\x20a\x20random\x20nam\
    e\x20for\x20this\x20snapshot\x20on\n\x20the\x20same\x20project\x20as\x20\
    the\x20subscription.\x20Note\x20that\x20for\x20REST\x20API\x20requests,\
    \x20you\n\x20must\x20specify\x20a\x20name.\x20\x20See\x20the\x20[resourc\
    e\x20name\n\x20rules](https://cloud.google.com/pubsub/docs/pubsub-basics\
    #resource_names).\n\x20Format\x20is\x20`projects/{project}/snapshots/{sn\
    ap}`.\n\n\r\n\x05\x04&\x02\0\x05\x12\x04\xaf\x0c\x02\x08\n\r\n\x05\x04&\
    \x02\0\x01\x12\x04\xaf\x0c\t\r\n\r\n\x05\x04&\x02\0\x03\x12\x04\xaf\x0c\
    \x10\x11\n\x0f\n\x05\x04&\x02\0\x08\x12\x06\xaf\x0c\x12\xb2\x0c\x03\n\
    \x10\n\x08\x04&\x02\0\x08\x9c\x08\0\x12\x04\xb0\x0c\x04*\n\x0f\n\x07\x04\
    &\x02\0\x08\x9f\x08\x12\x04\xb1\x0c\x04P\n\xb9\x04\n\x04\x04&\x02\x01\
    \x12\x06\xbd\x0c\x02\xc2\x0c\x04\x1a\xa8\x04\x20Required.\x20The\x20subs\
    cription\x20whose\x20backlog\x20the\x20snapshot\x20retains.\n\x20Specifi\
    cally,\x20the\x20created\x20snapshot\x20is\x20guaranteed\x20to\x20retain\
    :\n\x20\x20(a)\x20The\x20existing\x20backlog\x20on\x20the\x20subscriptio\
    n.\x20More\x20precisely,\x20this\x20is\n\x20\x20\x20\x20\x20\x20defined\
    ...
    tions/{sub}`.\n\n\r\n\x05\x04&\x02\x01\x05\x12\x04\xbd\x0c\x02\x08\n\r\n\
    \x05\x04&\x02\x01\x01\x12\x04\xbd\x0c\t\x15\n\r\n\x05\x04&\x02\x01\x03\
    \x12\x04\xbd\x0c\x18\x19\n\x0f\n\x05\x04&\x02\x01\x08\x12\x06\xbd\x0c\
    \x1a\xc2\x0c\x03\n\x10\n\x08\x04&\x02\x01\x08\x9c\x08\0\x12\x04\xbe\x0c\
    \x04*\n\x11\n\x07\x04&\x02\x01\x08\x9f\x08\x12\x06\xbf\x0c\x04\xc1\x0c\
    \x05\nk\n\x04\x04&\x02\x02\x12\x04\xc6\x0c\x02J\x1a]\x20Optional.\x20See\
    \x20[Creating\x20and\x20managing\n\x20labels](https://cloud.google.com/p\
    ubsub/docs/labels).\n\n\r\n\x05\x04&\x02\x02\x06\x12\x04\xc6\x0c\x02\x15\
    \n\r\n\x05\x04&\x02\x02\x01\x12\x04\xc6\x0c\x16\x1c\n\r\n\x05\x04&\x02\
    \x02\x03\x12\x04\xc6\x0c\x1f\x20\n\r\n\x05\x04&\x02\x02\x08\x12\x04\xc6\
    \x0c!I\n\x10\n\x08\x04&\x02\x02\x08\x9c\x08\0\x12\x04\xc6\x0c\"H\n6\n\
    \x02\x04'\x12\x06\xca\x0c\0\xd2\x0c\x01\x1a(\x20Request\x20for\x20the\
    \x20UpdateSnapshot\x20method.\n\n\x0b\n\x03\x04'\x01\x12\x04\xca\x0c\x08\
    \x1d\n6\n\x04\x04'\x02\0\x12\x04\xcc\x0c\x02A\x1a(\x20Required.\x20The\
    \x20updated\x20snapshot\x20object.\n\n\r\n\x05\x04'\x02\0\x06\x12\x04\
    \xcc\x0c\x02\n\n\r\n\x05\x04'\x02\0\x01\x12\x04\xcc\x0c\x0b\x13\n\r\n\
    \x05\x04'\x02\0\x03\x12\x04\xcc\x0c\x16\x17\n\r\n\x05\x04'\x02\0\x08\x12\
    \x04\xcc\x0c\x18@\n\x10\n\x08\x04'\x02\0\x08\x9c\x08\0\x12\x04\xcc\x0c\
    \x19?\nx\n\x04\x04'\x02\x01\x12\x06\xd0\x0c\x02\xd1\x0c/\x1ah\x20Require\
    d.\x20Indicates\x20which\x20fields\x20in\x20the\x20provided\x20snapshot\
    \x20to\x20update.\n\x20Must\x20be\x20specified\x20and\x20non-empty.\n\n\
    \r\n\x05\x04'\x02\x01\x06\x12\x04\xd0\x0c\x02\x1b\n\r\n\x05\x04'\x02\x01\
    \x01\x12\x04\xd0\x0c\x1c'\n\r\n\x05\x04'\x02\x01\x03\x12\x04\xd0\x0c*+\n\
    \r\n\x05\x04'\x02\x01\x08\x12\x04\xd1\x0c\x06.\n\x10\n\x08\x04'\x02\x01\
    \x08\x9c\x08\0\x12\x04\xd1\x0c\x07-\n\xbe\x02\n\x02\x04(\x12\x06\xd9\x0c\
    \0\xf9\x0c\x01\x1a\xaf\x02\x20A\x20snapshot\x20resource.\x20Snapshots\
    ...
    \x20by\x20a\x20snapshot.\n\n\x0b\n\x03\x04(\x01\x12\x04\xd9\x0c\x08\x10\
    \n\r\n\x03\x04(\x07\x12\x06\xda\x0c\x02\xdd\x0c\x04\n\x0f\n\x05\x04(\x07\
    \x9d\x08\x12\x06\xda\x0c\x02\xdd\x0c\x04\n3\n\x04\x04(\x02\0\x12\x04\xe0\
    \x0c\x02;\x1a%\x20Optional.\x20The\x20name\x20of\x20the\x20snapshot.\n\n\
    \r\n\x05\x04(\x02\0\x05\x12\x04\xe0\x0c\x02\x08\n\r\n\x05\x04(\x02\0\x01\
    \x12\x04\xe0\x0c\t\r\n\r\n\x05\x04(\x02\0\x03\x12\x04\xe0\x0c\x10\x11\n\
    \r\n\x05\x04(\x02\0\x08\x12\x04\xe0\x0c\x12:\n\x10\n\x08\x04(\x02\0\x08\
    \x9c\x08\0\x12\x04\xe0\x0c\x139\nb\n\x04\x04(\x02\x01\x12\x06\xe4\x0c\
    \x02\xe7\x0c\x04\x1aR\x20Optional.\x20The\x20name\x20of\x20the\x20topic\
    \x20from\x20which\x20this\x20snapshot\x20is\x20retaining\n\x20messages.\
    \n\n\r\n\x05\x04(\x02\x01\x05\x12\x04\xe4\x0c\x02\x08\n\r\n\x05\x04(\x02\
    \x01\x01\x12\x04\xe4\x0c\t\x0e\n\r\n\x05\x04(\x02\x01\x03\x12\x04\xe4\
    \x0c\x11\x12\n\x0f\n\x05\x04(\x02\x01\x08\x12\x06\xe4\x0c\x13\xe7\x0c\
    \x03\n\x10\n\x08\x04(\x02\x01\x08\x9c\x08\0\x12\x04\xe5\x0c\x04*\n\x0f\n\
    \x07\x04(\x02\x01\x08\x9f\x08\x12\x04\xe6\x0c\x04M\n\xe0\x05\n\x04\x04(\
    \x02\x02\x12\x06\xf3\x0c\x02\xf4\x0c/\x1a\xcf\x05\x20Optional.\x20The\
    ...
    \r\n\x05\x04(\x02\x02\x06\x12\x04\xf3\x0c\x02\x1b\n\r\n\x05\x04(\x02\x02\
    \x01\x12\x04\xf3\x0c\x1c'\n\r\n\x05\x04(\x02\x02\x03\x12\x04\xf3\x0c*+\n\
    \r\n\x05\x04(\x02\x02\x08\x12\x04\xf4\x0c\x06.\n\x10\n\x08\x04(\x02\x02\
    \x08\x9c\x08\0\x12\x04\xf4\x0c\x07-\nl\n\x04\x04(\x02\x03\x12\x04\xf8\
    \x0c\x02J\x1a^\x20Optional.\x20See\x20[Creating\x20and\x20managing\x20la\
    bels]\n\x20(https://cloud.google.com/pubsub/docs/labels).\n\n\r\n\x05\
    \x04(\x02\x03\x06\x12\x04\xf8\x0c\x02\x15\n\r\n\x05\x04(\x02\x03\x01\x12\
    \x04\xf8\x0c\x16\x1c\n\r\n\x05\x04(\x02\x03\x03\x12\x04\xf8\x0c\x1f\x20\
    \n\r\n\x05\x04(\x02\x03\x08\x12\x04\xf8\x0c!I\n\x10\n\x08\x04(\x02\x03\
    \x08\x9c\x08\0\x12\x04\xf8\x0c\"H\n3\n\x02\x04)\x12\x06\xfc\x0c\0\x83\r\
    \x01\x1a%\x20Request\x20for\x20the\x20GetSnapshot\x20method.\n\n\x0b\n\
    \x03\x04)\x01\x12\x04\xfc\x0c\x08\x1a\nn\n\x04\x04)\x02\0\x12\x06\xff\
    \x0c\x02\x82\r\x04\x1a^\x20Required.\x20The\x20name\x20of\x20the\x20snap\
    shot\x20to\x20get.\n\x20Format\x20is\x20`projects/{project}/snapshots/{s\
    nap}`.\n\n\r\n\x05\x04)\x02\0\x05\x12\x04\xff\x0c\x02\x08\n\r\n\x05\x04)\
    \x02\0\x01\x12\x04\xff\x0c\t\x11\n\r\n\x05\x04)\x02\0\x03\x12\x04\xff\
    \x0c\x14\x15\n\x0f\n\x05\x04)\x02\0\x08\x12\x06\xff\x0c\x16\x82\r\x03\n\
    \x10\n\x08\x04)\x02\0\x08\x9c\x08\0\x12\x04\x80\r\x04*\n\x0f\n\x07\x04)\
    \x02\0\x08\x9f\x08\x12\x04\x81\r\x04P\n7\n\x02\x04*\x12\x06\x86\r\0\x97\
    \r\x01\x1a)\x20Request\x20for\x20the\x20`ListSnapshots`\x20method.\n\n\
    \x0b\n\x03\x04*\x01\x12\x04\x86\r\x08\x1c\ns\n\x04\x04*\x02\0\x12\x06\
    \x89\r\x02\x8e\r\x04\x1ac\x20Required.\x20The\x20name\x20of\x20the\x20pr\
    oject\x20in\x20which\x20to\x20list\x20snapshots.\n\x20Format\x20is\x20`p\
    rojects/{project-id}`.\n\n\r\n\x05\x04*\x02\0\x05\x12\x04\x89\r\x02\x08\
    \n\r\n\x05\x04*\x02\0\x01\x12\x04\x89\r\t\x10\n\r\n\x05\x04*\x02\0\x03\
    \x12\x04\x89\r\x13\x14\n\x0f\n\x05\x04*\x02\0\x08\x12\x06\x89\r\x15\x8e\
    \r\x03\n\x10\n\x08\x04*\x02\0\x08\x9c\x08\0\x12\x04\x8a\r\x04*\n\x11\n\
    \x07\x04*\x02\0\x08\x9f\x08\x12\x06\x8b\r\x04\x8d\r\x05\n@\n\x04\x04*\
    \x02\x01\x12\x04\x91\r\x02?\x1a2\x20Optional.\x20Maximum\x20number\x20of\
    \x20snapshots\x20to\x20return.\n\n\r\n\x05\x04*\x02\x01\x05\x12\x04\x91\
    \r\x02\x07\n\r\n\x05\x04*\x02\x01\x01\x12\x04\x91\r\x08\x11\n\r\n\x05\
    \x04*\x02\x01\x03\x12\x04\x91\r\x14\x15\n\r\n\x05\x04*\x02\x01\x08\x12\
    \x04\x91\r\x16>\n\x10\n\x08\x04*\x02\x01\x08\x9c\x08\0\x12\x04\x91\r\x17\
    =\n\xd4\x01\n\x04\x04*\x02\x02\x12\x04\x96\r\x02A\x1a\xc5\x01\x20Optiona\
    l.\x20The\x20value\x20returned\x20by\x20the\x20last\x20`ListSnapshotsRes\
    ponse`;\x20indicates\n\x20that\x20this\x20is\x20a\x20continuation\x20of\
    \x20a\x20prior\x20`ListSnapshots`\x20call,\x20and\x20that\x20the\n\x20sy\
    stem\x20should\x20return\x20the\x20next\x20page\x20of\x20data.\n\n\r\n\
    \x05\x04*\x02\x02\x05\x12\x04\x96\r\x02\x08\n\r\n\x05\x04*\x02\x02\x01\
    \x12\x04\x96\r\t\x13\n\r\n\x05\x04*\x02\x02\x03\x12\x04\x96\r\x16\x17\n\
    \r\n\x05\x04*\x02\x02\x08\x12\x04\x96\r\x18@\n\x10\n\x08\x04*\x02\x02\
    \x08\x9c\x08\0\x12\x04\x96\r\x19?\n8\n\x02\x04+\x12\x06\x9a\r\0\xa2\r\
    \x01\x1a*\x20Response\x20for\x20the\x20`ListSnapshots`\x20method.\n\n\
    \x0b\n\x03\x04+\x01\x12\x04\x9a\r\x08\x1d\n2\n\x04\x04+\x02\0\x12\x04\
    \x9c\r\x02K\x1a$\x20Optional.\x20The\x20resulting\x20snapshots.\n\n\r\n\
    \x05\x04+\x02\0\x04\x12\x04\x9c\r\x02\n\n\r\n\x05\x04+\x02\0\x06\x12\x04\
    \x9c\r\x0b\x13\n\r\n\x05\x04+\x02\0\x01\x12\x04\x9c\r\x14\x1d\n\r\n\x05\
    \x04+\x02\0\x03\x12\x04\x9c\r\x20!\n\r\n\x05\x04+\x02\0\x08\x12\x04\x9c\
    \r\"J\n\x10\n\x08\x04+\x02\0\x08\x9c\x08\0\x12\x04\x9c\r#I\n\xa9\x01\n\
    \x04\x04+\x02\x01\x12\x04\xa1\r\x02F\x1a\x9a\x01\x20Optional.\x20If\x20n\
    ot\x20empty,\x20indicates\x20that\x20there\x20may\x20be\x20more\x20snaps\
    hot\x20that\n\x20match\x20the\x20request;\x20this\x20value\x20should\x20\
    be\x20passed\x20in\x20a\x20new\n\x20`ListSnapshotsRequest`.\n\n\r\n\x05\
    \x04+\x02\x01\x05\x12\x04\xa1\r\x02\x08\n\r\n\x05\x04+\x02\x01\x01\x12\
    \x04\xa1\r\t\x18\n\r\n\x05\x04+\x02\x01\x03\x12\x04\xa1\r\x1b\x1c\n\r\n\
    \x05\x04+\x02\x01\x08\x12\x04\xa1\r\x1dE\n\x10\n\x08\x04+\x02\x01\x08\
    \x9c\x08\0\x12\x04\xa1\r\x1eD\n8\n\x02\x04,\x12\x06\xa5\r\0\xac\r\x01\
    \x1a*\x20Request\x20for\x20the\x20`DeleteSnapshot`\x20method.\n\n\x0b\n\
    \x03\x04,\x01\x12\x04\xa5\r\x08\x1d\nq\n\x04\x04,\x02\0\x12\x06\xa8\r\
    \x02\xab\r\x04\x1aa\x20Required.\x20The\x20name\x20of\x20the\x20snapshot\
    \x20to\x20delete.\n\x20Format\x20is\x20`projects/{project}/snapshots/{sn\
    ap}`.\n\n\r\n\x05\x04,\x02\0\x05\x12\x04\xa8\r\x02\x08\n\r\n\x05\x04,\
    \x02\0\x01\x12\x04\xa8\r\t\x11\n\r\n\x05\x04,\x02\0\x03\x12\x04\xa8\r\
    \x14\x15\n\x0f\n\x05\x04,\x02\0\x08\x12\x06\xa8\r\x16\xab\r\x03\n\x10\n\
    \x08\x04,\x02\0\x08\x9c\x08\0\x12\x04\xa9\r\x04*\n\x0f\n\x07\x04,\x02\0\
    \x08\x9f\x08\x12\x04\xaa\r\x04P\n.\n\x02\x04-\x12\x06\xaf\r\0\xd0\r\x01\
    \x1a\x20\x20Request\x20for\x20the\x20`Seek`\x20method.\n\n\x0b\n\x03\x04\
    -\x01\x12\x04\xaf\r\x08\x13\n7\n\x04\x04-\x02\0\x12\x06\xb1\r\x02\xb6\r\
    \x04\x1a'\x20Required.\x20The\x20subscription\x20to\x20affect.\n\n\r\n\
    \x05\x04-\x02\0\x05\x12\x04\xb1\r\x02\x08\n\r\n\x05\x04-\x02\0\x01\x12\
    \x04\xb1\r\t\x15\n\r\n\x05\x04-\x02\0\x03\x12\x04\xb1\r\x18\x19\n\x0f\n\
    \x05\x04-\x02\0\x08\x12\x06\xb1\r\x1a\xb6\r\x03\n\x10\n\x08\x04-\x02\0\
    \x08\x9c\x08\0\x12\x04\xb2\r\x04*\n\x11\n\x07\x04-\x02\0\x08\x9f\x08\x12\
    \x06\xb3\r\x04\xb5\r\x05\n\x0e\n\x04\x04-\x08\0\x12\x06\xb8\r\x02\xcf\r\
    \x03\n\r\n\x05\x04-\x08\0\x01\x12\x04\xb8\r\x08\x0e\n\xc8\x05\n\x04\x04-\
    \x02\x01\x12\x04\xc4\r\x04P\x1a\xb9\x05\x20Optional.\x20The\x20time\x20t\
    o\x20seek\x20to.\n\x20Messages\x20retained\x20in\x20the\x20subscription\
    \x20that\x20were\x20published\x20before\x20this\n\x20time\x20are\x20mark\
    ed\x20as\x20acknowledged,\x20and\x20messages\x20retained\x20in\x20the\n\
    \x20subscription\x20that\x20were\x20published\x20after\x20this\x20time\
    \x20are\x20marked\x20as\n\x20unacknowledged.\x20Note\x20that\x20this\x20\
    operation\x20affects\x20only\x20those\x20messages\n\x20retained\x20in\
    \x20the\x20subscription\x20(configured\x20by\x20the\x20combination\x20of\
    \n\x20`message_retention_duration`\x20and\x20`retain_acked_messages`).\
    \x20For\x20example,\n\x20if\x20`time`\x20corresponds\x20to\x20a\x20point\
    \x20before\x20the\x20message\x20retention\n\x20window\x20(or\x20to\x20a\
    \x20point\x20before\x20the\x20system's\x20notion\x20of\x20the\x20subscri\
    ption\n\x20creation\x20time),\x20only\x20retained\x20messages\x20will\
    \x20be\x20marked\x20as\x20unacknowledged,\n\x20and\x20already-expunged\
    \x20messages\x20will\x20not\x20be\x20restored.\n\n\r\n\x05\x04-\x02\x01\
    \x06\x12\x04\xc4\r\x04\x1d\n\r\n\x05\x04-\x02\x01\x01\x12\x04\xc4\r\x1e\
    \"\n\r\n\x05\x04-\x02\x01\x03\x12\x04\xc4\r%&\n\r\n\x05\x04-\x02\x01\x08\
    \x12\x04\xc4\r'O\n\x10\n\x08\x04-\x02\x01\x08\x9c\x08\0\x12\x04\xc4\r(N\
    \n\xb4\x01\n\x04\x04-\x02\x02\x12\x06\xc9\r\x04\xce\r\x06\x1a\xa3\x01\
    \x20Optional.\x20The\x20snapshot\x20to\x20seek\x20to.\x20The\x20snapshot\
    's\x20topic\x20must\x20be\x20the\x20same\n\x20as\x20that\x20of\x20the\
    \x20provided\x20subscription.\x20Format\x20is\n\x20`projects/{project}/s\
    napshots/{snap}`.\n\n\r\n\x05\x04-\x02\x02\x05\x12\x04\xc9\r\x04\n\n\r\n\
    \x05\x04-\x02\x02\x01\x12\x04\xc9\r\x0b\x13\n\r\n\x05\x04-\x02\x02\x03\
    \x12\x04\xc9\r\x16\x17\n\x0f\n\x05\x04-\x02\x02\x08\x12\x06\xc9\r\x18\
    \xce\r\x05\n\x10\n\x08\x04-\x02\x02\x08\x9c\x08\0\x12\x04\xca\r\x06,\n\
    \x11\n\x07\x04-\x02\x02\x08\x9f\x08\x12\x06\xcb\r\x06\xcd\r\x07\nF\n\x02\
    \x04.\x12\x04\xd3\r\0\x17\x1a:\x20Response\x20for\x20the\x20`Seek`\x20me\
    thod\x20(this\x20response\x20is\x20empty).\n\n\x0b\n\x03\x04.\x01\x12\
    \x04\xd3\r\x08\x14b\x06proto3\
";
